...
{		
	...
	public partial class KetQuaThanhToanThuLaoServiceBase : ServiceBase<KetQuaThanhToanThuLao, KetQuaThanhToanThuLaoKey>
	{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public virtual  IDataReader TongHopKetQuaChiTien(System.String namHoc, System.String hocKy, System.String donVi, System.String loaiGiangVien, System.Int32 lanChot, System.String nganHang)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("TongHopKetQuaChiTien");
			#endregion Security check
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction(noTranByDefault);
				dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.KetQuaThanhToanThuLaoProvider.TongHopKetQuaChiTien(transactionManager , namHoc, hocKy, donVi, loaiGiangVien, lanChot, nganHang);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public virtual  IDataReader TongHopKetQuaChiTien( System.String namHoc, System.String hocKy, System.String donVi, System.String loaiGiangVien, System.Int32 lanChot, System.String nganHang, int start, int pageLength)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("TongHopKetQuaChiTien");
			...
			try
            {
				...
				result = dataProvider.KetQuaThanhToanThuLaoProvider.TongHopKetQuaChiTien(transactionManager, start, pageLength , namHoc, hocKy, donVi, loaiGiangVien, lanChot, nganHang);
