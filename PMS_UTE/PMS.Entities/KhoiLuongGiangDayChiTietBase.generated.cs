        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{55}{54}- MaKhoiLuong: {0}{54}- MaLichHoc: {1}{54}- MaGiangVien: {2}{54}- MaLopHocPhan: {3}{54}- NamHoc: {4}{54}- HocKy: {5}{54}- MaMonHoc: {6}{54}- TenMonHoc: {7}{54}- Nhom: {8}{54}- SoTinChi: {9}{54}- LyThuyet: {10}{54}- ThucHanh: {11}{54}- BaiTap: {12}{54}- BaiTapLon: {13}{54}- DoAn: {14}{54}- LuanAn: {15}{54}- TieuLuan: {16}{54}- ThucTap: {17}{54}- SoLuong: {18}{54}- MaLoaiHocPhan: {19}{54}- LoaiHocPhan: {20}{54}- PhanLoai: {21}{54}- HeSoThanhPhan: {22}{54}- Nam: {23}{54}- Tuan: {24}{54}- DonViTinh: {25}{54}- MaBuoiHoc: {26}{54}- MaLop: {27}{54}- TietBatDau: {28}{54}- SoTiet: {29}{54}- TinhTrang: {30}{54}- NgayDay: {31}{54}- Compensate: {32}{54}- MaBacDaoTao: {33}{54}- MaKhoa: {34}{54}- MaNhomMonHoc: {35}{54}- MaPhongHoc: {36}{54}- MaKhoaHoc: {37}{54}- LoaiHocKy: {38}{54}- HeSoHocKy: {39}{54}- NamThu: {40}{54}- MaHocHam: {41}{54}- MaHocVi: {42}{54}- MaLoaiGiangVien: {43}{54}- MaChucVu: {44}{54}- MaHinhThucDaoTao: {45}{54}- GhiChu: {46}{54}- NgayCapNhat: {47}{54}- LopHocPhanChuyenNganh: {48}{54}- DotImport: {49}{54}- DaoTaoTinChi: {50}{54}- MaCauHinhChotGio: {51}{54}- MaKhoaCuaMonHoc: {52}{54}- MaLoaiHinhDaoTao: {53}{54}{56}", 
				this.MaKhoiLuong,
				this.MaLichHoc,
				this.MaGiangVien,
