...
namespace PMS.Entities
{
	...
	{		
		...
		protected override void AddValidationRules()
		{
			...
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
				new CommonRules.MaxLengthRuleArgs("NgaySinh", "Ngay Sinh", 50));
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
				new CommonRules.MaxLengthRuleArgs("NoiSinh", "Noi Sinh", 200));
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
				new CommonRules.MaxLengthRuleArgs("Cmnd", "Cmnd", 50));
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
				new CommonRules.MaxLengthRuleArgs("NgayCap", "Ngay Cap", 50));
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
				new CommonRules.MaxLengthRuleArgs("NoiCap", "Noi Cap", 200));
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
				new CommonRules.MaxLengthRuleArgs("NgayVaoDoanDang", "Ngay Vao Doan Dang", 50));
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
...
/*
	...
	public enum GiangVienColumn : int
	{
		...
		[ColumnEnum("NgaySinh", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 50)]
		NgaySinh = 15,
		/// <summary>
		/// GioiTinh : 
		/// </summary>
		...
		/// </summary>
		[EnumTextValue("Cmnd")]
		[ColumnEnum("Cmnd", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 50)]
		Cmnd = 18,
		/// <summary>
		/// NgayCap : 
		/// </summary>
		[EnumTextValue("Ngay Cap")]
		[ColumnEnum("NgayCap", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 50)]
		NgayCap = 19,
		/// <summary>
		/// NoiCap : 
		/// </summary>
		...
		[ColumnEnum("NgayVaoDoanDang", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 50)]
		NgayVaoDoanDang = 22,
		/// <summary>
		/// NgayKyHopDong : 
		/// </summary>
