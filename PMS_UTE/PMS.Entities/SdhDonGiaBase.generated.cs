...
namespace PMS.Entities
{
	...
	{		
		...
		public SdhDonGiaBase(System.String _maQuanLy, System.Int32? _maLoaiGiangVien, System.Int32? _maHocHam, 
			...
			System.String _ngonNguGiangDay, System.String _namHoc, System.String _hocKy, System.Int32? _tietBatDauDay, 
			System.Int32? _tietKetThucDay)
		{
			this.entityData = new SdhDonGiaEntityData();
			this.backupData = null;
			...
			this.NamHoc = _namHoc;
			this.HocKy = _hocKy;
			this.TietBatDauDay = _tietBatDauDay;
			this.TietKetThucDay = _tietKetThucDay;
		}
			...
			System.Int32? _tietKetThucDay)
		{
			...
			newSdhDonGia.TietBatDauDay = _tietBatDauDay;
			newSdhDonGia.TietKetThucDay = _tietKetThucDay;
			return newSdhDonGia;
		}
		...
		/// <summary>
		/// 	Gets or sets the TietBatDauDay property. 
		///		
		/// </summary>
		/// <value>This type is int.</value>
		/// <remarks>
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		public virtual System.Int32? TietBatDauDay
		{
			get
			{
				return this.entityData.TietBatDauDay; 
			}
			
			set
			{
				if (this.entityData.TietBatDauDay == value)
					return;
				
                OnPropertyChanging("TietBatDauDay");                    
				OnColumnChanging(SdhDonGiaColumn.TietBatDauDay, this.entityData.TietBatDauDay);
				this.entityData.TietBatDauDay = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhDonGiaColumn.TietBatDauDay, this.entityData.TietBatDauDay);
				OnPropertyChanged("TietBatDauDay");
			}
		}
		
		/// <summary>
		/// 	Gets or sets the TietKetThucDay property. 
		///		
		/// </summary>
		/// <value>This type is int.</value>
		/// <remarks>
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		public virtual System.Int32? TietKetThucDay
		{
			get
			{
				return this.entityData.TietKetThucDay; 
			}
			
			set
			{
				if (this.entityData.TietKetThucDay == value)
					return;
				
                OnPropertyChanging("TietKetThucDay");                    
				OnColumnChanging(SdhDonGiaColumn.TietKetThucDay, this.entityData.TietKetThucDay);
				this.entityData.TietKetThucDay = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhDonGiaColumn.TietKetThucDay, this.entityData.TietKetThucDay);
				OnPropertyChanged("TietKetThucDay");
			}
		}
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"Id", "MaQuanLy", "MaLoaiGiangVien", "MaHocHam", "MaHocVi", "DonGia", "NgayCapNhat", "NguoiCapNhat", "DonGiaClc", "HeSoQuyDoiChatLuong", "DonGiaTrongChuan", "DonGiaNgoaiChuan", "MaHinhThucDaoTao", "BacDaoTao", "NgonNguGiangDay", "NamHoc", "HocKy", "TietBatDauDay", "TietKetThucDay"};
			}
		}
		#endregion 
		...
		protected virtual SdhDonGia Copy(IDictionary existingCopies)
		{
			...
			copy.SuppressEntityEvents = true;
				...
				copy.TietBatDauDay = this.TietBatDauDay;
				copy.TietKetThucDay = this.TietKetThucDay;
		...
		public bool IsPropertyChanged(SdhDonGiaColumn column)
		{
			switch(column)
			{
					...
					case SdhDonGiaColumn.TietBatDauDay:
					return entityData.TietBatDauDay != _originalData.TietBatDauDay;
					case SdhDonGiaColumn.TietKetThucDay:
					return entityData.TietKetThucDay != _originalData.TietKetThucDay;
		...
		public bool HasDataChanged()
		{
			...
			result = result || entityData.TietBatDauDay != _originalData.TietBatDauDay;
			result = result || entityData.TietKetThucDay != _originalData.TietKetThucDay;
			return result;
		}	
		...
		public SdhDonGia GetOriginalEntity()
		{
			if (_originalData != null)
				...
				_originalData.HocKy,
				_originalData.TietBatDauDay,
				_originalData.TietKetThucDay
				);
	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.Id.GetHashCode() ^ 
					...
					((this.TietBatDauDay == null) ? string.Empty : this.TietBatDauDay.ToString()).GetHashCode() ^ 
					((this.TietKetThucDay == null) ? string.Empty : this.TietKetThucDay.ToString()).GetHashCode();
        }
		...
		public static bool ValueEquals(SdhDonGiaBase Object1, SdhDonGiaBase Object2)
		{
			...
			if ( Object1.TietBatDauDay != null && Object2.TietBatDauDay != null )
			{
				if (Object1.TietBatDauDay != Object2.TietBatDauDay)
					equal = false;
			}
			else if (Object1.TietBatDauDay == null ^ Object2.TietBatDauDay == null )
			{
				equal = false;
			}
			if ( Object1.TietKetThucDay != null && Object2.TietKetThucDay != null )
			{
				if (Object1.TietKetThucDay != Object2.TietKetThucDay)
					equal = false;
			}
			else if (Object1.TietKetThucDay == null ^ Object2.TietKetThucDay == null )
			{
				equal = false;
			}
...
/*
        ...
        public int CompareTo(SdhDonGia rhs, SdhDonGiaColumn which)
        {
            switch (which)
            {
            	...
            	case SdhDonGiaColumn.TietBatDauDay:
            		return this.TietBatDauDay.Value.CompareTo(rhs.TietBatDauDay.Value);
            		
            		                 
            	
            	
            	case SdhDonGiaColumn.TietKetThucDay:
            		return this.TietKetThucDay.Value.CompareTo(rhs.TietKetThucDay.Value);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{20}{19}- Id: {0}{19}- MaQuanLy: {1}{19}- MaLoaiGiangVien: {2}{19}- MaHocHam: {3}{19}- MaHocVi: {4}{19}- DonGia: {5}{19}- NgayCapNhat: {6}{19}- NguoiCapNhat: {7}{19}- DonGiaClc: {8}{19}- HeSoQuyDoiChatLuong: {9}{19}- DonGiaTrongChuan: {10}{19}- DonGiaNgoaiChuan: {11}{19}- MaHinhThucDaoTao: {12}{19}- BacDaoTao: {13}{19}- NgonNguGiangDay: {14}{19}- NamHoc: {15}{19}- HocKy: {16}{19}- TietBatDauDay: {17}{19}- TietKetThucDay: {18}{19}{21}", 
				this.Id,
				...
				(this.TietBatDauDay == null) ? string.Empty : this.TietBatDauDay.ToString(),
				(this.TietKetThucDay == null) ? string.Empty : this.TietKetThucDay.ToString(),
	...
	internal protected class SdhDonGiaEntityData : ICloneable, ICloneableEx
	{
		...
		/// TietBatDauDay : 
		/// </summary>
		public System.Int32? TietBatDauDay = null;
		
		/// <summary>
		/// TietKetThucDay : 
		/// </summary>
		public System.Int32? TietKetThucDay = null;
		#endregion
		...
		public Object Clone()
		{
			...
			_tmp.TietBatDauDay = this.TietBatDauDay;
			_tmp.TietKetThucDay = this.TietKetThucDay;
	...
	public enum SdhDonGiaColumn : int
	{
		...
		/// TietBatDauDay : 
		/// </summary>
		[EnumTextValue("Tiet Bat Dau Day")]
		[ColumnEnum("TietBatDauDay", typeof(System.Int32), System.Data.DbType.Int32, false, false, true)]
		TietBatDauDay = 18,
		/// <summary>
		/// TietKetThucDay : 
		/// </summary>
		[EnumTextValue("Tiet Ket Thuc Day")]
		[ColumnEnum("TietKetThucDay", typeof(System.Int32), System.Data.DbType.Int32, false, false, true)]
		TietKetThucDay = 19
	}//End enum
