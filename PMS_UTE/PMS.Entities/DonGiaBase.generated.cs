...
{
	///<summary>
	/// An object representation of the 'DonGia' table. [No description found the database]	
	///</summary>
	[Serializable]
	[DataObject, CLSCompliant(true)]
	public abstract partial class DonGiaBase : EntityBase, IDonGia, IEntityId<DonGiaKey>, System.IComparable, System.ICloneable, ICloneableEx, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		/// </summary>
		private DonGiaEntityData entityData;
		
		/// <summary>
		/// 	Hold the original data of the entity, as loaded from the repository.
		/// </summary>
		private DonGiaEntityData _originalData;
		
		/// <summary>
		/// 	Hold a backup of the inner data of the entity.
		/// </summary>
		private DonGiaEntityData backupData; 
		...
		[NonSerialized]
		private TList<DonGia> parentCollection;
		...
		/// </summary>
		[field:NonSerialized]
		public event DonGiaEventHandler ColumnChanging;		
		
		/// <summary>
		/// Occurs after a value has been changed for the specified column.
		/// </summary>
		[field:NonSerialized]
		public event DonGiaEventHandler ColumnChanged;
		
		#endregion Variable Declarations
		
		#region Constructors
		///<summary>
		/// Creates a new <see cref="DonGiaBase"/> instance.
		///</summary>
		public DonGiaBase()
		{
			this.entityData = new DonGiaEntityData();
		...
		///<param name="_donGiaGdtc"></param>
		///<param name="_donGiaDoAnClc"></param>
		///<param name="_donGiaDoAnDaiTra"></param>
		public DonGiaBase(System.String _maQuanLy, System.Int32? _maLoaiGiangVien, System.Int32? _maHocHam, 
			System.Int32? _maHocVi, System.Decimal? _donGia, System.DateTime? _ngayCapNhat, System.String _nguoiCapNhat, 
			System.Decimal? _donGiaClc, System.Decimal? _heSoQuyDoiChatLuong, System.Decimal? _donGiaTrongChuan, System.Decimal? _donGiaNgoaiChuan, 
			System.String _maHinhThucDaoTao, System.String _bacDaoTao, System.String _ngonNguGiangDay, System.String _namHoc, 
			System.String _hocKy, System.Int32? _maNhomMon, System.String _nhomMonHoc, System.Decimal? _donGiaNgoaiNgu, 
			System.Decimal? _donGiaGdtc, System.Decimal? _donGiaDoAnClc, System.Decimal? _donGiaDoAnDaiTra)
		{
			this.entityData = new DonGiaEntityData();
			this.backupData = null;
			...
			this.DonGiaGdtc = _donGiaGdtc;
			this.DonGiaDoAnClc = _donGiaDoAnClc;
			this.DonGiaDoAnDaiTra = _donGiaDoAnDaiTra;
		}
		...
		public static DonGia CreateDonGia(System.String _maQuanLy, System.Int32? _maLoaiGiangVien, System.Int32? _maHocHam, 
			...
			System.Decimal? _donGiaGdtc, System.Decimal? _donGiaDoAnClc, System.Decimal? _donGiaDoAnDaiTra)
		{
			DonGia newDonGia = new DonGia();
			newDonGia.MaQuanLy = _maQuanLy;
			newDonGia.MaLoaiGiangVien = _maLoaiGiangVien;
			newDonGia.MaHocHam = _maHocHam;
			newDonGia.MaHocVi = _maHocVi;
			newDonGia.DonGia = _donGia;
			newDonGia.NgayCapNhat = _ngayCapNhat;
			newDonGia.NguoiCapNhat = _nguoiCapNhat;
			newDonGia.DonGiaClc = _donGiaClc;
			newDonGia.HeSoQuyDoiChatLuong = _heSoQuyDoiChatLuong;
			newDonGia.DonGiaTrongChuan = _donGiaTrongChuan;
			newDonGia.DonGiaNgoaiChuan = _donGiaNgoaiChuan;
			newDonGia.MaHinhThucDaoTao = _maHinhThucDaoTao;
			newDonGia.BacDaoTao = _bacDaoTao;
			newDonGia.NgonNguGiangDay = _ngonNguGiangDay;
			newDonGia.NamHoc = _namHoc;
			newDonGia.HocKy = _hocKy;
			newDonGia.MaNhomMon = _maNhomMon;
			newDonGia.NhomMonHoc = _nhomMonHoc;
			newDonGia.DonGiaNgoaiNgu = _donGiaNgoaiNgu;
			newDonGia.DonGiaGdtc = _donGiaGdtc;
			newDonGia.DonGiaDoAnClc = _donGiaDoAnClc;
			newDonGia.DonGiaDoAnDaiTra = _donGiaDoAnDaiTra;
			return newDonGia;
		}
		...
		public virtual System.Int32 Id
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.Id, this.entityData.Id);
				this.entityData.Id = value;
				this.EntityId.Id = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.Id, this.entityData.Id);
		...
		public virtual System.String MaQuanLy
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.MaQuanLy, this.entityData.MaQuanLy);
				this.entityData.MaQuanLy = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.MaQuanLy, this.entityData.MaQuanLy);
		...
		public virtual System.Int32? MaLoaiGiangVien
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.MaLoaiGiangVien, this.entityData.MaLoaiGiangVien);
				this.entityData.MaLoaiGiangVien = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.MaLoaiGiangVien, this.entityData.MaLoaiGiangVien);
		...
		public virtual System.Int32? MaHocHam
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.MaHocHam, this.entityData.MaHocHam);
				this.entityData.MaHocHam = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.MaHocHam, this.entityData.MaHocHam);
		...
		public virtual System.Int32? MaHocVi
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.MaHocVi, this.entityData.MaHocVi);
				this.entityData.MaHocVi = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.MaHocVi, this.entityData.MaHocVi);
		...
		public virtual System.Decimal? DonGia
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.DonGia, this.entityData.DonGia);
				this.entityData.DonGia = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.DonGia, this.entityData.DonGia);
		...
		public virtual System.DateTime? NgayCapNhat
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.NgayCapNhat, this.entityData.NgayCapNhat);
				this.entityData.NgayCapNhat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.NgayCapNhat, this.entityData.NgayCapNhat);
		...
		public virtual System.String NguoiCapNhat
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.NguoiCapNhat, this.entityData.NguoiCapNhat);
				this.entityData.NguoiCapNhat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.NguoiCapNhat, this.entityData.NguoiCapNhat);
		...
		public virtual System.Decimal? DonGiaClc
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.DonGiaClc, this.entityData.DonGiaClc);
				this.entityData.DonGiaClc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.DonGiaClc, this.entityData.DonGiaClc);
		...
		public virtual System.Decimal? HeSoQuyDoiChatLuong
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.HeSoQuyDoiChatLuong, this.entityData.HeSoQuyDoiChatLuong);
				this.entityData.HeSoQuyDoiChatLuong = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.HeSoQuyDoiChatLuong, this.entityData.HeSoQuyDoiChatLuong);
		...
		public virtual System.Decimal? DonGiaTrongChuan
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.DonGiaTrongChuan, this.entityData.DonGiaTrongChuan);
				this.entityData.DonGiaTrongChuan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.DonGiaTrongChuan, this.entityData.DonGiaTrongChuan);
		...
		public virtual System.Decimal? DonGiaNgoaiChuan
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.DonGiaNgoaiChuan, this.entityData.DonGiaNgoaiChuan);
				this.entityData.DonGiaNgoaiChuan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.DonGiaNgoaiChuan, this.entityData.DonGiaNgoaiChuan);
		...
		public virtual System.String MaHinhThucDaoTao
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.MaHinhThucDaoTao, this.entityData.MaHinhThucDaoTao);
				this.entityData.MaHinhThucDaoTao = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.MaHinhThucDaoTao, this.entityData.MaHinhThucDaoTao);
		...
		public virtual System.String BacDaoTao
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.BacDaoTao, this.entityData.BacDaoTao);
				this.entityData.BacDaoTao = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.BacDaoTao, this.entityData.BacDaoTao);
		...
		public virtual System.String NgonNguGiangDay
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.NgonNguGiangDay, this.entityData.NgonNguGiangDay);
				this.entityData.NgonNguGiangDay = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.NgonNguGiangDay, this.entityData.NgonNguGiangDay);
		...
		public virtual System.String NamHoc
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.NamHoc, this.entityData.NamHoc);
				this.entityData.NamHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.NamHoc, this.entityData.NamHoc);
		...
		public virtual System.String HocKy
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.HocKy, this.entityData.HocKy);
				this.entityData.HocKy = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.HocKy, this.entityData.HocKy);
		...
		public virtual System.Int32? MaNhomMon
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.MaNhomMon, this.entityData.MaNhomMon);
				this.entityData.MaNhomMon = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.MaNhomMon, this.entityData.MaNhomMon);
		...
		public virtual System.String NhomMonHoc
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.NhomMonHoc, this.entityData.NhomMonHoc);
				this.entityData.NhomMonHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.NhomMonHoc, this.entityData.NhomMonHoc);
		...
		public virtual System.Decimal? DonGiaNgoaiNgu
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.DonGiaNgoaiNgu, this.entityData.DonGiaNgoaiNgu);
				this.entityData.DonGiaNgoaiNgu = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.DonGiaNgoaiNgu, this.entityData.DonGiaNgoaiNgu);
				OnPropertyChanged("DonGiaNgoaiNgu");
			}
		}
		
		/// <summary>
		/// 	Gets or sets the DonGiaGdtc property. 
		///		
		/// </summary>
		/// <value>This type is decimal.</value>
		/// <remarks>
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		public virtual System.Decimal? DonGiaGdtc
		{
			get
			{
				return this.entityData.DonGiaGdtc; 
			}
			
			set
			{
				if (this.entityData.DonGiaGdtc == value)
					return;
				
                OnPropertyChanging("DonGiaGdtc");                    
				OnColumnChanging(DonGiaColumn.DonGiaGdtc, this.entityData.DonGiaGdtc);
				this.entityData.DonGiaGdtc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.DonGiaGdtc, this.entityData.DonGiaGdtc);
				OnPropertyChanged("DonGiaGdtc");
			}
		}
		...
		public virtual System.Decimal? DonGiaDoAnClc
		{
			...
			set
			{
				...
				OnColumnChanging(DonGiaColumn.DonGiaDoAnClc, this.entityData.DonGiaDoAnClc);
				this.entityData.DonGiaDoAnClc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.DonGiaDoAnClc, this.entityData.DonGiaDoAnClc);
				OnPropertyChanged("DonGiaDoAnClc");
			}
		}
		
		/// <summary>
		/// 	Gets or sets the DonGiaDoAnDaiTra property. 
		///		
		/// </summary>
		/// <value>This type is decimal.</value>
		/// <remarks>
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		public virtual System.Decimal? DonGiaDoAnDaiTra
		{
			get
			{
				return this.entityData.DonGiaDoAnDaiTra; 
			}
			
			set
			{
				if (this.entityData.DonGiaDoAnDaiTra == value)
					return;
				
                OnPropertyChanging("DonGiaDoAnDaiTra");                    
				OnColumnChanging(DonGiaColumn.DonGiaDoAnDaiTra, this.entityData.DonGiaDoAnDaiTra);
				this.entityData.DonGiaDoAnDaiTra = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(DonGiaColumn.DonGiaDoAnDaiTra, this.entityData.DonGiaDoAnDaiTra);
				OnPropertyChanged("DonGiaDoAnDaiTra");
			}
		}
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"Id", "MaQuanLy", "MaLoaiGiangVien", "MaHocHam", "MaHocVi", "DonGia", "NgayCapNhat", "NguoiCapNhat", "DonGiaClc", "HeSoQuyDoiChatLuong", "DonGiaTrongChuan", "DonGiaNgoaiChuan", "MaHinhThucDaoTao", "BacDaoTao", "NgonNguGiangDay", "NamHoc", "HocKy", "MaNhomMon", "NhomMonHoc", "DonGiaNgoaiNgu", "DonGiaGdtc", "DonGiaDoAnClc", "DonGiaDoAnDaiTra"};
			}
		}
		#endregion 
		...
		void IEditableObject.BeginEdit() 
	    {
	        ...
	        if (!inTxn) 
	        {
	            this.backupData = this.entityData.Clone() as DonGiaEntityData;
	            inTxn = true;
	        ...
	        if (this.inTxn) 
	        {
	        	...
	        	//if (this.EntityState == EntityState.Added)
	        	{
					if (this.parentCollection != null)
						this.parentCollection.Remove( (DonGia) this ) ;
				}	            
	        }
	    ...
	    public override object ParentCollection
	    {
	        ...
	        set 
	        {
	            this.parentCollection = value as TList<DonGia>;
	        }
	    }
	    ...
	    private void OnEntityChanged() 
	    {
	        ...
	        {
	            this.parentCollection.EntityChanged(this as DonGia);
	        }
	    }
		...
		///<summary>
		///  Returns a Typed DonGia Entity 
		///</summary>
		protected virtual DonGia Copy(IDictionary existingCopies)
		{
			...
			copy.SuppressEntityEvents = true;
				...
				copy.DonGiaGdtc = this.DonGiaGdtc;
				copy.DonGiaDoAnClc = this.DonGiaDoAnClc;
				copy.DonGiaDoAnDaiTra = this.DonGiaDoAnDaiTra;
		...
		///<summary>
		///  Returns a Typed DonGia Entity which is a deep copy of the current entity.
		///</summary>
		public virtual DonGia DeepCopy()
		{
			return EntityHelper.Clone<DonGia>(this as DonGia);	
		}
		#endregion
		...
		public override void CancelChanges()
		{
			...
			{
				this.entityData = this._originalData.Clone() as DonGiaEntityData;
			}
			else
			{
		...
		public override void AcceptChanges()
		{
			...
			this._originalData = this.entityData.Clone() as DonGiaEntityData;
		}
		...
		{
			return 	IsPropertyChanged(EntityHelper.GetEnumValue< DonGiaColumn >(columnName));
		}
		...
		public bool HasDataChanged()
		{
			...
			result = result || entityData.DonGiaGdtc != _originalData.DonGiaGdtc;
			result = result || entityData.DonGiaDoAnClc != _originalData.DonGiaDoAnClc;
			result = result || entityData.DonGiaDoAnDaiTra != _originalData.DonGiaDoAnDaiTra;
			return result;
		}	
		
		///<summary>
		///  Returns a DonGia Entity with the original data.
		///</summary>
		public DonGia GetOriginalEntity()
		{
			if (_originalData != null)
				...
				_originalData.DonGiaGdtc,
				_originalData.DonGiaDoAnClc,
				_originalData.DonGiaDoAnDaiTra
				);
				
			return (DonGia)this.Clone();
		}
		#endregion
	...
	#region Value Semantics Instance Equality
        ...
        ///<returns>true if Object1 is a <see cref="DonGiaBase"/> and has the same value as this instance; otherwise, false.</returns>
        public override bool Equals(object Object1)
        {
			// Cast exception if Object1 is null or DbNull
			if (Object1 != null && Object1 != DBNull.Value && Object1 is DonGiaBase)
				return ValueEquals(this, (DonGiaBase)Object1);
			else
				return false;
        }
        ...
        /// Provides a hash function that is appropriate for <see cref="DonGiaBase"/> class 
        ...
        public override int GetHashCode()
        {
			return this.Id.GetHashCode() ^ 
					...
					((this.DonGiaGdtc == null) ? string.Empty : this.DonGiaGdtc.ToString()).GetHashCode() ^ 
					((this.DonGiaDoAnClc == null) ? string.Empty : this.DonGiaDoAnClc.ToString()).GetHashCode() ^ 
					((this.DonGiaDoAnDaiTra == null) ? string.Empty : this.DonGiaDoAnDaiTra.ToString()).GetHashCode();
        }
		...
		///<returns>true if toObject is a <see cref="DonGiaBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(DonGiaBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="DonGiaBase"/> instances are considered equal using value semantics.
		///</summary>
		///<param name="Object1">The first <see cref="DonGiaBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="DonGiaBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool ValueEquals(DonGiaBase Object1, DonGiaBase Object2)
		{
			// both are null
			...
			if ( Object1.DonGiaGdtc != null && Object2.DonGiaGdtc != null )
			{
				if (Object1.DonGiaGdtc != Object2.DonGiaGdtc)
					equal = false;
			}
			else if (Object1.DonGiaGdtc == null ^ Object2.DonGiaGdtc == null )
			{
				equal = false;
			}
			...
			if ( Object1.DonGiaDoAnDaiTra != null && Object2.DonGiaDoAnDaiTra != null )
			{
				if (Object1.DonGiaDoAnDaiTra != Object2.DonGiaDoAnDaiTra)
					equal = false;
			}
			else if (Object1.DonGiaDoAnDaiTra == null ^ Object2.DonGiaDoAnDaiTra == null )
			{
				equal = false;
			}
		...
		public virtual int CompareTo(object obj)
		{
			...
			//return this. GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]) .CompareTo(((DonGiaBase)obj).GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]));
		}
		
		/*
		// static method to get a Comparer object
        public static DonGiaComparer GetComparer()
        {
            return new DonGiaComparer();
        }
        */

        // Comparer delegates back to DonGia
...
/*
        ...
        public int CompareTo(DonGia rhs, DonGiaColumn which)
        {
            switch (which)
            {
            	...
            	case DonGiaColumn.DonGiaGdtc:
            		return this.DonGiaGdtc.Value.CompareTo(rhs.DonGiaGdtc.Value);
            	...
            	case DonGiaColumn.DonGiaDoAnDaiTra:
            		return this.DonGiaDoAnDaiTra.Value.CompareTo(rhs.DonGiaDoAnDaiTra.Value);
        ...
        */
		...
		#region IEntityKey<DonGiaKey> Members
		
		// member variable for the EntityId property
		private DonGiaKey _entityId;

		/// <summary>
		/// Gets or sets the EntityId property.
		/// </summary>
		[XmlIgnore]
		public virtual DonGiaKey EntityId
		{
			get
			{
				if ( _entityId == null )
				{
					_entityId = new DonGiaKey(this);
				}
		...
		public override string EntityTrackingKey
		{
			get
			{
				if(entityTrackingKey == null)
					entityTrackingKey = new System.Text.StringBuilder("DonGia")
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{24}{23}- Id: {0}{23}- MaQuanLy: {1}{23}- MaLoaiGiangVien: {2}{23}- MaHocHam: {3}{23}- MaHocVi: {4}{23}- DonGia: {5}{23}- NgayCapNhat: {6}{23}- NguoiCapNhat: {7}{23}- DonGiaClc: {8}{23}- HeSoQuyDoiChatLuong: {9}{23}- DonGiaTrongChuan: {10}{23}- DonGiaNgoaiChuan: {11}{23}- MaHinhThucDaoTao: {12}{23}- BacDaoTao: {13}{23}- NgonNguGiangDay: {14}{23}- NamHoc: {15}{23}- HocKy: {16}{23}- MaNhomMon: {17}{23}- NhomMonHoc: {18}{23}- DonGiaNgoaiNgu: {19}{23}- DonGiaGdtc: {20}{23}- DonGiaDoAnClc: {21}{23}- DonGiaDoAnDaiTra: {22}{23}{25}", 
				this.Id,
				...
				(this.DonGiaGdtc == null) ? string.Empty : this.DonGiaGdtc.ToString(),
				(this.DonGiaDoAnClc == null) ? string.Empty : this.DonGiaDoAnClc.ToString(),
				(this.DonGiaDoAnDaiTra == null) ? string.Empty : this.DonGiaDoAnDaiTra.ToString(),
	...
	/// <summary>
	///		The data structure representation of the 'DonGia' table.
	/// </summary>
	/// <remarks>
	...
	[Serializable]
	internal protected class DonGiaEntityData : ICloneable, ICloneableEx
	{
		#region Variable Declarations
		...
		/// Id : 
		/// </summary>
		/// <remarks>Member of the primary key of the underlying table "DonGia"</remarks>
		...
		/// DonGiaGdtc : 
		/// </summary>
		public System.Decimal? DonGiaGdtc = null;
		...
		/// DonGiaDoAnDaiTra : 
		/// </summary>
		public System.Decimal? DonGiaDoAnDaiTra = null;
		#endregion
		...
		public Object Clone()
		{
			DonGiaEntityData _tmp = new DonGiaEntityData();
			...
			_tmp.DonGiaGdtc = this.DonGiaGdtc;
			_tmp.DonGiaDoAnClc = this.DonGiaDoAnClc;
			_tmp.DonGiaDoAnDaiTra = this.DonGiaDoAnDaiTra;
		...
		/// </summary>
		/// <param name="column">The <see cref="DonGiaColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanging(DonGiaColumn column)
		{
		...
		/// </summary>
		/// <param name="column">The <see cref="DonGiaColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanged(DonGiaColumn column)
		{
		...
		public virtual void OnColumnChanging(DonGiaColumn column, object value)
		{
			...
			if (!SuppressEntityEvents)
			{
				DonGiaEventHandler handler = ColumnChanging;
				if(handler != null)
				{
					handler(this, new DonGiaEventArgs(column, value));
				}
			}
		}
		...
		/// <param name="column">The <see cref="DonGiaColumn"/> which has raised the event.</param>
		/// <param name="value">The changed value.</param>
		public virtual void OnColumnChanged(DonGiaColumn column, object value)
		{
			if (!SuppressEntityEvents)
			{
				DonGiaEventHandler handler = ColumnChanged;
				if(handler != null)
				{
					handler(this, new DonGiaEventArgs(column, value));
				}
	...
	#region DonGiaEventArgs class
	/// <summary>
	/// Provides data for the ColumnChanging and ColumnChanged events.
	/// </summary>
	/// <remarks>
	/// The ColumnChanging and ColumnChanged events occur when a change is made to the value 
	/// of a property of a <see cref="DonGia"/> object.
	/// </remarks>
	public class DonGiaEventArgs : System.EventArgs
	{
		private DonGiaColumn column;
		private object value;
		
		///<summary>
		/// Initalizes a new Instance of the DonGiaEventArgs class.
		///</summary>
		public DonGiaEventArgs(DonGiaColumn column)
		{
			this.column = column;
		}
		...
		/// Initalizes a new Instance of the DonGiaEventArgs class.
		///</summary>
		public DonGiaEventArgs(DonGiaColumn column, object value)
		{
			this.column = column;
			this.value = value;
		}
		...
		///<summary>
		/// The DonGiaColumn that was modified, which has raised the event.
		///</summary>
		///<value cref="DonGiaColumn" />
		public DonGiaColumn Column { get { return this.column; } }
	...
	///<summary>
	/// Define a delegate for all DonGia related events.
	///</summary>
	public delegate void DonGiaEventHandler(object sender, DonGiaEventArgs e);
	
	#region DonGiaComparer
		
	/// <summary>
	///	Strongly Typed IComparer
	/// </summary>
	public class DonGiaComparer : System.Collections.Generic.IComparer<DonGia>
	{
		DonGiaColumn whichComparison;
		
		/// <summary>
        /// Initializes a new instance of the <see cref="T:DonGiaComparer"/> class.
        /// </summary>
		public DonGiaComparer()
        {            
        }               
        ...
        public DonGiaComparer(DonGiaColumn column)
        {
            this.whichComparison = column;
        }

		/// <summary>
        /// Determines whether the specified <see cref="DonGia"/> instances are considered equal.
        /// </summary>
        /// <param name="a">The first <see cref="DonGia"/> to compare.</param>
        /// <param name="b">The second <c>DonGia</c> to compare.</param>
        /// <returns>true if objA is the same instance as objB or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
        public bool Equals(DonGia a, DonGia b)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(DonGia entity)
        {
        ...
        /// <returns></returns>
        public int Compare(DonGia a, DonGia b)
        {
        ...
        public DonGiaColumn WhichComparison
        {
	...
	#region DonGiaKey Class

	/// <summary>
	/// Wraps the unique identifier values for the <see cref="DonGia"/> object.
	/// </summary>
	[Serializable]
	[CLSCompliant(true)]
	public class DonGiaKey : EntityKeyBase
	{
		#region Constructors
		
		/// <summary>
		/// Initializes a new instance of the DonGiaKey class.
		/// </summary>
		public DonGiaKey()
		{
		}
		...
		/// Initializes a new instance of the DonGiaKey class.
		/// </summary>
		public DonGiaKey(DonGiaBase entity)
		{
			this.Entity = entity;
		...
		/// Initializes a new instance of the DonGiaKey class.
		/// </summary>
		public DonGiaKey(System.Int32 _id)
		{
			#region Init Properties
		...
		private DonGiaBase _entity;
		
		/// <summary>
		/// Gets or sets the Entity property.
		/// </summary>
		public DonGiaBase Entity
		{
			get { return _entity; }
			set { _entity = value; }
		}
	...
	#region DonGiaColumn Enum
	
	/// <summary>
	/// Enumerate the DonGia columns.
	/// </summary>
	[Serializable]
	public enum DonGiaColumn : int
	{
		/// <summary>
		/// Id : 
		/// </summary>
		...
		/// DonGiaGdtc : 
		/// </summary>
		[EnumTextValue("Don Gia Gdtc")]
		[ColumnEnum("DonGiaGdtc", typeof(System.Decimal), System.Data.DbType.Decimal, false, false, true)]
		DonGiaGdtc = 21,
		/// <summary>
		/// DonGiaDoAnClc : 
		/// </summary>
		...
		/// DonGiaDoAnDaiTra : 
		/// </summary>
		[EnumTextValue("Don Gia Do An Dai Tra")]
		[ColumnEnum("DonGiaDoAnDaiTra", typeof(System.Decimal), System.Data.DbType.Decimal, false, false, true)]
		DonGiaDoAnDaiTra = 23
	}//End enum

	#endregion DonGiaColumn Enum
