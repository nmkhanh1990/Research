...
{	
	...
	public abstract class ViewKhoaBoMonProviderBaseCore : EntityViewProviderBase<ViewKhoaBoMon>
	{
		...
		public IDataReader GetBoMonByMaKhoa(System.String maKhoa)
		{
			return GetBoMonByMaKhoa(null, 0, int.MaxValue , maKhoa);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader GetBoMonByMaKhoa(int start, int pageLength, System.String maKhoa)
		{
			return GetBoMonByMaKhoa(null, start, pageLength , maKhoa);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader GetBoMonByMaKhoa(TransactionManager transactionManager, System.String maKhoa)
		{
			return GetBoMonByMaKhoa(transactionManager, 0, int.MaxValue , maKhoa);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public abstract IDataReader GetBoMonByMaKhoa(TransactionManager transactionManager, int start, int pageLength, System.String maKhoa);
