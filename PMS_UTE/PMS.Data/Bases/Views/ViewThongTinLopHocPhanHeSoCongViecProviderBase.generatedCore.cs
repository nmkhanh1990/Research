		...
		protected VList<ViewThongTinLopHocPhanHeSoCongViec> Fill(IDataReader reader, VList<ViewThongTinLopHocPhanHeSoCongViec> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.StudyUnitTypeName = reader.IsDBNull(reader.GetOrdinal("StudyUnitTypeName")) ? null : (System.String)reader["StudyUnitTypeName"];
					...
					entity.ListOfClassStudentId = reader.IsDBNull(reader.GetOrdinal("ListOfClassStudentId")) ? null : (System.String)reader["ListOfClassStudentId"];
					...
					entity.ListOfProfessorId = reader.IsDBNull(reader.GetOrdinal("ListOfProfessorId")) ? null : (System.String)reader["ListOfProfessorId"];
					//entity.ListOfProfessorId = (Convert.IsDBNull(reader["ListOfProfessorID"]))?string.Empty:(System.String)reader["ListOfProfessorID"];
					entity.ListOfProfessorFirstName = reader.IsDBNull(reader.GetOrdinal("ListOfProfessorFirstName")) ? null : (System.String)reader["ListOfProfessorFirstName"];
