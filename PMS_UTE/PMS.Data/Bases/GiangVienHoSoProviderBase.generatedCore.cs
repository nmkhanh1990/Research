...
{	
	...
	{		
		...
		public static TList<GiangVienHoSo> Fill(IDataReader reader, TList<GiangVienHoSo> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.TinhTrang = (reader[GiangVienHoSoColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(GiangVienHoSoColumn.TinhTrang.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.GiangVienHoSo entity)
		{
			...
			entity.TinhTrang = (reader[GiangVienHoSoColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(GiangVienHoSoColumn.TinhTrang.ToString())];
