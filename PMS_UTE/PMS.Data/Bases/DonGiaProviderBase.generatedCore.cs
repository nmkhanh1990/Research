...
{	
	...
	{		
		...
		public static TList<DonGia> Fill(IDataReader reader, TList<DonGia> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.DonGiaNgoaiNgu = (reader[DonGiaColumn.DonGiaNgoaiNgu.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DonGiaColumn.DonGiaNgoaiNgu.ToString())];
					c.DonGiaGdtc = (reader[DonGiaColumn.DonGiaGdtc.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DonGiaColumn.DonGiaGdtc.ToString())];
					c.DonGiaDoAnClc = (reader[DonGiaColumn.DonGiaDoAnClc.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DonGiaColumn.DonGiaDoAnClc.ToString())];
					c.DonGiaDoAnDaiTra = (reader[DonGiaColumn.DonGiaDoAnDaiTra.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DonGiaColumn.DonGiaDoAnDaiTra.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.DonGia entity)
		{
			...
			entity.DonGiaNgoaiNgu = (reader[DonGiaColumn.DonGiaNgoaiNgu.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DonGiaColumn.DonGiaNgoaiNgu.ToString())];
			entity.DonGiaGdtc = (reader[DonGiaColumn.DonGiaGdtc.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DonGiaColumn.DonGiaGdtc.ToString())];
			entity.DonGiaDoAnClc = (reader[DonGiaColumn.DonGiaDoAnClc.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DonGiaColumn.DonGiaDoAnClc.ToString())];
			entity.DonGiaDoAnDaiTra = (reader[DonGiaColumn.DonGiaDoAnDaiTra.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DonGiaColumn.DonGiaDoAnDaiTra.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.DonGia entity)
		{
			...
			entity.DonGiaGdtc = Convert.IsDBNull(dataRow["DonGiaGdtc"]) ? null : (System.Decimal?)dataRow["DonGiaGdtc"];
			entity.DonGiaDoAnClc = Convert.IsDBNull(dataRow["DonGiaDoAnClc"]) ? null : (System.Decimal?)dataRow["DonGiaDoAnClc"];
			entity.DonGiaDoAnDaiTra = Convert.IsDBNull(dataRow["DonGiaDoAnDaiTra"]) ? null : (System.Decimal?)dataRow["DonGiaDoAnDaiTra"];
			entity.AcceptChanges();
		}
		#endregion 
