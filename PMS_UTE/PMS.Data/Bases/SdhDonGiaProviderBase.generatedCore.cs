...
{	
	...
	{		
		...
		public static TList<SdhDonGia> Fill(IDataReader reader, TList<SdhDonGia> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.TietBatDauDay = (reader[SdhDonGiaColumn.TietBatDauDay.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(SdhDonGiaColumn.TietBatDauDay.ToString())];
					c.TietKetThucDay = (reader[SdhDonGiaColumn.TietKetThucDay.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(SdhDonGiaColumn.TietKetThucDay.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.SdhDonGia entity)
		{
			...
			entity.TietBatDauDay = (reader[SdhDonGiaColumn.TietBatDauDay.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(SdhDonGiaColumn.TietBatDauDay.ToString())];
			entity.TietKetThucDay = (reader[SdhDonGiaColumn.TietKetThucDay.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(SdhDonGiaColumn.TietKetThucDay.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.SdhDonGia entity)
		{
			...
			entity.TietBatDauDay = Convert.IsDBNull(dataRow["TietBatDauDay"]) ? null : (System.Int32?)dataRow["TietBatDauDay"];
			entity.TietKetThucDay = Convert.IsDBNull(dataRow["TietKetThucDay"]) ? null : (System.Int32?)dataRow["TietKetThucDay"];
			entity.AcceptChanges();
		}
		#endregion 
