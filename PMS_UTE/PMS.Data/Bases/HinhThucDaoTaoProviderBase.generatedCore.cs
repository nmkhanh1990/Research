...
{	
	...
	{		
		...
		public static TList<HinhThucDaoTao> Fill(IDataReader reader, TList<HinhThucDaoTao> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.Hrmid = (reader[HinhThucDaoTaoColumn.Hrmid.ToString()] == DBNull.Value) ? null : (System.Guid?)reader[(HinhThucDaoTaoColumn.Hrmid.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.HinhThucDaoTao entity)
		{
			...
			entity.Hrmid = (reader[HinhThucDaoTaoColumn.Hrmid.ToString()] == DBNull.Value) ? null : (System.Guid?)reader[(HinhThucDaoTaoColumn.Hrmid.ToString())];
