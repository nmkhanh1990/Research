...
{
    public partial class rptHopDongMoiGiangDay : DevExpress.XtraReports.UI.XtraReport
    {
        string tienChu = "";

        public rptHopDongMoiGiangDay()
        {
            InitializeComponent();
        }
        ...
        public void InitData(string diachi,string dienthoai,string dongia,string donvicongtac,string hochamhocvi,string masothunhap,string noicapcmnd
            ...
            , string daidienbenA, string chucvudaidienbenA, string chucvu02daidienbenA, string diachidaidienbenA, string dienthoaidaidienbenA, string faxdaidienbenA, DateTime ngayin,DataTable tb)
        {
