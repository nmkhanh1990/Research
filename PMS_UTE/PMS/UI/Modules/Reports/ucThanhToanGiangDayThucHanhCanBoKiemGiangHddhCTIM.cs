...
{
    public partial class ucThanhToanGiangDayThucHanhCanBoKiemGiangHddhCTIM : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        ...
        public ucThanhToanGiangDayThucHanhCanBoKiemGiangHddhCTIM()
        {
            InitializeComponent();
        ...
        private void ucThanhToanGiangDayThucHanhCanBoKiemGiangHddhCTIM_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewThongKe, new string[] { "Chon", "XacNhanChiTra", "MaQuanLy", "HoTen", "ChucDanh", "MaMonHoc", "TenMonHoc", "MaLopHocPhan", "MaLop", "SiSo", "TietThucDay", "HeSoLopDong", "HeSoChucDanhChuyenMon", "HeSoQuyDoiThucHanhSangLyThuyet", "TietQuyDoi", "DonGia", "TongTien", "NgayCapNhat", "NguoiCapNhat" }
                    , new string[] { "Chọn in", "Khoá thanh toán", "Mã giảng viên", "Họ tên", "Chức danh", "Mã môn học", "Tên môn học", "Mã lớp học phần", "Mã lớp", "Sĩ số", "Số tiết", "Hệ số lớp đông", "Hệ số chức danh", "Hệ số quy đổi", "Số tiết thanh toán", "Đơn giá", "Số tiền thanh toán", "Ngày cập nhật", "Người cập nhật" }
                    , new int[] { 60, 60, 90, 140, 140, 90, 150, 110, 100, 60, 60, 110, 110, 110, 110, 100, 120, 90, 90 });
            AppGridView.AlignHeader(gridViewThongKe, new string[] { "Chon", "XacNhanChiTra", "MaQuanLy", "HoTen", "ChucDanh", "MaMonHoc", "TenMonHoc", "MaLopHocPhan", "MaLop", "SiSo", "TietThucDay", "HeSoLopDong", "HeSoQuyDoiThucHanhSangLyThuyet", "HeSoChucDanhChuyenMon", "TietQuyDoi", "DonGia", "TongTien", "NgayCapNhat", "NguoiCapNhat" }, DevExpress.Utils.HorzAlignment.Center);
            AppGridView.ReadOnlyColumn(gridViewThongKe, new string[] { "MaQuanLy", "HoTen", "ChucDanh", "MaMonHoc", "TenMonHoc", "MaLopHocPhan", "MaLop", "SiSo", "TietThucDay", "HeSoLopDong", "HeSoChucDanhChuyenMon", "HeSoQuyDoiThucHanhSangLyThuyet", "TietQuyDoi", "DonGia", "TongTien", "NgayCapNhat", "NguoiCapNhat" });
        ...
        void InitData()
        {
            ...
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null && cboLanChot.EditValue != null && cboBacDaoTao.EditValue != null && cboKhoaHoc.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.KetQuaThanhToanThuLao.ThongKeTienGiangThucHanhCBKGHDDHCtim(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), cboKhoaDonVi.EditValue.ToString(), cboBacDaoTao.EditValue.ToString(), cboKhoaHoc.EditValue.ToString(), int.Parse(cboLanChot.EditValue.ToString()));
                dt.Load(reader);
