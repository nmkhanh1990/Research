...
{
    public partial class ucBangKeThanhToanTienRaDeCTIM : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        ...
        string _maTruong;
        #endregion
        public ucBangKeThanhToanTienRaDeCTIM()
        {
            InitializeComponent();
        ...
        private void ucBangKeThanhToanTienRaDeCTIM_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewThongKe, new string[] { "Stt", "MaQuanLy", "HoTen", "MonThi", "Stc", "LopSinhVien", "SoDe", "DonGiaChuan", "ThanhTien", "ThueThuNhap", "ThucLinh" }
                    , new string[] { "STT", "Mã giảng viên", "Họ tên", "Môn thi", "Số tín chỉ", "Lớp khoá", "Bộ đề thi", "Đơn giá chuẩn", "Thành tiền", "Thuế TNCN (%)", "Số tiền còn lĩnh" }
                    , new int[] { 50, 90, 140, 140, 50, 90, 70, 70, 100, 100, 100 });
            AppGridView.AlignHeader(gridViewThongKe, new string[] { "Stt", "MaQuanLy", "HoTen", "MonThi", "Stc", "LopSinhVien", "SoDe", "DonGiaChuan", "ThanhTien", "ThueThuNhap", "ThucLinh" }, DevExpress.Utils.HorzAlignment.Center);
        ...
        void InitData()
        {
            ...
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null && cboBacDaoTao.EditValue != null && cboKhoaHoc.EditValue != null && cboLoaiGiangVien.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.KetQuaThanhToanThuLao.BangKeThanhToanTienRaDeCtim(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), cboKhoaHoc.EditValue.ToString(), cboBacDaoTao.EditValue.ToString(), cboKhoaDonVi.EditValue.ToString(), int.Parse(cboLoaiGiangVien.EditValue.ToString()));
                dt.Load(reader);
        ...
        private void btnIn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (vListBaoCao != null && vListBaoCao.Rows.Count > 0)
            {
                ...
                {
                    if (cboLoaiGiangVien.EditValue.ToString() == "3")   //Thỉnh giảng
                    {
                        frm.InThongKeThanhToanTienRaDeGVThinhGiang(cboNamHoc.EditValue.ToString(), cboHocKy.Text, cboKhoaDonVi.Text
                    ...
                    {
                        frm.InThongKeThanhToanTienRaDeCBKGHDDH(cboNamHoc.EditValue.ToString(), cboHocKy.Text, cboKhoaDonVi.Text
                            , PMS.Common.Globals._cauhinh.PhongDaoTao, PMS.Common.Globals._cauhinh.KeToan, PMS.Common.Globals._cauhinh.BanGiamHieu, PMS.Common.Globals._cauhinh.NguoiLapbieu
