...
namespace PMS.UI.Modules.Reports
{
    public partial class ucBangThanhToanThuLaoGiangDayTheoKhoa : XtraUserControl
    {
        ...
        private void ucBangThanhToanThuLaoGiangDayTheoKhoa_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewBangThanhToan, new string[] { "MaQuanLy", "HoTen", "TenQuocTich", "TenLoaiGiangVien", "TenKhoaHoc", "TenBacDaoTao", "LoaiHinhDaoTao", "KhoaBacLoaiHinh", "TenMonHoc", "MaLop", "SoTinChi", "SoTiet", "SoLuongSv", "DonGia", "ThanhTien", "ThueTncn", "ThucNhan", "MaSoThue", "SoTaiKhoan", "TenNganHang", "DaChiTra", "Id", "NgayChiTra", "ChonIn" }
            ...
            AppGridView.HideField(gridViewBangThanhToan, new string[] { "Id", "NgayChiTra", "ChonIn" });
