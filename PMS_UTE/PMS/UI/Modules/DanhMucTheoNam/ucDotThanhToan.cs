...
{
    public partial class ucDotThanhToan : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void KhongDuocPhepCapNhat(string value)
        {
            if (value.ToLower() == "true")
            {
                ...
                btn_Luu.ItemShortcut = DevExpress.XtraBars.BarShortcut.Empty;

                btn_Xoa.Visibility = DevExpress.XtraBars.BarItemVisibility.Never;
                btn_Xoa.ItemShortcut = DevExpress.XtraBars.BarShortcut.Empty;
            }
            else
            {
        ...
        public ucDotThanhToan()
        {
            InitializeComponent();
        }

        private void ucDotThanhToan_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewCauHinhChotGio, new string[] { "MaQuanLy", "TenQuanLy", "TuNgay", "DenNgay", "PhanTramDonGia", "PhanTramHeSoCongThem", "CoTinhNckh", "NamHoc", "HocKy", "TinhVaoCaNam" },
                new string[] { "Mã đợt", "Tên đợt", "Từ ngày", "Đến ngày", "Tỉ lệ đơn giá tính (%)", "Tỉ lệ HS cộng thêm (%)", "Có tính NCKH", "Năm học", "Học kỳ", "Cộng vào cả năm" },
                new int[] { 100, 150, 120, 120, 120, 120, 90, 100, 100, 100 });
            ...
            AppGridView.AlignHeader(gridViewCauHinhChotGio, new string[] { "MaQuanLy", "TenQuanLy", "TuNgay", "DenNgay", "PhanTramDonGia", "PhanTramHeSoCongThem", "CoTinhNckh", "NamHoc", "HocKy", "TinhVaoCaNam" }, DevExpress.Utils.HorzAlignment.Center);

            PMS.Common.Globals.WordWrapHeader(gridViewCauHinhChotGio, 45);
            #region Nam Hoc
            ...
            if (cauHinhchung.Find(p => p.TenCauHinh == "Năm học hiện tại").GiaTri == null)
            {
                ...
                cbNamHoc.DataBindings.Add("EditValue", bindingSourceNamHoc, "NamHoc", true, DataSourceUpdateMode.Never);
            }
            #endregion
        ...
        private void btn_Luu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            TList<CauHinhChotGio> list = bindingSourceCauHinhChotGio.DataSource as TList<CauHinhChotGio>;
            if (list != null)
            {
                if (XtraMessageBox.Show("Bạn có muốn lưu các thay đổi không ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    try
                    {
                        if (list.IsValid)
                        {
                            ...
                            DataServices.CauHinhChotGio.Save(list);
        ...
        {
            CauHinhChotGio obj = bindingSourceCauHinhChotGio.Current as CauHinhChotGio;
            if (obj != null)
            {
                if (obj.IsNew)
        ...
        private void btn_Lamtuoi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (cbNamHoc.EditValue != null && cboHocKy.EditValue != null)
                bindingSourceCauHinhChotGio.DataSource = DataServices.CauHinhChotGio.GetByNamHocHocKy(cbNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString());
