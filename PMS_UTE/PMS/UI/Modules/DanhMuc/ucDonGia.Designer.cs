namespace PMS.UI.Modules.DanhMuc
{
    partial class ucDonGia
    {
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ucDonGia));
			...
			this.cboHinhThucDaoTao = new DevExpress.XtraEditors.GridLookUpEdit();
			...
			this.bindingSourceDonGia = new System.Windows.Forms.BindingSource();
			...
			this.repositoryItemSpinEditDonGiaClc = new DevExpress.XtraEditors.Repository.RepositoryItemSpinEdit();
			this.repositoryItemSpinEditDonGiaTrongChuan = new DevExpress.XtraEditors.Repository.RepositoryItemSpinEdit();
			this.repositoryItemSpinEditDonGiaNgoaiChuan = new DevExpress.XtraEditors.Repository.RepositoryItemSpinEdit();
			this.repositoryItemGridLookUpEditBacDaoTao = new DevExpress.XtraEditors.Repository.RepositoryItemGridLookUpEdit();
			this.bindingSourceBacDaoTao = new System.Windows.Forms.BindingSource();
			this.gridView3 = new DevExpress.XtraGrid.Views.Grid.GridView();
			this.repositoryItemGridLookUpEditNgonNguGiangDay = new DevExpress.XtraEditors.Repository.RepositoryItemGridLookUpEdit();
			this.bindingSourceNgonNguGiangDay = new System.Windows.Forms.BindingSource();
			...
			((System.ComponentModel.ISupportInitialize)(this.cboHinhThucDaoTao.Properties)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.repositoryItemSpinEditDonGiaClc)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.repositoryItemSpinEditDonGiaTrongChuan)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.repositoryItemSpinEditDonGiaNgoaiChuan)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.repositoryItemGridLookUpEditBacDaoTao)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.bindingSourceBacDaoTao)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gridView3)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.repositoryItemGridLookUpEditNgonNguGiangDay)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.bindingSourceNgonNguGiangDay)).BeginInit();
			...
			this.layoutControl1.Controls.Add(this.cboHinhThucDaoTao);
			this.layoutControl1.Controls.Add(this.gridControlDonGia);
			this.layoutControl1.Dock = System.Windows.Forms.DockStyle.Fill;
			this.layoutControl1.Location = new System.Drawing.Point(0, 29);
			this.layoutControl1.Name = "layoutControl1";
			this.layoutControl1.Root = this.layoutControlGroup1;
			this.layoutControl1.Size = new System.Drawing.Size(591, 333);
			this.layoutControl1.TabIndex = 0;
			this.layoutControl1.Text = "layoutControl1";
			// 
			// cboHocKy
			// 
			this.cboHocKy.Location = new System.Drawing.Point(190, 12);
			...
			this.barDockControlRight.Location = new System.Drawing.Point(591, 29);
			...
			this.imageCollection2.Images.SetKeyName(1, "undo.png");
			this.imageCollection2.Images.SetKeyName(2, "save.png");
			this.imageCollection2.Images.SetKeyName(3, "printer.png");
			this.imageCollection2.Images.SetKeyName(4, "delete.png");
			this.imageCollection2.Images.SetKeyName(5, "excel.png");
			this.imageCollection2.Images.SetKeyName(6, "gtk-copy.png");
			// 
			// gridLookUpEdit2View
			// 
			...
			this.cboNamHoc.Properties.View = this.gridView5;
			this.cboNamHoc.Size = new System.Drawing.Size(83, 20);
			...
			// layoutControl2
			// 
			this.layoutControl2.Location = new System.Drawing.Point(512, 12);
			this.layoutControl2.Name = "layoutControl2";
			this.layoutControl2.Root = this.Root;
			this.layoutControl2.Size = new System.Drawing.Size(67, 20);
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(67, 20);
			this.Root.TextVisible = false;
			// 
			// cboHinhThucDaoTao
			// 
			this.cboHinhThucDaoTao.Location = new System.Drawing.Point(371, 12);
			this.cboHinhThucDaoTao.MenuManager = this.barManager1;
			this.cboHinhThucDaoTao.Name = "cboHinhThucDaoTao";
			this.cboHinhThucDaoTao.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.cboHinhThucDaoTao.Properties.DataSource = this.bindingSourceHinhThucDaoTao;
			this.cboHinhThucDaoTao.Properties.View = this.gridLookUpEdit1View;
			this.cboHinhThucDaoTao.Size = new System.Drawing.Size(137, 20);
			this.cboHinhThucDaoTao.StyleController = this.layoutControl1;
			this.cboHinhThucDaoTao.TabIndex = 5;
			this.cboHinhThucDaoTao.EditValueChanged += new System.EventHandler(this.cboHinhThucDaoTao_EditValueChanged);
			// 
			// gridLookUpEdit1View
			// 
			...
			this.gridControlDonGia.Location = new System.Drawing.Point(12, 36);
            ...
            this.repositoryItemSpinEditDonGiaClc,
            this.repositoryItemSpinEditDonGiaTrongChuan,
            this.repositoryItemSpinEditDonGiaNgoaiChuan,
            this.repositoryItemGridLookUpEditBacDaoTao,
            this.repositoryItemGridLookUpEditNgonNguGiangDay,
            this.repositoryItemCheckedComboBoxEditHocVi});
			this.gridControlDonGia.Size = new System.Drawing.Size(567, 285);
			this.gridControlDonGia.TabIndex = 4;
			...
			this.gridViewDonGia.InvalidRowException += new DevExpress.XtraGrid.Views.Base.InvalidRowExceptionEventHandler(this.gridViewDonGia_InvalidRowException);
			...
			this.repositoryItemGridLookUpEditLoaiGiangVien.View = this.repositoryItemGridLookUpEdit1View;
			// 
			...
			this.repositoryItemGridLookUpEditHocVi.View = this.gridView2;
			// 
			// gridView2
			// 
			...
			this.repositoryItemSpinEditDonGia.Increment = new decimal(new int[] {
            100,
            0,
            0,
            0});
			...
			// 
			// repositoryItemSpinEditDonGiaClc
			// 
			this.repositoryItemSpinEditDonGiaClc.AutoHeight = false;
			this.repositoryItemSpinEditDonGiaClc.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton()});
			this.repositoryItemSpinEditDonGiaClc.Name = "repositoryItemSpinEditDonGiaClc";
			// 
			// repositoryItemSpinEditDonGiaTrongChuan
			// 
			this.repositoryItemSpinEditDonGiaTrongChuan.AutoHeight = false;
			this.repositoryItemSpinEditDonGiaTrongChuan.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton()});
			this.repositoryItemSpinEditDonGiaTrongChuan.Name = "repositoryItemSpinEditDonGiaTrongChuan";
			// 
			// repositoryItemSpinEditDonGiaNgoaiChuan
			// 
			this.repositoryItemSpinEditDonGiaNgoaiChuan.AutoHeight = false;
			this.repositoryItemSpinEditDonGiaNgoaiChuan.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton()});
			this.repositoryItemSpinEditDonGiaNgoaiChuan.Name = "repositoryItemSpinEditDonGiaNgoaiChuan";
			// 
			// repositoryItemGridLookUpEditBacDaoTao
			// 
			this.repositoryItemGridLookUpEditBacDaoTao.AutoHeight = false;
			this.repositoryItemGridLookUpEditBacDaoTao.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repositoryItemGridLookUpEditBacDaoTao.DataSource = this.bindingSourceBacDaoTao;
			this.repositoryItemGridLookUpEditBacDaoTao.Name = "repositoryItemGridLookUpEditBacDaoTao";
			this.repositoryItemGridLookUpEditBacDaoTao.View = this.gridView3;
			// 
			// gridView3
			// 
			...
			// 
			// repositoryItemGridLookUpEditNgonNguGiangDay
			// 
			this.repositoryItemGridLookUpEditNgonNguGiangDay.AutoHeight = false;
			this.repositoryItemGridLookUpEditNgonNguGiangDay.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
			this.repositoryItemGridLookUpEditNgonNguGiangDay.DataSource = this.bindingSourceNgonNguGiangDay;
			this.repositoryItemGridLookUpEditNgonNguGiangDay.Name = "repositoryItemGridLookUpEditNgonNguGiangDay";
			this.repositoryItemGridLookUpEditNgonNguGiangDay.View = this.gridView4;
			// 
			// gridView4
			// 
			...
			this.layoutControlGroup1.Size = new System.Drawing.Size(591, 333);
			this.layoutControlGroup1.TextVisible = false;
			// 
			// layoutControlItem1
			// 
			this.layoutControlItem1.Control = this.gridControlDonGia;
			this.layoutControlItem1.CustomizationFormText = "layoutControlItem1";
			this.layoutControlItem1.Location = new System.Drawing.Point(0, 24);
			this.layoutControlItem1.Name = "layoutControlItem1";
			this.layoutControlItem1.Size = new System.Drawing.Size(571, 289);
			this.layoutControlItem1.TextSize = new System.Drawing.Size(0, 0);
			this.layoutControlItem1.TextVisible = false;
			// 
			// layoutControlItem2
			// 
			this.layoutControlItem2.Control = this.cboHinhThucDaoTao;
			this.layoutControlItem2.CustomizationFormText = "Hình thức đào tạo:";
			...
			this.layoutControlItem2.Text = "Hình thức đào tạo:";
			...
			this.layoutControlItem5.Location = new System.Drawing.Point(137, 0);
			this.layoutControlItem5.MaxSize = new System.Drawing.Size(129, 24);
			this.layoutControlItem5.MinSize = new System.Drawing.Size(129, 24);
			this.layoutControlItem5.Name = "layoutControlItem5";
			this.layoutControlItem5.Size = new System.Drawing.Size(129, 24);
			...
			this.Load += new System.EventHandler(this.ucDonGia_Load);
			...
			((System.ComponentModel.ISupportInitialize)(this.cboHinhThucDaoTao.Properties)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.repositoryItemSpinEditDonGiaClc)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.repositoryItemSpinEditDonGiaTrongChuan)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.repositoryItemSpinEditDonGiaNgoaiChuan)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.repositoryItemGridLookUpEditBacDaoTao)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.bindingSourceBacDaoTao)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gridView3)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.repositoryItemGridLookUpEditNgonNguGiangDay)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.bindingSourceNgonNguGiangDay)).EndInit();
        ...
        private DevExpress.XtraEditors.Repository.RepositoryItemSpinEdit repositoryItemSpinEditDonGiaClc;
        private DevExpress.XtraBars.BarButtonItem btnExcel;
        private DevExpress.XtraLayout.LayoutControl layoutControl2;
        private DevExpress.XtraLayout.LayoutControlGroup Root;
        private DevExpress.XtraEditors.GridLookUpEdit cboHinhThucDaoTao;
        private System.Windows.Forms.BindingSource bindingSourceHinhThucDaoTao;
        private DevExpress.XtraGrid.Views.Grid.GridView gridLookUpEdit1View;
        private DevExpress.XtraLayout.LayoutControlItem layoutControlItem2;
        private DevExpress.XtraLayout.LayoutControlItem layoutControlItem3;
        private DevExpress.XtraEditors.Repository.RepositoryItemSpinEdit repositoryItemSpinEditDonGiaTrongChuan;
        private DevExpress.XtraEditors.Repository.RepositoryItemSpinEdit repositoryItemSpinEditDonGiaNgoaiChuan;
        private DevExpress.XtraEditors.Repository.RepositoryItemGridLookUpEdit repositoryItemGridLookUpEditBacDaoTao;
        private System.Windows.Forms.BindingSource bindingSourceBacDaoTao;
        private DevExpress.XtraGrid.Views.Grid.GridView gridView3;
        private DevExpress.XtraEditors.Repository.RepositoryItemGridLookUpEdit repositoryItemGridLookUpEditNgonNguGiangDay;
        private System.Windows.Forms.BindingSource bindingSourceNgonNguGiangDay;
