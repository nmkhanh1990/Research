...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucHeSoChucDanhLanhDao : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void InitGridBUH()
        {
            ...
            AppGridView.ShowField(gridViewHeSoChucDanhLanhDao, new string[] { "ThuTu", "MaQuanLy", "TenChucVu", "DinhMucToiThieu", "DinhMucToiThieuNckh", "CongDonKiemNhiem", "NgayBdApDung", "NgayKtApDung" },
                        new string[] { "STT", "Mã chức vụ", "Tên chức vụ", "Định mức tối thiểu (%)", "Định mức tối thiểu NCKH (%)", "Chức vụ thuộc phòng ban", "Ngày BD áp dụng", "Ngày KT áp dụng" },
                        new int[] { 70, 70, 300, 150, 150,150, 150, 150000000 });
            AppGridView.AlignHeader(gridViewHeSoChucDanhLanhDao, new string[] { "ThuTu", "MaQuanLy", "TenChucVu", "DinhMucToiThieu", "DinhMucToiThieuNckh", "CongDonKiemNhiem", "NgayBdApDung", "NgayKtApDung" }, DevExpress.Utils.HorzAlignment.Center);
            ...
            AppGridView.RegisterControlField(gridViewHeSoChucDanhLanhDao, "DinhMucToiThieuNckh", repositoryItemSpinEditDinhMucToiThieuNCKH);
        ...
        {           
            ...
            try
            {
                ...
                else if (obj.DinhMucToiThieuNckh > 100)
                {
                    XtraMessageBox.Show("Định mức NCKH không được lớn hơn 100.", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    e.Valid = false;
                    return;
                }
