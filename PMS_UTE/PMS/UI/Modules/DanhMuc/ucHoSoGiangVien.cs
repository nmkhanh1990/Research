...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucHoSoGiangVien : XtraUserControl
    {
        ...
        private void ucHoSoGiangVien_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewHoSoGiangVien, new string[] { "ThuTu", "MaQuanLy", "TenHoSo","TinhTrang" },
                new string[] { "STT", "Mã hồ sơ", "Tên hồ sơ","Không dùng" },
                new int[] { 70, 100, 300 ,100});
            AppGridView.AlignHeader(gridViewHoSoGiangVien, new string[] { "ThuTu", "MaQuanLy", "TenHoSo", "TinhTrang" }, DevExpress.Utils.HorzAlignment.Center);
            AppGridView.HideField(gridViewHoSoGiangVien, new string[] { "ThuTu" });
