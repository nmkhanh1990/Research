    ...
    public partial class ucMonHocGiangBangTiengNuocNgoai : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucMonHocGiangBangTiengNuocNgoai_Load(object sender, EventArgs e)
        {
            ...
            AppRepositoryItemGridLookUpEdit.InitRepositoryItemGridLookUp(repositoryItemGridLookUpEditLopHocPhan,
                ...
                new string[] { "Mã LHP", "Mã LSV", "Môn học", "Loại HP", "Khoa" },
                new int[] { 100, 100, 150, 80, 150 },
            ...
            if (XtraMessageBox.Show("Bạn có muốn lưu các thay đổi không ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    //{
                        string xmlData = "<Root>";
                        int kq = 0;
                        TList<LopHocPhanGiangBangTiengNuocNgoai> vlist = bindingSourceGVLHPNN.DataSource as TList<LopHocPhanGiangBangTiengNuocNgoai>;
                        foreach (LopHocPhanGiangBangTiengNuocNgoai lhp in vlist)
                        {
                            xmlData += "<LHPNN MaLopHocPhan = \"" + lhp.MaLopHocPhan
                                    + "\" NamHoc = \"" + lhp.NamHoc
                                    + "\" HocKy = \"" + lhp.HocKy
                                    + "\" NgonNgu = \"" + lhp.NgonNgu
                                    + "\" />";
