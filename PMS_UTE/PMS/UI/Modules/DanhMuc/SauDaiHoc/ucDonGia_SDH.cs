...
namespace PMS.UI.Modules.DanhMuc.SauDaiHoc
{
    public partial class ucDonGia_SDH : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucDonGia_SDH_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewDonGia, new string[] { "MaQuanLy", "MaLoaiGiangVien", "MaHocHam", "MaHocVi"
                    , "BacDaoTao", "TietBatDauDay", "TietKetThucDay", "DonGia", "DonGiaTrongChuan", "NgayCapNhat", "NguoiCapNhat" }
                , new string[] { "Mã quản lý", "Loại giảng viên", "Học hàm", "Học vị"
                    , "Bậc đào tạo", "Tiết bắt đầu", "Tiết kết thúc", "Đơn giá", "Số tiền cộng thêm", "NgayCapNhat", "NguoiCapNhat" }
                , new int[] { 100, 110, 100, 100, 80, 100, 100, 120, 120, 120, 99, 99 });
            AppGridView.AlignHeader(gridViewDonGia, new string[] { "MaQuanLy", "MaLoaiGiangVien", "MaHocHam", "MaHocVi"
                    , "BacDaoTao", "TietBatDauDay", "TietKetThucDay", "DonGia", "DonGiaTrongChuan", "NgayCapNhat", "NguoiCapNhat" }
        ...
        private bool RuleCheckDuplicate(object target, ValidationRuleArgs e)
        {
            ...
            if (obj != null)
            {
                ...
                //    return false;
                //}
                if (((TList<SdhDonGia>)bindingSourceDonGia.DataSource).FindAll(
                        p => p.MaLoaiGiangVien == obj.MaLoaiGiangVien
                        && p.MaHocHam == obj.MaHocHam
                        && p.MaHocVi == obj.MaHocVi
                        && p.BacDaoTao == obj.BacDaoTao
                        && p.TietBatDauDay == obj.TietBatDauDay
                        && p.TietKetThucDay == obj.TietKetThucDay
                    ).Count > 1)
                {
