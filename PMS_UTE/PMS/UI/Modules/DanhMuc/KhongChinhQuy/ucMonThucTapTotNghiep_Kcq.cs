...
{
    public partial class ucMonThucTapTotNghiep_Kcq : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucMonThucTapTotNghiep_Kcq()
        {
            InitializeComponent();
        }
        ...
        void InitData()
        {
            ...
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null)
            {
                ...
                bindingSourceMonThucTapTotNghiep.DataSource = DataServices.ViewKcqMonThucTapTotNghiep.GetByNamHocHocKy(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString());
            }
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            VList<ViewKcqMonThucTapTotNghiep> list = bindingSourceMonThucTapTotNghiep.DataSource as VList<ViewKcqMonThucTapTotNghiep>;
            if (list != null)
            {
                if (XtraMessageBox.Show("Bạn có muốn lưu các thay đổi không ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    {
                        string xmlData = "";
                        foreach (ViewKcqMonThucTapTotNghiep v in list)
                        {
                            if (v.MaMonHoc == null)
                            {
                        ...
                        int kq = 0;
                        DataServices.KcqMonThucTapTotNghiep.Luu(xmlData, cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), ref kq);
                        if (kq == 0)
        ...
        private void gridViewMonThucTapTotNghiep_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            { 
                ViewKcqMonThucTapTotNghiep v = gridViewMonThucTapTotNghiep.GetRow(pos) as ViewKcqMonThucTapTotNghiep;
        ...
        {
            using (frmSaoChepNamHocHocKy_Kcq frm = new frmSaoChepNamHocHocKy_Kcq(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), "SaoChepMonThucTapTotNghiep"))
            {
                frm.ShowDialog();
            }
        }
