...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucGiangVienDangKyHinhThucGiangDay : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void btnSaoChep_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (_cauHinhHeSoTheoNam.ToLower() == "true")
            {
                using (frmSaoChepNamHoc frm = new frmSaoChepNamHoc(cboNamHoc.EditValue.ToString(), "SaoChepHinhThucGiangDay"))
                {
                    frm.ShowDialog();
                }
            }
            ...
            {
                using (frmSaoChepNamHocHocKy frm = new frmSaoChepNamHocHocKy(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), "SaoChepHinhThucGiangDay"))
                {
                    frm.ShowDialog();
                }
            }
