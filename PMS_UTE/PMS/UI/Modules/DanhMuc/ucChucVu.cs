...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucChucVu : XtraUserControl
    {
        ...
        void InitGridCDGTVT()
        {
            ...
            AppGridView.AlignHeader(gridViewChucVu, new string[] { "ThuTu", "MaQuanLy", "TenChucVu", "CongDonKiemNhiem" }, DevExpress.Utils.HorzAlignment.Center);
        ...
        {
            AppGridView.InitGridView(gridViewChucVu, true, true, GridMultiSelectMode.RowSelect, false, false, "Nhấn vào đây để thêm dòng mới");
            AppGridView.ShowField(gridViewChucVu, new string[] { "ThuTu", "MaQuanLy", "TenChucVu","TinhTrang" },
                new string[] { "STT", "Mã chức vụ", "Tên chức vụ","Không dùng" },
                new int[] { 70, 100, 400,100 });
            AppGridView.AlignHeader(gridViewChucVu, new string[] { "ThuTu", "MaQuanLy", "TenChucVu", "TinhTrang" }, DevExpress.Utils.HorzAlignment.Center);
            AppGridView.HideField(gridViewChucVu, new string[] { "ThuTu" });
            AppGridView.ShowEditor(gridViewChucVu, NewItemRowPosition.Top);
        }
