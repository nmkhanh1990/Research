...
namespace PMS.UI.Forms.BaoCao
{
    public partial class frmBaoCao : XtraForm
    {
        ...
        public void InDanhSachThanhToanThuLaoGianLuoc_UTE(string tenTruong, string namHoc, string hocKy, string phongToChucCanBo, string phongDaoTao, string nguoiLapBieu, DataTable data)
        {
            Text = "DANH SÁCH CHI TIỀN GIẢNG DẠY CHÍNH QUY";
            rptDanhSachThanhToanThuLao_ChiTien report = new rptDanhSachThanhToanThuLao_ChiTien();
            XReport = report;
            OpenLayout(report);
            report.InitData(tenTruong, namHoc, hocKy, phongToChucCanBo, phongDaoTao, nguoiLapBieu, data);
            printControl.PrintingSystem = report.PrintingSystem;
