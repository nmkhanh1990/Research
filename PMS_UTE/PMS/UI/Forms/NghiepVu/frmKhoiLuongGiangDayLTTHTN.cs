...
{
    public partial class frmKhoiLuongGiangDayLTTHTN : DevExpress.XtraEditors.XtraForm
    {
        ...
        #region Event Form
        public frmKhoiLuongGiangDayLTTHTN()
        {
            InitializeComponent();
        ...
        private void frmKhoiLuongGiangDayLTTHTN_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewKhoiLuongGiangDay, new string[] { "MaGiangVienQuanLy", "HoTen", "MaMonHoc", "TenMonHoc", "SoTinChi", "MaLopHocPhan", "MaLop", "Nhom", "SiSo", "SoTiet", "SoTietDayChuNhat", "TenLoaiHocPhan", "TenNhomMon", "HeSoLopDongLyThuyet", "HeSoLopDongThTnTt", "SoGioThucGiangTrenLop", "SoGioChuanTinhThem", "HeSoHocKy", "TietQuyDoi" }
                , new string[]{ "Mã giảng viên", "Họ và tên", "Mã môn học", "Tên môn học", "STC", "Mã lớp học phần", "Mã lớp", "Nhóm", "Sĩ số", "Số tiết", "Số tiết chủ nhật", "Loại học phần", "Nhóm môn học", "HSLD Lý thuyết", "HSLD TH - TN", "Giờ thực giảng trên lớp", "Giờ chuẩn tính thêm", "Hệ số học kỳ", "Tổng tiêt quy đổi" }
                    , new int[] { 80, 150, 100, 200, 50, 120, 100, 80, 50, 50, 100, 100, 100, 100, 100, 120, 120, 90, 90 });
            AppGridView.AlignHeader(gridViewKhoiLuongGiangDay, new string[] { "MaGiangVienQuanLy", "HoTen", "MaMonHoc", "TenMonHoc", "SoTinChi", "MaLopHocPhan", "MaLop", "Nhom", "SiSo", "SoTiet", "SoTietDayChuNhat", "TenLoaiHocPhan", "TenNhomMon", "HeSoLopDongLyThuyet", "HeSoLopDongThTnTt", "SoGioThucGiangTrenLop", "SoGioChuanTinhThem", "HeSoHocKy", "TietQuyDoi" }, DevExpress.Utils.HorzAlignment.Center);
        ...
        void InitData()
        {
            ...
            if(cboNamHoc.EditValue!=null && cboHocKy.EditValue!=null)
                bindingSourceKhoiLuongGiangDay.DataSource = DataServices.ViewUteKhoiLuongQuyDoi2.GetByNamHocHocKy(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString());
        }
        #endregion
        ...
        private void btnQuyDoi_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                using (frmPhanLoaiHocPhanChoLopHocPhan frm = new frmPhanLoaiHocPhanChoLopHocPhan())
                {
                    frm.ShowDialog();
                }
            }
            ...
            if (kt == 2)
            {
                ...
                {
                    frmXuLyQuyDoiGioiChuanUTE frm = new frmXuLyQuyDoiGioiChuanUTE(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), true);
                    frm.ShowDialog();
                }
            }
            else
