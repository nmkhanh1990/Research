...
namespace PMS.UI.Forms.NghiepVu.SauDaiHoc
{
    public partial class frmChotTongKetKhoiLuongGiangDay_SDH : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmChotTongKetKhoiLuongGiangDay_SDH_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewTongKet, new string[] { "MaQuanLy", "HoTen", "MaHocHam", "MaHocVi", "MaLoaiGiangVien"
                    , "MaMonHoc", "TenMonHoc", "SoTinChi", "Loai", "Nhom", "MaLop", "MaDiaDiem", "TenDiaDiem", "SiSo", "SoTiet"
                    , "HeSoLopDong", "TietQuyDoi", "TietChuNhat", "HeSoDiaDiem", "DonGiaDiaDiem", "TienXeDiaDiem"
                    , "DonGia", "DonGiaQuyDoi", "TongThanhTien", "TienChamBai", "TongCong", "MaDonVi" }
                , new string[] { "Mã giảng viên", "Họ và tên", "Học hàm", "Học vị", "Loại giảng viên"
                    , "Mã môn học", "Tên môn học", "Số tín chỉ", "Loại", "Nhóm", "Mã lớp","Mã địa điểm","Tên địa điểm", "Sĩ số", "Tiết thực dạy"
                    , "Hệ số lớp đông", "Tiết quy đổi", "Số tiết buổi tối", "Hệ số địa điểm", "Đơn giá địa điểm", "Tiền xe địa điểm"
                    , "Đơn giá", "Đơn giá quy đổi", "Thành tiền", "Tiền chấm bài", "Tổng cộng", "Đơn vị" }
                , new int[] { 80, 140, 100, 100, 100, 80, 150, 60, 60, 60, 90, 80, 120, 70, 80, 80, 80, 80, 80, 100, 100, 100, 100, 110, 100, 110, 90 });
            AppGridView.AlignHeader(gridViewTongKet, new string[] { "MaQuanLy", "HoTen", "MaHocHam", "MaHocVi", "MaLoaiGiangVien"
                    , "MaMonHoc", "TenMonHoc", "SoTinChi", "Loai", "Nhom", "MaLop", "MaDiaDiem", "TenDiaDiem", "SiSo", "SoTiet"
                    , "HeSoLopDong", "TietQuyDoi", "TietChuNhat", "HeSoDiaDiem", "DonGiaDiaDiem", "TienXeDiaDiem"
                    , "DonGia", "DonGiaQuyDoi", "TongThanhTien", "TienChamBai", "TongCong", "MaDonVi" }
            ...
            AppGridView.FormatDataField(gridViewTongKet, new string[] { "SiSo", "SoTinChi", "DonGia", "TongThanhTien", "DonGiaDiaDiem", "TienXeDiaDiem"
                    , "DonGiaQuyDoi", "TongThanhTien", "TienChamBai", "TongCong" }, DevExpress.Utils.FormatType.Custom, "n0");
            AppGridView.BackColorFieldAppearance(gridViewTongKet, new string[] { "HeSoLopDong", "HeSoDiaDiem", "SoTiet", "TietQuyDoi" }, System.Drawing.Color.Azure);
            AppGridView.BackColorFieldAppearance(gridViewTongKet, new string[] { "DonGia", "DonGiaDiaDiem", "TienXeDiaDiem"
                    , "DonGiaQuyDoi", "TongThanhTien", "TienChamBai", "TongCong"}, System.Drawing.Color.FromArgb(250,240,230));
            AppGridView.FormatDataField(gridViewTongKet, new string[] { "SoTiet", "TietQuyDoi", "HeSoLopDong", "HeSoDiaDiem", "TietChuNhat" }, DevExpress.Utils.FormatType.Custom, "n2");
