...
namespace PMS.UI.Forms.NghiepVu
{
    public partial class frmXuLyQuyDoiGioiChuan : XtraForm
    {
        ...
        private void backgroundWorker_DoWork(object sender, System.ComponentModel.DoWorkEventArgs e)
        {
            ...
            else if (_maTruong == "USSH")
            {
                QuyDoiUSSH(index, NamHoc, HocKy);
            }
            else if (_maTruong == "ACT")
            {
            ...
            else if (_maTruong == "UEL")
                QuyDoiUEL(index, NamHoc, HocKy);
            else if ("CTIM;UFM".Contains(_maTruong))
                QuyDoiCTIM(index, NamHoc, HocKy);
            else if (_maTruong == "IUH")
            {
            ...
            else if (_maTruong == "VHU")
                QuyDoiVHU(index, NamHoc, HocKy);
            else if (_maTruong == "CDGTVT")
                QuyDoiCDGTVT(index, NamHoc, HocKy);
            else if (_maTruong == "HBU")
                QuyDoiHBU(index, NamHoc, HocKy);
            else if ("DLU".Contains(_maTruong))
            ...
            else //(_danhSachTruong.Contains(_maTruong) == false)
            ...
            try
            {
                ...
                foreach (KhoiLuongGiangDayChiTiet klGiangDay in listKhoiLuong)
                {
                    if (!backgroundWorker.CancellationPending)
                    {
                        ...
                        klQuyDoi.HeSoThamNien = decimal.Parse(tblHeSo.Rows[0]["HeSoThamNien"].ToString());
                        ...
                        _heSoThinhGiang = decimal.Parse(Common.Globals.ReplaceDotEnviroment(_heSo, "decimal"));

                        if (klGiangDay.MaLoaiGiangVien != 1)    //Nếu không phải là giảng viên cơ hữu
                        {
                            klQuyDoi.HeSoThinhGiangMonChuyenNganh = _heSoThinhGiang == 0 ? 1 : _heSoThinhGiang;
                        }
                        else
                        ...
                        {
                            _heSo = tblHeSo.Rows[0]["HeSoQuyDoiThucHanhSangLyThuyet"].ToString(); //_listCauHinhChung.Find(p => p.TenCauHinh == "Hệ số quy đổi thực hành sang lý thuyết").GiaTri;
                            _heSoThucHanh = decimal.Parse(Common.Globals.ReplaceDotEnviroment(_heSo, "decimal"));
                        ...
                        if (klQuyDoi.MaNhomMonHoc == "TTCK")    //Nhóm môn thực tập cuối khoá
                        {
                            ...
                            _SoTietQuyChuanHuongDanTTCK = decimal.Parse(_tietQuyChuanHuongDanTTCK.Replace(",", "."));
                            klQuyDoi.TietQuyDoi = klQuyDoi.SoLuong * _SoTietQuyChuanHuongDanTTCK;
                        }
                        else
                        {
                            klQuyDoi.TietQuyDoi = klQuyDoi.SoTiet *
                                (1 + (klQuyDoi.HeSoChucDanhChuyenMon - 1) + (klQuyDoi.HeSoLopDong - 1) + (klQuyDoi.HeSoThinhGiangMonChuyenNganh - 1))
                        ...
                        xmlData += "<Input _00MKL=\"" + klQuyDoi.MaKhoiLuongGiangDay
                                   ...
                                   + "\" _22HSCD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoChucDanhChuyenMon, "decimal", true)
                                   + "\" _23HSLD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoLopDong, "decimal", true)
                                   + "\" _24HSTG=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoThinhGiangMonChuyenNganh, "decimal", true)
                                   + "\" _25HSTH=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoQuyDoiThucHanhSangLyThuyet, "decimal", true)
                                   + "\" _26HSTN=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoThamNien, "decimal", true)
                                   + "\" _27HSTC=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoTroCap, "decimal", true)
                                   + "\" _28TQD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.TietQuyDoi, "decimal", true)
                                   + "\" />";
            ...
            try
            {
                ...
                foreach (KhoiLuongGiangDayChiTiet klGiangDay in listKhoiLuong)
                {
                    if (!backgroundWorker.CancellationPending)
                    {
                        ...
                        //, _hesoChucDanhChuyenMon = 0, _heSoDiaDiemVaNgoaiGio = 0
                ...
                foreach (KhoiLuongGiangDayChiTiet klGiangDay in listKhoiLuong)
                {
                    if (!backgroundWorker.CancellationPending)
                    {
                        ...
                        xmlData += "<Input _01MKL=\"" + klQuyDoi.MaKhoiLuongGiangDay
                                ...
                                + "\" _08STC=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.SoTinChi, "decimal")
                                ...
                                + "\" _15ST=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.SoTiet, "decimal")
                                ...
                                + "\" _23HSCV=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoCongViec, "decimal")
                                + "\" _24HSBDT=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoBacDaoTao, "decimal")
                                + "\" _25HSNN=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoNgonNgu, "decimal")
                                + "\" _26HSCDCM=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoChucDanhChuyenMon, "decimal")
                                + "\" _27HSLD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoLopDong, "decimal")
                                + "\" _28HSCS=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoCoSo, "decimal")
                                + "\" _29STTTQD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.SoTietThucTeQuyDoi, "decimal")
                                + "\" _30TQD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.TietQuyDoi, "decimal")
                                + "\" _31HSQDTHSLT=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoQuyDoiThucHanhSangLyThuyet
                                + "\" _32HSNG=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoNgoaiGio
                                + "\" _33LL=\"" + klQuyDoi.LoaiLop
                                + "\" _34HSCLCCNTN=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoClcCntn
                                + "\" _35HSTGMCN=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoThinhGiangMonChuyenNganh
                                + "\" _36NNGD=\"" + klQuyDoi.NgonNguGiangDay
                                + "\" _37HSTCGD=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoTroCapGiangDay
                                + "\" _38HSTC=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoTroCap, "decimal")//klQuyDoi.HeSoTroCap
                                + "\" _39HSL=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoLuong
                                + "\" _40HSMM=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoMonMoi
                                + "\" _41HSNCTC=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoNienCheTinChi, "decimal")
                                + "\" _42GC=\"" + string.Empty//klQuyDoi.GhiChu
                                + "\" _43MTT=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.MucThanhToan, "decimal")
                                + "\" />";
                    }
                }
        ...
        void QuyDoiTamUngLAW(int index, string NamHoc, string HocKy)
        {
            try
            {
                ...
                foreach (KhoiLuongTamUng klGiangDay in listKhoiLuong)
                {
                    if (!backgroundWorker.CancellationPending)
                    {
                        backgroundWorker.ReportProgress(index++ * 100 / process, String.Format("GV: {0}.  LHP: {1}.  MH: {2}", klGiangDay.MaQuanLyGv, klGiangDay.TenMonHoc, klGiangDay.MaLopHocPhan));
                        ...
                        xmlData += "<Input _01MKLTU=\"" + klQuyDoi.MaKhoiLuongTamUng
                                + "\" _02HSCV=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoCongViec, "decimal")
                                + "\" _03HSBDT=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoBacDaoTao, "decimal")
                                + "\" _04HSNN=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoNgonNgu, "decimal")
                                + "\" _05HSCDCM=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoChucDanhChuyenMon, "decimal")
                                + "\" _06HSLD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoLopDong, "decimal")
                                + "\" _07HSCS=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoCoSo, "decimal")
                                + "\" _08STTTQD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.SoTietThucTeQuyDoi, "decimal")
                                + "\" _09TQD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.TietQuyDoi, "decimal")
                                + "\" _10HSQDTHSLT=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoQuyDoiThucHanhSangLyThuyet
                                + "\" _11HSNG=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoNgoaiGio
                                + "\" _12LL=\"" + klQuyDoi.LoaiLop
                                + "\" _13HSCLCCNTN=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoClcCntn
                                + "\" _14HSTGMCN=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoThinhGiangMonChuyenNganh
                                + "\" _15HSTC=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoTroCap, "decimal")//klQuyDoi.HeSoTroCap
                                + "\" _16HSL=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoLuong
                                + "\" _17HSMM=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoMonMoi
                                + "\" _18HSNCTC=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoNienCheTinChi, "decimal")
                                + "\" _19GC=\"" + string.Empty//klQuyDoi.GhiChu
                                + "\" _20Chot=\"" + 0
                                + "\" _21MTT=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.MucThanhToan, "decimal")
                                + "\" />";
                    }
                }
        ...
        void QuyDoiBUH(int index, string NamHoc, string HocKy)
        {
            try
            {
                ...
                {
                    TList<KhoiLuongGiangDayChiTiet> list = DataServices.KhoiLuongGiangDayChiTiet.GetByNamHocHocKy(NamHoc, HocKy);
                    foreach (KhoiLuongGiangDayChiTiet khoiLuong in list)
                    {
                        foreach (DataRow row in this._duLieuQuyDoi.Rows)
                        {
        ...
        void QuyDoiVHU(int index, string NamHoc, string HocKy)
        {
            try
            {
                strTenTruong = PMS.Common.Globals.GetMaTruong(_listCauHinhChung, "Tên trường");
                ...
                foreach (KhoiLuongGiangDayChiTiet klGiangDay in listKhoiLuong)
                {
                    if (!backgroundWorker.CancellationPending)
                    {
                        ...
                        if (klQuyDoi.MaLopHocPhan.Equals("161MCA01915"))
                        {
                            //int a = 0;
                        }

                        DataTable _heSoQuyDoi = new DataTable();
                        IDataReader reader = DataServices.GiangVien.GetHeSoQuyDoiTietChuanChung(NamHoc, HocKy, klQuyDoi.MaBacDaoTao, klQuyDoi.MaLopHocPhan, klQuyDoi.MaMonHoc, (int)klQuyDoi.SoLuong, klQuyDoi.MaLop, klQuyDoi.MaLoaiHocPhan.ToString(), (DateTime)klQuyDoi.NgayDay
                        ...
                        klQuyDoi.HeSoCoSo = decimal.Parse(_rowHeSo["HeSoCoSo"].ToString());
                        if (iichekc != 1)
                            klQuyDoi.TietQuyDoi = klQuyDoi.SoTiet * klQuyDoi.HeSoQuyDoiThucHanhSangLyThuyet * (1 + klQuyDoi.HeSoNgoaiGio + klQuyDoi.HeSoLopDong);
                        else
                            klQuyDoi.TietQuyDoi = klQuyDoi.SoTiet * klQuyDoi.HeSoQuyDoiThucHanhSangLyThuyet * ((klQuyDoi.HeSoNgoaiGio + klQuyDoi.HeSoLopDong) - 1);
                        ...
                        xmlData += "<Input _01MKL=\"" + klQuyDoi.MaKhoiLuongGiangDay
                                ...
                                + "\" _30TQD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.TietQuyDoi, "decimal")
                                + "\" _31HSQDTHSLT=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoQuyDoiThucHanhSangLyThuyet, "decimal")//klQuyDoi.HeSoQuyDoiThucHanhSangLyThuyet
                                + "\" _32HSNG=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoNgoaiGio, "decimal")//klQuyDoi.HeSoNgoaiGio
                                + "\" _33LL=\"" + ""//klQuyDoi.LoaiLop
                                + "\" _34HSCLCCNTN=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoClcCntn, "decimal")//klQuyDoi.HeSoClcCntn
                                + "\" _35HSTGMCN=\"" + Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoThinhGiangMonChuyenNganh
                                + "\" _36NNGD=\"" + klQuyDoi.NgonNguGiangDay
            ...
            try
            {
                ...
                foreach (KhoiLuongGiangDayChiTiet klGiangDay in listKhoiLuong)
                {
                    if (!backgroundWorker.CancellationPending)
                    {
                        ...
                        {
                           klQuyDoi.TietQuyDoi = klQuyDoi.SoTiet * klQuyDoi.HeSoQuyDoiThucHanhSangLyThuyet * (1 + klQuyDoi.HeSoLopDong + klQuyDoi.HeSoBacDaoTao + klQuyDoi.HeSoNgonNgu
                            + klQuyDoi.HeSoNgoaiGio  + klQuyDoi.HeSoKhoiNganh);
                        }
                        else
                        {
                        ...
                        xmlData += "<Input _01MKL=\"" + klQuyDoi.MaKhoiLuongGiangDay
                                ...
                                + "\" _33LL=\"" + string.Empty//klQuyDoi.LoaiLop
                                ...
                                + "\" _36NNGD=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.NgonNguGiangDay, "decimal", true)
                                + "\" _37HSTCGD=\"" + 0//PMS.Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoTroCapGiangDay
                                + "\" _38HSTC=\"" + 0//PMS.Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoTroCap, "decimal")//klQuyDoi.HeSoTroCap
                                + "\" _39HSL=\"" + 0//PMS.Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoLuong
                                + "\" _40HSMM=\"" + 0//PMS.Common.Globals.ReplaceDotEnviroment(0, "decimal")//klQuyDoi.HeSoMonMoi
                                + "\" _41HSNCTC=\"" + 0//PMS.Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoNienCheTinChi, "decimal")
                                + "\" _42HSKN=\"" + Common.Globals.ReplaceDotEnviroment(klQuyDoi.HeSoKhoiNganh, "decimal", true)
        ...
        void QuyDoiDLU(int index, string NamHoc, string HocKy, string bac, string he)
        {
            try
            {
                ...
                {
                    //now = DateTime.Now;
                    //Common.XuLyTapTin.WriteTextFile(klGiangDay.MaLopHocPhan + ":\t" + Common.XuLyThoiGian.SoMillisecond(time,now) + "\t");
                    //time = now;
                    if (!backgroundWorker.CancellationPending)
                    {
                        backgroundWorker.ReportProgress(index++ * 100 / process, String.Format("GV: {0}.  LHP: {1}.  MH: {2}", klGiangDay.MaGiangVien, klGiangDay.MaLopHocPhan, klGiangDay.TenMonHoc));
                        ...
                        else
                        {
                            ...
                            if (klQuyDoi.LoaiHocPhan.Equals("LT")) //Lý thuyết
                            {
                            ...
                            else //Thực hành
                            {
                                ...
                                if (!"CH;NC".Contains(klQuyDoi.MaBacDaoTao) && "CQ".Contains(klGiangDay.MaLoaiHinhDaoTao)) //Chính quy
                                {
                                    ...
                                    klQuyDoi.TietQuyDoi = (_soNhomThucHanh * klQuyDoi.SoTiet * klQuyDoi.HeSoQuyDoiThucHanhSangLyThuyet)
                                        * (klQuyDoi.HeSoLopDong + klQuyDoi.HeSoChucDanhChuyenMon); //DLU
                                }
            ...
            try
            {
                ...
                foreach (KhoiLuongGiangDayChiTiet klGiangDay in listKhoiLuong)
                {
                    if (!backgroundWorker.CancellationPending)
                    {
                        ...
                        klQuyDoi.MaNhomMonHoc = klGiangDay.MaNhomMonHoc;
                        klQuyDoi.MaPhongHoc = klGiangDay.MaPhongHoc;
                        klQuyDoi.HeSoCongViec = 0; //(DataServices.HeSoCongViec.GetByLoaiHocPhanNgayDay(klQuyDoi.MaLoaiHocPhan.ToString(), DateTime.Parse(klQuyDoi.NgayDay.ToString())) as TList<HeSoCongViec>)[0].HeSo;
                        klQuyDoi.HeSoBacDaoTao = 0; //(DataServices.HeSoBacDaoTao.GetByBacDaoTaoKhoaNgayDay(klQuyDoi.MaBacDaoTao, klQuyDoi.MaKhoa, DateTime.Parse(klQuyDoi.NgayDay.ToString())) as TList<HeSoBacDaoTao>)[0].HeSo;
                        klQuyDoi.HeSoNgonNgu = 0; //(DataServices.HeSoNgonNgu.GetByMaLopHocPhanNgayDay(klQuyDoi.MaLopHocPhan, DateTime.Parse(klQuyDoi.NgayDay.ToString())) as TList<HeSoNgonNgu>)[0].HeSo;
                        try
                        {
                            TList<HeSoChucDanhTietNghiaVu> he_so_chuc_danh = DataServices.HeSoChucDanhTietNghiaVu.GetByMaHocHam(klGiangDay.MaHocHam);
                            if (he_so_chuc_danh.Count == 0) klQuyDoi.HeSoChucDanhChuyenMon = 0;
                            klQuyDoi.HeSoChucDanhChuyenMon = he_so_chuc_danh[0].HeSo;
                        }
                        catch
                        {
