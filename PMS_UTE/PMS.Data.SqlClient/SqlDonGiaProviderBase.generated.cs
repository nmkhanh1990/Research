...
namespace PMS.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@DonGiaGdtc", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@DonGiaDoAnClc", DbType.Decimal, DBNull.Value);
		database.AddInParameter(commandWrapper, "@DonGiaDoAnDaiTra", DbType.Decimal, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("dongiagdtc ") || clause.Trim().StartsWith("dongiagdtc="))
				{
					database.SetParameterValue(commandWrapper, "@DonGiaGdtc", 
						clause.Trim().Remove(0,10).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				...
				if (clause.Trim().StartsWith("dongiadoandaitra ") || clause.Trim().StartsWith("dongiadoandaitra="))
				{
					database.SetParameterValue(commandWrapper, "@DonGiaDoAnDaiTra", 
						clause.Trim().Remove(0,16).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.DonGia> entities)
		{
			...
			DataColumn col19 = dataTable.Columns.Add("DonGiaNgoaiNgu", typeof(System.Decimal));
			col19.AllowDBNull = true;		
			DataColumn col20 = dataTable.Columns.Add("DonGiaGdtc", typeof(System.Decimal));
			col20.AllowDBNull = true;		
			DataColumn col21 = dataTable.Columns.Add("DonGiaDoAnClc", typeof(System.Decimal));
			col21.AllowDBNull = true;		
			DataColumn col22 = dataTable.Columns.Add("DonGiaDoAnDaiTra", typeof(System.Decimal));
			...
			bulkCopy.ColumnMappings.Add("DonGiaGdtc", "DonGiaGdtc");
			bulkCopy.ColumnMappings.Add("DonGiaDoAnClc", "DonGiaDoAnClc");
			bulkCopy.ColumnMappings.Add("DonGiaDoAnDaiTra", "DonGiaDoAnDaiTra");
			...
			foreach(PMS.Entities.DonGia entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["DonGiaGdtc"] = entity.DonGiaGdtc.HasValue ? (object) entity.DonGiaGdtc  : System.DBNull.Value;
							
				
					row["DonGiaDoAnClc"] = entity.DonGiaDoAnClc.HasValue ? (object) entity.DonGiaDoAnClc  : System.DBNull.Value;
							
				
					row["DonGiaDoAnDaiTra"] = entity.DonGiaDoAnDaiTra.HasValue ? (object) entity.DonGiaDoAnDaiTra  : System.DBNull.Value;
		...
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.DonGia entity)
		{
			...
			database.AddInParameter(commandWrapper, "@DonGiaGdtc", DbType.Decimal, (entity.DonGiaGdtc.HasValue ? (object) entity.DonGiaGdtc  : System.DBNull.Value));
			...
			database.AddInParameter(commandWrapper, "@DonGiaDoAnDaiTra", DbType.Decimal, (entity.DonGiaDoAnDaiTra.HasValue ? (object) entity.DonGiaDoAnDaiTra  : System.DBNull.Value));
