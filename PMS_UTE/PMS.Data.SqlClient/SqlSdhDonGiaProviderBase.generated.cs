/*
	...
	Important: Do not modify this file. Edit the file SqlSdhDonGiaProvider.cs instead.
*/
...
{
	///<summary>
	/// This class is the SqlClient Data Access Logic Component implementation for the <see cref="SdhDonGia"/> entity.
	///</summary>
	public abstract partial class SqlSdhDonGiaProviderBase : SdhDonGiaProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlSdhDonGiaProviderBase"/> instance.
		/// </summary>
		public SqlSdhDonGiaProviderBase()
		{
		}
	...
	public SqlSdhDonGiaProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhDonGia_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(SdhDonGia)
					,_id);
		...
		/// <returns>Returns a typed collection of PMS.Entities.SdhDonGia objects.</returns>
		public override TList<SdhDonGia> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<SdhDonGia>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhDonGia_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@TietBatDauDay", DbType.Int32, DBNull.Value);
		database.AddInParameter(commandWrapper, "@TietKetThucDay", DbType.Int32, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("tietbatdauday ") || clause.Trim().StartsWith("tietbatdauday="))
				{
					database.SetParameterValue(commandWrapper, "@TietBatDauDay", 
						clause.Trim().Remove(0,13).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("tietketthucday ") || clause.Trim().StartsWith("tietketthucday="))
				{
					database.SetParameterValue(commandWrapper, "@TietKetThucDay", 
			...
			//Create Collection
			TList<SdhDonGia> rows = new TList<SdhDonGia>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PMS.Entities.SdhDonGia objects.</returns>
		public override TList<SdhDonGia> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhDonGia_Find_Dynamic", typeof(SdhDonGiaColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<SdhDonGia> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhDonGia_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PMS.Entities.SdhDonGia objects.</returns>
		public override TList<SdhDonGia> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhDonGia_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.SdhDonGia GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhDonGia_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int32, _id);
			
			IDataReader reader = null;
			TList<SdhDonGia> tmp = new TList<SdhDonGia>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.SdhDonGia object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.SdhDonGia> entities)
		{
			...
			bulkCopy.DestinationTableName = "SdhDonGia";
			...
			DataColumn col17 = dataTable.Columns.Add("TietBatDauDay", typeof(System.Int32));
			col17.AllowDBNull = true;		
			DataColumn col18 = dataTable.Columns.Add("TietKetThucDay", typeof(System.Int32));
			...
			bulkCopy.ColumnMappings.Add("TietBatDauDay", "TietBatDauDay");
			bulkCopy.ColumnMappings.Add("TietKetThucDay", "TietKetThucDay");
			
			foreach(PMS.Entities.SdhDonGia entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["TietBatDauDay"] = entity.TietBatDauDay.HasValue ? (object) entity.TietBatDauDay  : System.DBNull.Value;
							
				
					row["TietKetThucDay"] = entity.TietKetThucDay.HasValue ? (object) entity.TietKetThucDay  : System.DBNull.Value;
		...
		/// <summary>
		/// 	Inserts a PMS.Entities.SdhDonGia object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.SdhDonGia object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.SdhDonGia object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.SdhDonGia entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhDonGia_Insert", _useStoredProcedure);
			...
			database.AddInParameter(commandWrapper, "@TietBatDauDay", DbType.Int32, (entity.TietBatDauDay.HasValue ? (object) entity.TietBatDauDay  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@TietKetThucDay", DbType.Int32, (entity.TietKetThucDay.HasValue ? (object) entity.TietKetThucDay  : System.DBNull.Value));
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.SdhDonGia object to update.</param>
		/// <remarks>
		///		After updating the datasource, the PMS.Entities.SdhDonGia object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, PMS.Entities.SdhDonGia entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_SdhDonGia_Update", _useStoredProcedure);
