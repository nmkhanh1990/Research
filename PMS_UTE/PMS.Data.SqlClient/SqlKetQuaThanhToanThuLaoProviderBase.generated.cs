...
namespace PMS.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		/// <summary>
		///	This method wraps the 'cust_KetQuaThanhToanThuLao_TongHopKetQuaChiTien' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="donVi"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader TongHopKetQuaChiTien(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String donVi, System.String loaiGiangVien, System.Int32 lanChot, System.String nganHang)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KetQuaThanhToanThuLao_TongHopKetQuaChiTien", true);
			...
			database.AddInParameter(commandWrapper, "@LoaiGiangVien", DbType.AnsiString,  loaiGiangVien );
			database.AddInParameter(commandWrapper, "@LanChot", DbType.Int32,  lanChot );
			database.AddInParameter(commandWrapper, "@NganHang", DbType.String,  nganHang );
	
			
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "TongHopKetQuaChiTien", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "TongHopKetQuaChiTien", (IEntity)null));
