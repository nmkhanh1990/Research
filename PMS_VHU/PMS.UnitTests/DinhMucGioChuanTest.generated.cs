   ...
   public partial class DinhMucGioChuanTest
    {
		...
		private void Step_30_TestFindByQuery_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				if(mock.MaBacDaoTao != null)
					query.AppendEquals(DinhMucGioChuanColumn.MaBacDaoTao, mock.MaBacDaoTao.ToString());
				if(mock.MaLoaiHinhDaoTao != null)
					query.AppendEquals(DinhMucGioChuanColumn.MaLoaiHinhDaoTao, mock.MaLoaiHinhDaoTao.ToString());
				if(mock.MaNhomGiangVien != null)
					query.AppendEquals(DinhMucGioChuanColumn.MaNhomGiangVien, mock.MaNhomGiangVien.ToString());
		...
		{		
			...
			mock.MaNhomGiangVien = TestUtility.Instance.RandomString(9, false);;
