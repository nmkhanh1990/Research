...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="TienCongTacPhiTest"/> instance.
		/// </summary>	
		public TienCongTacPhiTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  TienCongTacPhi objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public TienCongTacPhi CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            TienCongTacPhi mock = TienCongTacPhiTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, TienCongTacPhi mock)
        {
            TienCongTacPhiTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(TienCongTacPhi mock)
        {
