...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="MonKhongTinhTest"/> instance.
		/// </summary>	
		public MonKhongTinhTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  MonKhongTinh objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public MonKhongTinh CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            MonKhongTinh mock = MonKhongTinhTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, MonKhongTinh mock)
        {
            MonKhongTinhTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(MonKhongTinh mock)
        {
