...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="NhomQuyenTest"/> instance.
		/// </summary>	
		public NhomQuyenTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  NhomQuyen objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public NhomQuyen CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            NhomQuyen mock = NhomQuyenTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, NhomQuyen mock)
        {
            NhomQuyenTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(NhomQuyen mock)
        {
