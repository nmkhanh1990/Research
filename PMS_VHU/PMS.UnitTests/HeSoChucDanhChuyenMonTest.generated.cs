   ...
   public partial class HeSoChucDanhChuyenMonTest
    {
		...
		private void Step_30_TestFindByQuery_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				if(mock.MaChucDanh != null)
					query.AppendEquals(HeSoChucDanhChuyenMonColumn.MaChucDanh, mock.MaChucDanh.ToString());
				...
				if(mock.SiSoToiThieu != null)
					query.AppendEquals(HeSoChucDanhChuyenMonColumn.SiSoToiThieu, mock.SiSoToiThieu.ToString());
				if(mock.SiSoToiDa != null)
					query.AppendEquals(HeSoChucDanhChuyenMonColumn.SiSoToiDa, mock.SiSoToiDa.ToString());
		...
		{		
			...
			mock.MaChucDanh = TestUtility.Instance.RandomNumber();
			...
			mock.SiSoToiThieu = TestUtility.Instance.RandomNumber();
			mock.SiSoToiDa = TestUtility.Instance.RandomNumber();
