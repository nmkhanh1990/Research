...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="PscUserConfigApplicationTest"/> instance.
		/// </summary>	
		public PscUserConfigApplicationTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  PscUserConfigApplication objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public PscUserConfigApplication CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            PscUserConfigApplication mock = PscUserConfigApplicationTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, PscUserConfigApplication mock)
        {
            PscUserConfigApplicationTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(PscUserConfigApplication mock)
        {
