...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="HeSoChucDanhChuyenMonTest"/> instance.
		/// </summary>	
		public HeSoChucDanhChuyenMonTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  HeSoChucDanhChuyenMon objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public HeSoChucDanhChuyenMon CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            HeSoChucDanhChuyenMon mock = HeSoChucDanhChuyenMonTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, HeSoChucDanhChuyenMon mock)
        {
            HeSoChucDanhChuyenMonTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(HeSoChucDanhChuyenMon mock)
        {
