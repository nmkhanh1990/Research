...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="PhanNhomMonHocTinhDinhMucTest"/> instance.
		/// </summary>	
		public PhanNhomMonHocTinhDinhMucTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  PhanNhomMonHocTinhDinhMuc objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public PhanNhomMonHocTinhDinhMuc CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            PhanNhomMonHocTinhDinhMuc mock = PhanNhomMonHocTinhDinhMucTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, PhanNhomMonHocTinhDinhMuc mock)
        {
            PhanNhomMonHocTinhDinhMucTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(PhanNhomMonHocTinhDinhMuc mock)
        {
