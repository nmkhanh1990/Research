...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="PhanNhomMonHocTest"/> instance.
		/// </summary>	
		public PhanNhomMonHocTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  PhanNhomMonHoc objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public PhanNhomMonHoc CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            PhanNhomMonHoc mock = PhanNhomMonHocTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, PhanNhomMonHoc mock)
        {
            PhanNhomMonHocTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(PhanNhomMonHoc mock)
        {
