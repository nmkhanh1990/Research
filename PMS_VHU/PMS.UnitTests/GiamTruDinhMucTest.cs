...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="GiamTruDinhMucTest"/> instance.
		/// </summary>	
		public GiamTruDinhMucTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  GiamTruDinhMuc objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public GiamTruDinhMuc CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            GiamTruDinhMuc mock = GiamTruDinhMucTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, GiamTruDinhMuc mock)
        {
            GiamTruDinhMucTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(GiamTruDinhMuc mock)
        {
