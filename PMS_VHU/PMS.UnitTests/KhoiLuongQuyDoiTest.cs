...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="KhoiLuongQuyDoiTest"/> instance.
		/// </summary>	
		public KhoiLuongQuyDoiTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  KhoiLuongQuyDoi objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public KhoiLuongQuyDoi CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            KhoiLuongQuyDoi mock = KhoiLuongQuyDoiTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, KhoiLuongQuyDoi mock)
        {
            KhoiLuongQuyDoiTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(KhoiLuongQuyDoi mock)
        {
