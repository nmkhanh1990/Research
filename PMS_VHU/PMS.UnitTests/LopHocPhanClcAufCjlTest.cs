...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="LopHocPhanClcAufCjlTest"/> instance.
		/// </summary>	
		public LopHocPhanClcAufCjlTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  LopHocPhanClcAufCjl objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public LopHocPhanClcAufCjl CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            LopHocPhanClcAufCjl mock = LopHocPhanClcAufCjlTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, LopHocPhanClcAufCjl mock)
        {
            LopHocPhanClcAufCjlTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(LopHocPhanClcAufCjl mock)
        {
