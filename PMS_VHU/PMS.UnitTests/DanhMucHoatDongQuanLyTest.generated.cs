   ...
   public partial class DanhMucHoatDongQuanLyTest
    {
		...
		private void Step_30_TestFindByQuery_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				if(mock.SoTiet != null)
					query.AppendEquals(DanhMucHoatDongQuanLyColumn.SoTiet, mock.SoTiet.ToString());
				if(mock.DonVi != null)
					query.AppendEquals(DanhMucHoatDongQuanLyColumn.DonVi, mock.DonVi.ToString());
				if(mock.NgayCapNhat != null)
					query.AppendEquals(DanhMucHoatDongQuanLyColumn.NgayCapNhat, mock.NgayCapNhat.ToString());
				if(mock.NguoiCapNhat != null)
					query.AppendEquals(DanhMucHoatDongQuanLyColumn.NguoiCapNhat, mock.NguoiCapNhat.ToString());
				if(mock.MaLoaiHdql != null)
					query.AppendEquals(DanhMucHoatDongQuanLyColumn.MaLoaiHdql, mock.MaLoaiHdql.ToString());
				if(mock.GhiChu != null)
