...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="KetQuaCacKhoanChiKhacTest"/> instance.
		/// </summary>	
		public KetQuaCacKhoanChiKhacTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  KetQuaCacKhoanChiKhac objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public KetQuaCacKhoanChiKhac CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            KetQuaCacKhoanChiKhac mock = KetQuaCacKhoanChiKhacTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, KetQuaCacKhoanChiKhac mock)
        {
            KetQuaCacKhoanChiKhacTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(KetQuaCacKhoanChiKhac mock)
        {
