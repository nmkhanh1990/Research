...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="LoaiThamSoTest"/> instance.
		/// </summary>	
		public LoaiThamSoTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  LoaiThamSo objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public LoaiThamSo CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            LoaiThamSo mock = LoaiThamSoTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, LoaiThamSo mock)
        {
            LoaiThamSoTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(LoaiThamSo mock)
        {
