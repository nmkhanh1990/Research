...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="CauHinhGiangVienPhanHoiTest"/> instance.
		/// </summary>	
		public CauHinhGiangVienPhanHoiTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  CauHinhGiangVienPhanHoi objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public CauHinhGiangVienPhanHoi CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            CauHinhGiangVienPhanHoi mock = CauHinhGiangVienPhanHoiTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, CauHinhGiangVienPhanHoi mock)
        {
            CauHinhGiangVienPhanHoiTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(CauHinhGiangVienPhanHoi mock)
        {
