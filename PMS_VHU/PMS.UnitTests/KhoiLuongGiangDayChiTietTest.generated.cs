		...
		private void Step_30_TestFindByQuery_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				if(mock.MaKhoaCuaMonHoc != null)
					query.AppendEquals(KhoiLuongGiangDayChiTietColumn.MaKhoaCuaMonHoc, mock.MaKhoaCuaMonHoc.ToString());
				if(mock.MaLoaiHinhDaoTao != null)
					query.AppendEquals(KhoiLuongGiangDayChiTietColumn.MaLoaiHinhDaoTao, mock.MaLoaiHinhDaoTao.ToString());
