...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="TcbKetQuaQuyDoiTest"/> instance.
		/// </summary>	
		public TcbKetQuaQuyDoiTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  TcbKetQuaQuyDoi objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public TcbKetQuaQuyDoi CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            TcbKetQuaQuyDoi mock = TcbKetQuaQuyDoiTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, TcbKetQuaQuyDoi mock)
        {
            TcbKetQuaQuyDoiTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(TcbKetQuaQuyDoi mock)
        {
