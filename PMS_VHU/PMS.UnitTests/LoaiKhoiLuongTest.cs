...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="LoaiKhoiLuongTest"/> instance.
		/// </summary>	
		public LoaiKhoiLuongTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  LoaiKhoiLuong objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public LoaiKhoiLuong CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            LoaiKhoiLuong mock = LoaiKhoiLuongTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, LoaiKhoiLuong mock)
        {
            LoaiKhoiLuongTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(LoaiKhoiLuong mock)
        {
