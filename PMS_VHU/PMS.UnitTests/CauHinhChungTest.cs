...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="CauHinhChungTest"/> instance.
		/// </summary>	
		public CauHinhChungTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  CauHinhChung objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public CauHinhChung CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            CauHinhChung mock = CauHinhChungTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, CauHinhChung mock)
        {
            CauHinhChungTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(CauHinhChung mock)
        {
