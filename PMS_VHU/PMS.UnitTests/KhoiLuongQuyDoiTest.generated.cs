		...
		private void Step_30_TestFindByQuery_Generated()
		{
			using (TransactionManager tm = CreateTransaction())
			{
				...
				if(mock.MaKhoaCuaMonHoc != null)
					query.AppendEquals(KhoiLuongQuyDoiColumn.MaKhoaCuaMonHoc, mock.MaKhoaCuaMonHoc.ToString());
				if(mock.HeSoThamNien != null)
					query.AppendEquals(KhoiLuongQuyDoiColumn.HeSoThamNien, mock.HeSoThamNien.ToString());
