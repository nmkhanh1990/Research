...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="KhoiLuongGiangDayCaoDangTest"/> instance.
		/// </summary>	
		public KhoiLuongGiangDayCaoDangTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  KhoiLuongGiangDayCaoDang objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public KhoiLuongGiangDayCaoDang CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            KhoiLuongGiangDayCaoDang mock = KhoiLuongGiangDayCaoDangTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, KhoiLuongGiangDayCaoDang mock)
        {
            KhoiLuongGiangDayCaoDangTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(KhoiLuongGiangDayCaoDang mock)
        {
