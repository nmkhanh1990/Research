...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="DonGiaNhomNganhTest"/> instance.
		/// </summary>	
		public DonGiaNhomNganhTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  DonGiaNhomNganh objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public DonGiaNhomNganh CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            DonGiaNhomNganh mock = DonGiaNhomNganhTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, DonGiaNhomNganh mock)
        {
            DonGiaNhomNganhTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(DonGiaNhomNganh mock)
        {
