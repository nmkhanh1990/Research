...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="HeSoTinChiTest"/> instance.
		/// </summary>	
		public HeSoTinChiTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  HeSoTinChi objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public HeSoTinChi CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            HeSoTinChi mock = HeSoTinChiTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, HeSoTinChi mock)
        {
            HeSoTinChiTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(HeSoTinChi mock)
        {
