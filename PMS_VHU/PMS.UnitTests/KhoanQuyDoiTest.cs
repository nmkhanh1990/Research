...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="KhoanQuyDoiTest"/> instance.
		/// </summary>	
		public KhoanQuyDoiTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  KhoanQuyDoi objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public KhoanQuyDoi CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            KhoanQuyDoi mock = KhoanQuyDoiTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, KhoanQuyDoi mock)
        {
            KhoanQuyDoiTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(KhoanQuyDoi mock)
        {
