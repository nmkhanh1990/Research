...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewQuyDoiHoatDongNgoaiGiangDay"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewQuyDoiHoatDongNgoaiGiangDayTest"/> instance.
		/// </summary>	
		public ViewQuyDoiHoatDongNgoaiGiangDayTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewQuyDoiHoatDongNgoaiGiangDay objects of the database.
		/// </summary>
