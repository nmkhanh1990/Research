...
{
    /// <summary>
    /// Provides tests for the <see cref="VThanhToanThuLao"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VThanhToanThuLaoTest"/> instance.
		/// </summary>	
		public VThanhToanThuLaoTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VThanhToanThuLao objects of the database.
		/// </summary>
