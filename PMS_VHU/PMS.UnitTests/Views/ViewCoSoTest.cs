...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewCoSo"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewCoSoTest"/> instance.
		/// </summary>	
		public ViewCoSoTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewCoSo objects of the database.
		/// </summary>
