...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewMonHoc"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewMonHocTest"/> instance.
		/// </summary>	
		public ViewMonHocTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewMonHoc objects of the database.
		/// </summary>
