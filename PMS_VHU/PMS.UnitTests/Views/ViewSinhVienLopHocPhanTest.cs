...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewSinhVienLopHocPhan"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewSinhVienLopHocPhanTest"/> instance.
		/// </summary>	
		public ViewSinhVienLopHocPhanTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewSinhVienLopHocPhan objects of the database.
		/// </summary>
