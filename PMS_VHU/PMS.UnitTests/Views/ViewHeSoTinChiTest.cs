...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewHeSoTinChi"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewHeSoTinChiTest"/> instance.
		/// </summary>	
		public ViewHeSoTinChiTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewHeSoTinChi objects of the database.
		/// </summary>
