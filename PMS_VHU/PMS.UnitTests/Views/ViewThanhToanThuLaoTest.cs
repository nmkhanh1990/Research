...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewThanhToanThuLao"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewThanhToanThuLaoTest"/> instance.
		/// </summary>	
		public ViewThanhToanThuLaoTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewThanhToanThuLao objects of the database.
		/// </summary>
