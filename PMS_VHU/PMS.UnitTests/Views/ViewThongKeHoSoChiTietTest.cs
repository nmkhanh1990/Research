...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewThongKeHoSoChiTiet"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewThongKeHoSoChiTietTest"/> instance.
		/// </summary>	
		public ViewThongKeHoSoChiTietTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewThongKeHoSoChiTiet objects of the database.
		/// </summary>
