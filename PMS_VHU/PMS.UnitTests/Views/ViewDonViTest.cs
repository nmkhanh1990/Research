...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewDonVi"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewDonViTest"/> instance.
		/// </summary>	
		public ViewDonViTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewDonVi objects of the database.
		/// </summary>
