...
{
    /// <summary>
    /// Provides tests for the <see cref="VChiTietKhoiLuong"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VChiTietKhoiLuongTest"/> instance.
		/// </summary>	
		public VChiTietKhoiLuongTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VChiTietKhoiLuong objects of the database.
		/// </summary>
