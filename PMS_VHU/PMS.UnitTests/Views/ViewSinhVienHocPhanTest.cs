...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewSinhVienHocPhan"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewSinhVienHocPhanTest"/> instance.
		/// </summary>	
		public ViewSinhVienHocPhanTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewSinhVienHocPhan objects of the database.
		/// </summary>
