...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewChiTietPhanCongGiangDay"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewChiTietPhanCongGiangDayTest"/> instance.
		/// </summary>	
		public ViewChiTietPhanCongGiangDayTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewChiTietPhanCongGiangDay objects of the database.
		/// </summary>
