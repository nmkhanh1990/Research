...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewQuyetDinhDoiHocHamHocVi"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewQuyetDinhDoiHocHamHocViTest"/> instance.
		/// </summary>	
		public ViewQuyetDinhDoiHocHamHocViTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewQuyetDinhDoiHocHamHocVi objects of the database.
		/// </summary>
