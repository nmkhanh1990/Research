...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewKetQuaThanhToanThuLao"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewKetQuaThanhToanThuLaoTest"/> instance.
		/// </summary>	
		public ViewKetQuaThanhToanThuLaoTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewKetQuaThanhToanThuLao objects of the database.
		/// </summary>
