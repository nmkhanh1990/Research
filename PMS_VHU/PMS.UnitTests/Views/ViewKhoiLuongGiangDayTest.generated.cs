/*
	...
	Important: Do not modify this file. Edit the file ViewKhoiLuongGiangDayTest.cs instead.
*/
...
{
    /// <summary>
    /// Provides tests for the and <see cref="ViewKhoiLuongGiangDay"/> objects (entity, collection and repository).
    /// </summary>
    public partial class ViewKhoiLuongGiangDayTest
    {
    	// the ViewKhoiLuongGiangDay instance used to test the repository.
		private ViewKhoiLuongGiangDay mock;
		
		// the VList<ViewKhoiLuongGiangDay> instance used to test the repository.
		private VList<ViewKhoiLuongGiangDay> mockCollection;		
        ...
        static private void Init_Generated()
        {
			...
			System.Console.WriteLine("-- Testing the ViewKhoiLuongGiangDay Entity with the {0} --", PMS.Data.DataRepository.Provider.Name);
			System.Console.WriteLine(new String('-', 75));
        }
		...
		/// <summary>
		/// Selects a page of ViewKhoiLuongGiangDay objects from the database.
		/// </summary>
		private void Step_1_SelectAll_Generated()
		{
			int count = -1;
			mockCollection = DataRepository.ViewKhoiLuongGiangDayProvider.GetPaged(null, 0, 10, out count);
			Assert.IsTrue(count >= 0, "Select Query Failed with GetPaged");
			System.Console.WriteLine("DataRepository.ViewKhoiLuongGiangDayProvider.GetPaged():");			
			System.Console.WriteLine(mockCollection);			
		}
		
		/// <summary>
		/// Searches some ViewKhoiLuongGiangDay objects from the database.
		/// </summary>
		private void Step_2_Search_Generated()
		{
			int count = -1;
			mockCollection = DataRepository.ViewKhoiLuongGiangDayProvider.Find(null, null, "", 0, 10, out count);
			Assert.IsTrue(count >= 0 && mockCollection != null, "Query Failed to issue Find Command.");
			
			System.Console.WriteLine("DataRepository.ViewKhoiLuongGiangDayProvider.Find():");			
			System.Console.WriteLine(mockCollection);
		...
		{
			string fileName = "temp_ViewKhoiLuongGiangDay.xml";
		
			XmlSerializer mySerializer = new XmlSerializer(typeof(ViewKhoiLuongGiangDay)); 
		...
		private void Step_7_DeserializeEntity_Generated()
		{
			...
			mock = (ViewKhoiLuongGiangDay) mySerializer.Deserialize(myFileStream);
			myFileStream.Close();
		...
		{
			string fileName = "temp_ViewKhoiLuongGiangDayCollection.xml";
		
			VList<ViewKhoiLuongGiangDay> mockCollection = new VList<ViewKhoiLuongGiangDay>();
			mockCollection.Add(mock);
		
			XmlSerializer mySerializer = new XmlSerializer(typeof(VList<ViewKhoiLuongGiangDay>)); 
			System.IO.StreamWriter myWriter = new System.IO.StreamWriter(fileName); 
			mySerializer.Serialize(myWriter, mockCollection); 
			myWriter.Close();
			
			System.Console.WriteLine("VList<ViewKhoiLuongGiangDay> correctly serialized to a temporary file.");					
		}
		...
		private void Step_9_DeserializeCollection_Generated()
		{
			...
			XmlSerializer mySerializer = new XmlSerializer(typeof(VList<ViewKhoiLuongGiangDay>)); 
			System.IO.FileStream myFileStream = new System.IO.FileStream(fileName,  System.IO.FileMode.Open); 
			VList<ViewKhoiLuongGiangDay> mockCollection = (VList<ViewKhoiLuongGiangDay>) mySerializer.Deserialize(myFileStream);
			myFileStream.Close();
			System.IO.File.Delete(fileName);
			System.Console.WriteLine("VList<ViewKhoiLuongGiangDay> correctly deserialized from a temporary file.");	
		}
		#endregion
		
		#region Mock Instance
		///<summary>
		///  Returns a Typed ViewKhoiLuongGiangDay Entity with mock values.
		///</summary>
		static public ViewKhoiLuongGiangDay CreateMockInstance()
		{		
			ViewKhoiLuongGiangDay mock = new ViewKhoiLuongGiangDay();
		   ...
		   return (ViewKhoiLuongGiangDay)mock;
		}
