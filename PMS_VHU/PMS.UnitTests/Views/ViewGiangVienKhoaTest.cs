...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewGiangVienKhoa"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewGiangVienKhoaTest"/> instance.
		/// </summary>	
		public ViewGiangVienKhoaTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewGiangVienKhoa objects of the database.
		/// </summary>
