...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewThongTinChiTietGiangVien"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewThongTinChiTietGiangVienTest"/> instance.
		/// </summary>	
		public ViewThongTinChiTietGiangVienTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewThongTinChiTietGiangVien objects of the database.
		/// </summary>
