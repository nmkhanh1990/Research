...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewDanToc"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewDanTocTest"/> instance.
		/// </summary>	
		public ViewDanTocTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewDanToc objects of the database.
		/// </summary>
