...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewSinhVienLopHocPhanSg"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewSinhVienLopHocPhanSgTest"/> instance.
		/// </summary>	
		public ViewSinhVienLopHocPhanSgTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewSinhVienLopHocPhanSg objects of the database.
		/// </summary>
