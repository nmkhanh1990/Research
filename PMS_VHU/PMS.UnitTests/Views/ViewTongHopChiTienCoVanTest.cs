...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewTongHopChiTienCoVan"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewTongHopChiTienCoVanTest"/> instance.
		/// </summary>	
		public ViewTongHopChiTienCoVanTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewTongHopChiTienCoVan objects of the database.
		/// </summary>
