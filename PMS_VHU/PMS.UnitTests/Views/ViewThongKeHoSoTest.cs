...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewThongKeHoSo"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewThongKeHoSoTest"/> instance.
		/// </summary>	
		public ViewThongKeHoSoTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewThongKeHoSo objects of the database.
		/// </summary>
