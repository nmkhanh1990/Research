...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewDanhSachLopPhanCongGiangDay"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewDanhSachLopPhanCongGiangDayTest"/> instance.
		/// </summary>	
		public ViewDanhSachLopPhanCongGiangDayTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewDanhSachLopPhanCongGiangDay objects of the database.
		/// </summary>
