...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewHocKy"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewHocKyTest"/> instance.
		/// </summary>	
		public ViewHocKyTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewHocKy objects of the database.
		/// </summary>
