...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewHeDaoTao"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewHeDaoTaoTest"/> instance.
		/// </summary>	
		public ViewHeDaoTaoTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewHeDaoTao objects of the database.
		/// </summary>
