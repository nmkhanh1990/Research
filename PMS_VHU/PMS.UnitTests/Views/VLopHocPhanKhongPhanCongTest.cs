...
{
    /// <summary>
    /// Provides tests for the <see cref="VLopHocPhanKhongPhanCong"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="VLopHocPhanKhongPhanCongTest"/> instance.
		/// </summary>	
		public VLopHocPhanKhongPhanCongTest()
		{			
		}
		...
		/// <summary>
		/// Selects all VLopHocPhanKhongPhanCong objects of the database.
		/// </summary>
