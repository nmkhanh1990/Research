...
{
    /// <summary>
    /// Provides tests for the <see cref="ViewChiTietHocPhan"/> objects (entity, collection and repository).
    /// </summary>
	/// <remarks>
    ...
    {
		/// <summary>
		/// Creates a new <see cref="ViewChiTietHocPhanTest"/> instance.
		/// </summary>	
		public ViewChiTietHocPhanTest()
		{			
		}
		...
		/// <summary>
		/// Selects all ViewChiTietHocPhan objects of the database.
		/// </summary>
