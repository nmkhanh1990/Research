...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="GiangVienPhucCapTest"/> instance.
		/// </summary>	
		public GiangVienPhucCapTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  GiangVienPhucCap objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public GiangVienPhucCap CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            GiangVienPhucCap mock = GiangVienPhucCapTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, GiangVienPhucCap mock)
        {
            GiangVienPhucCapTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(GiangVienPhucCap mock)
        {
