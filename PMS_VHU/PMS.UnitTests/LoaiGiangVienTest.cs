...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="LoaiGiangVienTest"/> instance.
		/// </summary>	
		public LoaiGiangVienTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  LoaiGiangVien objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public LoaiGiangVien CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            LoaiGiangVien mock = LoaiGiangVienTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, LoaiGiangVien mock)
        {
            LoaiGiangVienTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(LoaiGiangVien mock)
        {
