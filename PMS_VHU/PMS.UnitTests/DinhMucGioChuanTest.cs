...
namespace PMS.UnitTests
{
    ...
    {    	
		/// <summary>
		/// Creates a new <see cref="DinhMucGioChuanTest"/> instance.
		/// </summary>	
		public DinhMucGioChuanTest()
		{				
		}
		...
		/// <summary>
		/// Selects a sample of  DinhMucGioChuan objects of the database.
		/// </summary>
		[NUnit.Framework.Test]
        ...
        ///</summary>
        static public DinhMucGioChuan CreateMockInstance(TransactionManager tm)
        {
            // get the default mock instance
            DinhMucGioChuan mock = DinhMucGioChuanTest.CreateMockInstance_Generated(tm);
        ...
        ///</summary>
        static public void UpdateMockInstance(TransactionManager tm, DinhMucGioChuan mock)
        {
            DinhMucGioChuanTest.UpdateMockInstance_Generated(tm, mock);
        ...
        static private void SetSpecialTestData(DinhMucGioChuan mock)
        {
