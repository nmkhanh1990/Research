...
namespace PMS.Entities
{
	...
	{		
		...
		public ChucNangBase(System.Int32? _parentId, System.String _phanLoai, System.Boolean? _menu, 
			...
			System.String _thamSo, System.String _kieuForm, System.Boolean? _trangThai, System.Boolean? _trangThaiChot)
		{
			this.entityData = new ChucNangEntityData();
			this.backupData = null;
			...
			System.String _thamSo, System.String _kieuForm, System.Boolean? _trangThai, System.Boolean? _trangThaiChot)
		{
			...
			newChucNang.TrangThaiChot = _trangThaiChot;
			return newChucNang;
		}
		...
		public virtual System.Boolean? TrangThaiChot
		{
			...
			set
			{
				...
				OnColumnChanging(ChucNangColumn.TrangThaiChot, this.entityData.TrangThaiChot);
				this.entityData.TrangThaiChot = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ChucNangColumn.TrangThaiChot, this.entityData.TrangThaiChot);
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"ID", "ParentID", "PhanLoai", "Menu", "BeginGroup", "RibbonStyle", "DataLayout", "TenChucNang", "TenForm", "HinhAnh", "ThuTu", "TenPhuongThuc", "ThamSo", "KieuForm", "TrangThai", "TrangThaiChot"};
			}
		}
		#endregion 
		...
		public bool IsPropertyChanged(ChucNangColumn column)
		{
			switch(column)
			{
					...
					case ChucNangColumn.TrangThaiChot:
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{17}{16}- Id: {0}{16}- ParentId: {1}{16}- PhanLoai: {2}{16}- Menu: {3}{16}- BeginGroup: {4}{16}- RibbonStyle: {5}{16}- DataLayout: {6}{16}- TenChucNang: {7}{16}- TenForm: {8}{16}- HinhAnh: {9}{16}- ThuTu: {10}{16}- TenPhuongThuc: {11}{16}- ThamSo: {12}{16}- KieuForm: {13}{16}- TrangThai: {14}{16}- TrangThaiChot: {15}{16}{18}", 
				this.Id,
