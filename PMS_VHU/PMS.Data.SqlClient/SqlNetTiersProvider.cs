...
namespace PMS.Data.SqlClient
{
	...
	public sealed class SqlNetTiersProvider : PMS.Data.Bases.NetTiersProvider
	{
		...
		#region "PhanLoaiChucNangProvider"
			
		private SqlPhanLoaiChucNangProvider innerSqlPhanLoaiChucNangProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="PhanLoaiChucNang"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override PhanLoaiChucNangProviderBase PhanLoaiChucNangProvider
		{
			get
			{
				if (innerSqlPhanLoaiChucNangProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlPhanLoaiChucNangProvider == null)
						{
							this.innerSqlPhanLoaiChucNangProvider = new SqlPhanLoaiChucNangProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlPhanLoaiChucNangProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlPhanLoaiChucNangProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlPhanLoaiChucNangProvider SqlPhanLoaiChucNangProvider
		{
			get {return PhanLoaiChucNangProvider as SqlPhanLoaiChucNangProvider;}
		}
		...
		#region "NhomGiangVienTinhDonGiaProvider"
			
		private SqlNhomGiangVienTinhDonGiaProvider innerSqlNhomGiangVienTinhDonGiaProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="NhomGiangVienTinhDonGia"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override NhomGiangVienTinhDonGiaProviderBase NhomGiangVienTinhDonGiaProvider
		{
			get
			{
				if (innerSqlNhomGiangVienTinhDonGiaProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlNhomGiangVienTinhDonGiaProvider == null)
						{
							this.innerSqlNhomGiangVienTinhDonGiaProvider = new SqlNhomGiangVienTinhDonGiaProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlNhomGiangVienTinhDonGiaProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlNhomGiangVienTinhDonGiaProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlNhomGiangVienTinhDonGiaProvider SqlNhomGiangVienTinhDonGiaProvider
		{
			get {return NhomGiangVienTinhDonGiaProvider as SqlNhomGiangVienTinhDonGiaProvider;}
		}
		...
		#region "LopHocPhanTheoNhomGiangVienProvider"
			
		private SqlLopHocPhanTheoNhomGiangVienProvider innerSqlLopHocPhanTheoNhomGiangVienProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="LopHocPhanTheoNhomGiangVien"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override LopHocPhanTheoNhomGiangVienProviderBase LopHocPhanTheoNhomGiangVienProvider
		{
			get
			{
				if (innerSqlLopHocPhanTheoNhomGiangVienProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlLopHocPhanTheoNhomGiangVienProvider == null)
						{
							this.innerSqlLopHocPhanTheoNhomGiangVienProvider = new SqlLopHocPhanTheoNhomGiangVienProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlLopHocPhanTheoNhomGiangVienProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlLopHocPhanTheoNhomGiangVienProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlLopHocPhanTheoNhomGiangVienProvider SqlLopHocPhanTheoNhomGiangVienProvider
		{
			get {return LopHocPhanTheoNhomGiangVienProvider as SqlLopHocPhanTheoNhomGiangVienProvider;}
		}
		...
		#region "PhanQuyenTheoKhoaProvider"
			
		private SqlPhanQuyenTheoKhoaProvider innerSqlPhanQuyenTheoKhoaProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="PhanQuyenTheoKhoa"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override PhanQuyenTheoKhoaProviderBase PhanQuyenTheoKhoaProvider
		{
			get
			{
				if (innerSqlPhanQuyenTheoKhoaProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlPhanQuyenTheoKhoaProvider == null)
						{
							this.innerSqlPhanQuyenTheoKhoaProvider = new SqlPhanQuyenTheoKhoaProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlPhanQuyenTheoKhoaProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlPhanQuyenTheoKhoaProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlPhanQuyenTheoKhoaProvider SqlPhanQuyenTheoKhoaProvider
		{
			get {return PhanQuyenTheoKhoaProvider as SqlPhanQuyenTheoKhoaProvider;}
		}
		...
		#region "DieuKhoanProvider"
			
		private SqlDieuKhoanProvider innerSqlDieuKhoanProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="DieuKhoan"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override DieuKhoanProviderBase DieuKhoanProvider
		{
			get
			{
				if (innerSqlDieuKhoanProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlDieuKhoanProvider == null)
						{
							this.innerSqlDieuKhoanProvider = new SqlDieuKhoanProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlDieuKhoanProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlDieuKhoanProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlDieuKhoanProvider SqlDieuKhoanProvider
		{
			get {return DieuKhoanProvider as SqlDieuKhoanProvider;}
		}
		...
		#region "DieuKhoanBaoCaoProvider"
			
		private SqlDieuKhoanBaoCaoProvider innerSqlDieuKhoanBaoCaoProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="DieuKhoanBaoCao"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override DieuKhoanBaoCaoProviderBase DieuKhoanBaoCaoProvider
		{
			get
			{
				if (innerSqlDieuKhoanBaoCaoProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlDieuKhoanBaoCaoProvider == null)
						{
							this.innerSqlDieuKhoanBaoCaoProvider = new SqlDieuKhoanBaoCaoProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlDieuKhoanBaoCaoProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlDieuKhoanBaoCaoProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlDieuKhoanBaoCaoProvider SqlDieuKhoanBaoCaoProvider
		{
			get {return DieuKhoanBaoCaoProvider as SqlDieuKhoanBaoCaoProvider;}
		}
		...
		#region "HeSoChatLuongCaoProvider"
			
		private SqlHeSoChatLuongCaoProvider innerSqlHeSoChatLuongCaoProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="HeSoChatLuongCao"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override HeSoChatLuongCaoProviderBase HeSoChatLuongCaoProvider
		{
			get
			{
				if (innerSqlHeSoChatLuongCaoProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlHeSoChatLuongCaoProvider == null)
						{
							this.innerSqlHeSoChatLuongCaoProvider = new SqlHeSoChatLuongCaoProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlHeSoChatLuongCaoProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlHeSoChatLuongCaoProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlHeSoChatLuongCaoProvider SqlHeSoChatLuongCaoProvider
		{
			get {return HeSoChatLuongCaoProvider as SqlHeSoChatLuongCaoProvider;}
		}
