...
public abstract partial class SqlViewKhoaProviderBase : ViewKhoaProviderBase
{
	...
	/// <summary>
	///	This method wraps the 'cust_View_Khoa_GetDonViTrucThuoc' stored procedure. 
	/// </summary>
	...
	public override VList<ViewKhoa> GetDonViTrucThuoc(TransactionManager transactionManager, int start, int pageLength, System.String maDonVi)
	{
		SqlDatabase database = new SqlDatabase(this._connectionString);
		DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_View_Khoa_GetDonViTrucThuoc", true);
	...
	/// <summary>
	///	This method wraps the 'cust_View_Khoa_GetByMaBoMon' stored procedure. 
	/// </summary>
	...
	/// <remark>This method is generated from a stored procedure.</remark>
	/// <returns>A <see cref="VList&lt;ViewKhoa&gt;"/> instance.</returns>
	public override VList<ViewKhoa> GetByMaBoMon(TransactionManager transactionManager, int start, int pageLength, System.String maBoMon)
	{
		SqlDatabase database = new SqlDatabase(this._connectionString);
		DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_View_Khoa_GetByMaBoMon", true);
	...
	/// <remark>This method is generated from a stored procedure.</remark>
	/// <returns>A <see cref="IDataReader"/> instance.</returns>
	public override IDataReader BoMon_GetBoMonByMaKhoa(TransactionManager transactionManager, int start, int pageLength, System.String maKhoa)
	{
		SqlDatabase database = new SqlDatabase(this._connectionString);
