...
namespace PMS.Common
{
    public static class Globals
    {
        ...
        #region IsNull
        public static T IsNull<T>(object obj)
        {
            if (typeof(T) == typeof(int))
            {
                if (obj == null || obj.ToString() == "")
                    obj = (T)Convert.ChangeType(0, typeof(T));
            }
            else if (typeof(T) == typeof(float))
            {
                if (obj == null || obj.ToString() == "")
                    obj = (T)Convert.ChangeType(float.Parse("0.0"), typeof(T));
            }
            else if (typeof(T) == typeof(decimal))
            {
                if (obj == null || obj.ToString() == "")
                    obj = (T)Convert.ChangeType(decimal.Parse("0.0"), typeof(T));
            }
            else if (typeof(T) == typeof(bool))
            {
                if (obj == null || obj.ToString() == "")
                    obj = (T)Convert.ChangeType(false, typeof(T));
            }
            else if (typeof(T) == typeof(string))
            {
                if (obj == null)
                    obj = (T)Convert.ChangeType("", typeof(T));
            }
