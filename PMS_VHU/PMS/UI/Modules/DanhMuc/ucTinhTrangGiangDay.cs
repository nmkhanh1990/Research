...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucTinhTrangGiangDay : XtraUserControl
    {
        ...
        private void ucTinhTrangGiangDay_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewTinhTrangGiangDay, new string[] { "ThuTu", "MaQuanLy", "TenTinhTrang","TinhTrang","TrangThai" },
                new string[] { "STT", "Mã tình trạng", "Tên tình trạng" ,"Không dùng","Không lọc"},
                new int[] { 70, 100, 300 ,100,100});
            AppGridView.AlignHeader(gridViewTinhTrangGiangDay, new string[] { "ThuTu", "MaQuanLy", "TenTinhTrang", "TinhTrang", "TrangThai" }, DevExpress.Utils.HorzAlignment.Center);
            AppGridView.HideField(gridViewTinhTrangGiangDay, new string[] { "ThuTu" });
