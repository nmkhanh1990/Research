...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucHeSoChucDanhTietNghiaVu : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucHeSoChucDanhTietNghiaVu_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewHeSoChucDanhTNV, new string[] { "Stt", "MaQuanLy", "HocHam", "HocVi", "LoaiGiangVien", "HinhThucDaoTao", "GiangDaySauDaiHoc", "HeSo", "SoTietNghiaVu", "HeSoLuongTangThem", "NgayBdApDung", "NgayKtApDung", "SoTietNghiaVuMonGdtc" },
                new string[] { "STT", "Mã hệ số", "Học hàm", "Học vị", "Loại giảng viên", "Hình thức", "Tham gia giảng dạy SDH", "Hệ số", "Số tiết nghĩa vụ/Năm", "Hệ số lương tăng thêm", "Ngày bắt đầu áp dụng", "Ngày kết thúc áp dụng", "Môn GDTC" },
                new int[] { 70, 70, 150, 150, 150, 150, 150, 70, 150, 150, 150, 150, 120 });
            AppGridView.ShowEditor(gridViewHeSoChucDanhTNV, NewItemRowPosition.Top);
            AppGridView.AlignHeader(gridViewHeSoChucDanhTNV, new string[] { "Stt", "MaQuanLy", "HocHam", "HocVi", "LoaiGiangVien", "HinhThucDaoTao", "GiangDaySauDaiHoc", "NgayBdApDung", "NgayKtApDung" }, DevExpress.Utils.HorzAlignment.Center);

            AppGridView.RegisterControlField(gridViewHeSoChucDanhTNV, "HocHam", repositoryItemCheckedComboBoxEditHocHam);
            AppGridView.RegisterControlField(gridViewHeSoChucDanhTNV, "HocVi", repositoryItemCheckedComboBoxEditHocVi);
            AppGridView.RegisterControlField(gridViewHeSoChucDanhTNV, "LoaiGiangVien", repositoryItemCheckedComboBoxEditLoaiGiangVien);
            AppGridView.RegisterControlField(gridViewHeSoChucDanhTNV, "HinhThucDaoTao", repositoryItemCheckedComboBoxEditHinhThuc);
            ...
            #region HocHam
            //AppRepositoryItemGridLookUpEdit.InitRepositoryItemGridLookUp(repositoryItemCheckedComboBoxEditHocHam, true, TextEditStyles.Standard);
            //AppRepositoryItemGridLookUpEdit.ShowField(repositoryItemCheckedComboBoxEditHocHam, new string[] { "MaQuanLy", "TenHocHam" }, new string[] { "Mã học hàm", "Tên học hàm" });
            //repositoryItemCheckedComboBoxEditHocHam.DisplayMember = "TenHocHam";
            //repositoryItemCheckedComboBoxEditHocHam.ValueMember = "MaHocHam";
            //repositoryItemCheckedComboBoxEditHocHam.NullText = string.Empty;
            AppRepositoryItemCheckedComboBoxEdit.Init(repositoryItemCheckedComboBoxEditHocHam, CheckState.Unchecked, LoaiDuLieu.HocHam);
            #endregion

            #region HocVi
            AppRepositoryItemCheckedComboBoxEdit.Init(repositoryItemCheckedComboBoxEditHocVi, CheckState.Unchecked, LoaiDuLieu.HocVi);
            #endregion

            #region LoaiGiangVien
            AppRepositoryItemCheckedComboBoxEdit.Init(repositoryItemCheckedComboBoxEditLoaiGiangVien, CheckState.Unchecked, LoaiDuLieu.LoaiGiangVien);
            #endregion

            #region HinhThucDangKy
            AppRepositoryItemCheckedComboBoxEdit.Init(repositoryItemCheckedComboBoxEditHinhThuc, CheckState.Unchecked, LoaiDuLieu.HinhThucDangKy);
            #endregion
