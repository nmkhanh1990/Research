...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucDonViTinh : XtraUserControl
    {
        ...
        private void ucDonViTinh_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewDonViTinh, new string[] { "ThuTu", "MaQuanLy", "TenDonVi","TinhTrang" },
                new string[] { "STT", "Mã đơn vị", "Tên đơn vị","Không dùng" },
                new int[] { 70, 100, 200 ,100});
            AppGridView.AlignHeader(gridViewDonViTinh, new string[] { "ThuTu", "MaQuanLy", "TenDonVi", "TinhTrang" }, DevExpress.Utils.HorzAlignment.Center);
            AppGridView.HideField(gridViewDonViTinh, new string[] { "ThuTu" });
