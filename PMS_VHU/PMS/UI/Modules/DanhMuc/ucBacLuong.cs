...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucBacLuong : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucBacLuong_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewBacLuong, new string[] { "MaBacLuong", "TenBacLuong", "GhiChu","TinhTrang" }, new string[] { "Mã bậc lương", "Tên bậc lương", "Ghi chú" ,"Không dùng"}, new int[] { 120, 120, 200,100 });
            AppGridView.AlignHeader(gridViewBacLuong, new string[] { "MaBacLuong", "TenBacLuong", "GhiChu","TinhTrang" }, DevExpress.Utils.HorzAlignment.Center);
