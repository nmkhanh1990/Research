...
{
    public partial class ucHeSoQuyDoiTinChi : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void InitData()
        {
            bindingSourceHeSo.DataSource = DataServices.HeSoQuyDoiTinChi.GetAll();
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            TList<HeSoQuyDoiTinChi> list = bindingSourceHeSo.DataSource as TList<HeSoQuyDoiTinChi>;
            if (list != null)
            {
                if (XtraMessageBox.Show("Bạn có muốn lưu các thay đổi không ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    try
                    {
                        if (list.IsValid)
                        {
                            ...
                            DataServices.HeSoQuyDoiTinChi.Save(list);
