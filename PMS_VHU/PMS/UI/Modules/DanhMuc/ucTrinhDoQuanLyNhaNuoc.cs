...
{
    public partial class ucTrinhDoQuanLyNhaNuoc : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTrinhDoQuanLyNhaNuoc()
        {
            InitializeComponent();
        }

        private void ucTrinhDoQuanLyNhaNuoc_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewKyThi, new string[] { "MaQuanLy", "TenTrinhDoQuanLyNhaNuoc", "GhiChu", "NgayCapNhat", "NguoiCapNhat" },
                new string[] { "Mã trình độ quản lý nhà nước", "Tên trình độ quản lý nhà nước", "Ghi chú", "Ngày cập nhật", "Người cập nhật" },
                new int[] { 250, 250, 250, 99, 99 });
        ...
        void InitData()
        {
            bindingSourceKyThi.DataSource = DataServices.TrinhDoQuanLyNhaNuoc.GetAll();
        }
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            TList<TrinhDoQuanLyNhaNuoc> list = bindingSourceKyThi.DataSource as TList<TrinhDoQuanLyNhaNuoc>;
            if (list != null)
            {
                if (XtraMessageBox.Show("Bạn có muốn lưu các thay đổi không ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    try
                    {
                        if (list.IsValid)
                        {
                            ...
                            DataServices.TrinhDoQuanLyNhaNuoc.Save(list);
        ...
        private void gridViewKyThi_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            if (col.FieldName == "MaQuanLy" || col.FieldName == "TenTrinhDoQuanLyNhaNuoc" || col.FieldName == "GhiChu")
            {
        ...
        {
            TrinhDoQuanLyNhaNuoc obj = e.Row as TrinhDoQuanLyNhaNuoc;
            if (obj != null)
            {
        ...
        {
            TrinhDoQuanLyNhaNuoc obj = target as TrinhDoQuanLyNhaNuoc;
            if (obj != null)
            {
                if (((TList<TrinhDoQuanLyNhaNuoc>)bindingSourceKyThi.DataSource).FindAll(p => p.MaQuanLy == obj.MaQuanLy).Count > 1)
                {
