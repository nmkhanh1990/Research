...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucNgonNguGiangDay : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucNgonNguGiangDay_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewNgonNgu, new string[] { "MaNgonNgu", "TenNgonNgu","TinhTrang" }, new string[] { "Mã ngôn ngữ", "Tên ngôn ngữ" ,"Không dùng"}, new int[] { 100, 200,100 });
            AppGridView.AlignHeader(gridViewNgonNgu, new string[] { "MaNgonNgu", "TenNgonNgu", "TinhTrang" }, DevExpress.Utils.HorzAlignment.Center);
            #endregion
            InitData();
        }
