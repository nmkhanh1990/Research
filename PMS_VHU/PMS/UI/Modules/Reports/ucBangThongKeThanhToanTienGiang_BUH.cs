...
namespace PMS.UI.Modules.Reports
{
    public partial class ucBangThongKeThanhToanTienGiang_BUH : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucBangThongKeThanhToanTienGiang_BUH_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewThongKe, new string[] { "TrangThai", "MaGiangVien", "Ho", "Ten", "TenBoMon", "TietQuyDoi", "DonGia", "ThanhTien", "SoTietClc", "DonGiaClc", "TienSauGiangClc", "ThanhTienClc", "TongCong", "SoTietDinhMucPhaiTru", "TienTruDinhMuc", "SoTienThanhToan", "ThueTncn", "TienViet", "SoTienConDuocNhan", "NoDinhMuc", "GhiChu", "LanChot", "IdGiangVien", "MaLoaiGiangVien" }
                    , new string[] { "Khóa", "Mã giảng viên", "Họ", "Tên", "Đơn vị", "Số tiết đại trà", "Đơn giá đại trà", "Thành tiền đại trà", "Số tiết CLC", "Đơn giá CLC", "Ra đề, chấm thi CLC", "Thành tiền CLC", "Tổng cộng", "Số tiết định mức phải trừ", "Tiền trừ định mức", "Số tiền thanh toán", "Tạm thu thuế TNCN", "Tiền viết", "Số tiền còn được nhận", "Nợ định mức", "Ghi chú", "LanChot", "IdGiangVien", "MaLoaiGiangVien" }
                    , new int[] { 70, 90, 100, 50, 150, 70, 70, 80, 70, 70, 70, 80, 90, 90, 90, 80, 80, 80, 90, 90, 90, 99, 99, 99 });
            AppGridView.AlignHeader(gridViewThongKe, new string[] { "TrangThai", "MaGiangVien", "Ho", "Ten", "TenBoMon", "TietQuyDoi", "DonGia", "ThanhTien", "SoTietClc", "DonGiaClc", "TienSauGiangClc", "ThanhTienClc", "TongCong", "SoTietDinhMucPhaiTru", "TienTruDinhMuc", "SoTienThanhToan", "ThueTncn", "TienViet", "SoTienConDuocNhan", "NoDinhMuc", "GhiChu", "LanChot", "IdGiangVien", "MaLoaiGiangVien" }, DevExpress.Utils.HorzAlignment.Center);
            ...
            AppGridView.FixedField(gridViewThongKe, new string[] { "TrangThai", "MaGiangVien", "Ho", "Ten" }, DevExpress.XtraGrid.Columns.FixedStyle.Left);
        ...
        void InitDotThanhToan()
        {
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null)
            {
                ...
                cboDotThanhToan.DataBindings.Add("EditValue", bindingSourceDotChiTra, "Id", true, DataSourceUpdateMode.Never);
            }
        }
                ...
                if (cboDotThanhToan.EditValue.ToString() != "-1")
                {
                    if (XtraMessageBox.Show("Bạn muốn lưu thay đổi?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        ...
                        foreach (DataRow r in tb.Rows)
                        {
                            ...
                            {
                                xmlData += String.Format("<Input M=\"{0}\" T=\"{1}\" G=\"{2}\" D=\"{3}\" L=\"{4}\" K=\"{5}\" NCN=\"{6}\" FRN=\"{7}\" NH=\"{8}\" HK=\"{9}\" />", r["IdGiangVien"], r["ThueTncn"], r["GhiChu"], cboDotThanhToan.EditValue.ToString(), r["MaLoaiGiangVien"], r["TrangThai"], PMS.Data.Utility.userID.ToString(), this.Name.ToString(), cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString());
                            }
                        }
        ...
        private void chk_khoatatca_CheckedChanged(object sender, EventArgs e)
        {
            PMS.Common.XuLyGiaoDien.CheckAll(gridViewThongKe, "TrangThai", Convert.ToBoolean(chk_khoatatca.EditValue.ToString()));
