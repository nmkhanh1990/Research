...
{
    public partial class ucHopDongMoiGiangDay : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        ...
        private void ucHopDongMoiGiangDay_Load(object sender, EventArgs e)
        {
            #region InitGridview
        ...
        private void btnLocDuLieu_Click(object sender, EventArgs e)
        {
            ...
            if (cboKhoaDonVi.EditValue != null && cboMaGiangVien.EditValue != null && cboNamHoc.EditValue != null && cboHocKy.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.GiangVien.HopDongMoiGiangDay(cboBacDaoTao.EditValue.ToString(), cboKhoaDonVi.EditValue.ToString(), cboMaGiangVien.EditValue.ToString(), cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString());
                tbl.Load(reader);
...
//string filter = gridViewHopDongMoiGiangVien.ActiveFilterString;
            ...
            if (vListBaoCao != null && vListBaoCao.Rows.Count > 0)
            {
                    ...
                    using (frmBaoCao frm = new frmBaoCao())
                    {
                        ...
                        //{
                            frm.InHopDongMoiGiangDay("", "", "", "", "", "", "", "", "", "", "", "", "", cboMaGiangVien.EditValue.ToString(), "", 0, "", 0
