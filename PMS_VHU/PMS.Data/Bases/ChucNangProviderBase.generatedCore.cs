...
{	
	...
	{		
		...
		public static TList<ChucNang> Fill(IDataReader reader, TList<ChucNang> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.TrangThaiChot = (reader[ChucNangColumn.TrangThaiChot.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(ChucNangColumn.TrangThaiChot.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.ChucNang entity)
		{
			...
			entity.TrangThaiChot = (reader[ChucNangColumn.TrangThaiChot.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(ChucNangColumn.TrangThaiChot.ToString())];
