...
{	
	...
	{		
		...
		public static TList<HeSoChucDanhChuyenMon> Fill(IDataReader reader, TList<HeSoChucDanhChuyenMon> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.MaChucDanh = (reader[HeSoChucDanhChuyenMonColumn.MaChucDanh.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(HeSoChucDanhChuyenMonColumn.MaChucDanh.ToString())];
					...
					c.SiSoToiThieu = (reader[HeSoChucDanhChuyenMonColumn.SiSoToiThieu.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(HeSoChucDanhChuyenMonColumn.SiSoToiThieu.ToString())];
					c.SiSoToiDa = (reader[HeSoChucDanhChuyenMonColumn.SiSoToiDa.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(HeSoChucDanhChuyenMonColumn.SiSoToiDa.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.HeSoChucDanhChuyenMon entity)
		{
			...
			entity.MaChucDanh = (reader[HeSoChucDanhChuyenMonColumn.MaChucDanh.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(HeSoChucDanhChuyenMonColumn.MaChucDanh.ToString())];
			...
			entity.SiSoToiThieu = (reader[HeSoChucDanhChuyenMonColumn.SiSoToiThieu.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(HeSoChucDanhChuyenMonColumn.SiSoToiThieu.ToString())];
			entity.SiSoToiDa = (reader[HeSoChucDanhChuyenMonColumn.SiSoToiDa.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(HeSoChucDanhChuyenMonColumn.SiSoToiDa.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.HeSoChucDanhChuyenMon entity)
		{
			...
			entity.MaChucDanh = Convert.IsDBNull(dataRow["MaChucDanh"]) ? null : (System.Int32?)dataRow["MaChucDanh"];
			...
			entity.SiSoToiThieu = Convert.IsDBNull(dataRow["SiSoToiThieu"]) ? null : (System.Int32?)dataRow["SiSoToiThieu"];
			entity.SiSoToiDa = Convert.IsDBNull(dataRow["SiSoToiDa"]) ? null : (System.Int32?)dataRow["SiSoToiDa"];
			entity.AcceptChanges();
		}
		#endregion 
