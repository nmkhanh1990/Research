...
{	
	...
	public abstract class ViewLopHocPhanProviderBaseCore : EntityViewProviderBase<ViewLopHocPhan>
	{
		...
		#region cust_View_LopHocPhan_GetLopClcByNamHocHocKy
		
		/// <summary>
		///	This method wrap the 'cust_View_LopHocPhan_GetLopClcByNamHocHocKy' stored procedure. 
		/// </summary>
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewLopHocPhan&gt;"/> instance.</returns>
		public VList<ViewLopHocPhan> GetLopClcByNamHocHocKy(System.String namHoc, System.String hocKy)
		{
			return GetLopClcByNamHocHocKy(null, 0, int.MaxValue , namHoc, hocKy);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewLopHocPhan&gt;"/> instance.</returns>
		public VList<ViewLopHocPhan> GetLopClcByNamHocHocKy(int start, int pageLength, System.String namHoc, System.String hocKy)
		{
			return GetLopClcByNamHocHocKy(null, start, pageLength , namHoc, hocKy);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <returns>A <see cref="VList&lt;ViewLopHocPhan&gt;"/> instance.</returns>
		public VList<ViewLopHocPhan> GetLopClcByNamHocHocKy(TransactionManager transactionManager, System.String namHoc, System.String hocKy)
		{
			return GetLopClcByNamHocHocKy(transactionManager, 0, int.MaxValue , namHoc, hocKy);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewLopHocPhan&gt;"/> instance.</returns>
		public abstract VList<ViewLopHocPhan> GetLopClcByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength, System.String namHoc, System.String hocKy);
