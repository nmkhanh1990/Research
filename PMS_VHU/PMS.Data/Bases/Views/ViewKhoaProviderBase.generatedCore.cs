...
{	
	...
	public abstract class ViewKhoaProviderBaseCore : EntityViewProviderBase<ViewKhoa>
	{
		...
		#region cust_View_Khoa_GetDonViTrucThuoc
		
		/// <summary>
		///	This method wrap the 'cust_View_Khoa_GetDonViTrucThuoc' stored procedure. 
		/// </summary>
		/// <param name="maDonVi"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewKhoa&gt;"/> instance.</returns>
		public VList<ViewKhoa> GetDonViTrucThuoc(System.String maDonVi)
		{
			return GetDonViTrucThuoc(null, 0, int.MaxValue , maDonVi);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewKhoa&gt;"/> instance.</returns>
		public VList<ViewKhoa> GetDonViTrucThuoc(int start, int pageLength, System.String maDonVi)
		{
			return GetDonViTrucThuoc(null, start, pageLength , maDonVi);
		}
		...
		/// <returns>A <see cref="VList&lt;ViewKhoa&gt;"/> instance.</returns>
		public VList<ViewKhoa> GetDonViTrucThuoc(TransactionManager transactionManager, System.String maDonVi)
		{
			return GetDonViTrucThuoc(transactionManager, 0, int.MaxValue , maDonVi);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewKhoa&gt;"/> instance.</returns>
		public abstract VList<ViewKhoa> GetDonViTrucThuoc(TransactionManager transactionManager, int start, int pageLength, System.String maDonVi);
		...
		#region cust_View_Khoa_GetByMaBoMon
		
		/// <summary>
		///	This method wrap the 'cust_View_Khoa_GetByMaBoMon' stored procedure. 
		/// </summary>
		/// <param name="maBoMon"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewKhoa&gt;"/> instance.</returns>
		public VList<ViewKhoa> GetByMaBoMon(System.String maBoMon)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewKhoa&gt;"/> instance.</returns>
		public VList<ViewKhoa> GetByMaBoMon(int start, int pageLength, System.String maBoMon)
		{
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <returns>A <see cref="VList&lt;ViewKhoa&gt;"/> instance.</returns>
		public VList<ViewKhoa> GetByMaBoMon(TransactionManager transactionManager, System.String maBoMon)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewKhoa&gt;"/> instance.</returns>
		public abstract VList<ViewKhoa> GetByMaBoMon(TransactionManager transactionManager, int start, int pageLength, System.String maBoMon);
		...
		#region cust_View_Khoa_BoMon_GetBoMonByMaKhoa
		
		/// <summary>
		///	This method wrap the 'cust_View_Khoa_BoMon_GetBoMonByMaKhoa' stored procedure. 
		/// </summary>
		/// <param name="maKhoa"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader BoMon_GetBoMonByMaKhoa(System.String maKhoa)
		{
			return BoMon_GetBoMonByMaKhoa(null, 0, int.MaxValue , maKhoa);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader BoMon_GetBoMonByMaKhoa(int start, int pageLength, System.String maKhoa)
		{
			return BoMon_GetBoMonByMaKhoa(null, start, pageLength , maKhoa);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader BoMon_GetBoMonByMaKhoa(TransactionManager transactionManager, System.String maKhoa)
		{
			return BoMon_GetBoMonByMaKhoa(transactionManager, 0, int.MaxValue , maKhoa);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public abstract IDataReader BoMon_GetBoMonByMaKhoa(TransactionManager transactionManager, int start, int pageLength, System.String maKhoa);
