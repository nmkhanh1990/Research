...
{	
	...
	{		
		...
		public static TList<GiangVienNghienCuuKh> Fill(IDataReader reader, TList<GiangVienNghienCuuKh> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.SoBai = (reader[GiangVienNghienCuuKhColumn.SoBai.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(GiangVienNghienCuuKhColumn.SoBai.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.GiangVienNghienCuuKh entity)
		{
			...
			entity.SoBai = (reader[GiangVienNghienCuuKhColumn.SoBai.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(GiangVienNghienCuuKhColumn.SoBai.ToString())];
