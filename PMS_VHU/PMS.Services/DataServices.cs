...
namespace PMS.Services
{
	...
	{		
        ...
        #region PhanLoaiChucNangService
        private static PhanLoaiChucNangService _PhanLoaiChucNangService;
        /// <summary>
		/// Initializes a new instance of the PhanLoaiChucNangService class.
		/// </summary>
        public static PhanLoaiChucNangService PhanLoaiChucNang
        {
            get
            {
                if(_PhanLoaiChucNangService == null)
                    _PhanLoaiChucNangService = new PhanLoaiChucNangService();
                return _PhanLoaiChucNangService;
            }
        }
        #endregion        
        ...
        #region NhomGiangVienTinhDonGiaService
        private static NhomGiangVienTinhDonGiaService _NhomGiangVienTinhDonGiaService;
        /// <summary>
		/// Initializes a new instance of the NhomGiangVienTinhDonGiaService class.
		/// </summary>
        public static NhomGiangVienTinhDonGiaService NhomGiangVienTinhDonGia
        {
            get
            {
                if(_NhomGiangVienTinhDonGiaService == null)
                    _NhomGiangVienTinhDonGiaService = new NhomGiangVienTinhDonGiaService();
                return _NhomGiangVienTinhDonGiaService;
            }
        }
        #endregion        
        ...
        #region LopHocPhanTheoNhomGiangVienService
        private static LopHocPhanTheoNhomGiangVienService _LopHocPhanTheoNhomGiangVienService;
        /// <summary>
		/// Initializes a new instance of the LopHocPhanTheoNhomGiangVienService class.
		/// </summary>
        public static LopHocPhanTheoNhomGiangVienService LopHocPhanTheoNhomGiangVien
        {
            get
            {
                if(_LopHocPhanTheoNhomGiangVienService == null)
                    _LopHocPhanTheoNhomGiangVienService = new LopHocPhanTheoNhomGiangVienService();
                return _LopHocPhanTheoNhomGiangVienService;
            }
        }
        #endregion        
        ...
        #region PhanQuyenTheoKhoaService
        private static PhanQuyenTheoKhoaService _PhanQuyenTheoKhoaService;
        /// <summary>
		/// Initializes a new instance of the PhanQuyenTheoKhoaService class.
		/// </summary>
        public static PhanQuyenTheoKhoaService PhanQuyenTheoKhoa
        {
            get
            {
                if(_PhanQuyenTheoKhoaService == null)
                    _PhanQuyenTheoKhoaService = new PhanQuyenTheoKhoaService();
                return _PhanQuyenTheoKhoaService;
            }
        }
        #endregion        
        ...
        #region DieuKhoanService
        private static DieuKhoanService _DieuKhoanService;
        /// <summary>
		/// Initializes a new instance of the DieuKhoanService class.
		/// </summary>
        public static DieuKhoanService DieuKhoan
        {
            get
            {
                if(_DieuKhoanService == null)
                    _DieuKhoanService = new DieuKhoanService();
                return _DieuKhoanService;
            }
        }
        #endregion        
        ...
        #region DieuKhoanBaoCaoService
        private static DieuKhoanBaoCaoService _DieuKhoanBaoCaoService;
        /// <summary>
		/// Initializes a new instance of the DieuKhoanBaoCaoService class.
		/// </summary>
        public static DieuKhoanBaoCaoService DieuKhoanBaoCao
        {
            get
            {
                if(_DieuKhoanBaoCaoService == null)
                    _DieuKhoanBaoCaoService = new DieuKhoanBaoCaoService();
                return _DieuKhoanBaoCaoService;
            }
        }
        #endregion        
        ...
        #region HeSoChatLuongCaoService
        private static HeSoChatLuongCaoService _HeSoChatLuongCaoService;
        /// <summary>
		/// Initializes a new instance of the HeSoChatLuongCaoService class.
		/// </summary>
        public static HeSoChatLuongCaoService HeSoChatLuongCao
        {
            get
            {
                if(_HeSoChatLuongCaoService == null)
                    _HeSoChatLuongCaoService = new HeSoChatLuongCaoService();
                return _HeSoChatLuongCaoService;
            }
        }
        #endregion        
