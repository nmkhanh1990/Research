...
{		
	...
	public partial class ViewLopHocPhanServiceBase : ServiceViewBase<ViewLopHocPhan>
	{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList{ViewLopHocPhan}"/> instance.</returns>
		public virtual VList<ViewLopHocPhan> GetLopClcByNamHocHocKy(System.String namHoc, System.String hocKy)
		{
			return GetLopClcByNamHocHocKy( namHoc, hocKy, 0, defaultMaxRecords );
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList{ViewLopHocPhan}"/> instance.</returns>
		public virtual VList<ViewLopHocPhan> GetLopClcByNamHocHocKy(System.String namHoc, System.String hocKy, int start, int pageLength)
		{
			// throws security exception if not authorized
			//SecurityContext.IsAuthorized("GetLopClcByNamHocHocKy");
			...
			try
            {
				...
				//Call Custom Procedure from Repository
				result = dataProvider.ViewLopHocPhanProvider.GetLopClcByNamHocHocKy(transactionManager, start, pageLength , namHoc, hocKy);
