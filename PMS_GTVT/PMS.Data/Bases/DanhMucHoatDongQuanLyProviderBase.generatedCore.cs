...
{	
	...
	{		
		...
		public static TList<DanhMucHoatDongQuanLy> Fill(IDataReader reader, TList<DanhMucHoatDongQuanLy> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.SoTiet = (reader[DanhMucHoatDongQuanLyColumn.SoTiet.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DanhMucHoatDongQuanLyColumn.SoTiet.ToString())];
					c.DonVi = (reader[DanhMucHoatDongQuanLyColumn.DonVi.ToString()] == DBNull.Value) ? null : (System.String)reader[(DanhMucHoatDongQuanLyColumn.DonVi.ToString())];
					c.NgayCapNhat = (reader[DanhMucHoatDongQuanLyColumn.NgayCapNhat.ToString()] == DBNull.Value) ? null : (System.String)reader[(DanhMucHoatDongQuanLyColumn.NgayCapNhat.ToString())];
					c.NguoiCapNhat = (reader[DanhMucHoatDongQuanLyColumn.NguoiCapNhat.ToString()] == DBNull.Value) ? null : (System.String)reader[(DanhMucHoatDongQuanLyColumn.NguoiCapNhat.ToString())];
					c.MaLoaiHdql = (reader[DanhMucHoatDongQuanLyColumn.MaLoaiHdql.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(DanhMucHoatDongQuanLyColumn.MaLoaiHdql.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.DanhMucHoatDongQuanLy entity)
		{
			...
			entity.SoTiet = (reader[DanhMucHoatDongQuanLyColumn.SoTiet.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DanhMucHoatDongQuanLyColumn.SoTiet.ToString())];
			entity.DonVi = (reader[DanhMucHoatDongQuanLyColumn.DonVi.ToString()] == DBNull.Value) ? null : (System.String)reader[(DanhMucHoatDongQuanLyColumn.DonVi.ToString())];
			entity.NgayCapNhat = (reader[DanhMucHoatDongQuanLyColumn.NgayCapNhat.ToString()] == DBNull.Value) ? null : (System.String)reader[(DanhMucHoatDongQuanLyColumn.NgayCapNhat.ToString())];
			entity.NguoiCapNhat = (reader[DanhMucHoatDongQuanLyColumn.NguoiCapNhat.ToString()] == DBNull.Value) ? null : (System.String)reader[(DanhMucHoatDongQuanLyColumn.NguoiCapNhat.ToString())];
			entity.MaLoaiHdql = (reader[DanhMucHoatDongQuanLyColumn.MaLoaiHdql.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(DanhMucHoatDongQuanLyColumn.MaLoaiHdql.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.DanhMucHoatDongQuanLy entity)
		{
			...
			entity.MaLoaiHdql = Convert.IsDBNull(dataRow["MaLoaiHDQL"]) ? null : (System.Int32?)dataRow["MaLoaiHDQL"];
