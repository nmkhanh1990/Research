...
{	
	...
	{		
		...
		public static TList<HocHam> Fill(IDataReader reader, TList<HocHam> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.TinhTrang = (reader[HocHamColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(HocHamColumn.TinhTrang.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.HocHam entity)
		{
			...
			entity.TinhTrang = (reader[HocHamColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(HocHamColumn.TinhTrang.ToString())];
		...
		public override void DeepLoad(TransactionManager transactionManager, PMS.Entities.HocHam entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			...
			if (CanDeepLoad(entity, "List<DonGiaTheoNganh>|DonGiaTheoNganhCollection", deepLoadType, innerList)) 
			{
				...
				entity.DonGiaTheoNganhCollection = DataRepository.DonGiaTheoNganhProvider.GetByMaHocHam(transactionManager, entity.MaHocHam);
	...
	{
		///<summary>
		/// Collection of <c>HocHam</c> as OneToMany for DonGiaTheoNganhCollection
		///</summary>
