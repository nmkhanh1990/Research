...
{	
	...
	{		
		...
		public static TList<DonViTinh> Fill(IDataReader reader, TList<DonViTinh> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.TinhTrang = (reader[DonViTinhColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(DonViTinhColumn.TinhTrang.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.DonViTinh entity)
		{
			...
			entity.TinhTrang = (reader[DonViTinhColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(DonViTinhColumn.TinhTrang.ToString())];
