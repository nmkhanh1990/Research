...
{	
	...
	{		
		...
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void UteChiTiet(System.String namHoc, System.String hocKy)
		{
			 UteChiTiet(null, 0, int.MaxValue , namHoc, hocKy);
		}
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void UteChiTiet(int start, int pageLength, System.String namHoc, System.String hocKy)
		{
			 UteChiTiet(null, start, pageLength , namHoc, hocKy);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void UteChiTiet(TransactionManager transactionManager, System.String namHoc, System.String hocKy)
		{
			 UteChiTiet(transactionManager, 0, int.MaxValue , namHoc, hocKy);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public abstract void UteChiTiet(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy);
		...
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetTietNghiaVuBuh(System.String namHoc, System.String hocKy)
		{
			 GetTietNghiaVuBuh(null, 0, int.MaxValue , namHoc, hocKy);
		}
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetTietNghiaVuBuh(int start, int pageLength, System.String namHoc, System.String hocKy)
		{
			 GetTietNghiaVuBuh(null, start, pageLength , namHoc, hocKy);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetTietNghiaVuBuh(TransactionManager transactionManager, System.String namHoc, System.String hocKy)
		{
			 GetTietNghiaVuBuh(transactionManager, 0, int.MaxValue , namHoc, hocKy);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public abstract void GetTietNghiaVuBuh(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy);
		...
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetGiangVienGiamTru(System.String namHoc)
		{
			 GetGiangVienGiamTru(null, 0, int.MaxValue , namHoc);
		}
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetGiangVienGiamTru(int start, int pageLength, System.String namHoc)
		{
			 GetGiangVienGiamTru(null, start, pageLength , namHoc);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetGiangVienGiamTru(TransactionManager transactionManager, System.String namHoc)
		{
			 GetGiangVienGiamTru(transactionManager, 0, int.MaxValue , namHoc);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public abstract void GetGiangVienGiamTru(TransactionManager transactionManager, int start, int pageLength , System.String namHoc);
		...
		public static TList<TietNghiaVu> Fill(IDataReader reader, TList<TietNghiaVu> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.DinhMucThucTeGiangDay = (reader[TietNghiaVuColumn.DinhMucThucTeGiangDay.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucThucTeGiangDay.ToString())];
					c.DinhMucThucTeNckh = (reader[TietNghiaVuColumn.DinhMucThucTeNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucThucTeNckh.ToString())];
					c.DinhMucThucTeKhac = (reader[TietNghiaVuColumn.DinhMucThucTeKhac.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucThucTeKhac.ToString())];
					c.TietNghiaVuHk01 = (reader[TietNghiaVuColumn.TietNghiaVuHk01.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.TietNghiaVuHk01.ToString())];
					c.TietNghiaVuHk02 = (reader[TietNghiaVuColumn.TietNghiaVuHk02.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.TietNghiaVuHk02.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.TietNghiaVu entity)
		{
			...
			entity.DinhMucThucTeGiangDay = (reader[TietNghiaVuColumn.DinhMucThucTeGiangDay.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucThucTeGiangDay.ToString())];
			entity.DinhMucThucTeNckh = (reader[TietNghiaVuColumn.DinhMucThucTeNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucThucTeNckh.ToString())];
			entity.DinhMucThucTeKhac = (reader[TietNghiaVuColumn.DinhMucThucTeKhac.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucThucTeKhac.ToString())];
			entity.TietNghiaVuHk01 = (reader[TietNghiaVuColumn.TietNghiaVuHk01.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.TietNghiaVuHk01.ToString())];
			entity.TietNghiaVuHk02 = (reader[TietNghiaVuColumn.TietNghiaVuHk02.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.TietNghiaVuHk02.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.TietNghiaVu entity)
		{
			...
			entity.DinhMucThucTeGiangDay = Convert.IsDBNull(dataRow["DinhMucThucTeGiangDay"]) ? null : (System.Decimal?)dataRow["DinhMucThucTeGiangDay"];
			entity.DinhMucThucTeNckh = Convert.IsDBNull(dataRow["DinhMucThucTeNckh"]) ? null : (System.Decimal?)dataRow["DinhMucThucTeNckh"];
			entity.DinhMucThucTeKhac = Convert.IsDBNull(dataRow["DinhMucThucTeKhac"]) ? null : (System.Decimal?)dataRow["DinhMucThucTeKhac"];
			entity.TietNghiaVuHk01 = Convert.IsDBNull(dataRow["TietNghiaVuHk01"]) ? null : (System.Decimal?)dataRow["TietNghiaVuHk01"];
			entity.TietNghiaVuHk02 = Convert.IsDBNull(dataRow["TietNghiaVuHk02"]) ? null : (System.Decimal?)dataRow["TietNghiaVuHk02"];
			entity.AcceptChanges();
		}
		#endregion 
