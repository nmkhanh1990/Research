...
{	
	...
	{		
		...
		public static TList<HeSoChucDanhTietNghiaVu> Fill(IDataReader reader, TList<HeSoChucDanhTietNghiaVu> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.HocHam = (reader[HeSoChucDanhTietNghiaVuColumn.HocHam.ToString()] == DBNull.Value) ? null : (System.String)reader[(HeSoChucDanhTietNghiaVuColumn.HocHam.ToString())];
					c.HocVi = (reader[HeSoChucDanhTietNghiaVuColumn.HocVi.ToString()] == DBNull.Value) ? null : (System.String)reader[(HeSoChucDanhTietNghiaVuColumn.HocVi.ToString())];
					c.LoaiGiangVien = (reader[HeSoChucDanhTietNghiaVuColumn.LoaiGiangVien.ToString()] == DBNull.Value) ? null : (System.String)reader[(HeSoChucDanhTietNghiaVuColumn.LoaiGiangVien.ToString())];
					c.HinhThucDaoTao = (reader[HeSoChucDanhTietNghiaVuColumn.HinhThucDaoTao.ToString()] == DBNull.Value) ? null : (System.String)reader[(HeSoChucDanhTietNghiaVuColumn.HinhThucDaoTao.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.HeSoChucDanhTietNghiaVu entity)
		{
			...
			entity.HocHam = (reader[HeSoChucDanhTietNghiaVuColumn.HocHam.ToString()] == DBNull.Value) ? null : (System.String)reader[(HeSoChucDanhTietNghiaVuColumn.HocHam.ToString())];
			entity.HocVi = (reader[HeSoChucDanhTietNghiaVuColumn.HocVi.ToString()] == DBNull.Value) ? null : (System.String)reader[(HeSoChucDanhTietNghiaVuColumn.HocVi.ToString())];
			entity.LoaiGiangVien = (reader[HeSoChucDanhTietNghiaVuColumn.LoaiGiangVien.ToString()] == DBNull.Value) ? null : (System.String)reader[(HeSoChucDanhTietNghiaVuColumn.LoaiGiangVien.ToString())];
			entity.HinhThucDaoTao = (reader[HeSoChucDanhTietNghiaVuColumn.HinhThucDaoTao.ToString()] == DBNull.Value) ? null : (System.String)reader[(HeSoChucDanhTietNghiaVuColumn.HinhThucDaoTao.ToString())];
