...
{	
	...
	{		
		...
		public static TList<QuyDinhTienCanTren> Fill(IDataReader reader, TList<QuyDinhTienCanTren> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.TietTran = (reader[QuyDinhTienCanTrenColumn.TietTran.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(QuyDinhTienCanTrenColumn.TietTran.ToString())];
					c.HocHam = (reader[QuyDinhTienCanTrenColumn.HocHam.ToString()] == DBNull.Value) ? null : (System.String)reader[(QuyDinhTienCanTrenColumn.HocHam.ToString())];
					c.HocVi = (reader[QuyDinhTienCanTrenColumn.HocVi.ToString()] == DBNull.Value) ? null : (System.String)reader[(QuyDinhTienCanTrenColumn.HocVi.ToString())];
					c.LoaiNhanVien = (reader[QuyDinhTienCanTrenColumn.LoaiNhanVien.ToString()] == DBNull.Value) ? null : (System.String)reader[(QuyDinhTienCanTrenColumn.LoaiNhanVien.ToString())];
					c.LoaiGiangVien = (reader[QuyDinhTienCanTrenColumn.LoaiGiangVien.ToString()] == DBNull.Value) ? null : (System.String)reader[(QuyDinhTienCanTrenColumn.LoaiGiangVien.ToString())];
					c.ChucVu = (reader[QuyDinhTienCanTrenColumn.ChucVu.ToString()] == DBNull.Value) ? null : (System.String)reader[(QuyDinhTienCanTrenColumn.ChucVu.ToString())];
					c.TruongHopKhac = (reader[QuyDinhTienCanTrenColumn.TruongHopKhac.ToString()] == DBNull.Value) ? null : (System.String)reader[(QuyDinhTienCanTrenColumn.TruongHopKhac.ToString())];
					c.CongVoiGioChuan = (reader[QuyDinhTienCanTrenColumn.CongVoiGioChuan.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(QuyDinhTienCanTrenColumn.CongVoiGioChuan.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.QuyDinhTienCanTren entity)
		{
			...
			entity.TietTran = (reader[QuyDinhTienCanTrenColumn.TietTran.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(QuyDinhTienCanTrenColumn.TietTran.ToString())];
			entity.HocHam = (reader[QuyDinhTienCanTrenColumn.HocHam.ToString()] == DBNull.Value) ? null : (System.String)reader[(QuyDinhTienCanTrenColumn.HocHam.ToString())];
			entity.HocVi = (reader[QuyDinhTienCanTrenColumn.HocVi.ToString()] == DBNull.Value) ? null : (System.String)reader[(QuyDinhTienCanTrenColumn.HocVi.ToString())];
			entity.LoaiNhanVien = (reader[QuyDinhTienCanTrenColumn.LoaiNhanVien.ToString()] == DBNull.Value) ? null : (System.String)reader[(QuyDinhTienCanTrenColumn.LoaiNhanVien.ToString())];
			entity.LoaiGiangVien = (reader[QuyDinhTienCanTrenColumn.LoaiGiangVien.ToString()] == DBNull.Value) ? null : (System.String)reader[(QuyDinhTienCanTrenColumn.LoaiGiangVien.ToString())];
			entity.ChucVu = (reader[QuyDinhTienCanTrenColumn.ChucVu.ToString()] == DBNull.Value) ? null : (System.String)reader[(QuyDinhTienCanTrenColumn.ChucVu.ToString())];
			entity.TruongHopKhac = (reader[QuyDinhTienCanTrenColumn.TruongHopKhac.ToString()] == DBNull.Value) ? null : (System.String)reader[(QuyDinhTienCanTrenColumn.TruongHopKhac.ToString())];
			entity.CongVoiGioChuan = (reader[QuyDinhTienCanTrenColumn.CongVoiGioChuan.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(QuyDinhTienCanTrenColumn.CongVoiGioChuan.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.QuyDinhTienCanTren entity)
		{
			...
			entity.TietTran = Convert.IsDBNull(dataRow["TietTran"]) ? null : (System.Decimal?)dataRow["TietTran"];
			entity.HocHam = Convert.IsDBNull(dataRow["HocHam"]) ? null : (System.String)dataRow["HocHam"];
			entity.HocVi = Convert.IsDBNull(dataRow["HocVi"]) ? null : (System.String)dataRow["HocVi"];
			entity.LoaiNhanVien = Convert.IsDBNull(dataRow["LoaiNhanVien"]) ? null : (System.String)dataRow["LoaiNhanVien"];
			entity.LoaiGiangVien = Convert.IsDBNull(dataRow["LoaiGiangVien"]) ? null : (System.String)dataRow["LoaiGiangVien"];
			entity.ChucVu = Convert.IsDBNull(dataRow["ChucVu"]) ? null : (System.String)dataRow["ChucVu"];
			entity.TruongHopKhac = Convert.IsDBNull(dataRow["TruongHopKhac"]) ? null : (System.String)dataRow["TruongHopKhac"];
			entity.CongVoiGioChuan = Convert.IsDBNull(dataRow["CongVoiGioChuan"]) ? null : (System.Decimal?)dataRow["CongVoiGioChuan"];
			entity.AcceptChanges();
		}
		#endregion 
