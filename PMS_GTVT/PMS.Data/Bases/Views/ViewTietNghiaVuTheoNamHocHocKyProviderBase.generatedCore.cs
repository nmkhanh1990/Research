...
{	
	...
	public abstract class ViewTietNghiaVuTheoNamHocHocKyProviderBaseCore : EntityViewProviderBase<ViewTietNghiaVuTheoNamHocHocKy>
	{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetByNamHocGroupId(System.String namHoc, System.String groupId)
		{
			 GetByNamHocGroupId(null, 0, int.MaxValue , namHoc, groupId);
		}
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetByNamHocGroupId(int start, int pageLength, System.String namHoc, System.String groupId)
		{
			 GetByNamHocGroupId(null, start, pageLength , namHoc, groupId);
		}
		...
		/// <param name="groupId"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetByNamHocGroupId(TransactionManager transactionManager, System.String namHoc, System.String groupId)
		{
			 GetByNamHocGroupId(transactionManager, 0, int.MaxValue , namHoc, groupId);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public abstract void GetByNamHocGroupId(TransactionManager transactionManager, int start, int pageLength, System.String namHoc, System.String groupId);
		...
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetByNamHocCdgtvt(System.String namHoc)
		{
			 GetByNamHocCdgtvt(null, 0, int.MaxValue , namHoc);
		}
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetByNamHocCdgtvt(int start, int pageLength, System.String namHoc)
		{
			 GetByNamHocCdgtvt(null, start, pageLength , namHoc);
		}
		...
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetByNamHocCdgtvt(TransactionManager transactionManager, System.String namHoc)
		{
			 GetByNamHocCdgtvt(transactionManager, 0, int.MaxValue , namHoc);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public abstract void GetByNamHocCdgtvt(TransactionManager transactionManager, int start, int pageLength, System.String namHoc);
