...
namespace PMS.Entities
{
	...
	{		
		...
		public KetQuaThanhToanThuLaoBase(System.Int32? _maGiangVien, System.String _namHoc, 
			...
			System.Decimal? _heSoNhieuLopHocPhan)
		{
			this.entityData = new KetQuaThanhToanThuLaoEntityData();
			this.backupData = null;
			...
			System.Decimal? _heSoNhieuLopHocPhan)
		{
			...
			newKetQuaThanhToanThuLao.HeSoNhieuLopHocPhan = _heSoNhieuLopHocPhan;
		...
		public virtual System.Decimal? HeSoNhieuLopHocPhan
		{
			...
			set
			{
				...
				OnColumnChanging(KetQuaThanhToanThuLaoColumn.HeSoNhieuLopHocPhan, this.entityData.HeSoNhieuLopHocPhan);
				this.entityData.HeSoNhieuLopHocPhan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KetQuaThanhToanThuLaoColumn.HeSoNhieuLopHocPhan, this.entityData.HeSoNhieuLopHocPhan);
		...
		public bool IsPropertyChanged(KetQuaThanhToanThuLaoColumn column)
		{
			switch(column)
			{
					...
					case KetQuaThanhToanThuLaoColumn.HeSoNhieuLopHocPhan:
