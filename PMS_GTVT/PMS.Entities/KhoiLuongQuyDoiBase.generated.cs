...
namespace PMS.Entities
{
	...
	{		
		...
		public KhoiLuongQuyDoiBase(System.Int32? _maKhoiLuongGiangDay, System.String _maGiangVien, 
			...
			System.Decimal? _heSoKhoiNganh, System.String _maKhoaCuaMonHoc, System.Decimal? _heSoThamNien, 
			...
			System.Decimal? _heSoNhieuLopHocPhan, System.Decimal? _soTietDayNhieuLopHocPhan)
		{
			...
			newKhoiLuongQuyDoi.MaKhoaCuaMonHoc = _maKhoaCuaMonHoc;
			newKhoiLuongQuyDoi.HeSoThamNien = _heSoThamNien;
			newKhoiLuongQuyDoi.HeSoNhieuLopHocPhan = _heSoNhieuLopHocPhan;
			newKhoiLuongQuyDoi.SoTietDayNhieuLopHocPhan = _soTietDayNhieuLopHocPhan;
		...
		[Required(ErrorMessage = "MaKhoiLuongQuyDoi is required")]
		...
		public virtual System.String MaKhoaCuaMonHoc
		{
			...
			set
			{
				...
				OnColumnChanging(KhoiLuongQuyDoiColumn.MaKhoaCuaMonHoc, this.entityData.MaKhoaCuaMonHoc);
				this.entityData.MaKhoaCuaMonHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KhoiLuongQuyDoiColumn.MaKhoaCuaMonHoc, this.entityData.MaKhoaCuaMonHoc);
		...
		public virtual System.Decimal? HeSoThamNien
		{
			...
			set
			{
				...
				OnColumnChanging(KhoiLuongQuyDoiColumn.HeSoThamNien, this.entityData.HeSoThamNien);
				this.entityData.HeSoThamNien = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KhoiLuongQuyDoiColumn.HeSoThamNien, this.entityData.HeSoThamNien);
		...
		public virtual System.Decimal? HeSoNhieuLopHocPhan
		{
			...
			set
			{
				...
				OnColumnChanging(KhoiLuongQuyDoiColumn.HeSoNhieuLopHocPhan, this.entityData.HeSoNhieuLopHocPhan);
				this.entityData.HeSoNhieuLopHocPhan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KhoiLuongQuyDoiColumn.HeSoNhieuLopHocPhan, this.entityData.HeSoNhieuLopHocPhan);
		...
		public virtual System.Decimal? SoTietDayNhieuLopHocPhan
		{
			...
			set
			{
				...
				OnColumnChanging(KhoiLuongQuyDoiColumn.SoTietDayNhieuLopHocPhan, this.entityData.SoTietDayNhieuLopHocPhan);
				this.entityData.SoTietDayNhieuLopHocPhan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KhoiLuongQuyDoiColumn.SoTietDayNhieuLopHocPhan, this.entityData.SoTietDayNhieuLopHocPhan);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{50}{49}- MaKhoiLuongQuyDoi: {0}{49}- MaKhoiLuongGiangDay: {1}{49}- MaGiangVien: {2}{49}- MaLopHocPhan: {3}{49}- NamHoc: {4}{49}- HocKy: {5}{49}- MaMonHoc: {6}{49}- TenMonHoc: {7}{49}- SoTinChi: {8}{49}- SoLuong: {9}{49}- MaLoaiHocPhan: {10}{49}- LoaiHocPhan: {11}{49}- MaBuoiHoc: {12}{49}- MaLop: {13}{49}- TietBatDau: {14}{49}- SoTiet: {15}{49}- TinhTrang: {16}{49}- NgayDay: {17}{49}- MaBacDaoTao: {18}{49}- MaKhoaHoc: {19}{49}- MaKhoa: {20}{49}- MaNhomMonHoc: {21}{49}- MaPhongHoc: {22}{49}- HeSoCongViec: {23}{49}- HeSoBacDaoTao: {24}{49}- HeSoNgonNgu: {25}{49}- HeSoChucDanhChuyenMon: {26}{49}- HeSoLopDong: {27}{49}- HeSoCoSo: {28}{49}- SoTietThucTeQuyDoi: {29}{49}- TietQuyDoi: {30}{49}- HeSoQuyDoiThucHanhSangLyThuyet: {31}{49}- HeSoNgoaiGio: {32}{49}- LoaiLop: {33}{49}- HeSoClcCntn: {34}{49}- HeSoThinhGiangMonChuyenNganh: {35}{49}- NgonNguGiangDay: {36}{49}- HeSoTroCapGiangDay: {37}{49}- HeSoTroCap: {38}{49}- HeSoLuong: {39}{49}- HeSoMonMoi: {40}{49}- HeSoNienCheTinChi: {41}{49}- GhiChu: {42}{49}- MucThanhToan: {43}{49}- HeSoKhoiNganh: {44}{49}- MaKhoaCuaMonHoc: {45}{49}- HeSoThamNien: {46}{49}- HeSoNhieuLopHocPhan: {47}{49}- SoTietDayNhieuLopHocPhan: {48}{49}{51}", 
