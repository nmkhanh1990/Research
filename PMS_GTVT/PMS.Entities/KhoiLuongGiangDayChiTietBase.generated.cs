...
namespace PMS.Entities
{
	...
	{		
		...
		///<param name="_soTietDayNhieuLopHocPhan"></param>
		public KhoiLuongGiangDayChiTietBase(System.Int32 _maLichHoc, System.String _maGiangVien, 
			...
			System.Int32? _maCauHinhChotGio, System.String _maKhoaCuaMonHoc, System.String _maLoaiHinhDaoTao, 
			System.Decimal? _heSoNhieuLopHocPhan, System.Decimal? _soTietDayNhieuLopHocPhan)
		{
			this.entityData = new KhoiLuongGiangDayChiTietEntityData();
			this.backupData = null;
			...
			this.HeSoNhieuLopHocPhan = _heSoNhieuLopHocPhan;
			this.SoTietDayNhieuLopHocPhan = _soTietDayNhieuLopHocPhan;
		}
			...
			System.Decimal? _heSoNhieuLopHocPhan, System.Decimal? _soTietDayNhieuLopHocPhan)
		{
			...
			newKhoiLuongGiangDayChiTiet.MaKhoaCuaMonHoc = _maKhoaCuaMonHoc;
			newKhoiLuongGiangDayChiTiet.MaLoaiHinhDaoTao = _maLoaiHinhDaoTao;
			newKhoiLuongGiangDayChiTiet.HeSoNhieuLopHocPhan = _heSoNhieuLopHocPhan;
			newKhoiLuongGiangDayChiTiet.SoTietDayNhieuLopHocPhan = _soTietDayNhieuLopHocPhan;
		...
		[Required(ErrorMessage = "MaKhoiLuong is required")]
		...
		[Required(ErrorMessage = "MaLichHoc is required")]
		...
		[Required(ErrorMessage = "TenMonHoc is required")]
		...
		[Required(ErrorMessage = "SoTinChi is required")]
		...
		[Required(ErrorMessage = "LyThuyet is required")]
		...
		[Required(ErrorMessage = "ThucHanh is required")]
		...
		[Required(ErrorMessage = "BaiTap is required")]
		...
		[Required(ErrorMessage = "BaiTapLon is required")]
		...
		[Required(ErrorMessage = "DoAn is required")]
		...
		[Required(ErrorMessage = "LuanAn is required")]
		...
		[Required(ErrorMessage = "TieuLuan is required")]
		...
		[Required(ErrorMessage = "ThucTap is required")]
		...
		[Required(ErrorMessage = "MaLoaiHocPhan is required")]
		...
		[Required(ErrorMessage = "TinhTrang is required")]
		...
		public virtual System.String MaKhoaCuaMonHoc
		{
			...
			set
			{
				...
				OnColumnChanging(KhoiLuongGiangDayChiTietColumn.MaKhoaCuaMonHoc, this.entityData.MaKhoaCuaMonHoc);
				this.entityData.MaKhoaCuaMonHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KhoiLuongGiangDayChiTietColumn.MaKhoaCuaMonHoc, this.entityData.MaKhoaCuaMonHoc);
		...
		public virtual System.String MaLoaiHinhDaoTao
		{
			...
			set
			{
				...
				OnColumnChanging(KhoiLuongGiangDayChiTietColumn.MaLoaiHinhDaoTao, this.entityData.MaLoaiHinhDaoTao);
				this.entityData.MaLoaiHinhDaoTao = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KhoiLuongGiangDayChiTietColumn.MaLoaiHinhDaoTao, this.entityData.MaLoaiHinhDaoTao);
				OnPropertyChanged("MaLoaiHinhDaoTao");
			}
		}
		
		/// <summary>
		/// 	Gets or sets the HeSoNhieuLopHocPhan property. 
		///		
		/// </summary>
		/// <value>This type is decimal.</value>
		/// <remarks>
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		public virtual System.Decimal? HeSoNhieuLopHocPhan
		{
			get
			{
				return this.entityData.HeSoNhieuLopHocPhan; 
			}
			
			set
			{
				if (this.entityData.HeSoNhieuLopHocPhan == value)
					return;
				
                OnPropertyChanging("HeSoNhieuLopHocPhan");                    
				OnColumnChanging(KhoiLuongGiangDayChiTietColumn.HeSoNhieuLopHocPhan, this.entityData.HeSoNhieuLopHocPhan);
				this.entityData.HeSoNhieuLopHocPhan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KhoiLuongGiangDayChiTietColumn.HeSoNhieuLopHocPhan, this.entityData.HeSoNhieuLopHocPhan);
				OnPropertyChanged("HeSoNhieuLopHocPhan");
			}
		}
		
		/// <summary>
		/// 	Gets or sets the SoTietDayNhieuLopHocPhan property. 
		///		
		/// </summary>
		/// <value>This type is decimal.</value>
		/// <remarks>
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		public virtual System.Decimal? SoTietDayNhieuLopHocPhan
		{
			get
			{
				return this.entityData.SoTietDayNhieuLopHocPhan; 
			}
			
			set
			{
				if (this.entityData.SoTietDayNhieuLopHocPhan == value)
					return;
				
                OnPropertyChanging("SoTietDayNhieuLopHocPhan");                    
				OnColumnChanging(KhoiLuongGiangDayChiTietColumn.SoTietDayNhieuLopHocPhan, this.entityData.SoTietDayNhieuLopHocPhan);
				this.entityData.SoTietDayNhieuLopHocPhan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KhoiLuongGiangDayChiTietColumn.SoTietDayNhieuLopHocPhan, this.entityData.SoTietDayNhieuLopHocPhan);
				OnPropertyChanged("SoTietDayNhieuLopHocPhan");
			}
		}
		...
		protected virtual KhoiLuongGiangDayChiTiet Copy(IDictionary existingCopies)
		{
			...
			copy.SuppressEntityEvents = true;
				...
				copy.HeSoNhieuLopHocPhan = this.HeSoNhieuLopHocPhan;
				copy.SoTietDayNhieuLopHocPhan = this.SoTietDayNhieuLopHocPhan;
		...
		public bool IsPropertyChanged(KhoiLuongGiangDayChiTietColumn column)
		{
			switch(column)
			{
					...
					case KhoiLuongGiangDayChiTietColumn.MaKhoaCuaMonHoc:
					return entityData.MaKhoaCuaMonHoc != _originalData.MaKhoaCuaMonHoc;
					case KhoiLuongGiangDayChiTietColumn.MaLoaiHinhDaoTao:
					return entityData.MaLoaiHinhDaoTao != _originalData.MaLoaiHinhDaoTao;
					case KhoiLuongGiangDayChiTietColumn.HeSoNhieuLopHocPhan:
					return entityData.HeSoNhieuLopHocPhan != _originalData.HeSoNhieuLopHocPhan;
					case KhoiLuongGiangDayChiTietColumn.SoTietDayNhieuLopHocPhan:
					return entityData.SoTietDayNhieuLopHocPhan != _originalData.SoTietDayNhieuLopHocPhan;
		...
		public bool HasDataChanged()
		{
			...
			result = result || entityData.HeSoNhieuLopHocPhan != _originalData.HeSoNhieuLopHocPhan;
			result = result || entityData.SoTietDayNhieuLopHocPhan != _originalData.SoTietDayNhieuLopHocPhan;
			return result;
		}	
		...
		public KhoiLuongGiangDayChiTiet GetOriginalEntity()
		{
			if (_originalData != null)
				...
				_originalData.HeSoNhieuLopHocPhan,
				_originalData.SoTietDayNhieuLopHocPhan
				);
	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.MaKhoiLuong.GetHashCode() ^ 
					...
					((this.HeSoNhieuLopHocPhan == null) ? string.Empty : this.HeSoNhieuLopHocPhan.ToString()).GetHashCode() ^ 
					((this.SoTietDayNhieuLopHocPhan == null) ? string.Empty : this.SoTietDayNhieuLopHocPhan.ToString()).GetHashCode();
        }
		...
		public static bool ValueEquals(KhoiLuongGiangDayChiTietBase Object1, KhoiLuongGiangDayChiTietBase Object2)
		{
			...
			if ( Object1.HeSoNhieuLopHocPhan != null && Object2.HeSoNhieuLopHocPhan != null )
			{
				if (Object1.HeSoNhieuLopHocPhan != Object2.HeSoNhieuLopHocPhan)
					equal = false;
			}
			else if (Object1.HeSoNhieuLopHocPhan == null ^ Object2.HeSoNhieuLopHocPhan == null )
			{
				equal = false;
			}
			if ( Object1.SoTietDayNhieuLopHocPhan != null && Object2.SoTietDayNhieuLopHocPhan != null )
			{
				if (Object1.SoTietDayNhieuLopHocPhan != Object2.SoTietDayNhieuLopHocPhan)
					equal = false;
			}
			else if (Object1.SoTietDayNhieuLopHocPhan == null ^ Object2.SoTietDayNhieuLopHocPhan == null )
			{
				equal = false;
			}
...
/*
        ...
        public int CompareTo(KhoiLuongGiangDayChiTiet rhs, KhoiLuongGiangDayChiTietColumn which)
        {
            switch (which)
            {
            	...
            	case KhoiLuongGiangDayChiTietColumn.HeSoNhieuLopHocPhan:
            		return this.HeSoNhieuLopHocPhan.Value.CompareTo(rhs.HeSoNhieuLopHocPhan.Value);
            		
            		                 
            	
            	
            	case KhoiLuongGiangDayChiTietColumn.SoTietDayNhieuLopHocPhan:
            		return this.SoTietDayNhieuLopHocPhan.Value.CompareTo(rhs.SoTietDayNhieuLopHocPhan.Value);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{57}{56}- MaKhoiLuong: {0}{56}- MaLichHoc: {1}{56}- MaGiangVien: {2}{56}- MaLopHocPhan: {3}{56}- NamHoc: {4}{56}- HocKy: {5}{56}- MaMonHoc: {6}{56}- TenMonHoc: {7}{56}- Nhom: {8}{56}- SoTinChi: {9}{56}- LyThuyet: {10}{56}- ThucHanh: {11}{56}- BaiTap: {12}{56}- BaiTapLon: {13}{56}- DoAn: {14}{56}- LuanAn: {15}{56}- TieuLuan: {16}{56}- ThucTap: {17}{56}- SoLuong: {18}{56}- MaLoaiHocPhan: {19}{56}- LoaiHocPhan: {20}{56}- PhanLoai: {21}{56}- HeSoThanhPhan: {22}{56}- Nam: {23}{56}- Tuan: {24}{56}- DonViTinh: {25}{56}- MaBuoiHoc: {26}{56}- MaLop: {27}{56}- TietBatDau: {28}{56}- SoTiet: {29}{56}- TinhTrang: {30}{56}- NgayDay: {31}{56}- Compensate: {32}{56}- MaBacDaoTao: {33}{56}- MaKhoa: {34}{56}- MaNhomMonHoc: {35}{56}- MaPhongHoc: {36}{56}- MaKhoaHoc: {37}{56}- LoaiHocKy: {38}{56}- HeSoHocKy: {39}{56}- NamThu: {40}{56}- MaHocHam: {41}{56}- MaHocVi: {42}{56}- MaLoaiGiangVien: {43}{56}- MaChucVu: {44}{56}- MaHinhThucDaoTao: {45}{56}- GhiChu: {46}{56}- NgayCapNhat: {47}{56}- LopHocPhanChuyenNganh: {48}{56}- DotImport: {49}{56}- DaoTaoTinChi: {50}{56}- MaCauHinhChotGio: {51}{56}- MaKhoaCuaMonHoc: {52}{56}- MaLoaiHinhDaoTao: {53}{56}- HeSoNhieuLopHocPhan: {54}{56}- SoTietDayNhieuLopHocPhan: {55}{56}{58}", 
				this.MaKhoiLuong,
				this.MaLichHoc,
				this.MaGiangVien,
				...
				(this.HeSoNhieuLopHocPhan == null) ? string.Empty : this.HeSoNhieuLopHocPhan.ToString(),
				(this.SoTietDayNhieuLopHocPhan == null) ? string.Empty : this.SoTietDayNhieuLopHocPhan.ToString(),
	...
	internal protected class KhoiLuongGiangDayChiTietEntityData : ICloneable, ICloneableEx
	{
		...
		/// HeSoNhieuLopHocPhan : 
		/// </summary>
		public System.Decimal? HeSoNhieuLopHocPhan = null;
		
		/// <summary>
		/// SoTietDayNhieuLopHocPhan : 
		/// </summary>
		public System.Decimal? SoTietDayNhieuLopHocPhan = null;
		#endregion
		...
		public Object Clone()
		{
			...
			_tmp.HeSoNhieuLopHocPhan = this.HeSoNhieuLopHocPhan;
			_tmp.SoTietDayNhieuLopHocPhan = this.SoTietDayNhieuLopHocPhan;
	...
	public enum KhoiLuongGiangDayChiTietColumn : int
	{
		...
		/// HeSoNhieuLopHocPhan : 
		/// </summary>
		[EnumTextValue("He So Nhieu Lop Hoc Phan")]
		[ColumnEnum("HeSoNhieuLopHocPhan", typeof(System.Decimal), System.Data.DbType.Decimal, false, false, true)]
		HeSoNhieuLopHocPhan = 55,
		/// <summary>
		/// SoTietDayNhieuLopHocPhan : 
		/// </summary>
		[EnumTextValue("So Tiet Day Nhieu Lop Hoc Phan")]
		[ColumnEnum("SoTietDayNhieuLopHocPhan", typeof(System.Decimal), System.Data.DbType.Decimal, false, false, true)]
		SoTietDayNhieuLopHocPhan = 56
	}//End enum
