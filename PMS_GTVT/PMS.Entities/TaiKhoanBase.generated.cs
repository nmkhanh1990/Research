...
namespace PMS.Entities
{
	...
	{		
		...
		public TaiKhoanBase(System.Int32? _maNhomQuyen, System.String _tenDangNhap, System.String _matKhau, 
			...
			System.Boolean? _resetPassWordGv, System.Int32? _maGiangVien, System.String _userUis)
		{
			this.entityData = new TaiKhoanEntityData();
			this.backupData = null;
			...
			System.Boolean? _resetPassWordGv, System.Int32? _maGiangVien, System.String _userUis)
		{
			...
			newTaiKhoan.MaGiangVien = _maGiangVien;
			newTaiKhoan.UserUis = _userUis;
			return newTaiKhoan;
		}
		...
		[Required(ErrorMessage = "MaTaiKhoan is required")]
		...
		public virtual System.Int32? MaGiangVien
		{
			...
			set
			{
				...
				OnColumnChanging(TaiKhoanColumn.MaGiangVien, this.entityData.MaGiangVien);
				this.entityData.MaGiangVien = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(TaiKhoanColumn.MaGiangVien, this.entityData.MaGiangVien);
				OnPropertyChanged("MaGiangVien");
			}
		}
		
		/// <summary>
		/// 	Gets or sets the UserUis property. 
		///		
		/// </summary>
		/// <value>This type is varchar.</value>
		/// <remarks>
		...
		public virtual System.String UserUis
		{
			get
			{
				return this.entityData.UserUis; 
			}
			
			set
			{
				if (this.entityData.UserUis == value)
					return;
				
                OnPropertyChanging("UserUis");                    
				OnColumnChanging(TaiKhoanColumn.UserUis, this.entityData.UserUis);
				this.entityData.UserUis = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(TaiKhoanColumn.UserUis, this.entityData.UserUis);
				OnPropertyChanged("UserUis");
			}
		}
		...
		protected override void AddValidationRules()
		{
			...
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
				new CommonRules.MaxLengthRuleArgs("UserUis", "User Uis", 4000));
		}
   		#endregion
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"MaTaiKhoan", "MaNhomQuyen", "TenDangNhap", "MatKhau", "HoTen", "TenMayTinh", "DuongDan", "PhienBan", "NgayDangNhap", "TrangThai", "SkinName", "NgayTao", "ResetPassWordGv", "MaGiangVien", "UserUis"};
			}
		}
		#endregion 
		...
		public bool IsPropertyChanged(TaiKhoanColumn column)
		{
			switch(column)
			{
					...
					case TaiKhoanColumn.MaGiangVien:
					return entityData.MaGiangVien != _originalData.MaGiangVien;
					case TaiKhoanColumn.UserUis:
					return entityData.UserUis != _originalData.UserUis;
		...
		public bool HasDataChanged()
		{
			...
			result = result || entityData.UserUis != _originalData.UserUis;
			return result;
		}	
	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.MaTaiKhoan.GetHashCode() ^ 
					...
					((this.UserUis == null) ? string.Empty : this.UserUis.ToString()).GetHashCode();
        }
		...
		public static bool ValueEquals(TaiKhoanBase Object1, TaiKhoanBase Object2)
		{
			...
			if ( Object1.UserUis != null && Object2.UserUis != null )
			{
				if (Object1.UserUis != Object2.UserUis)
					equal = false;
			}
			else if (Object1.UserUis == null ^ Object2.UserUis == null )
			{
				equal = false;
			}
...
/*
        ...
        public int CompareTo(TaiKhoan rhs, TaiKhoanColumn which)
        {
            switch (which)
            {
            	...
            	case TaiKhoanColumn.UserUis:
            		return this.UserUis.CompareTo(rhs.UserUis);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{16}{15}- MaTaiKhoan: {0}{15}- MaNhomQuyen: {1}{15}- TenDangNhap: {2}{15}- MatKhau: {3}{15}- HoTen: {4}{15}- TenMayTinh: {5}{15}- DuongDan: {6}{15}- PhienBan: {7}{15}- NgayDangNhap: {8}{15}- TrangThai: {9}{15}- SkinName: {10}{15}- NgayTao: {11}{15}- ResetPassWordGv: {12}{15}- MaGiangVien: {13}{15}- UserUis: {14}{15}{17}", 
				this.MaTaiKhoan,
				...
				(this.UserUis == null) ? string.Empty : this.UserUis.ToString(),
	...
	internal protected class TaiKhoanEntityData : ICloneable, ICloneableEx
	{
		...
		/// UserUis : 
		/// </summary>
		public System.String UserUis = null;
		#endregion
	...
	public enum TaiKhoanColumn : int
	{
		...
		/// UserUis : 
		/// </summary>
		[EnumTextValue("User Uis")]
		[ColumnEnum("UserUis", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 4000)]
		UserUis = 15
	}//End enum
