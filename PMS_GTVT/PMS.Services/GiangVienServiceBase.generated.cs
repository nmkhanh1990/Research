...
{		
	...
	public partial class GiangVienServiceBase : ServiceBase<GiangVien, GiangVienKey>
	{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public virtual  IDataReader ChuyenMon_Luu(System.String xmlData, System.String maGiangVien)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction(noTranByDefault);
				dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.GiangVienProvider.ChuyenMon_Luu(transactionManager , xmlData, maGiangVien);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public virtual  IDataReader ChuyenMon_Luu( System.String xmlData, System.String maGiangVien, int start, int pageLength)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("ChuyenMon_Luu");
			...
			try
            {
				...
				result = dataProvider.GiangVienProvider.ChuyenMon_Luu(transactionManager, start, pageLength , xmlData, maGiangVien);
		...
		/// <param name="loaiGiangVien"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public virtual  void GioDinhMucCuaGiangVien(System.String namHoc, System.String hocKy, System.String maDonVi, System.String loaiGiangVien)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				dataProvider = ConnectionScope.Current.DataProvider;
				dataProvider.GiangVienProvider.GioDinhMucCuaGiangVien(transactionManager , namHoc, hocKy, maDonVi, loaiGiangVien);
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public virtual  void GioDinhMucCuaGiangVien( System.String namHoc, System.String hocKy, System.String maDonVi, System.String loaiGiangVien, int start, int pageLength)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GioDinhMucCuaGiangVien");
			...
			try
            {
				...
				dataProvider.GiangVienProvider.GioDinhMucCuaGiangVien(transactionManager, start, pageLength , namHoc, hocKy, maDonVi, loaiGiangVien);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public virtual  IDataReader GetQuyetDinh(System.DateTime? tuNgay, System.DateTime? denNgay)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetQuyetDinh");
			#endregion Security check
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction(noTranByDefault);
				dataProvider = ConnectionScope.Current.DataProvider;
				result = dataProvider.GiangVienProvider.GetQuyetDinh(transactionManager , tuNgay, denNgay);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public virtual  IDataReader GetQuyetDinh( System.DateTime? tuNgay, System.DateTime? denNgay, int start, int pageLength)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("GetQuyetDinh");
			...
			try
            {
				...
				result = dataProvider.GiangVienProvider.GetQuyetDinh(transactionManager, start, pageLength , tuNgay, denNgay);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		public virtual  void TruongKhoaXemThuLaoTrenWeb_Cdgtvt(System.String namHoc, System.String maCanBoGiangDay)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				dataProvider = ConnectionScope.Current.DataProvider;
				dataProvider.GiangVienProvider.TruongKhoaXemThuLaoTrenWeb_Cdgtvt(transactionManager , namHoc, maCanBoGiangDay);
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public virtual  void TruongKhoaXemThuLaoTrenWeb_Cdgtvt( System.String namHoc, System.String maCanBoGiangDay, int start, int pageLength)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("TruongKhoaXemThuLaoTrenWeb_Cdgtvt");
			...
			try
            {
				...
				dataProvider.GiangVienProvider.TruongKhoaXemThuLaoTrenWeb_Cdgtvt(transactionManager, start, pageLength , namHoc, maCanBoGiangDay);
		...
		/// <param name="maCanBoGiangDay"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public virtual  void XemThuLaoTrenWeb_Cdgtvt(System.String namHoc, System.String maCanBoGiangDay)
		{
			#region Security check
			// throws security exception if not authorized
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				dataProvider = ConnectionScope.Current.DataProvider;
				dataProvider.GiangVienProvider.XemThuLaoTrenWeb_Cdgtvt(transactionManager , namHoc, maCanBoGiangDay);
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public virtual  void XemThuLaoTrenWeb_Cdgtvt( System.String namHoc, System.String maCanBoGiangDay, int start, int pageLength)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("XemThuLaoTrenWeb_Cdgtvt");
			...
			try
            {
				...
				dataProvider.GiangVienProvider.XemThuLaoTrenWeb_Cdgtvt(transactionManager, start, pageLength , namHoc, maCanBoGiangDay);
		...
		/// <param name="xmlData"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public virtual  void LuuQuyetDinh(System.String xmlData)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("LuuQuyetDinh");
			#endregion Security check
			...
			try
            {
				...
				transactionManager = ConnectionScope.ValidateOrCreateTransaction();
				dataProvider = ConnectionScope.Current.DataProvider;
				dataProvider.GiangVienProvider.LuuQuyetDinh(transactionManager , xmlData);
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public virtual  void LuuQuyetDinh( System.String xmlData, int start, int pageLength)
		{
			#region Security check
			// throws security exception if not authorized
			SecurityContext.IsAuthorized("LuuQuyetDinh");
			...
			try
            {
				...
				dataProvider.GiangVienProvider.LuuQuyetDinh(transactionManager, start, pageLength , xmlData);
