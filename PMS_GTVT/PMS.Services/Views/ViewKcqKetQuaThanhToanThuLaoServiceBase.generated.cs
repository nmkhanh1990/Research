...
{		
	...
	public partial class ViewKcqKetQuaThanhToanThuLaoServiceBase : ServiceViewBase<ViewKcqKetQuaThanhToanThuLao>
	{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		public virtual void GetByMaGiangVienNamHocHocKyReader(System.String namHoc, System.String hocKy, System.String listMaGiangVien)
		{
			 GetByMaGiangVienNamHocHocKyReader( namHoc, hocKy, listMaGiangVien, 0, defaultMaxRecords );
		}
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public virtual void GetByMaGiangVienNamHocHocKyReader(System.String namHoc, System.String hocKy, System.String listMaGiangVien, int start, int pageLength)
		{
			// throws security exception if not authorized
			...
			try
            {
				...
				//Call Custom Procedure from Repository
				dataProvider.ViewKcqKetQuaThanhToanThuLaoProvider.GetByMaGiangVienNamHocHocKyReader(transactionManager, start, pageLength , namHoc, hocKy, listMaGiangVien);
