...
{
    partial class frmKhoiLuongDoAnTotNghiepChiTiet
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmKhoiLuongDoAnTotNghiepChiTiet));
			this.layoutControl1 = new DevExpress.XtraLayout.LayoutControl();
			this.gridControlKhoiLuongDoAnTotNghiepChiTiet = new DevExpress.XtraGrid.GridControl();
			this.bindingSourceKhoiLuong = new System.Windows.Forms.BindingSource();
			this.gridViewKhoiLuongDoAnTotNghiepChiTiet = new DevExpress.XtraGrid.Views.Grid.GridView();
			...
			this.btnTinh = new DevExpress.XtraBars.BarButtonItem();
			...
			this.bindingSourceGiangVien = new System.Windows.Forms.BindingSource();
			...
			((System.ComponentModel.ISupportInitialize)(this.gridControlKhoiLuongDoAnTotNghiepChiTiet)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.bindingSourceKhoiLuong)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.gridViewKhoiLuongDoAnTotNghiepChiTiet)).BeginInit();
			...
			// layoutControl1
			// 
			this.layoutControl1.Controls.Add(this.gridControlKhoiLuongDoAnTotNghiepChiTiet);
			...
			this.layoutControl1.Size = new System.Drawing.Size(596, 354);
			this.layoutControl1.TabIndex = 0;
			this.layoutControl1.Text = "layoutControl1";
			// 
			// gridControlKhoiLuongDoAnTotNghiepChiTiet
			// 
			this.gridControlKhoiLuongDoAnTotNghiepChiTiet.DataSource = this.bindingSourceKhoiLuong;
			this.gridControlKhoiLuongDoAnTotNghiepChiTiet.Location = new System.Drawing.Point(12, 36);
			this.gridControlKhoiLuongDoAnTotNghiepChiTiet.MainView = this.gridViewKhoiLuongDoAnTotNghiepChiTiet;
			this.gridControlKhoiLuongDoAnTotNghiepChiTiet.MenuManager = this.barManager1;
			this.gridControlKhoiLuongDoAnTotNghiepChiTiet.Name = "gridControlKhoiLuongDoAnTotNghiepChiTiet";
			this.gridControlKhoiLuongDoAnTotNghiepChiTiet.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] {
            this.repositoryItemGridLookUpEditGiangVien});
			this.gridControlKhoiLuongDoAnTotNghiepChiTiet.Size = new System.Drawing.Size(572, 306);
			this.gridControlKhoiLuongDoAnTotNghiepChiTiet.TabIndex = 7;
			this.gridControlKhoiLuongDoAnTotNghiepChiTiet.ViewCollection.AddRange(new DevExpress.XtraGrid.Views.Base.BaseView[] {
            this.gridViewKhoiLuongDoAnTotNghiepChiTiet});
			// 
			// gridViewKhoiLuongDoAnTotNghiepChiTiet
			// 
			this.gridViewKhoiLuongDoAnTotNghiepChiTiet.GridControl = this.gridControlKhoiLuongDoAnTotNghiepChiTiet;
			this.gridViewKhoiLuongDoAnTotNghiepChiTiet.Name = "gridViewKhoiLuongDoAnTotNghiepChiTiet";
			// 
			// barManager1
			// 
            ...
            new DevExpress.XtraBars.LinkPersistInfo(this.btnTinh, true),
			...
			// btnTinh
			// 
			this.btnTinh.Caption = "Tính";
			this.btnTinh.Id = 1;
			this.btnTinh.ImageIndex = 6;
			this.btnTinh.Name = "btnTinh";
			this.btnTinh.PaintStyle = DevExpress.XtraBars.BarItemPaintStyle.CaptionGlyph;
			...
			this.barDockControlTop.Size = new System.Drawing.Size(596, 29);
			// 
			...
			this.barDockControlRight.Location = new System.Drawing.Point(596, 29);
			...
			this.imageCollection1.Images.SetKeyName(6, "3341-financial-money-class-icon-png-4.jpg");
			this.imageCollection1.Images.SetKeyName(7, "downloads-icon.png");
			this.imageCollection1.Images.SetKeyName(8, "excel.png");
			this.imageCollection1.Images.SetKeyName(9, "import.png");
			this.imageCollection1.Images.SetKeyName(10, "paste.png");
			this.imageCollection1.Images.SetKeyName(11, "search-footer-icon.png");
			// 
			...
			// layoutControl2
			// 
			this.layoutControl2.Location = new System.Drawing.Point(265, 12);
			this.layoutControl2.Name = "layoutControl2";
			this.layoutControl2.Root = this.Root;
			this.layoutControl2.Size = new System.Drawing.Size(319, 20);
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(319, 20);
			this.Root.TextVisible = false;
			// 
			// cboHocKy
			// 
			this.cboHocKy.Location = new System.Drawing.Point(176, 12);
			...
			this.layoutControlGroup1.Size = new System.Drawing.Size(596, 354);
			...
			// layoutControlItem4
			// 
			this.layoutControlItem4.Control = this.gridControlKhoiLuongDoAnTotNghiepChiTiet;
			this.layoutControlItem4.CustomizationFormText = "layoutControlItem4";
			this.layoutControlItem4.Location = new System.Drawing.Point(0, 24);
			this.layoutControlItem4.Name = "layoutControlItem4";
			this.layoutControlItem4.Size = new System.Drawing.Size(576, 310);
			this.layoutControlItem4.TextSize = new System.Drawing.Size(0, 0);
			this.layoutControlItem4.TextVisible = false;
			// 
			// frmKhoiLuongDoAnTotNghiepChiTiet
			// 
			...
			this.Name = "frmKhoiLuongDoAnTotNghiepChiTiet";
			this.Text = "frmKhoiLuongDoAnTotNghiepChiTiet";
			this.Load += new System.EventHandler(this.frmKhoiLuongDoAnTotNghiepChiTiet_Load);
			((System.ComponentModel.ISupportInitialize)(this.layoutControl1)).EndInit();
			this.layoutControl1.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.gridControlKhoiLuongDoAnTotNghiepChiTiet)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.bindingSourceKhoiLuong)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gridViewKhoiLuongDoAnTotNghiepChiTiet)).EndInit();
        ...
        private DevExpress.XtraGrid.GridControl gridControlKhoiLuongDoAnTotNghiepChiTiet;
        private System.Windows.Forms.BindingSource bindingSourceKhoiLuong;
        private DevExpress.XtraGrid.Views.Grid.GridView gridViewKhoiLuongDoAnTotNghiepChiTiet;
        private DevExpress.XtraBars.BarButtonItem btnLamTuoi;
        private DevExpress.XtraBars.BarButtonItem btnTinh;
