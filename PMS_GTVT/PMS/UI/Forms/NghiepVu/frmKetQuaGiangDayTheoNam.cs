    ...
    public partial class frmKetQuaGiangDayTheoNam : XtraForm
    {
        ...
        private void frmKetQuaGiangDayTheoNam_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewKetQua, new string[] { "TenDonVi", "MaQuanLy", "HoTen", "TenHocHam", "TenHocVi", "TenLoaiGiangVien"
                ...
                , "Tổng hợp định mức giảng dạy", "Tổng hợp định mức NCKH","Tổng hợp định mức "+ GetTitle("TGQL"), "GC thực hiện giảng LT-TH", "GC thực hiện giảng khác", "Tổng GC thực hiện giảng dạy"
            ...
            AppGridView.HideField(gridViewKetQua, new string[] { "DinhMucGiangDayGiam", "DinhMucNckhGiam", "DinhMucQuanLyGiam", "TietThieuGiangDay", "TietThieuNckh", "TietThieuQuanLy" });
