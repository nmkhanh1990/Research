...
namespace PMS.UI.Forms.HeThong
{
    public partial class frmTaiKhoan : XtraForm
    {
        ...
        private void frmTaiKhoan_Load(object sender, EventArgs e)
        {
            ...
            bindingSourceTaiKhoan.DataSource = DataServices.TaiKhoan.GetByMaNhomQuyen((Int32)UserInfo.GroupID); 
            bindingSourceNhomQuyen.DataSource = DataServices.NhomQuyen.GetByMaNhomQuyen((Int32)UserInfo.GroupID);
