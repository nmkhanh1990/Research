...
namespace PMS.UI.Forms.BaoCao
{
    public partial class frmBaoCao : XtraForm
    {
        ...
        public void InBaoCaoDynamid(string reportname, string fileName, DataTable dt)
        {
            ...
            XReport = report;
            OpenLayout(report);
            //report.ReloadGridView(tentruong, ngayin, nam, tb);
            printControl.PrintingSystem = report.PrintingSystem;
            report.CreateDocument();
        ...
        public void InDanhSachCanBoGiangVien(string tentruong, string namhoc, string hocky, string nguoilapbieu, DateTime ngayin, DataTable tb)
        {
            ...
            XReport = report;
            OpenLayout(report);
            //report.ReloadGridView(tentruong, namhoc, hocky, nguoilapbieu, ngayin, tb);
            printControl.PrintingSystem = report.PrintingSystem;
            report.CreateDocument();
        }
        #endregion
        ...
        //    XReport = report;
        //    OpenLayout(report);
        //    report.ReloadGridView(truong, phongDT, namHoc, hocKy, vList);
        //    printControl.PrintingSystem = report.PrintingSystem;
        //    report.CreateDocument();
        //}
        #endregion
        ...
        //    XReport = report;
        //    OpenLayout(report);
        //    report.ReloadGridView(tuade, tentruong, namhoctruoc, vlist);
        //    printControl.PrintingSystem = report.PrintingSystem;
        //    report.CreateDocument();
        //}
        #endregion
        ...
        //    XReport = report;
        //    OpenLayout(report);
        //    report.ReloadGridView(vlist, dt,tentruong,tuade,hieutruong,tpDaoTao);
        //    printControl.PrintingSystem = report.PrintingSystem;
        //    report.CreateDocument();
        //}
        #endregion
        ...
        //    XReport = report;
        //    OpenLayout(report);
        //    report.ReloadGridView(tentruong, vlist);
        //    printControl.PrintingSystem = report.PrintingSystem;
        //    report.CreateDocument();
        //}
        #endregion
        ...
        //    XReport = report;
        //    OpenLayout(report);
        //    report.ReloadGridView(tennguoilap, tentruong, tuade,daotao,hieutruong, vlist);
        //    printControl.PrintingSystem = report.PrintingSystem;
        //    report.CreateDocument();
        //}
        #endregion
        ...
        //    XReport = report;
        //    OpenLayout(report);
        //    report.ReloadGridView(tentruong,obj);
        //    printControl.PrintingSystem = report.PrintingSystem;
        //    report.CreateDocument();
        //}
        #endregion
        ...
        //    XReport = report;
        //    OpenLayout(report);
        //    report.ReloadGridView(truong, nguoiKeToan, nguoilapbang, tPDaoTao,tuade, vList);
        //    printControl.PrintingSystem = report.PrintingSystem;
        //    report.CreateDocument();
        //}
        #endregion
        ...
        //    XReport = report;
        //    OpenLayout(report);
        //    report.ReloadGridView(namHoc,  hocKy,  tenBoMon,  tenLoaiGiangVien,tenTruong, phongDaoTao, phongTCCB, nguoiKeToan, banGiamHieu, nguoiLapBieu,vList);
        //    printControl.PrintingSystem = report.PrintingSystem;
        //    report.CreateDocument();
        //}
        #endregion
        ...
        //    XReport = report;
        //    OpenLayout(report);
        //    report.ReloadGridView( namHoc,hocKy, truong, phongDaotao,vList);
        //    printControl.PrintingSystem = report.PrintingSystem;
        //    report.CreateDocument();
        //}
        #endregion
        ...
        //    XReport = report;
        //    OpenLayout(report);
        //    report.ReloadGridView( truong,  nguoiLapBieu,namHoc, hocKy, donVi, tenGiangVien, hocVi,soTienNghiaVu,soTienGiangDay,soTienDAMH,soTienThucLanh,soTienBangChu, vList);
        //    printControl.PrintingSystem = report.PrintingSystem;
        //    report.CreateDocument();
        //}
        #endregion
