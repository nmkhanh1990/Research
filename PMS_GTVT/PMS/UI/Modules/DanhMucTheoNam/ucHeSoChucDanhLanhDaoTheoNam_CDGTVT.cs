...
namespace PMS.UI.Modules.DanhMucTheoNam
{
    public partial class ucHeSoChucDanhLanhDaoTheoNam_CDGTVT : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucHeSoChucDanhLanhDaoTheoNam_CDGTVT_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewHeSoChucDanhLanhDao, new string[] { "MaChucVu", "PhanTramGiamTru", "NhomGiangVien", "SoTietNghiaVu", "SoTietNghiaVuNckh", "SoTietNghiaVuKhac", "NgayCapNhat", "NguoiCapNhat" },
                        new string[] { "Chức vụ", "Định mức tối thiểu (%)", "Nhóm giảng viên", "Giờ chuẩn giảng dạy / năm", "Giờ chuẩn NCKH / năm", "Giờ chuẩn khác / năm", "NgayCapNhat", "NguoiCapNhat" },
                        new int[] { 150, 120, 150, 120, 120, 120, 99, 99 });
        ...
        void InitPhanLoai()
        {
            ...
            AppRepositoryItemGridLookUpEdit.InitPopupFormSize(repositoryItemGridLookUpEditPhanLoai, 310, 200);
            AppRepositoryItemGridLookUpEdit.ShowField(repositoryItemGridLookUpEditPhanLoai, new string[] { "TenNhomGiangVien" }, new string[] { "Tên nhóm" }, new int[] { 300 });
            repositoryItemGridLookUpEditPhanLoai.DisplayMember = "TenNhomGiangVien";
            repositoryItemGridLookUpEditPhanLoai.ValueMember = "MaNhomGiangVien";
            repositoryItemGridLookUpEditPhanLoai.NullText = "(Chọn một)";

            bindingSourcePhanLoai.DataSource = DataServices.NhomGiangVienTinhDinhMuc.GetAll();
        }
