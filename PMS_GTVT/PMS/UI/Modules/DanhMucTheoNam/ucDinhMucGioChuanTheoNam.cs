...
namespace PMS.UI.Modules.DanhMucTheoNam
{
    public partial class ucDinhMucGioChuanTheoNam : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void InitGridCDGTVT()
        {
            ...
            AppGridView.ShowField(gridViewDinhMucGioGiang, new string[] { "MaBacDaoTao", "MaNhomGiangVien", "DinhMucMonHoc", "DinhMucNckh", "DinhMucHoatDongChuyenMonKhac", "TongDinhMuc", "NgayCapNhat", "NguoiCapNhat" },
                                                           new string[] { "Bậc đào tạo", "Nhóm giảng viên", "Định mức giảng dạy", "Định mức NCKH", "Định mức các HĐ khác", "Tổng định mức", "NgayCapNhat", "NguoiCapNhat" },
                                                           new int[] { 100, 250, 100, 100, 100, 100, 99, 99 });
            AppGridView.AlignHeader(gridViewDinhMucGioGiang, new string[] { "MaBacDaoTao", "MaNhomGiangVien", "DinhMucMonHoc", "DinhMucNckh", "DinhMucHoatDongChuyenMonKhac", "NgayCapNhat", "NguoiCapNhat" }, DevExpress.Utils.HorzAlignment.Center);

            AppGridView.RegisterControlField(gridViewDinhMucGioGiang, "MaBacDaoTao", repositoryItemGridLookUpEditBacDaoTao);
            AppGridView.RegisterControlField(gridViewDinhMucGioGiang, "MaNhomGiangVien", repositoryItemGridLookUpEditNhomGiangVien);
        ...
        {
            #region BacDaoTao
            AppRepositoryItemGridLookUpEdit.InitRepositoryItemGridLookUp(repositoryItemGridLookUpEditBacDaoTao
                , new string[] { "TenBacDaoTao" }, new string[] { "Bậc đào tạo" }
                , new int[] { 100 }, "MaBacDaoTao", "TenBacDaoTao", 150, 300);
            bindingSourceBacDaoTao.DataSource = DataServices.ViewBacDaoTao.GetAll();
            #endregion
            #region NhomGiangVien
            AppRepositoryItemGridLookUpEdit.InitRepositoryItemGridLookUp(repositoryItemGridLookUpEditNhomGiangVien
                , new string[] { "TenNhomGiangVien" }, new string[] { "Nhóm giảng viên" }
                , new int[] { 120 }, "MaNhomGiangVien", "TenNhomGiangVien", 200, 300);
