...
namespace PMS.UI.Modules.Reports
{
    public partial class ucThongKeGioCoiThiChamBaiRaDe : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucThongKeGioCoiThiChamBaiRaDe_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewThongKe, new string[] { "Stt", "MaQuanLy", "Ho", "Ten", "HoTen", "TenLoaiGiangVien", "MaDonVi", "TenDonVi", "MaKhoaToChuc"
                , "TenKhoaToChuc", "LanThi", "GioCoiThi", "GioChamBai", "GioRaDe", "GioToChucThi", "GioNhapDiem", "GioDoDiem", "TongCong", "GhiChu" }
                    , new string[] { "STT", "Mã CB", "Họ", "Tên", "Họ tên", "Loại giảng viên", "Mã đơn vị", "Tên đơn vị", "Mã khoa tổ chức thi"
                , "Khoa tổ chức thi", "Lần thi", "Coi thi", "Chấm thi", "Ra đề", "Tổ chức thi", "Nhập điểm", "Dò điểm", "Tổng cộng", "Ghi chú" }
                    , new int[] { 45, 90, 125, 65, 170, 100, 90, 170, 50, 170, 50, 70, 70, 70, 70, 70, 70, 70, 100 });
            ...
            AppGridView.BackColorFieldAppearance(gridViewThongKe, new string[] { "MaDonVi", "TenDonVi", "MaKhoaToChuc", "TenKhoaToChuc", "LanThi" }, Color.Snow);
            AppGridView.BackColorFieldAppearance(gridViewThongKe, "GioCoiThi", Color.FromArgb(0xD8, 0xB2, 0xE6));
            AppGridView.BackColorFieldAppearance(gridViewThongKe, "GioChamBai", Color.FromArgb(0xA9, 0xB9, 0xF5));
            AppGridView.BackColorFieldAppearance(gridViewThongKe, "GioRaDe", Color.FromArgb(0xAB, 0xCA, 0xB2));
            AppGridView.BackColorFieldAppearance(gridViewThongKe, "GioToChucThi", Color.FromArgb(0xF9, 0xC2, 0xC8));
            AppGridView.BackColorFieldAppearance(gridViewThongKe, "GioNhapDiem", Color.FromArgb(0xCB, 0xCB, 0xC9));
            AppGridView.BackColorFieldAppearance(gridViewThongKe, "GioDoDiem", Color.FromArgb(0xF4, 0xF6, 0xD1));
