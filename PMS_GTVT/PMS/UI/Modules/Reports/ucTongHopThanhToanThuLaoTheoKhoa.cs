    ...
    public partial class ucTongHopThanhToanThuLaoTheoKhoa : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void initGridView()
        {
            switch (_maTruong)
            {
                ...
                case "VHU":
                    AppGridView.InitGridView(gridViewThongKe, true, true, DevExpress.XtraGrid.Views.Grid.GridMultiSelectMode.RowSelect, false, true);
                    AppGridView.ShowField(gridViewThongKe, new string[] { "MaQuanLy", "HoTen","TenQuocTich", "TenDonVi", "TenHocHam", "TenHocVi", "TenLoaiGiangVien", "MaMonHoc", "TenMonHoc", "Loai", "Nhom", "MaLop", "SiSo", "SoTiet", "HeSoLopDong", "HeSoNgoaiGio", "TietQuyDoi", "HeSoChucDanhChuyenMon", "DonGia", "ThanhTien" }
                            , new string[] { "Mã giảng viên", "Họ và tên","Quốc tịch", "Bộ môn", "Học hàm", "Học vị", "Loại giảng viên", "Mã môn học", "Tên môn học", "Loại", "Nhóm", "Mã lớp", "Sĩ số", "Số tiết", "Hệ số lớp đông", "Hệ số ngoài giờ", "Tiết quy đổi", "Hệ số chức danh", "Đơn giá", "Thành tiền" }
                            , new int[] { 90, 140,100, 120, 80, 80, 80, 80, 150, 60, 70, 80, 70, 70, 90, 90, 90, 90, 90, 90 });
                    AppGridView.AlignHeader(gridViewThongKe, new string[] { "MaQuanLy", "HoTen","TenQuocTich", "TenDonVi", "TenHocHam", "TenHocVi", "TenLoaiGiangVien", "MaMonHoc", "TenMonHoc", "Loai", "Nhom", "MaLop", "SiSo", "SoTiet", "HeSoLopDong", "HeSoNgoaiGio", "DonGia", "ThanhTien", "TietQuyDoi", "HeSoChucDanhChuyenMon" }, DevExpress.Utils.HorzAlignment.Center);
                    AppGridView.SummaryField(gridViewThongKe, "MaQuanLy", "{0}", DevExpress.Data.SummaryItemType.Count);
                    AppGridView.ReadOnlyColumn(gridViewThongKe);
                    AppGridView.FormatDataField(gridViewThongKe, "SiSo", DevExpress.Utils.FormatType.Custom, "n0");
                    AppGridView.FormatDataField(gridViewThongKe, "SoTiet", DevExpress.Utils.FormatType.Custom, "n2");
