...
{
    public partial class ucThanhToanGiangDayMonGDTCGiangVienThinhGiang : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        ...
        public ucThanhToanGiangDayMonGDTCGiangVienThinhGiang()
        {
            InitializeComponent();
        ...
        private void ucThanhToanGiangDayMonGDTCGiangVienThinhGiang_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewThongKe, new string[] { "Chon", "XacNhanChiTra", "MaQuanLy", "HoTen", "ChucDanh", "MaMonHoc", "TenMonHoc", "MaLopHocPhan", "MaLop", "SiSo", "TietThucDay", "HeSoLopDong", "HeSoThinhGiangMonChuyenNganh", "HeSoChucDanhChuyenMon", "TietQuyDoi", "HeSoQuyDoiThucHanhSangLyThuyet", "DonGia", "TongTien", "Thue", "ThucLanh", "NgayCapNhat", "NguoiCapNhat" }
                    , new string[] { "Chọn", "Khoá thanh toán", "Mã giảng viên", "Họ tên", "Chức danh", "Mã môn học", "Tên môn học", "Mã lớp học phần", "Mã lớp", "Sĩ số", "Số tiết", "Hệ số nhóm", "Hệ số thỉnh giảng", "Hệ số chức danh", "Số tiết thanh toán", "Hệ số quy đổi", "Đơn giá", "Số tiền thanh toán", "Thuế TNCN", "Thực lãnh", "Ngày cập nhật", "Người cập nhật" }
                    , new int[] { 60, 60, 90, 140, 140, 90, 150, 110, 100, 60, 60, 110, 110, 110, 110, 110, 100, 120, 100, 120, 90, 90 });
            AppGridView.AlignHeader(gridViewThongKe, new string[] { "MaQuanLy", "HoTen", "ChucDanh", "MaMonHoc", "TenMonHoc", "MaLopHocPhan", "MaLop", "SiSo", "TietThucDay", "HeSoLopDong", "HeSoThinhGiangMonChuyenNganh", "HeSoQuyDoiThucHanhSangLyThuyet", "HeSoChucDanhChuyenMon", "TietQuyDoi", "DonGia", "TongTien", "Thue", "ThucLanh", "NgayCapNhat", "NguoiCapNhat" }, DevExpress.Utils.HorzAlignment.Center);
            AppGridView.ReadOnlyColumn(gridViewThongKe, new string[] { "MaQuanLy", "HoTen", "ChucDanh", "MaMonHoc", "TenMonHoc", "MaLopHocPhan", "MaLop", "SiSo", "TietThucDay", "HeSoLopDong", "HeSoThinhGiangMonChuyenNganh", "HeSoChucDanhChuyenMon", "TietQuyDoi", "HeSoQuyDoiThucHanhSangLyThuyet", "DonGia", "TongTien", "Thue", "ThucLanh", "NgayCapNhat", "NguoiCapNhat" });
        ...
        void InitData()
        {
            ...
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null && cboLanChot.EditValue != null && cboBacDaoTao.EditValue != null && cboKhoaHoc.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.KetQuaThanhToanThuLao.ThongKeTienGiangGDTCGiangVienThinhGiangCtim(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), cboKhoaDonVi.EditValue.ToString(), cboBacDaoTao.EditValue.ToString(), cboKhoaHoc.EditValue.ToString(), int.Parse(cboLanChot.EditValue.ToString()));
                dt.Load(reader);
...
//            int dem = vListBaoCao.Rows.Count;
            ...
            if (vListBaoCao != null && vListBaoCao.Rows.Count > 0)
            {
                ...
                {
                    frm.InThongKeThanhToanTienGiangThucHanhGDTCGiangVienThinhGiang(PMS.Common.Globals._cauhinh.TenTruong, cboNamHoc.EditValue.ToString(), cboHocKy.Text, cboKhoaDonVi.Text
