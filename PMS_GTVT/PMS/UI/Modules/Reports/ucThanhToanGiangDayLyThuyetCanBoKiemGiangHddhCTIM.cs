...
{
    public partial class ucThanhToanGiangDayLyThuyetCanBoKiemGiangHddhCTIM : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        ...
        public ucThanhToanGiangDayLyThuyetCanBoKiemGiangHddhCTIM()
        {
            InitializeComponent();
        ...
        private void ucThanhToanGiangDayLyThuyetCanBoKiemGiangHddhCTIM_Load(object sender, EventArgs e)
        {
        ...
        void InitData()
        {
            ...
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null && cboLanChot.EditValue != null && cboBacDaoTao.EditValue != null && cboKhoaHoc.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.KetQuaThanhToanThuLao.ThongKeTienGiangLyThuyetCBKGHDDHCtim(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), cboKhoaDonVi.EditValue.ToString(), cboBacDaoTao.EditValue.ToString(), cboKhoaHoc.EditValue.ToString(), int.Parse(cboLanChot.EditValue.ToString()));
                dt.Load(reader);
