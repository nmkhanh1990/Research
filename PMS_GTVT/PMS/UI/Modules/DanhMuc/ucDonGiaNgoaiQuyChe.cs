...
{
    public partial class ucDonGiaNgoaiQuyChe : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void InitGridVHU()
        {
            ...
            AppGridView.ShowField(gridViewDonGiaNgoaiQuyChe, new string[] { "MaGiangVien", "HoTen", "DonGiaDaiTra", "DonGiaClc", "GhiChu", "NgayCapNhat" }
                    , new string[] { "Mã giảng viên", "Họ và tên", "Đơn giá", "Đơn giá CLC", "Ghi chú", "NgayCapNhat"}
                    , new int[] { 90, 150, 90, 90, 150, 100});
            AppGridView.ShowEditor(gridViewDonGiaNgoaiQuyChe, DevExpress.XtraGrid.Views.Grid.NewItemRowPosition.Top);
            AppGridView.AlignHeader(gridViewDonGiaNgoaiQuyChe, new string[] { "MaGiangVien", "HoTen", "DonGiaDaiTra", "DonGiaClc", "GhiChu"}, DevExpress.Utils.HorzAlignment.Center);
        ...
        void InitData()
        {
            ...
            if (_maTruong == "TCB")
            {
                bindingSourceDonGiaNgoaiQuyChe.DataSource = DataServices.ViewDonGiaNgoaiQuyChe.GetAll();
            }
            else
            {
                ...
                if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null)
                    bindingSourceDonGiaNgoaiQuyChe.DataSource = DataServices.ViewDonGiaNgoaiQuyChe.GetByNamHocHocKy(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString());
            }
        }
        #endregion
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                VList<ViewDonGiaNgoaiQuyChe> list = bindingSourceDonGiaNgoaiQuyChe.DataSource as VList<ViewDonGiaNgoaiQuyChe>;
                if (list != null)
                {
                    try
                    {
                        string xmlData = "";
                        foreach (ViewDonGiaNgoaiQuyChe kl in list)
                        {
                        ...
                        int kq = 0;
                        DataServices.DonGiaNgoaiQuyChe.Luu(xmlData, cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), ref kq);
                        if (kq == 0)
        ...
        private void gridViewDonGiaNgoaiQuyChe_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            {
                ViewDonGiaNgoaiQuyChe v = (ViewDonGiaNgoaiQuyChe)gridViewDonGiaNgoaiQuyChe.GetRow(pos);
