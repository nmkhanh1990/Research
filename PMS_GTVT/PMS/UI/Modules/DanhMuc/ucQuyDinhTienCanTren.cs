...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucQuyDinhTienCanTren : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucQuyDinhTienCanTrenTheoNam_Load(object sender, EventArgs e)
        {
            ...
            #region LoaiNhanVien
            AppRepositoryItemCheckedComboBoxEdit.Init(repositoryItemCheckedComboBoxEditLoaiNhanVien, CheckState.Unchecked, LoaiDuLieu.LoaiNhanVien);
            #endregion
            ...
            #region ChucVu
            AppRepositoryItemCheckedComboBoxEdit.Init(repositoryItemCheckedComboBoxEditChucVu, CheckState.Unchecked, LoaiDuLieu.ChucVu);
            #endregion

            #region TruongHopKhac
            //AppRepositoryItemCheckedComboBoxEdit.Init(repositoryItemCheckedComboBoxEditLoaiGiangVien, CheckState.Unchecked, LoaiDuLieu.LoaiGiangVien);
            #endregion
        ...
        void InitRemaining()
        {
            ...
            AppGridView.ShowField(gridViewQuyDinhTienCanTren, new string[] { "Id", "Stt", "LoaiGiangVien", "LoaiNhanVien", "ChucVu", "CongVoiGioChuan", "TietTran" },
                        new string[] { "ID", "STT", "Loại giảng viên", "Loại nhân viên", "Chức vụ", "Cộng với giờ chuẩn", "Tiết trần" },
                        new int[] { 50, 40, 120, 120, 150, 120, 100 });
            AppGridView.ShowEditor(gridViewQuyDinhTienCanTren, DevExpress.XtraGrid.Views.Grid.NewItemRowPosition.Top);
            AppGridView.AlignHeader(gridViewQuyDinhTienCanTren, new string[] { "Id", "Stt", "LoaiGiangVien", "LoaiNhanVien", "ChucVu", "CongVoiGioChuan", "TietTran" }, DevExpress.Utils.HorzAlignment.Center);
            AppGridView.RegisterControlField(gridViewQuyDinhTienCanTren, "LoaiGiangVien", repositoryItemCheckedComboBoxEditLoaiGiangVien);
            AppGridView.RegisterControlField(gridViewQuyDinhTienCanTren, "LoaiNhanVien", repositoryItemCheckedComboBoxEditLoaiNhanVien);
            AppGridView.RegisterControlField(gridViewQuyDinhTienCanTren, "ChucVu", repositoryItemCheckedComboBoxEditChucVu);
            AppGridView.FormatDataField(gridViewQuyDinhTienCanTren, "CongVoiGioChuan", DevExpress.Utils.FormatType.Custom, "n2");
            AppGridView.FormatDataField(gridViewQuyDinhTienCanTren, "TietTran", DevExpress.Utils.FormatType.Custom, "n2");
        ...
        private bool RuleCheckDuplicate(object target, PMS.Entities.Validation.ValidationRuleArgs e)
        {
            ...
            if (obj != null)
            {
                if (((TList<QuyDinhTienCanTren>)bindingSourceQuyDinhTienCanTren.DataSource).FindAll(p => p.HocHam == obj.HocHam && p.HocVi == obj.HocVi && p.LoaiNhanVien == obj.LoaiNhanVien && p.LoaiGiangVien == obj.LoaiGiangVien && p.ChucVu == obj.ChucVu).Count > 1)
                {
                ...
                else if (obj.TietTran != null && obj.TietTran > 0 && obj.CongVoiGioChuan != null && obj.CongVoiGioChuan > 0)
                {
                    e.Description = string.Format("Nếu đã có tiết trần thì không có số tiết cộng thêm và ngược lại!");
                    return false;
                }
            }
            return true;
