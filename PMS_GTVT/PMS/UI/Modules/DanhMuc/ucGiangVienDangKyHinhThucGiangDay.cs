...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucGiangVienDangKyHinhThucGiangDay : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucGiangVienDangKyHinhThucGiangDay_Load(object sender, EventArgs e)
        {
            ...
            #region GiangVien
            AppRepositoryItemGridLookUpEdit.InitRepositoryItemGridLookUp(repositoryItemGridLookUpEditGiangVien, new string[] { "MaQuanLy", "HoTen" },
                new string[] { "Mã giảng viên", "Họ tên" }, new int[] { 80, 150 }, "MaGiangVien", "HoTen", 300, 500);
            #endregion

            #region Hinh thuc dang ky giang day
            AppRepositoryItemGridLookUpEdit.InitRepositoryItemGridLookUp(repositoryItemGridLookUpEditHinhThuc, new string[] { "TenHinhThucDaoTao" },
                new string[] { "Tên hình thức" }, new int[] { 250 }, "MaHinhThucDaoTao", "TenHinhThucDaoTao", 300, 200);
            #endregion
