...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucNhomMonHoc : UserControl
    {
        ...
        private void ucNhomMonHoc_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewNhomMonHoc, new string[] { "MaQuanLy", "TenNhomMon", "HeSoQuyDoiThSangLt", "TinhTrang" },
                        new string[] { "Mã nhóm môn", "Tên nhóm môn", "Hệ số LT/TH", "Không dùng" },
                        new int[] { 100, 500, 100, 70 });
            AppGridView.ShowEditor(gridViewNhomMonHoc, DevExpress.XtraGrid.Views.Grid.NewItemRowPosition.Top);
            AppGridView.AlignHeader(gridViewNhomMonHoc, new string[] { "MaQuanLy", "TenNhomMon", "HeSoQuyDoiThSangLt", "TinhTrang" }, DevExpress.Utils.HorzAlignment.Center);
            #endregion
