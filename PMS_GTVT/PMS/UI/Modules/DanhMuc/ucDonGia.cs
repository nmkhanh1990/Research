    ...
    public partial class ucDonGia : DevExpress.XtraEditors.XtraUserControl
    {
            ...
            try
            {
                switch (_maTruong)
                {
                    ...
                    default:
                        ...
                        AppGridView.ShowField(gridViewDonGia, new string[] { "MaQuanLy", "MaLoaiGiangVien", "MaHocHam", "MaHocVi", "DonGia", "DonGiaClc", "DonGiaDoAnClc", "DonGiaNgoaiNgu", "DonGiaGdtc", "DonGiaTrongChuan", "DonGiaNgoaiChuan", "HeSoQuyDoiChatLuong", "NgayCapNhat", "NguoiCapNhat" }
                                    , new string[] { "Mã quản lý", "Loại giảng viên", "Học hàm", "Học vị", "Đơn giá", "Đơn giá CLC", "Đơn giá đồ án CLC", "Đơn giá ngoại ngữ", "Đơn giá môn GDTC", "Đơn giá trong chuẩn", "Đơn giá ngoài chuẩn", "Hệ số quy đổi chất lượng", "NgayCapNhat", "NguoiCapNhat" }
                                    , new int[] { 100, 150, 150, 150, 100, 100, 100, 100, 100, 100, 100, 160, 99, 99 });
                        AppGridView.AlignHeader(gridViewDonGia, new string[] { "MaQuanLy", "MaLoaiGiangVien", "MaHocHam", "MaHocVi", "DonGia", "DonGiaClc", "DonGiaDoAnClc", "DonGiaNgoaiNgu", "DonGiaGdtc", "DonGiaTrongChuan", "DonGiaNgoaiChuan", "HeSoQuyDoiChatLuong", "NgayCapNhat", "NguoiCapNhat" }, DevExpress.Utils.HorzAlignment.Center);
                        ...
                        AppGridView.FormatDataField(gridViewDonGia, new string[] { "DonGia", "DonGiaClc", "DonGiaDoAnClc", "DonGiaNgoaiNgu", "DonGiaGdtc", "DonGiaTrongChuan", "DonGiaNgoaiChuan" }, DevExpress.Utils.FormatType.Custom, "n0");

                        AppGridView.HideField(gridViewDonGia, new string[] { "NgayCapNhat", "NguoiCapNhat" });
                        if (_maTruong == "USSH")
                            AppGridView.HideField(gridViewDonGia, new string[] { "MaLoaiGiangVien", "DonGia", "DonGiaClc", "DonGiaDoAnClc", "DonGiaNgoaiNgu", "DonGiaGdtc" });
                        else if (_maTruong == "UTE")
                            AppGridView.HideField(gridViewDonGia, new string[] { "HeSoQuyDoiChatLuong", "DonGiaTrongChuan", "DonGiaNgoaiChuan" });
                        else
                            AppGridView.HideField(gridViewDonGia, new string[] { "HeSoQuyDoiChatLuong", "DonGiaTrongChuan", "DonGiaNgoaiChuan", "DonGiaNgoaiNgu", "DonGiaGdtc" });
                        break;
                }
            }
            catch (Exception ex)
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (list != null)
            {
                ...
                {
                    if (cboHinhThucDaoTao.EditValue == null) break;
