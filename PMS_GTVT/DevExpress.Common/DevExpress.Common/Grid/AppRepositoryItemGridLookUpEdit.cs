...
namespace DevExpress.Common.Grid
{
    public static class AppRepositoryItemGridLookUpEdit
    {
        ...
        /// <param name="autoPopup"></param>
        /// <param name="textEditStyle"></param>
        public static void InitRepositoryItemGridLookUp(RepositoryItemGridLookUpEdit grid, string[] showFields, string[] showFieldNames, int[] columnWidths, string valueMember, string displayMember, int width, int height)
        {
            //Show filter
            grid.View.OptionsView.ShowAutoFilterRow = true;
            ...
            ShowField(grid, showFields, showFieldNames, columnWidths);
