...
namespace DevExpress.Common.Grid
{
    public static class AppGridView
    {
        ...
        /// <summary>
        /// Thiết lập giao diện một dòng trong gridview
        /// </summary>
        /// <param name="grid">gridview muốn thiết lập</param>
        /// <param name="coLumn_name">tên cột muốn thiết lập</param>
        /// <param name="condition">điểu kiện xét trên mỗi ô của cột</param> 
        /// <param name="value">giá trị xét cho điều kiện</param>
        /// <param name="font">phông chữ</param>
        /// <param name="fore_color">màu chữ</param>
        /// <param name="back_color">màu nền</param>
        public static void GridRowAppearance(GridView grid, string coLumn_name, FormatConditionEnum condition, object value, Font font, Color fore_color, Color back_color)
        {
            ...
            styleFormatCondition1.Appearance.ForeColor = fore_color;
            styleFormatCondition1.Appearance.BackColor = back_color;
            styleFormatCondition1.Appearance.Font = font;
            styleFormatCondition1.Column = grid.Columns[coLumn_name];
            styleFormatCondition1.Condition = condition; //FormatConditionEnum.Equal;
            styleFormatCondition1.Value1 = value;
            grid.FormatConditions.AddRange(new StyleFormatCondition[] {
            styleFormatCondition1});
        }

        /// <summary>
        /// Thiết lập màu nền cho 1 dòng trong gridview
        /// </summary>
        /// <param name="grid">gridview muốn thiết lập</param>
        /// <param name="coLumn_name">tên cột muốn thiết lập</param>
        /// <param name="condition">điểu kiện xét trên mỗi ô của cột</param> 
        /// <param name="value">giá trị xét cho điều kiện</param>
        /// <param name="back_color">màu nền</param>
        public static void GridRowAppearance(GridView grid, string coLumn_name, FormatConditionEnum condition, string value, Color back_color)
        {
            StyleFormatCondition styleFormatCondition1 = new StyleFormatCondition();
            styleFormatCondition1.Appearance.Options.UseBackColor = true;
            styleFormatCondition1.ApplyToRow = true;
