...
namespace PMS.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader ChuyenMon_Luu(TransactionManager transactionManager, int start, int pageLength , System.String xmlData, System.String maGiangVien)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void GioDinhMucCuaGiangVien(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maDonVi, System.String loaiGiangVien)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_GetQuyetDinh' stored procedure. 
		/// </summary>	
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader GetQuyetDinh(TransactionManager transactionManager, int start, int pageLength , System.DateTime? tuNgay, System.DateTime? denNgay)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_GetQuyetDinh", true);
			
			database.AddInParameter(commandWrapper, "@TuNgay", DbType.Date,  tuNgay );
			database.AddInParameter(commandWrapper, "@DenNgay", DbType.Date,  denNgay );
	
			
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetQuyetDinh", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetQuyetDinh", (IEntity)null));
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void TruongKhoaXemThuLaoTrenWeb_Cdgtvt(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String maCanBoGiangDay)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void XemThuLaoTrenWeb_Cdgtvt(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String maCanBoGiangDay)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_LuuQuyetDinh' stored procedure. 
		/// </summary>	
		/// <param name="xmlData"> A <c>System.String</c> instance.</param>
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void LuuQuyetDinh(TransactionManager transactionManager, int start, int pageLength , System.String xmlData)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_LuuQuyetDinh", true);
			
			database.AddInParameter(commandWrapper, "@XmlData", DbType.String,  xmlData );
	
			
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "LuuQuyetDinh", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "LuuQuyetDinh", (IEntity)null));
