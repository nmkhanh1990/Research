...
namespace PMS.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.KhoiLuongGiangDayChiTiet> entities)
		{
			...
			DataColumn col54 = dataTable.Columns.Add("HeSoNhieuLopHocPhan", typeof(System.Decimal));
			col54.AllowDBNull = true;		
			DataColumn col55 = dataTable.Columns.Add("SoTietDayNhieuLopHocPhan", typeof(System.Decimal));
		...
		/// <summary>
		///	This method wraps the 'cust_KhoiLuongGiangDayChiTiet_KiemTraDongBo_TheoGiangVienLopHocPhan' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void KiemTraDongBo_TheoGiangVienLopHocPhan(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maQuanLyGiangVien, System.String maLopHocPhan, ref System.Int32 reVal)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KhoiLuongGiangDayChiTiet_KiemTraDongBo_TheoGiangVienLopHocPhan", true);
			...
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "KiemTraDongBo_TheoGiangVienLopHocPhan", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "KiemTraDongBo_TheoGiangVienLopHocPhan", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_KhoiLuongGiangDayChiTiet_GetByMaGiangVienLopHocPhan' stored procedure. 
		/// </summary>	
		/// <param name="maQuanLyGiangVien"> A <c>System.String</c> instance.</param>
		/// <param name="maLopHocPhan"> A <c>System.String</c> instance.</param>
		/// <param name="start">Row number at which to start reading.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;KhoiLuongGiangDayChiTiet&gt;"/> instance.</returns>
		public override TList<KhoiLuongGiangDayChiTiet> GetByMaGiangVienLopHocPhan(TransactionManager transactionManager, int start, int pageLength , System.String maQuanLyGiangVien, System.String maLopHocPhan)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KhoiLuongGiangDayChiTiet_GetByMaGiangVienLopHocPhan", true);
			...
			//Create Collection
				TList<KhoiLuongGiangDayChiTiet> rows = new TList<KhoiLuongGiangDayChiTiet>();
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByMaGiangVienLopHocPhan", rows));
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByMaGiangVienLopHocPhan", rows));
