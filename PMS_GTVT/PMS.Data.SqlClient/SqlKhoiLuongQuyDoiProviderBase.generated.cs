...
namespace PMS.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@SoTietDayNhieuLopHocPhan", DbType.Decimal, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("sotietdaynhieulophocphan ") || clause.Trim().StartsWith("sotietdaynhieulophocphan="))
				{
					database.SetParameterValue(commandWrapper, "@SoTietDayNhieuLopHocPhan", 
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.KhoiLuongQuyDoi> entities)
		{
			...
			DataColumn col45 = dataTable.Columns.Add("MaKhoaCuaMonHoc", typeof(System.String));
			col45.AllowDBNull = true;		
			DataColumn col46 = dataTable.Columns.Add("HeSoThamNien", typeof(System.Decimal));
			col46.AllowDBNull = true;		
			DataColumn col47 = dataTable.Columns.Add("HeSoNhieuLopHocPhan", typeof(System.Decimal));
			col47.AllowDBNull = true;		
			DataColumn col48 = dataTable.Columns.Add("SoTietDayNhieuLopHocPhan", typeof(System.Decimal));
			...
			bulkCopy.ColumnMappings.Add("SoTietDayNhieuLopHocPhan", "SoTietDayNhieuLopHocPhan");
			...
			foreach(PMS.Entities.KhoiLuongQuyDoi entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["SoTietDayNhieuLopHocPhan"] = entity.SoTietDayNhieuLopHocPhan.HasValue ? (object) entity.SoTietDayNhieuLopHocPhan  : System.DBNull.Value;
		...
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.KhoiLuongQuyDoi entity)
		{
			...
			database.AddInParameter(commandWrapper, "@SoTietDayNhieuLopHocPhan", DbType.Decimal, (entity.SoTietDayNhieuLopHocPhan.HasValue ? (object) entity.SoTietDayNhieuLopHocPhan  : System.DBNull.Value));
		...
		/// <summary>
		///	This method wraps the 'cust_KhoiLuongQuyDoi_DeleteByNamHocHocKyGiangVienLopHocPhan' stored procedure. 
		/// </summary>	
		...
		public override void DeleteByNamHocHocKyGiangVienLopHocPhan(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maQuanLyGiangVien, System.String maLopHocPhan)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KhoiLuongQuyDoi_DeleteByNamHocHocKyGiangVienLopHocPhan", true);
			...
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "DeleteByNamHocHocKyGiangVienLopHocPhan", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "DeleteByNamHocHocKyGiangVienLopHocPhan", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_KhoiLuongQuyDoi_DeleteKhoiLuongBoSungByNamHocHocKyGiangVienLopHocPhan' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="maQuanLyGiangVien"> A <c>System.String</c> instance.</param>
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void DeleteKhoiLuongBoSungByNamHocHocKyGiangVienLopHocPhan(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maQuanLyGiangVien, System.String maLopHocPhan)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KhoiLuongQuyDoi_DeleteKhoiLuongBoSungByNamHocHocKyGiangVienLopHocPhan", true);
			...
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "DeleteKhoiLuongBoSungByNamHocHocKyGiangVienLopHocPhan", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "DeleteKhoiLuongBoSungByNamHocHocKyGiangVienLopHocPhan", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_KhoiLuongQuyDoi_ThongKeTongHop_Act' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KhoiLuongQuyDoi_ThongKeTongHop_Act", true);
		...
		/// <summary>
		///	This method wraps the 'cust_KhoiLuongQuyDoi_GetByBacLoaiHinhNamHocHocKyDot' stored procedure. 
		/// </summary>	
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader GetByBacLoaiHinhNamHocHocKyDot(TransactionManager transactionManager, int start, int pageLength , System.String bacDaoTao, System.String loaiHinhDaoTao, System.String namHoc, System.String hocKy, System.Int32 maCauHinhChotGio)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KhoiLuongQuyDoi_GetByBacLoaiHinhNamHocHocKyDot", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByBacLoaiHinhNamHocHocKyDot", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetByBacLoaiHinhNamHocHocKyDot", (IEntity)null));
