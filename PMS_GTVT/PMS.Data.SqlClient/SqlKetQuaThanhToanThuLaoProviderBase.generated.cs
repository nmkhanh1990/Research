...
namespace PMS.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@HeSoNhieuLopHocPhan", DbType.Decimal, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("hesonhieulophocphan ") || clause.Trim().StartsWith("hesonhieulophocphan="))
				{
					database.SetParameterValue(commandWrapper, "@HeSoNhieuLopHocPhan", 
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.KetQuaThanhToanThuLao> entities)
		{
			...
			DataColumn col63 = dataTable.Columns.Add("HeSoNhieuLopHocPhan", typeof(System.Decimal));
			...
			bulkCopy.ColumnMappings.Add("HeSoNhieuLopHocPhan", "HeSoNhieuLopHocPhan");
			...
			foreach(PMS.Entities.KetQuaThanhToanThuLao entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["HeSoNhieuLopHocPhan"] = entity.HeSoNhieuLopHocPhan.HasValue ? (object) entity.HeSoNhieuLopHocPhan  : System.DBNull.Value;
		...
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.KetQuaThanhToanThuLao entity)
		{
			...
			database.AddInParameter(commandWrapper, "@HeSoNhieuLopHocPhan", DbType.Decimal, (entity.HeSoNhieuLopHocPhan.HasValue ? (object) entity.HeSoNhieuLopHocPhan  : System.DBNull.Value));
		...
		/// <summary>
		///	This method wraps the 'cust_KetQuaThanhToanThuLao_BangTongHopGioGiangCacKhoa_Vien_HBU' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader BangTongHopGioGiangCacKhoa_Vien_HBU(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maDonVi, System.Int32 lanChot)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KetQuaThanhToanThuLao_BangTongHopGioGiangCacKhoa_Vien_HBU", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "BangTongHopGioGiangCacKhoa_Vien_HBU", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "BangTongHopGioGiangCacKhoa_Vien_HBU", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_KetQuaThanhToanThuLao_GetThuLaoThinhGiangNamHocHocKyDonViBacDaoTao_Yersin' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader GetThuLaoThinhGiangNamHocHocKyDonViBacDaoTao_Yersin(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String bacDaoTao, System.String donVi)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KetQuaThanhToanThuLao_GetThuLaoThinhGiangNamHocHocKyDonViBacDaoTao_Yersin", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetThuLaoThinhGiangNamHocHocKyDonViBacDaoTao_Yersin", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetThuLaoThinhGiangNamHocHocKyDonViBacDaoTao_Yersin", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_KetQuaThanhToanThuLao_BangKeThuTeGioGiangKLK_VHU' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader BangKeThuTeGioGiangKLK_VHU(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maKhoa, System.String lanChot, System.String listGiangVien)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KetQuaThanhToanThuLao_BangKeThuTeGioGiangKLK_VHU", true);
			
			database.AddInParameter(commandWrapper, "@NamHoc", DbType.String,  namHoc );
			database.AddInParameter(commandWrapper, "@HocKy", DbType.String,  hocKy );
			database.AddInParameter(commandWrapper, "@MaKhoa", DbType.String,  maKhoa );
			database.AddInParameter(commandWrapper, "@LanChot", DbType.String,  lanChot );
			database.AddInParameter(commandWrapper, "@ListGiangVien", DbType.String,  listGiangVien );
	
			
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "BangKeThuTeGioGiangKLK_VHU", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "BangKeThuTeGioGiangKLK_VHU", (IEntity)null));
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void GetDataVuotGioBoSung(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.Int32 lanChotHk01, System.Int32 lanChotHk02, System.String khoaDonVi)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void GetThongTinGiangVienTheoNamHocHocKy(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.Int32 maGiangVien)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void GetNoiDungGiamTruGioChuan(TransactionManager transactionManager, int start, int pageLength , System.String xmlData, System.String namHoc, System.String hocKy, System.Int32 lanChot)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void TongHopKetQuaThanhToanTapSu(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String donVi, System.String loaiGiangVien, System.Int32 lanChot)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void GetSoTietChuyeNoTon(TransactionManager transactionManager, int start, int pageLength , System.String namHoc)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <summary>
		///	This method wraps the 'cust_KetQuaThanhToanThuLao_BangChiTraThuLaoGiangDayKLK_VHU' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="maKhoa"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader BangChiTraThuLaoGiangDayKLK_VHU(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maKhoa, System.String lanChot, System.String listGiangVien)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KetQuaThanhToanThuLao_BangChiTraThuLaoGiangDayKLK_VHU", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "BangChiTraThuLaoGiangDayKLK_VHU", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "BangChiTraThuLaoGiangDayKLK_VHU", (IEntity)null));
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void ThuLaoTrenWebIuh(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String professorId)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <summary>
		///	This method wraps the 'cust_KetQuaThanhToanThuLao_GetThongTinGiangVien' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="maKhoa"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader GetThongTinGiangVien(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maKhoa, System.String where)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KetQuaThanhToanThuLao_GetThongTinGiangVien", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetThongTinGiangVien", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetThongTinGiangVien", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_KetQuaThanhToanThuLao_rptBangTongHopVuotGioGiangVienCoHuu_HBU' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="maKhoa"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader rptBangTongHopVuotGioGiangVienCoHuu_HBU(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maKhoa, System.String xml)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KetQuaThanhToanThuLao_rptBangTongHopVuotGioGiangVienCoHuu_HBU", true);
			
			database.AddInParameter(commandWrapper, "@NamHoc", DbType.String,  namHoc );
			database.AddInParameter(commandWrapper, "@HocKy", DbType.String,  hocKy );
			database.AddInParameter(commandWrapper, "@MaKhoa", DbType.String,  maKhoa );
			database.AddInParameter(commandWrapper, "@XML", DbType.String,  xml );
	
			
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "rptBangTongHopVuotGioGiangVienCoHuu_HBU", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "rptBangTongHopVuotGioGiangVienCoHuu_HBU", (IEntity)null));
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void ThongKeThanhToanTienGiang(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String donVi, System.String loaiGiangVien, System.Int32 lanChot, System.String dotChiTra)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void ThongKeThanhToanTienGiang_Bk(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String donVi, System.String loaiGiangVien, System.Int32 lanChot)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void ThanhToanTamUngDot1(TransactionManager transactionManager, int start, int pageLength , System.String namHoc)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void ThanhToanThuLaoDot2(TransactionManager transactionManager, int start, int pageLength , System.String namHoc)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <summary>
		///	This method wraps the 'cust_KetQuaThanhToanThuLao_rptTongHopGioChuanCuaKhoa_HBU' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="maKhoa"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader rptTongHopGioChuanCuaKhoa_HBU(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maKhoa, System.String xml)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KetQuaThanhToanThuLao_rptTongHopGioChuanCuaKhoa_HBU", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "rptTongHopGioChuanCuaKhoa_HBU", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "rptTongHopGioChuanCuaKhoa_HBU", (IEntity)null));
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void ThanhToanGioVuotDinhMucVhu(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.Int32 lanChotHk01, System.Int32 lanChotHk02)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void GetKhoiLuongChiTietHbu(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String listMaGiangVien)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <summary>
		///	This method wraps the 'cust_KetQuaThanhToanThuLao_BangKeKhaiGioGiangCuaGiangVien_HBU' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="maKhoa"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader BangKeKhaiGioGiangCuaGiangVien_HBU(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maKhoa, System.String xml)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KetQuaThanhToanThuLao_BangKeKhaiGioGiangCuaGiangVien_HBU", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "BangKeKhaiGioGiangCuaGiangVien_HBU", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "BangKeKhaiGioGiangCuaGiangVien_HBU", (IEntity)null));
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void ThongKeKhoiLuongGiangDayTheoBoMon(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String boMon, System.Int32 lanChot)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void BangKeThanhToanTheoNamLaw(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String lanChotHk01, System.String lanChotHk02, System.String bacDaoTao, System.String loaiHinhDaoTao, System.String khoaDonVi, System.String loaiGiangVien)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void DanhSachChiTienCanBoCoHuuVuotGio(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String donVi, System.String loaiGiangVien, System.Int32 lanChot)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void TongHopGioGiangIuh(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String donVi, System.String loaiGiangVien)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <summary>
		///	This method wraps the 'cust_KetQuaThanhToanThuLao_GetThanhToanHopDong_BHU' stored procedure. 
		/// </summary>	
		/// <param name="xmlData"> A <c>System.String</c> instance.</param>
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader GetThanhToanHopDong_BHU(TransactionManager transactionManager, int start, int pageLength , System.String xmlData, System.String namHoc, System.String hocKy)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KetQuaThanhToanThuLao_GetThanhToanHopDong_BHU", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetThanhToanHopDong_BHU", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetThanhToanHopDong_BHU", (IEntity)null));
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void BangKeVuotGioGiangBuh(TransactionManager transactionManager, int start, int pageLength , System.String xmlData, System.String namHoc, System.String hocKy, System.Int32 lanChot)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader ThongKeChung_DLU(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String donVi, System.String dotThanhToan, System.String loaiGiangVien, System.String loaiHinhDaoTao, System.Int32 loaiThongKe)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void GetGiangVienTamUng(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String maDonVi)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
