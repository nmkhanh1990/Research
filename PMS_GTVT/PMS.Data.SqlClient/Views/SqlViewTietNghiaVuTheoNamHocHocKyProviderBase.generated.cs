...
public abstract partial class SqlViewTietNghiaVuTheoNamHocHocKyProviderBase : ViewTietNghiaVuTheoNamHocHocKyProviderBase
{
	...
	/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
	/// <remark>This method is generated from a stored procedure.</remark>
	public override void GetByNamHocGroupId(TransactionManager transactionManager, int start, int pageLength, System.String namHoc, System.String groupId)
	{
		SqlDatabase database = new SqlDatabase(this._connectionString);
	...
	/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
	/// <remark>This method is generated from a stored procedure.</remark>
	public override void GetByNamHocCdgtvt(TransactionManager transactionManager, int start, int pageLength, System.String namHoc)
	{
		SqlDatabase database = new SqlDatabase(this._connectionString);
