/*
	...
	Important: Do not modify this file. Edit the file SqlKcqKetQuaThanhToanThuLaoProvider.cs instead.
*/
...
{
	///<summary>
	/// This class is the SqlClient Data Access Logic Component implementation for the <see cref="KcqKetQuaThanhToanThuLao"/> entity.
	///</summary>
	public abstract partial class SqlKcqKetQuaThanhToanThuLaoProviderBase : KcqKetQuaThanhToanThuLaoProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlKcqKetQuaThanhToanThuLaoProviderBase"/> instance.
		/// </summary>
		public SqlKcqKetQuaThanhToanThuLaoProviderBase()
		{
		}
	...
	public SqlKcqKetQuaThanhToanThuLaoProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKetQuaThanhToanThuLao_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(KcqKetQuaThanhToanThuLao)
					,_id);
		...
		/// <returns>Returns a typed collection of PMS.Entities.KcqKetQuaThanhToanThuLao objects.</returns>
		public override TList<KcqKetQuaThanhToanThuLao> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<KcqKetQuaThanhToanThuLao>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKetQuaThanhToanThuLao_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@SoTinChi", DbType.Int32, DBNull.Value);
			...
			//Create Collection
			TList<KcqKetQuaThanhToanThuLao> rows = new TList<KcqKetQuaThanhToanThuLao>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PMS.Entities.KcqKetQuaThanhToanThuLao objects.</returns>
		public override TList<KcqKetQuaThanhToanThuLao> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKetQuaThanhToanThuLao_Find_Dynamic", typeof(KcqKetQuaThanhToanThuLaoColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<KcqKetQuaThanhToanThuLao> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKetQuaThanhToanThuLao_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PMS.Entities.KcqKetQuaThanhToanThuLao objects.</returns>
		public override TList<KcqKetQuaThanhToanThuLao> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKetQuaThanhToanThuLao_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.KcqKetQuaThanhToanThuLao GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKetQuaThanhToanThuLao_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int32, _id);
			
			IDataReader reader = null;
			TList<KcqKetQuaThanhToanThuLao> tmp = new TList<KcqKetQuaThanhToanThuLao>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.KcqKetQuaThanhToanThuLao object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.KcqKetQuaThanhToanThuLao> entities)
		{
			...
			bulkCopy.DestinationTableName = "KcqKetQuaThanhToanThuLao";
			...
			foreach(PMS.Entities.KcqKetQuaThanhToanThuLao entity in entities)
			{
		...
		/// <summary>
		/// 	Inserts a PMS.Entities.KcqKetQuaThanhToanThuLao object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.KcqKetQuaThanhToanThuLao object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.KcqKetQuaThanhToanThuLao object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.KcqKetQuaThanhToanThuLao entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKetQuaThanhToanThuLao_Insert", _useStoredProcedure);
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.KcqKetQuaThanhToanThuLao object to update.</param>
		/// <remarks>
		///		After updating the datasource, the PMS.Entities.KcqKetQuaThanhToanThuLao object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, PMS.Entities.KcqKetQuaThanhToanThuLao entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_KcqKetQuaThanhToanThuLao_Update", _useStoredProcedure);
		...
		/// <summary>
		///	This method wraps the 'cust_KcqKetQuaThanhToanThuLao_TongHopKetQuaThanhToanTapSu' stored procedure. 
		/// </summary>	
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KcqKetQuaThanhToanThuLao_TongHopKetQuaThanhToanTapSu", true);
		...
		/// <summary>
		///	This method wraps the 'cust_KcqKetQuaThanhToanThuLao_GetSoLanChot' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KcqKetQuaThanhToanThuLao_GetSoLanChot", true);
		...
		/// <summary>
		///	This method wraps the 'cust_KcqKetQuaThanhToanThuLao_TongHopKetQuaThanhToan' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="donVi"> A <c>System.String</c> instance.</param>
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void TongHopKetQuaThanhToan(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String donVi, System.String loaiGiangVien, System.Int32 lanChot)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KcqKetQuaThanhToanThuLao_TongHopKetQuaThanhToan", true);
		...
		/// <summary>
		///	This method wraps the 'cust_KcqKetQuaThanhToanThuLao_HuyChotThuLao' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="lanChot"> A <c>System.Int32</c> instance.</param>
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KcqKetQuaThanhToanThuLao_HuyChotThuLao", true);
		...
		/// <summary>
		///	This method wraps the 'cust_KcqKetQuaThanhToanThuLao_SoSanhHaiLanChot' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KcqKetQuaThanhToanThuLao_SoSanhHaiLanChot", true);
		...
		/// <summary>
		///	This method wraps the 'cust_KcqKetQuaThanhToanThuLao_ChotThanhToan2' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="lanChot"> A <c>System.Int32</c> instance.</param>
		...
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_KcqKetQuaThanhToanThuLao_ChotThanhToan2", true);
