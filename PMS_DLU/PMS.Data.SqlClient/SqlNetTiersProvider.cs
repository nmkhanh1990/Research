...
namespace PMS.Data.SqlClient
{
	...
	public sealed class SqlNetTiersProvider : PMS.Data.Bases.NetTiersProvider
	{
		...
		#region "HeSoGiangDayNhieuLopCungHocPhanProvider"
			
		private SqlHeSoGiangDayNhieuLopCungHocPhanProvider innerSqlHeSoGiangDayNhieuLopCungHocPhanProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="HeSoGiangDayNhieuLopCungHocPhan"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override HeSoGiangDayNhieuLopCungHocPhanProviderBase HeSoGiangDayNhieuLopCungHocPhanProvider
		{
			get
			{
				if (innerSqlHeSoGiangDayNhieuLopCungHocPhanProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlHeSoGiangDayNhieuLopCungHocPhanProvider == null)
						{
							this.innerSqlHeSoGiangDayNhieuLopCungHocPhanProvider = new SqlHeSoGiangDayNhieuLopCungHocPhanProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlHeSoGiangDayNhieuLopCungHocPhanProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlHeSoGiangDayNhieuLopCungHocPhanProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlHeSoGiangDayNhieuLopCungHocPhanProvider SqlHeSoGiangDayNhieuLopCungHocPhanProvider
		{
			get {return HeSoGiangDayNhieuLopCungHocPhanProvider as SqlHeSoGiangDayNhieuLopCungHocPhanProvider;}
		}
		...
		#region "ViewNganHangProvider"
		
		private SqlViewNganHangProvider innerSqlViewNganHangProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="ViewNganHang"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override ViewNganHangProviderBase ViewNganHangProvider
		{
			get
			{
				if (innerSqlViewNganHangProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlViewNganHangProvider == null)
						{
							this.innerSqlViewNganHangProvider = new SqlViewNganHangProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlViewNganHangProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <see cref="SqlViewNganHangProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlViewNganHangProvider SqlViewNganHangProvider
		{
			get {return ViewNganHangProvider as SqlViewNganHangProvider;}
		}
