...
namespace PMS.Services
{
	...
	{		
        ...
        #region HeSoGiangDayNhieuLopCungHocPhanService
        private static HeSoGiangDayNhieuLopCungHocPhanService _HeSoGiangDayNhieuLopCungHocPhanService;
        /// <summary>
		/// Initializes a new instance of the HeSoGiangDayNhieuLopCungHocPhanService class.
		/// </summary>
        public static HeSoGiangDayNhieuLopCungHocPhanService HeSoGiangDayNhieuLopCungHocPhan
        {
            get
            {
                if(_HeSoGiangDayNhieuLopCungHocPhanService == null)
                    _HeSoGiangDayNhieuLopCungHocPhanService = new HeSoGiangDayNhieuLopCungHocPhanService();
                return _HeSoGiangDayNhieuLopCungHocPhanService;
            }
        }
        #endregion        
        ...
        #region ViewNganHangService
        private static ViewNganHangService _ViewNganHangService;
        /// <summary>
		/// Initializes a new instance of the ViewNganHangService class.
		/// </summary>
        public static ViewNganHangService ViewNganHang
        {
            get
            {
                if(_ViewNganHangService == null)
                    _ViewNganHangService = new ViewNganHangService();
                return _ViewNganHangService;
            }
        }
        #endregion        
