...
{
    public partial class ucMonTinhTheoQuyCheMoi_Kcq : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        #endregion
        public ucMonTinhTheoQuyCheMoi_Kcq()
        {
            InitializeComponent();
        }
        ...
        void InitData()
        {
            ...
            if (cboNamHoc != null && cboHocKy.EditValue != null)
            {
                ...
                bindingSourceMonHocQuyCheMoi.DataSource = DataServices.ViewKcqMonTinhTheoQuyCheMoi.GetByNamHocHocKy(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString()); 
            }
        }
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            VList<ViewKcqMonTinhTheoQuyCheMoi> list = bindingSourceMonHocQuyCheMoi.DataSource as VList<ViewKcqMonTinhTheoQuyCheMoi>;
            if (list != null)
            {
                string xmlData = "";
                foreach (ViewKcqMonTinhTheoQuyCheMoi d in list)
                {
                    if (d.Chon == true)
                    {
                ...
                if (XtraMessageBox.Show("Bạn có muốn lưu các thay đổi không?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        DataServices.KcqMonTinhTheoQuyCheMoi.Luu(xmlData, cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), ref kq);
                        if (kq == 0)
        ...
        private void gridViewMonHoc_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            {
                ViewKcqMonTinhTheoQuyCheMoi v = gridViewMonHoc.GetRow(e.RowHandle) as ViewKcqMonTinhTheoQuyCheMoi;
                DataRow dr = null;
                try
                {
        ...
        {
            using (frmSaoChepNamHocHocKy_Kcq frm = new frmSaoChepNamHocHocKy_Kcq(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), "SaoChepMonTinhTheoQuyCheMoi"))
            {
                frm.ShowDialog();
            }
        }
