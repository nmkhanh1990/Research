...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucBangCauHinhChung : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        {
            InitializeComponent();
            _maTruong =PMS.Common.Globals.GetMaTruong(listCauHinhChung,"Mã trường");
            ...
            { 
                ...
                case "BUH":
                    ...
                    layoutControlItem51.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
                    layoutControlItem53.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
                    layoutControllhsphucap.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always;
                break;
                case "ACT":
                    layoutControlItem2.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
                    layoutControlItem8.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
        ...
        private void LoadCauHinh()
        {
            ...
            try
            {
                ...
                if (_maTruong == "BUH")
                {
                    cauHinh = listCauHinhChung.Find(p => p.TenCauHinh == "Hệ số phụ cấp clc");
                    if (cauHinh != null)
                        textEdithsphucap.EditValue = float.Parse(cauHinh.GiaTri);
                }
        ...
        private void SetNamHoc()
        {
            ...
            cboNamHocHienTai.DataBindings.Add("EditValue", bindingSourceNamHocHienTai, "NamHoc", true, DataSourceUpdateMode.Never);
        }
        ...
        private void SetHocKy(string namHoc)
        {
            ...
            cboHocKyHienTai.DataBindings.Add("EditValue", bindingSourceHocKyHienTai, "MaHocKy", true, DataSourceUpdateMode.Never);
        }
        #endregion
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                if (_maTruong == "BUH")
                {
                    objCauHinh = listCauHinhChung.Find(p => p.TenCauHinh == "Hệ số phụ cấp clc");
                    if (objCauHinh != null)
                    {
                        if (objCauHinh.GiaTri != textEdithsphucap.EditValue.ToString())
                        {
                            objCauHinh.NgayCapNhat = DateTime.Parse(DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"));
                            objCauHinh.GiaTri = textEdithsphucap.EditValue.ToString();
                        }
                    }
                }
            }
