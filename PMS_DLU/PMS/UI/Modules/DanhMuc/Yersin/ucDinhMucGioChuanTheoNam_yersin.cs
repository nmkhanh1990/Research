...
{
    public partial class ucDinhMucGioChuanTheoNam_yersin : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        #endregion
        public ucDinhMucGioChuanTheoNam_yersin()
        {
            InitializeComponent();
        ...
        private void ucDinhMucGioChuanTheoNam_Load(object sender, EventArgs e)
        {
            ...
            #region HocHam
            #region BacLuong
            repositoryItemCheckedComboBoxEdit_PhanLoaiGiangVien.SelectAllItemCaption = "Tất cả";
            repositoryItemCheckedComboBoxEdit_PhanLoaiGiangVien.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.Standard;
            repositoryItemCheckedComboBoxEdit_PhanLoaiGiangVien.Items.Clear();
            TList<HocHam> listHocHam = DataServices.HocHam.GetAll();
            List<CheckedListBoxItem> listHH = new List<CheckedListBoxItem>();
            foreach (HocHam bl in listHocHam)
                listHH.Add(new CheckedListBoxItem(bl.MaHocHam, bl.TenHocHam, CheckState.Unchecked, true));
            repositoryItemCheckedComboBoxEdit_PhanLoaiGiangVien.Items.AddRange(listHH.ToArray());
            repositoryItemCheckedComboBoxEdit_PhanLoaiGiangVien.SeparatorChar = ';';
        ...
        void InitGridVHU()
        {
            ...
            AppGridView.ShowField(gridViewDinhMucGioGiang, new string[] {  "PhanLoaiGiangVien", "MaBacLuong", "DinhMucMonHoc", "DinhMucNckh", "DinhMucHoatDongChuyenMonKhac", "TongDinhMuc", "NgayCapNhat", "NguoiCapNhat" },
                                                           new string[] { "Học hàm", "Bậc lương", "Định mức giảng dạy", "Định mức NCKH", "Định mức các khác", "Tổng định mức", "Ngày cập nhật", "Người cập nhật" },
                                                           new int[] {  120, 80, 120, 120, 150, 150, 99, 99 });
            AppGridView.AlignHeader(gridViewDinhMucGioGiang, new string[] { "PhanLoaiGiangVien", "MaBacLuong", "DinhMucMonHoc", "DinhMucNckh", "DinhMucHoatDongChuyenMonKhac", "TongDinhMuc", "NgayCapNhat", "NguoiCapNhat" }, DevExpress.Utils.HorzAlignment.Center);

            AppGridView.RegisterControlField(gridViewDinhMucGioGiang, "PhanLoaiGiangVien",repositoryItemCheckedComboBoxEdit_PhanLoaiGiangVien);            
            ...
            AppGridView.BackColorFieldAppearance(gridViewDinhMucGioGiang, new string[] { "DinhMucMonHoc" }, Color.FromArgb(235, 220, 255));
            AppGridView.BackColorFieldAppearance(gridViewDinhMucGioGiang, new string[] { "DinhMucNckh" }, Color.FromArgb(230, 255, 245));
            AppGridView.BackColorFieldAppearance(gridViewDinhMucGioGiang, new string[] { "DinhMucHoatDongChuyenMonKhac" }, Color.FromArgb(255, 250, 240));
            AppGridView.HideField(gridViewDinhMucGioGiang, new string[] { "NgayCapNhat", "NguoiCapNhat", "MaBacLuong" });
