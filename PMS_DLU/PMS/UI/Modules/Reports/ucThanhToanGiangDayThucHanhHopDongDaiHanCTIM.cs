...
{
    public partial class ucThanhToanGiangDayThucHanhHopDongDaiHanCTIM : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        ...
        public ucThanhToanGiangDayThucHanhHopDongDaiHanCTIM()
        {
            InitializeComponent();
        ...
        private void ucThanhToanGiangDayThucHanhHopDongDaiHanCTIM_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewThongKe, new string[] { "Chon", "XacNhanChiTra", "MaQuanLy", "HoTen", "ChucDanh", "MaMonHoc", "TenMonHoc", "MaLopHocPhan", "MaLop", "SiSo", "TietThucDay", "HeSoLopDong", "HeSoChucDanhChuyenMon", "HeSoQuyDoiThucHanhSangLyThuyet", "TietQuyDoi", "DonGia", "TongTien", "Thue", "ThucLinh", "NgayCapNhat", "NguoiCapNhat" }
                    , new string[] { "Chọn in", "Khoá thanh toán", "Mã giảng viên", "Họ tên", "Chức danh", "Mã môn học", "Tên môn học", "Mã lớp học phần", "Mã lớp", "Sĩ số", "Số tiết", "Hệ số lớp đông", "Hệ số chức danh", "Hệ số quy đổi", "Số tiết thanh toán", "Đơn giá", "Số tiền thanh toán", "Thuế TNCN", "Số tiền thực nhận", "ngày cập nhật", "Người cập nhật" }
            ...
            AppGridView.ReadOnlyColumn(gridViewThongKe, new string[] { "MaQuanLy", "HoTen", "ChucDanh", "MaMonHoc", "TenMonHoc", "MaLopHocPhan", "MaLop", "SiSo", "TietThucDay", "HeSoLopDong", "HeSoChucDanhChuyenMon", "HeSoQuyDoiThucHanhSangLyThuyet", "TietQuyDoi", "DonGia", "TongTien", "Thue", "ThucLinh", "NgayCapNhat", "NguoiCapNhat" });
        ...
        void InitData()
        {
            ...
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null && cboLanChot.EditValue != null && cboBacDaoTao.EditValue != null && cboKhoaHoc.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.KetQuaThanhToanThuLao.ThongKeTienGiangThucHanhHopDongDaiHanCtim(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), cboKhoaDonVi.EditValue.ToString(), cboBacDaoTao.EditValue.ToString(), cboKhoaHoc.EditValue.ToString(), int.Parse(cboLanChot.EditValue.ToString()));
                dt.Load(reader);
        ...
        private void btnIn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (vListBaoCao != null && vListBaoCao.Rows.Count > 0)
            {
                ...
                {
                    frm.InThongKeThanhToanTienGiangThucHanhHDDH(PMS.Common.Globals._cauhinh.TenTruong, cboNamHoc.EditValue.ToString(), cboHocKy.Text, cboKhoaDonVi.Text
