...
{
    public partial class ucThanhToanThuLaoKhoiLuongKhac_Kcq : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        TList<CauHinhChung> _cauHinhChung = DataServices.CauHinhChung.GetAll();
        #endregion
        #region Event Form
        public ucThanhToanThuLaoKhoiLuongKhac_Kcq()
        {
            InitializeComponent();
        }
        ...
        void InitData()
        {
            ...
            cboDonVi.DataBindings.Add("EditValue", bindingSourceDonVi, "MaKhoa", true, DataSourceUpdateMode.Never);
            ...
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null && cboDonVi.EditValue != null && cboLoaiGiangVien.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.KcqUteKhoiLuongKhac.GetByNamHocHocKyDonViLoaiGiangVien(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), cboDonVi.EditValue.ToString(), (int)cboLoaiGiangVien.EditValue);
                tb.Load(reader);
        ...
        private void btnIn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (vListBaoCao != null)
            {
                ...
                {
                    frm.InThanhToanThuLaoKhoiLuongKhac_Kcq(PMS.Common.Globals._cauhinh.TenTruong, cboDonVi.Text, cboLoaiGiangVien.Text, cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), PMS.Common.Globals._cauhinh.NguoiLapbieu, data);
                    frm.ShowDialog();
                }
            }
            Cursor.Current = Cursors.Default;
