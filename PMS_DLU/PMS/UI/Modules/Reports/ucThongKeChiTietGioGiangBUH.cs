    ...
    public partial class ucThongKeChiTietGioGiangBUH : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucThongKeChiTietGioGiangBUH_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                gridViewThongKe.Columns["NgayChonThanhToan"].Visible = false;
            }
        }
        #endregion
        ...
        {
            //if(gridViewThongKe.FocusedColumn.FieldName== "DaChiTra")
            //{
            //    int _kiemTra = -1;
            //    DataRowView r = gridViewThongKe.GetRow(gridViewThongKe.FocusedRowHandle) as DataRowView;
            //    DataServices.KetQuaThanhToanThuLao.KiemTraTinhTrangKeToanChiTra(int.Parse(r["Id"].ToString()), ref _kiemTra);
            //    if(_kiemTra != 0)
            //    {
            //        e.Valid = false;
            //        e.ErrorText = "Không thể thay đổi dòng dữ liệu kế toán đã thanh toán.";
            //    }
            //}
        }
