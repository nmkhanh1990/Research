...
{
    public partial class ucThanhToanThuLaoChamBai : DevExpress.XtraEditors.XtraUserControl
    {
        TList<CauHinhChung> _cauHinhChung = DataServices.CauHinhChung.GetAll();
        DateTime _ngayIn;
        string _maTruong;
        public ucThanhToanThuLaoChamBai()
        {
            InitializeComponent();
            _maTruong = _cauHinhChung.Find(p => p.TenCauHinh == "Mã trường").GiaTri;
        }

        private void ucThanhToanThuLaoChamBai_Load(object sender, EventArgs e)
        {
        ...
        void InitData()
        {
            try
            {
                ...
                if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null)
                {
                    ...
                    bindingSourceDotThanhToan.DataSource = DataServices.ThuLaoChamBai.GetDotThanhToanByNamHocHocKy(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString());
                    cboDotThanhToan.DataBindings.Add("EditValue", bindingSourceDotThanhToan, "MaDot", true, DataSourceUpdateMode.Never);
                }
...
//                    cboDotThanhToan.DataBindings.Clear();
//                    DataTable tb = new DataTable();
//                    IDataReader reader = DataServices.ThuLaoChamBai.GetDotThanhToanByNamHocHocKy(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString());
//                    tb.Load(reader);
