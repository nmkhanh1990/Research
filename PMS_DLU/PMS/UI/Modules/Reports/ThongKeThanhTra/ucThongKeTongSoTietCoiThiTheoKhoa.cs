...
{
    public partial class ucThongKeTongSoTietCoiThiTheoKhoa : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucThongKeTongSoTietCoiThiTheoKhoa()
        {
            InitializeComponent();
        ...
        private void ucThongKeTongSoTietCoiThiTheoKhoa_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewThongKe, new string[] { "Stt", "MaCanBoCoiThi", "HoTen", "SoTiet", "GhiChu", "TenDonVi" }
                    , new string[] { "STT", "Mã giảng viên", "Họ tên", "Số tiết coi thi", "Ghi chú", "Khoa - Đơn vị" }
                    , new int[] { 45, 100, 200, 120, 300, 99 });
            AppGridView.AlignHeader(gridViewThongKe, new string[] { "Stt", "MaCanBoCoiThi", "HoTen", "SoTiet", "GhiChu", "TenDonVi" }, DevExpress.Utils.HorzAlignment.Center);
            AppGridView.AlignField(gridViewThongKe, new string[] { "Stt", "MaCanBoCoiThi", "SoTiet", "TenDonVi" }, DevExpress.Utils.HorzAlignment.Center);
        ...
        private void btnLocDuLieu_Click(object sender, EventArgs e)
        {
            if (cboKhoaDonVi.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.ThanhTraCoiThi.ThongKeTongTietTheoKhoa(cboKhoaDonVi.EditValue.ToString(), dateEditTuNgay.DateTime, dateEditDenNgay.DateTime);
                tb.Load(reader);
...
vListBaoCao = Common.XuLyGiaoDien.LayDuLieuIn(gridViewThongKe, bindingSourceThongKe);
            ...
            if (vListBaoCao != null && vListBaoCao.Rows.Count > 0)
            {
                ...
                {
                    frm.InThongKeTongSoTietCoiThiTheoKhoa(PMS.Common.Globals._cauhinh.TenTruong, dateEditTuNgay.DateTime.ToString("dd/MM/yyyy"), dateEditDenNgay.DateTime.ToString("dd/MM/yyyy"), UserInfo.FullName, _ngayIn, vListBaoCao);
                    frm.ShowDialog();
                }
            }
            Cursor.Current = Cursors.Default;
