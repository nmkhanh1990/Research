...
{
    public partial class ucThanhToanGiangDayTTTNGiangVienHopDongDaiHanCTIM : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        ...
        public ucThanhToanGiangDayTTTNGiangVienHopDongDaiHanCTIM()
        {
            InitializeComponent();
        ...
        private void ucThanhToanGiangDayTTTNGiangVienThinhGiangCTIM_Load(object sender, EventArgs e)
        {
        ...
        void InitData()
        {
            ...
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null && cboLanChot.EditValue != null && cboBacDaoTao.EditValue != null && cboKhoaHoc.EditValue != null)
            {
                ...
                IDataReader reader = DataServices.KetQuaThanhToanThuLao.ThongKeTienGiangTttnGiangVienHopDongDaiHanCtim(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), cboKhoaDonVi.EditValue.ToString(), cboBacDaoTao.EditValue.ToString(), cboKhoaHoc.EditValue.ToString(), int.Parse(cboLanChot.EditValue.ToString()));
                dt.Load(reader);
...
//            int dem = vListBaoCao.Rows.Count;
            ...
            if (vListBaoCao != null && vListBaoCao.Rows.Count > 0)
            {
                ...
                {
                    frm.InThongKeThanhToanTienGiangTTTNGiangVienHopDongDaiHan(PMS.Common.Globals._cauhinh.TenTruong, cboNamHoc.EditValue.ToString(), cboHocKy.Text, cboKhoaDonVi.Text
            ...
            try
            {
                if (e.Column.FieldName == "Chon")
                {
                    ...
                    if (e.Value.ToString().ToLower() == "true" && v["XacNhanChiTra"].ToString().ToLower() == "true")
                    {
                        ...
                        DevExpress.XtraGrid.Views.Base.ColumnView view = (DevExpress.XtraGrid.Views.Base.ColumnView)gridControlThongKe.FocusedView;
                        if (view.IsEditing)
                            view.HideEditor();
