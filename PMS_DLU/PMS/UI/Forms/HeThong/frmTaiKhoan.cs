...
namespace PMS.UI.Forms.HeThong
{
    public partial class frmTaiKhoan : XtraForm
    {
        ...
        private void frmTaiKhoan_Load(object sender, EventArgs e)
        {
            ...
            {
                string strMaTaiKhoan = obj["MaTaiKhoan"] != null ? obj["MaTaiKhoan"].ToString() : string.Empty;
                string strTenTaiKhoan = obj["HoTen"] != null ? obj["HoTen"].ToString() : string.Empty;
                list.Add(new CheckedListBoxItem(strMaTaiKhoan, strTenTaiKhoan, CheckState.Unchecked, true));
            }
