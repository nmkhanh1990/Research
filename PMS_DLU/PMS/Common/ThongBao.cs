...
namespace PMS.Common
{
    public class ThongBao   //Tên biến thông báo nên sắp xếp theo A->Z cho dễ tìm.
    {
        ...
        public const string Str_ChiNhapSo = "Vui lòng chỉ nhập số và khác không.";
        public const string Str_SoTietGhiNhan = "Vui lòng nhập không lớn hơn số tiết thực tế.";
        public const string Str_VuiLongKhongDeTrong = "Vui lòng không được để trống.";
        #endregion
