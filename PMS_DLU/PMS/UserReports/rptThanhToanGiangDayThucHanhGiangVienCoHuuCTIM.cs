...
{
    public partial class rptThanhToanGiangDayThucHanhGiangVienCoHuuCTIM : DevExpress.XtraReports.UI.XtraReport
    {
        int _sttKhoa = 0;

        public rptThanhToanGiangDayThucHanhGiangVienCoHuuCTIM()
        {
            InitializeComponent();
        }
