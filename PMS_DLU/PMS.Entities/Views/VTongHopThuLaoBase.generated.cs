...
{
	///<summary>
	/// An object representation of the 'v_TongHop_ThuLao' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VTongHopThuLaoBase")]
	public abstract partial class VTongHopThuLaoBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VTongHopThuLaoBase"/> instance.
		///</summary>
		public VTongHopThuLaoBase()
		{
		}		
		...
		public VTongHopThuLaoBase(System.Int32? _maLoaiGiangVien, System.Int32 _maGiangVien, System.String _maQuanLy, System.String _hoTen, System.String _hoDem, System.String _ten, System.String _chucDanh, System.String _maDonVi, System.String _maNhomKhoiLuong, System.Int32? _tietNghiaVu, System.Decimal? _tietGioiHan, System.Decimal? _tietQuyDoi, System.Decimal? _tietDoAn, System.Decimal? _ngoaiGio, System.Decimal? _trongGio, System.Decimal? _donGia, System.String _hocKy, System.String _namHoc)
		{
		...
		{
			VTongHopThuLao newVTongHopThuLao = new VTongHopThuLao();
			newVTongHopThuLao.MaLoaiGiangVien = _maLoaiGiangVien;
			newVTongHopThuLao.MaGiangVien = _maGiangVien;
			newVTongHopThuLao.MaQuanLy = _maQuanLy;
			newVTongHopThuLao.HoTen = _hoTen;
			newVTongHopThuLao.HoDem = _hoDem;
			newVTongHopThuLao.Ten = _ten;
			newVTongHopThuLao.ChucDanh = _chucDanh;
			newVTongHopThuLao.MaDonVi = _maDonVi;
			newVTongHopThuLao.MaNhomKhoiLuong = _maNhomKhoiLuong;
			newVTongHopThuLao.TietNghiaVu = _tietNghiaVu;
			newVTongHopThuLao.TietGioiHan = _tietGioiHan;
			newVTongHopThuLao.TietQuyDoi = _tietQuyDoi;
			newVTongHopThuLao.TietDoAn = _tietDoAn;
			newVTongHopThuLao.NgoaiGio = _ngoaiGio;
			newVTongHopThuLao.TrongGio = _trongGio;
			newVTongHopThuLao.DonGia = _donGia;
			newVTongHopThuLao.HocKy = _hocKy;
			newVTongHopThuLao.NamHoc = _namHoc;
			return newVTongHopThuLao;
		}
		...
		///<summary>
		///  Returns a Typed VTongHopThuLaoBase Entity 
		///</summary>
		public virtual VTongHopThuLaoBase Copy()
		{
			//shallow copy entity
			VTongHopThuLao copy = new VTongHopThuLao();
		...
		///<returns>true if toObject is a <see cref="VTongHopThuLaoBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VTongHopThuLaoBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VTongHopThuLaoBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VTongHopThuLaoBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VTongHopThuLaoBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VTongHopThuLaoBase Object1, VTongHopThuLaoBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VTongHopThuLao entity, string propertyName)
		{
			switch (propertyName)
			{
		...
		{			
			return GetPropertyValueByName(this as VTongHopThuLao, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{19}{18}- MaLoaiGiangVien: {0}{18}- MaGiangVien: {1}{18}- MaQuanLy: {2}{18}- HoTen: {3}{18}- HoDem: {4}{18}- Ten: {5}{18}- ChucDanh: {6}{18}- MaDonVi: {7}{18}- MaNhomKhoiLuong: {8}{18}- TietNghiaVu: {9}{18}- TietGioiHan: {10}{18}- TietQuyDoi: {11}{18}- TietDoAn: {12}{18}- NgoaiGio: {13}{18}- TrongGio: {14}{18}- DonGia: {15}{18}- HocKy: {16}{18}- NamHoc: {17}{18}", 
	...
	/// <summary>
	/// Enumerate the VTongHopThuLao columns.
	/// </summary>
	[Serializable]
	public enum VTongHopThuLaoColumn
	{
		/// <summary>
		/// MaLoaiGiangVien : 
		/// </summary>
