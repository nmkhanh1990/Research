...
{
	///<summary>
	/// An object representation of the 'v_TongHop_QuyDoi' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("VTongHopQuyDoiBase")]
	public abstract partial class VTongHopQuyDoiBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="VTongHopQuyDoiBase"/> instance.
		///</summary>
		public VTongHopQuyDoiBase()
		{
		}		
		...
		public VTongHopQuyDoiBase(System.String _maKhoa, System.String _tenKhoa, System.String _namHoc, System.String _hocKy, System.Decimal? _soTiet1, System.Decimal? _tietDoAn1, System.Decimal? _soTiet2, System.Decimal? _tietDoAn2, System.Decimal? _tietLyThuyet, System.Decimal? _tietThucHanh, System.Decimal? _tietThiNghiem, System.Decimal? _tietThucTap, System.Decimal? _tietDoAn)
		{
		...
		{
			VTongHopQuyDoi newVTongHopQuyDoi = new VTongHopQuyDoi();
			newVTongHopQuyDoi.MaKhoa = _maKhoa;
			newVTongHopQuyDoi.TenKhoa = _tenKhoa;
			newVTongHopQuyDoi.NamHoc = _namHoc;
			newVTongHopQuyDoi.HocKy = _hocKy;
			newVTongHopQuyDoi.SoTiet1 = _soTiet1;
			newVTongHopQuyDoi.TietDoAn1 = _tietDoAn1;
			newVTongHopQuyDoi.SoTiet2 = _soTiet2;
			newVTongHopQuyDoi.TietDoAn2 = _tietDoAn2;
			newVTongHopQuyDoi.TietLyThuyet = _tietLyThuyet;
			newVTongHopQuyDoi.TietThucHanh = _tietThucHanh;
			newVTongHopQuyDoi.TietThiNghiem = _tietThiNghiem;
			newVTongHopQuyDoi.TietThucTap = _tietThucTap;
			newVTongHopQuyDoi.TietDoAn = _tietDoAn;
			return newVTongHopQuyDoi;
		}
		...
		///<summary>
		///  Returns a Typed VTongHopQuyDoiBase Entity 
		///</summary>
		public virtual VTongHopQuyDoiBase Copy()
		{
			//shallow copy entity
			VTongHopQuyDoi copy = new VTongHopQuyDoi();
		...
		///<returns>true if toObject is a <see cref="VTongHopQuyDoiBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(VTongHopQuyDoiBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="VTongHopQuyDoiBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="VTongHopQuyDoiBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="VTongHopQuyDoiBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(VTongHopQuyDoiBase Object1, VTongHopQuyDoiBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(VTongHopQuyDoi entity, string propertyName)
		{
			switch (propertyName)
			{
				case "MaKhoa":
		...
		{			
			return GetPropertyValueByName(this as VTongHopQuyDoi, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{14}{13}- MaKhoa: {0}{13}- TenKhoa: {1}{13}- NamHoc: {2}{13}- HocKy: {3}{13}- SoTiet1: {4}{13}- TietDoAn1: {5}{13}- SoTiet2: {6}{13}- TietDoAn2: {7}{13}- TietLyThuyet: {8}{13}- TietThucHanh: {9}{13}- TietThiNghiem: {10}{13}- TietThucTap: {11}{13}- TietDoAn: {12}{13}", 
	...
	/// <summary>
	/// Enumerate the VTongHopQuyDoi columns.
	/// </summary>
	[Serializable]
	public enum VTongHopQuyDoiColumn
	{
		/// <summary>
		/// MaKhoa : 
		/// </summary>
