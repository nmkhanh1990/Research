...
{
	///<summary>
	/// An object representation of the 'view_Ute_KhoiLuongQuyDoi' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("ViewUteKhoiLuongQuyDoiBase")]
	public abstract partial class ViewUteKhoiLuongQuyDoiBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="ViewUteKhoiLuongQuyDoiBase"/> instance.
		///</summary>
		public ViewUteKhoiLuongQuyDoiBase()
		{
		}		
		...
		public ViewUteKhoiLuongQuyDoiBase(System.Int32 _id, System.String _maMonHoc, System.String _tenMonHoc, System.String _nhomMonHoc, System.String _maHocPhan, System.String _namHoc, System.String _hocKy, System.String _maLopHocPhan, System.String _nhom, System.String _maLop, System.String _maGiangVienQuanLy, System.Int32? _soTinChi, System.Int32? _siSo, System.Boolean? _lopClc, System.Int32? _soTietDayChuNhat, System.Decimal? _soTiet, System.Int32? _maLoaiHocPhan, System.Decimal? _heSoLopDongLyThuyet, System.Decimal? _heSoLopDongThTnTt, System.Decimal? _tietQuyDoi, System.String _ho, System.String _ten, System.String _hoTen, System.String _tenLoaiHocPhan, System.String _loaiHocPhan, System.Int32? _maNhomMon, System.String _tenNhomMon)
		{
			this._id = _id;
		...
		{
			ViewUteKhoiLuongQuyDoi newViewUteKhoiLuongQuyDoi = new ViewUteKhoiLuongQuyDoi();
			newViewUteKhoiLuongQuyDoi.Id = _id;
			newViewUteKhoiLuongQuyDoi.MaMonHoc = _maMonHoc;
			newViewUteKhoiLuongQuyDoi.TenMonHoc = _tenMonHoc;
			newViewUteKhoiLuongQuyDoi.NhomMonHoc = _nhomMonHoc;
			newViewUteKhoiLuongQuyDoi.MaHocPhan = _maHocPhan;
			newViewUteKhoiLuongQuyDoi.NamHoc = _namHoc;
			newViewUteKhoiLuongQuyDoi.HocKy = _hocKy;
			newViewUteKhoiLuongQuyDoi.MaLopHocPhan = _maLopHocPhan;
			newViewUteKhoiLuongQuyDoi.Nhom = _nhom;
			newViewUteKhoiLuongQuyDoi.MaLop = _maLop;
			newViewUteKhoiLuongQuyDoi.MaGiangVienQuanLy = _maGiangVienQuanLy;
			newViewUteKhoiLuongQuyDoi.SoTinChi = _soTinChi;
			newViewUteKhoiLuongQuyDoi.SiSo = _siSo;
			newViewUteKhoiLuongQuyDoi.LopClc = _lopClc;
			newViewUteKhoiLuongQuyDoi.SoTietDayChuNhat = _soTietDayChuNhat;
			newViewUteKhoiLuongQuyDoi.SoTiet = _soTiet;
			newViewUteKhoiLuongQuyDoi.MaLoaiHocPhan = _maLoaiHocPhan;
			newViewUteKhoiLuongQuyDoi.HeSoLopDongLyThuyet = _heSoLopDongLyThuyet;
			newViewUteKhoiLuongQuyDoi.HeSoLopDongThTnTt = _heSoLopDongThTnTt;
			newViewUteKhoiLuongQuyDoi.TietQuyDoi = _tietQuyDoi;
			newViewUteKhoiLuongQuyDoi.Ho = _ho;
			newViewUteKhoiLuongQuyDoi.Ten = _ten;
			newViewUteKhoiLuongQuyDoi.HoTen = _hoTen;
			newViewUteKhoiLuongQuyDoi.TenLoaiHocPhan = _tenLoaiHocPhan;
			newViewUteKhoiLuongQuyDoi.LoaiHocPhan = _loaiHocPhan;
			newViewUteKhoiLuongQuyDoi.MaNhomMon = _maNhomMon;
			newViewUteKhoiLuongQuyDoi.TenNhomMon = _tenNhomMon;
			return newViewUteKhoiLuongQuyDoi;
		}
		...
		{
			get { return "view_Ute_KhoiLuongQuyDoi"; }
		}
		...
		///<summary>
		///  Returns a Typed ViewUteKhoiLuongQuyDoiBase Entity 
		///</summary>
		public virtual ViewUteKhoiLuongQuyDoiBase Copy()
		{
			//shallow copy entity
			ViewUteKhoiLuongQuyDoi copy = new ViewUteKhoiLuongQuyDoi();
				copy.Id = this.Id;
			...
			copy.AcceptChanges();
			return (ViewUteKhoiLuongQuyDoi)copy;
		}
		...
		///<returns>true if toObject is a <see cref="ViewUteKhoiLuongQuyDoiBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ViewUteKhoiLuongQuyDoiBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ViewUteKhoiLuongQuyDoiBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="ViewUteKhoiLuongQuyDoiBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="ViewUteKhoiLuongQuyDoiBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(ViewUteKhoiLuongQuyDoiBase Object1, ViewUteKhoiLuongQuyDoiBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(ViewUteKhoiLuongQuyDoi entity, string propertyName)
		{
			switch (propertyName)
			{
				case "Id":
		...
		{			
			return GetPropertyValueByName(this as ViewUteKhoiLuongQuyDoi, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{28}{27}- Id: {0}{27}- MaMonHoc: {1}{27}- TenMonHoc: {2}{27}- NhomMonHoc: {3}{27}- MaHocPhan: {4}{27}- NamHoc: {5}{27}- HocKy: {6}{27}- MaLopHocPhan: {7}{27}- Nhom: {8}{27}- MaLop: {9}{27}- MaGiangVienQuanLy: {10}{27}- SoTinChi: {11}{27}- SiSo: {12}{27}- LopClc: {13}{27}- SoTietDayChuNhat: {14}{27}- SoTiet: {15}{27}- MaLoaiHocPhan: {16}{27}- HeSoLopDongLyThuyet: {17}{27}- HeSoLopDongThTnTt: {18}{27}- TietQuyDoi: {19}{27}- Ho: {20}{27}- Ten: {21}{27}- HoTen: {22}{27}- TenLoaiHocPhan: {23}{27}- LoaiHocPhan: {24}{27}- MaNhomMon: {25}{27}- TenNhomMon: {26}{27}", 
				this.Id,
	...
	/// <summary>
	/// Enumerate the ViewUteKhoiLuongQuyDoi columns.
	/// </summary>
	[Serializable]
	public enum ViewUteKhoiLuongQuyDoiColumn
	{
		/// <summary>
		/// Id : 
		/// </summary>
