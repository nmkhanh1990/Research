...
{
	///<summary>
	/// An object representation of the 'view_KcqUte_KhoiLuongQuyDoi2' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("ViewKcqUteKhoiLuongQuyDoi2Base")]
	public abstract partial class ViewKcqUteKhoiLuongQuyDoi2Base : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="ViewKcqUteKhoiLuongQuyDoi2Base"/> instance.
		///</summary>
		public ViewKcqUteKhoiLuongQuyDoi2Base()
		{
		}		
		...
		{
			ViewKcqUteKhoiLuongQuyDoi2 newViewKcqUteKhoiLuongQuyDoi2 = new ViewKcqUteKhoiLuongQuyDoi2();
			newViewKcqUteKhoiLuongQuyDoi2.Id = _id;
			newViewKcqUteKhoiLuongQuyDoi2.MaMonHoc = _maMonHoc;
			newViewKcqUteKhoiLuongQuyDoi2.TenMonHoc = _tenMonHoc;
			newViewKcqUteKhoiLuongQuyDoi2.NhomMonHoc = _nhomMonHoc;
			newViewKcqUteKhoiLuongQuyDoi2.MaHocPhan = _maHocPhan;
			newViewKcqUteKhoiLuongQuyDoi2.NamHoc = _namHoc;
			newViewKcqUteKhoiLuongQuyDoi2.HocKy = _hocKy;
			newViewKcqUteKhoiLuongQuyDoi2.MaDot = _maDot;
			newViewKcqUteKhoiLuongQuyDoi2.MaLopHocPhan = _maLopHocPhan;
			newViewKcqUteKhoiLuongQuyDoi2.Nhom = _nhom;
			newViewKcqUteKhoiLuongQuyDoi2.MaLop = _maLop;
			newViewKcqUteKhoiLuongQuyDoi2.MaDiaDiem = _maDiaDiem;
			newViewKcqUteKhoiLuongQuyDoi2.TenDiaDiem = _tenDiaDiem;
			newViewKcqUteKhoiLuongQuyDoi2.TienXeDiaDiem = _tienXeDiaDiem;
			newViewKcqUteKhoiLuongQuyDoi2.MaGiangVienQuanLy = _maGiangVienQuanLy;
			newViewKcqUteKhoiLuongQuyDoi2.SoTinChi = _soTinChi;
			newViewKcqUteKhoiLuongQuyDoi2.SiSo = _siSo;
			newViewKcqUteKhoiLuongQuyDoi2.LopClc = _lopClc;
			newViewKcqUteKhoiLuongQuyDoi2.SoTietDayChuNhat = _soTietDayChuNhat;
			newViewKcqUteKhoiLuongQuyDoi2.SoTiet = _soTiet;
			newViewKcqUteKhoiLuongQuyDoi2.MaLoaiHocPhan = _maLoaiHocPhan;
			newViewKcqUteKhoiLuongQuyDoi2.HeSoLopDongLyThuyet = _heSoLopDongLyThuyet;
			newViewKcqUteKhoiLuongQuyDoi2.HeSoLopDongThTnTt = _heSoLopDongThTnTt;
			newViewKcqUteKhoiLuongQuyDoi2.TietQuyDoi = _tietQuyDoi;
			newViewKcqUteKhoiLuongQuyDoi2.Ho = _ho;
			newViewKcqUteKhoiLuongQuyDoi2.Ten = _ten;
			newViewKcqUteKhoiLuongQuyDoi2.HoTen = _hoTen;
			newViewKcqUteKhoiLuongQuyDoi2.TenLoaiHocPhan = _tenLoaiHocPhan;
			newViewKcqUteKhoiLuongQuyDoi2.LoaiHocPhan = _loaiHocPhan;
			newViewKcqUteKhoiLuongQuyDoi2.SoGioThucGiangTrenLop = _soGioThucGiangTrenLop;
			newViewKcqUteKhoiLuongQuyDoi2.SoGioChuanTinhThem = _soGioChuanTinhThem;
			newViewKcqUteKhoiLuongQuyDoi2.MaNhomMon = _maNhomMon;
			newViewKcqUteKhoiLuongQuyDoi2.TenNhomMon = _tenNhomMon;
			newViewKcqUteKhoiLuongQuyDoi2.HeSoHocKy = _heSoHocKy;
			return newViewKcqUteKhoiLuongQuyDoi2;
		}
		...
		{
			get { return "view_KcqUte_KhoiLuongQuyDoi2"; }
		}
		...
		///<summary>
		///  Returns a Typed ViewKcqUteKhoiLuongQuyDoi2Base Entity 
		///</summary>
		public virtual ViewKcqUteKhoiLuongQuyDoi2Base Copy()
		{
			//shallow copy entity
			ViewKcqUteKhoiLuongQuyDoi2 copy = new ViewKcqUteKhoiLuongQuyDoi2();
				copy.Id = this.Id;
			...
			copy.AcceptChanges();
			return (ViewKcqUteKhoiLuongQuyDoi2)copy;
		}
		...
		///<returns>true if toObject is a <see cref="ViewKcqUteKhoiLuongQuyDoi2Base"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ViewKcqUteKhoiLuongQuyDoi2Base toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ViewKcqUteKhoiLuongQuyDoi2Base"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="ViewKcqUteKhoiLuongQuyDoi2Base"/> to compare.</param>
		///<param name="Object2">The second <see cref="ViewKcqUteKhoiLuongQuyDoi2Base"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(ViewKcqUteKhoiLuongQuyDoi2Base Object1, ViewKcqUteKhoiLuongQuyDoi2Base Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(ViewKcqUteKhoiLuongQuyDoi2 entity, string propertyName)
		{
			switch (propertyName)
			{
				case "Id":
		...
		{			
			return GetPropertyValueByName(this as ViewKcqUteKhoiLuongQuyDoi2, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the ViewKcqUteKhoiLuongQuyDoi2 columns.
	/// </summary>
	[Serializable]
	public enum ViewKcqUteKhoiLuongQuyDoi2Column
	{
		/// <summary>
		/// Id : 
		/// </summary>
