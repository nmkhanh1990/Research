...
{
	///<summary>
	/// An object representation of the 'view_PhanNhomMonHoc' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("ViewPhanNhomMonHocBase")]
	public abstract partial class ViewPhanNhomMonHocBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="ViewPhanNhomMonHocBase"/> instance.
		///</summary>
		public ViewPhanNhomMonHocBase()
		{
		}		
		...
		public ViewPhanNhomMonHocBase(System.String _curriculumId, System.String _curriculumName, System.Decimal _credits, System.String _departmentId, System.String _departmentName, System.Byte _studyUnitTypeId, System.Decimal _numberOfPeriods, System.Int32? _maNhomMonHoc, System.String _namHoc, System.String _hocKy)
		{
		...
		{
			ViewPhanNhomMonHoc newViewPhanNhomMonHoc = new ViewPhanNhomMonHoc();
			newViewPhanNhomMonHoc.CurriculumId = _curriculumId;
			newViewPhanNhomMonHoc.CurriculumName = _curriculumName;
			newViewPhanNhomMonHoc.Credits = _credits;
			newViewPhanNhomMonHoc.DepartmentId = _departmentId;
			newViewPhanNhomMonHoc.DepartmentName = _departmentName;
			newViewPhanNhomMonHoc.StudyUnitTypeId = _studyUnitTypeId;
			newViewPhanNhomMonHoc.NumberOfPeriods = _numberOfPeriods;
			newViewPhanNhomMonHoc.MaNhomMonHoc = _maNhomMonHoc;
			newViewPhanNhomMonHoc.NamHoc = _namHoc;
			newViewPhanNhomMonHoc.HocKy = _hocKy;
			return newViewPhanNhomMonHoc;
		}
		...
		{
			get { return "view_PhanNhomMonHoc"; }
		}
		...
		///<summary>
		///  Returns a Typed ViewPhanNhomMonHocBase Entity 
		///</summary>
		public virtual ViewPhanNhomMonHocBase Copy()
		{
			//shallow copy entity
			ViewPhanNhomMonHoc copy = new ViewPhanNhomMonHoc();
			...
			copy.AcceptChanges();
			return (ViewPhanNhomMonHoc)copy;
		}
		...
		///<returns>true if toObject is a <see cref="ViewPhanNhomMonHocBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ViewPhanNhomMonHocBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ViewPhanNhomMonHocBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="ViewPhanNhomMonHocBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="ViewPhanNhomMonHocBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(ViewPhanNhomMonHocBase Object1, ViewPhanNhomMonHocBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(ViewPhanNhomMonHoc entity, string propertyName)
		{
			switch (propertyName)
			{
				case "CurriculumId":
		...
		{			
			return GetPropertyValueByName(this as ViewPhanNhomMonHoc, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the ViewPhanNhomMonHoc columns.
	/// </summary>
	[Serializable]
	public enum ViewPhanNhomMonHocColumn
	{
		/// <summary>
		/// CurriculumID : 
		/// </summary>
