...
{
	///<summary>
	/// An object representation of the 'View_TietNoKyTruoc' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("ViewTietNoKyTruocBase")]
	public abstract partial class ViewTietNoKyTruocBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// SoTietNoKyTruoc : 
		/// </summary>
		private System.Decimal?		  _soTietNoKyTruoc = null;
		...
		/// TietNoKhac : 
		/// </summary>
		private System.Decimal?		  _tietNoKhac = null;
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="ViewTietNoKyTruocBase"/> instance.
		///</summary>
		public ViewTietNoKyTruocBase()
		{
		}		
		...
		public ViewTietNoKyTruocBase(System.Int32 _id, System.String _namHoc, System.String _hocKy, System.Int32? _maGiangVien, System.Decimal? _soTietNoKyTruoc, System.String _ngayCapNhat, System.String _nguoiCapNhat, System.String _ho, System.String _ten, System.String _hoTen, System.String _maDonVi, System.String _tenDonVi, System.Decimal? _tietNoKhac)
		{
			this._id = _id;
			this._namHoc = _namHoc;
			this._hocKy = _hocKy;
			this._maGiangVien = _maGiangVien;
			this._soTietNoKyTruoc = _soTietNoKyTruoc;
		...
		{
			ViewTietNoKyTruoc newViewTietNoKyTruoc = new ViewTietNoKyTruoc();
			newViewTietNoKyTruoc.Id = _id;
			newViewTietNoKyTruoc.NamHoc = _namHoc;
			newViewTietNoKyTruoc.HocKy = _hocKy;
			newViewTietNoKyTruoc.MaGiangVien = _maGiangVien;
			newViewTietNoKyTruoc.SoTietNoKyTruoc = _soTietNoKyTruoc;
			newViewTietNoKyTruoc.NgayCapNhat = _ngayCapNhat;
			newViewTietNoKyTruoc.NguoiCapNhat = _nguoiCapNhat;
			newViewTietNoKyTruoc.Ho = _ho;
			newViewTietNoKyTruoc.Ten = _ten;
			newViewTietNoKyTruoc.HoTen = _hoTen;
			newViewTietNoKyTruoc.MaDonVi = _maDonVi;
			newViewTietNoKyTruoc.TenDonVi = _tenDonVi;
			newViewTietNoKyTruoc.TietNoKhac = _tietNoKhac;
			return newViewTietNoKyTruoc;
		}
		...
		/// to check the value of IsSoTietNoKyTruocNull() and perform business logic appropriately.
		/// </remarks>
		[DescriptionAttribute(""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		public virtual System.Decimal? SoTietNoKyTruoc
		{
			get
			{
				return this._soTietNoKyTruoc; 
			}
			set
			{
				if (_soTietNoKyTruoc == value && SoTietNoKyTruoc != null )
					return;
					
				this._soTietNoKyTruoc = value;
				this._isDirty = true;
		...
		/// This property can be set to null. 
		/// If this column is null, this property will return 0.0m. It is up to the developer
		/// to check the value of IsTietNoKhacNull() and perform business logic appropriately.
		/// </remarks>
		[DescriptionAttribute(""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		public virtual System.Decimal? TietNoKhac
		{
			get
			{
				return this._tietNoKhac; 
			}
			set
			{
				if (_tietNoKhac == value && TietNoKhac != null )
					return;
					
				this._tietNoKhac = value;
				this._isDirty = true;
		...
		///<summary>
		///  Returns a Typed ViewTietNoKyTruocBase Entity 
		///</summary>
		public virtual ViewTietNoKyTruocBase Copy()
		{
			//shallow copy entity
			ViewTietNoKyTruoc copy = new ViewTietNoKyTruoc();
				copy.Id = this.Id;
		...
		///<returns>true if toObject is a <see cref="ViewTietNoKyTruocBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ViewTietNoKyTruocBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ViewTietNoKyTruocBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="ViewTietNoKyTruocBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="ViewTietNoKyTruocBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(ViewTietNoKyTruocBase Object1, ViewTietNoKyTruocBase Object2)
		{
			// both are null
			...
			else if (Object1.SoTietNoKyTruoc == null ^ Object1.SoTietNoKyTruoc == null )
			{
				equal = false;
			}
			...
			else if (Object1.TietNoKhac == null ^ Object1.TietNoKhac == null )
			{
				equal = false;
			}
			return equal;
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(ViewTietNoKyTruoc entity, string propertyName)
		{
			switch (propertyName)
			{
				case "Id":
				...
				case "SoTietNoKyTruoc":
					return entity.SoTietNoKyTruoc;
				case "NgayCapNhat":
		...
		{			
			return GetPropertyValueByName(this as ViewTietNoKyTruoc, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{14}{13}- Id: {0}{13}- NamHoc: {1}{13}- HocKy: {2}{13}- MaGiangVien: {3}{13}- SoTietNoKyTruoc: {4}{13}- NgayCapNhat: {5}{13}- NguoiCapNhat: {6}{13}- Ho: {7}{13}- Ten: {8}{13}- HoTen: {9}{13}- MaDonVi: {10}{13}- TenDonVi: {11}{13}- TietNoKhac: {12}{13}", 
				this.Id,
	...
	/// <summary>
	/// Enumerate the ViewTietNoKyTruoc columns.
	/// </summary>
	[Serializable]
	public enum ViewTietNoKyTruocColumn
	{
		/// <summary>
		/// Id : 
		/// </summary>
