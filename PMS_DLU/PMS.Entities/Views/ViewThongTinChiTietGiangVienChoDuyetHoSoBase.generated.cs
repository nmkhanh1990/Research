...
{
	///<summary>
	/// An object representation of the 'View_ThongTin_ChiTiet_GiangVienChoDuyetHoSo' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("ViewThongTinChiTietGiangVienChoDuyetHoSoBase")]
	public abstract partial class ViewThongTinChiTietGiangVienChoDuyetHoSoBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// DaDuyet : 
		/// </summary>
		private System.Boolean?		  _daDuyet = null;
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="ViewThongTinChiTietGiangVienChoDuyetHoSoBase"/> instance.
		///</summary>
		public ViewThongTinChiTietGiangVienChoDuyetHoSoBase()
		{
		}		
		...
		{
			ViewThongTinChiTietGiangVienChoDuyetHoSo newViewThongTinChiTietGiangVienChoDuyetHoSo = new ViewThongTinChiTietGiangVienChoDuyetHoSo();
			newViewThongTinChiTietGiangVienChoDuyetHoSo.MaQuanLy = _maQuanLy;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.Ho = _ho;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.TenDem = _tenDem;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.Ten = _ten;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.HoTenDem = _hoTenDem;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.NgaySinh = _ngaySinh;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.GioiTinh = _gioiTinh;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.TenGioiTinh = _tenGioiTinh;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.NoiSinh = _noiSinh;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.Cmnd = _cmnd;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.NgayCap = _ngayCap;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.NoiCap = _noiCap;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.DoanDang = _doanDang;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.NgayVaoDoanDang = _ngayVaoDoanDang;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.NgayKyHopDong = _ngayKyHopDong;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.NgayKetThucHopDong = _ngayKetThucHopDong;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.HinhAnh = _hinhAnh;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.DiaChi = _diaChi;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.ThuongTru = _thuongTru;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.NoiLamViec = _noiLamViec;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.Email = _email;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.DienThoai = _dienThoai;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.SoDiDong = _soDiDong;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.SoTaiKhoan = _soTaiKhoan;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.TenNganHang = _tenNganHang;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.MaSoThue = _maSoThue;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.ChiNhanh = _chiNhanh;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.SoSoBaoHiem = _soSoBaoHiem;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.ThoiGianBatDau = _thoiGianBatDau;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.BacLuong = _bacLuong;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.NgayHuongLuong = _ngayHuongLuong;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.NamLamViec = _namLamViec;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.ChuyenNganh = _chuyenNganh;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.MaHeSoThuLao = _maHeSoThuLao;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.MaDanToc = _maDanToc;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.TenDanToc = _tenDanToc;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.MaTonGiao = _maTonGiao;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.TenTonGiao = _tenTonGiao;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.MaDonVi = _maDonVi;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.TenDonVi = _tenDonVi;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.MaHocHam = _maHocHam;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.TenHocHam = _tenHocHam;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.MaHocVi = _maHocVi;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.TenHocVi = _tenHocVi;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.MaLoaiGiangVien = _maLoaiGiangVien;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.TenLoaiGiangVien = _tenLoaiGiangVien;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.TenDangNhap = _tenDangNhap;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.TenMayTinh = _tenMayTinh;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.MatKhau = _matKhau;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.MaTinhTrang = _maTinhTrang;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.TenTinhTrang = _tenTinhTrang;
			newViewThongTinChiTietGiangVienChoDuyetHoSo.DaDuyet = _daDuyet;
			return newViewThongTinChiTietGiangVienChoDuyetHoSo;
		}
		...
		/// This property can be set to null. 
		/// If this column is null, this property will return false. It is up to the developer
		/// to check the value of IsDaDuyetNull() and perform business logic appropriately.
		/// </remarks>
		[DescriptionAttribute(""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		public virtual System.Boolean? DaDuyet
		{
			...
			set
			{
				if (_daDuyet == value && DaDuyet != null )
					return;
		...
		{
			get { return "View_ThongTin_ChiTiet_GiangVienChoDuyetHoSo"; }
		}
		...
		///<summary>
		///  Returns a Typed ViewThongTinChiTietGiangVienChoDuyetHoSoBase Entity 
		///</summary>
		public virtual ViewThongTinChiTietGiangVienChoDuyetHoSoBase Copy()
		{
			//shallow copy entity
			ViewThongTinChiTietGiangVienChoDuyetHoSo copy = new ViewThongTinChiTietGiangVienChoDuyetHoSo();
			...
			copy.AcceptChanges();
			return (ViewThongTinChiTietGiangVienChoDuyetHoSo)copy;
		}
		...
		///<returns>true if toObject is a <see cref="ViewThongTinChiTietGiangVienChoDuyetHoSoBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ViewThongTinChiTietGiangVienChoDuyetHoSoBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ViewThongTinChiTietGiangVienChoDuyetHoSoBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="ViewThongTinChiTietGiangVienChoDuyetHoSoBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="ViewThongTinChiTietGiangVienChoDuyetHoSoBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(ViewThongTinChiTietGiangVienChoDuyetHoSoBase Object1, ViewThongTinChiTietGiangVienChoDuyetHoSoBase Object2)
		{
			// both are null
			...
			else if (Object1.DaDuyet == null ^ Object1.DaDuyet == null )
			{
				equal = false;
			}
			return equal;
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(ViewThongTinChiTietGiangVienChoDuyetHoSo entity, string propertyName)
		{
			switch (propertyName)
			{
				case "MaQuanLy":
		...
		{			
			return GetPropertyValueByName(this as ViewThongTinChiTietGiangVienChoDuyetHoSo, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{53}{52}- MaQuanLy: {0}{52}- Ho: {1}{52}- TenDem: {2}{52}- Ten: {3}{52}- HoTenDem: {4}{52}- NgaySinh: {5}{52}- GioiTinh: {6}{52}- TenGioiTinh: {7}{52}- NoiSinh: {8}{52}- Cmnd: {9}{52}- NgayCap: {10}{52}- NoiCap: {11}{52}- DoanDang: {12}{52}- NgayVaoDoanDang: {13}{52}- NgayKyHopDong: {14}{52}- NgayKetThucHopDong: {15}{52}- HinhAnh: {16}{52}- DiaChi: {17}{52}- ThuongTru: {18}{52}- NoiLamViec: {19}{52}- Email: {20}{52}- DienThoai: {21}{52}- SoDiDong: {22}{52}- SoTaiKhoan: {23}{52}- TenNganHang: {24}{52}- MaSoThue: {25}{52}- ChiNhanh: {26}{52}- SoSoBaoHiem: {27}{52}- ThoiGianBatDau: {28}{52}- BacLuong: {29}{52}- NgayHuongLuong: {30}{52}- NamLamViec: {31}{52}- ChuyenNganh: {32}{52}- MaHeSoThuLao: {33}{52}- MaDanToc: {34}{52}- TenDanToc: {35}{52}- MaTonGiao: {36}{52}- TenTonGiao: {37}{52}- MaDonVi: {38}{52}- TenDonVi: {39}{52}- MaHocHam: {40}{52}- TenHocHam: {41}{52}- MaHocVi: {42}{52}- TenHocVi: {43}{52}- MaLoaiGiangVien: {44}{52}- TenLoaiGiangVien: {45}{52}- TenDangNhap: {46}{52}- TenMayTinh: {47}{52}- MatKhau: {48}{52}- MaTinhTrang: {49}{52}- TenTinhTrang: {50}{52}- DaDuyet: {51}{52}", 
	...
	/// <summary>
	/// Enumerate the ViewThongTinChiTietGiangVienChoDuyetHoSo columns.
	/// </summary>
	[Serializable]
	public enum ViewThongTinChiTietGiangVienChoDuyetHoSoColumn
	{
		/// <summary>
		/// MaQuanLy : 
		/// </summary>
