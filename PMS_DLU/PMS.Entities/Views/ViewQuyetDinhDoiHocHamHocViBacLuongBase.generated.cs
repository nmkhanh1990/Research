...
{
	///<summary>
	/// An object representation of the 'view_QuyetDinhDoiHocHamHocViBacLuong' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("ViewQuyetDinhDoiHocHamHocViBacLuongBase")]
	public abstract partial class ViewQuyetDinhDoiHocHamHocViBacLuongBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="ViewQuyetDinhDoiHocHamHocViBacLuongBase"/> instance.
		///</summary>
		public ViewQuyetDinhDoiHocHamHocViBacLuongBase()
		{
		}		
		...
		public ViewQuyetDinhDoiHocHamHocViBacLuongBase(System.Int32? _maGiangVien, System.Int32? _maCu, System.Int32? _maMoi, System.String _tenCu, System.String _tenMoi, System.DateTime? _ngayHieuLuc, System.String _loaiQuyetDinh)
		{
		...
		{
			ViewQuyetDinhDoiHocHamHocViBacLuong newViewQuyetDinhDoiHocHamHocViBacLuong = new ViewQuyetDinhDoiHocHamHocViBacLuong();
			newViewQuyetDinhDoiHocHamHocViBacLuong.MaGiangVien = _maGiangVien;
			newViewQuyetDinhDoiHocHamHocViBacLuong.MaCu = _maCu;
			newViewQuyetDinhDoiHocHamHocViBacLuong.MaMoi = _maMoi;
			newViewQuyetDinhDoiHocHamHocViBacLuong.TenCu = _tenCu;
			newViewQuyetDinhDoiHocHamHocViBacLuong.TenMoi = _tenMoi;
			newViewQuyetDinhDoiHocHamHocViBacLuong.NgayHieuLuc = _ngayHieuLuc;
			newViewQuyetDinhDoiHocHamHocViBacLuong.LoaiQuyetDinh = _loaiQuyetDinh;
			return newViewQuyetDinhDoiHocHamHocViBacLuong;
		}
		...
		{
			get { return "view_QuyetDinhDoiHocHamHocViBacLuong"; }
		}
		...
		///<summary>
		///  Returns a Typed ViewQuyetDinhDoiHocHamHocViBacLuongBase Entity 
		///</summary>
		public virtual ViewQuyetDinhDoiHocHamHocViBacLuongBase Copy()
		{
			//shallow copy entity
			ViewQuyetDinhDoiHocHamHocViBacLuong copy = new ViewQuyetDinhDoiHocHamHocViBacLuong();
			...
			copy.AcceptChanges();
			return (ViewQuyetDinhDoiHocHamHocViBacLuong)copy;
		}
		...
		///<returns>true if toObject is a <see cref="ViewQuyetDinhDoiHocHamHocViBacLuongBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ViewQuyetDinhDoiHocHamHocViBacLuongBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ViewQuyetDinhDoiHocHamHocViBacLuongBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="ViewQuyetDinhDoiHocHamHocViBacLuongBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="ViewQuyetDinhDoiHocHamHocViBacLuongBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(ViewQuyetDinhDoiHocHamHocViBacLuongBase Object1, ViewQuyetDinhDoiHocHamHocViBacLuongBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(ViewQuyetDinhDoiHocHamHocViBacLuong entity, string propertyName)
		{
			switch (propertyName)
			{
				case "MaGiangVien":
		...
		{			
			return GetPropertyValueByName(this as ViewQuyetDinhDoiHocHamHocViBacLuong, propertyName);
		}
	...
	/// <summary>
	/// Enumerate the ViewQuyetDinhDoiHocHamHocViBacLuong columns.
	/// </summary>
	[Serializable]
	public enum ViewQuyetDinhDoiHocHamHocViBacLuongColumn
	{
		/// <summary>
		/// MaGiangVien : 
		/// </summary>
