...
{
	///<summary>
	/// An object representation of the 'View_LietKeKhoiLuongGiangDayChiTiet_USSH_CDGTVT' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtBase")]
	public abstract partial class ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtBase"/> instance.
		///</summary>
		public ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtBase()
		{
		}		
		...
		{
			ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt = new ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt();
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaQuanLy = _maQuanLy;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.Ho = _ho;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.Ten = _ten;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HoTen = _hoTen;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaHocHam = _maHocHam;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaHocVi = _maHocVi;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaLoaiGiangVien = _maLoaiGiangVien;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaDonVi = _maDonVi;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.NamHoc = _namHoc;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HocKy = _hocKy;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.LoaiHocPhan = _loaiHocPhan;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaMonHoc = _maMonHoc;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.TenMonHoc = _tenMonHoc;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.Nhom = _nhom;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaLop = _maLop;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.SiSo = _siSo;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.SoTiet = _soTiet;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.TenCoSo = _tenCoSo;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoLopDong = _heSoLopDong;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoCoSo = _heSoCoSo;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoQuyDoiThucHanhSangLyThuyet = _heSoQuyDoiThucHanhSangLyThuyet;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.TietQuyDoi = _tietQuyDoi;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaHinhThucDaoTao = _maHinhThucDaoTao;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoChucDanhChuyenMon = _heSoChucDanhChuyenMon;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoClcCntn = _heSoClcCntn;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoThinhGiangMonChuyenNganh = _heSoThinhGiangMonChuyenNganh;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaNhomMonHoc = _maNhomMonHoc;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.LoaiLop = _loaiLop;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaBacDaoTao = _maBacDaoTao;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.NgonNguGiangDay = _ngonNguGiangDay;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaLopHocPhan = _maLopHocPhan;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaKhoaHoc = _maKhoaHoc;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoTroCap = _heSoTroCap;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoLuong = _heSoLuong;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoMonMoi = _heSoMonMoi;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoNgoaiGio = _heSoNgoaiGio;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.PhanLoai = _phanLoai;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoNienCheTinChi = _heSoNienCheTinChi;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoNgonNgu = _heSoNgonNgu;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoBacDaoTao = _heSoBacDaoTao;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaLoaiHocPhan = _maLoaiHocPhan;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoKhoiNganh = _heSoKhoiNganh;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.GhiChu = _ghiChu;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.HeSoCongViec = _heSoCongViec;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.SoTietThucTeQuyDoi = _soTietThucTeQuyDoi;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MaCoSo = _maCoSo;
			newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt.MucThanhToan = _mucThanhToan;
			return newViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt;
		}
		...
		{
			get { return "View_LietKeKhoiLuongGiangDayChiTiet_USSH_CDGTVT"; }
		}
		...
		///<summary>
		///  Returns a Typed ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtBase Entity 
		///</summary>
		public virtual ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtBase Copy()
		{
			//shallow copy entity
			ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt copy = new ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt();
			...
			copy.AcceptChanges();
			return (ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt)copy;
		}
		...
		///<returns>true if toObject is a <see cref="ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtBase Object1, ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt entity, string propertyName)
		{
			switch (propertyName)
			{
				case "MaQuanLy":
		...
		{			
			return GetPropertyValueByName(this as ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{48}{47}- MaQuanLy: {0}{47}- Ho: {1}{47}- Ten: {2}{47}- HoTen: {3}{47}- MaHocHam: {4}{47}- MaHocVi: {5}{47}- MaLoaiGiangVien: {6}{47}- MaDonVi: {7}{47}- NamHoc: {8}{47}- HocKy: {9}{47}- LoaiHocPhan: {10}{47}- MaMonHoc: {11}{47}- TenMonHoc: {12}{47}- Nhom: {13}{47}- MaLop: {14}{47}- SiSo: {15}{47}- SoTiet: {16}{47}- TenCoSo: {17}{47}- HeSoLopDong: {18}{47}- HeSoCoSo: {19}{47}- HeSoQuyDoiThucHanhSangLyThuyet: {20}{47}- TietQuyDoi: {21}{47}- MaHinhThucDaoTao: {22}{47}- HeSoChucDanhChuyenMon: {23}{47}- HeSoClcCntn: {24}{47}- HeSoThinhGiangMonChuyenNganh: {25}{47}- MaNhomMonHoc: {26}{47}- LoaiLop: {27}{47}- MaBacDaoTao: {28}{47}- NgonNguGiangDay: {29}{47}- MaLopHocPhan: {30}{47}- MaKhoaHoc: {31}{47}- HeSoTroCap: {32}{47}- HeSoLuong: {33}{47}- HeSoMonMoi: {34}{47}- HeSoNgoaiGio: {35}{47}- PhanLoai: {36}{47}- HeSoNienCheTinChi: {37}{47}- HeSoNgonNgu: {38}{47}- HeSoBacDaoTao: {39}{47}- MaLoaiHocPhan: {40}{47}- HeSoKhoiNganh: {41}{47}- GhiChu: {42}{47}- HeSoCongViec: {43}{47}- SoTietThucTeQuyDoi: {44}{47}- MaCoSo: {45}{47}- MucThanhToan: {46}{47}", 
				this.MaQuanLy,
	...
	/// <summary>
	/// Enumerate the ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvt columns.
	/// </summary>
	[Serializable]
	public enum ViewLietKeKhoiLuongGiangDayChiTietUsshCdgtvtColumn
	{
		/// <summary>
		/// MaQuanLy : 
		/// </summary>
