...
{
	///<summary>
	/// An object representation of the 'View_LietKeKhoiLuongGiangDayChiTiet' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("ViewLietKeKhoiLuongGiangDayChiTietBase")]
	public abstract partial class ViewLietKeKhoiLuongGiangDayChiTietBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// PhanLoai : 
		/// </summary>
		private System.String		  _phanLoai = string.Empty;
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="ViewLietKeKhoiLuongGiangDayChiTietBase"/> instance.
		///</summary>
		public ViewLietKeKhoiLuongGiangDayChiTietBase()
		{
		}		
		...
		{
			ViewLietKeKhoiLuongGiangDayChiTiet newViewLietKeKhoiLuongGiangDayChiTiet = new ViewLietKeKhoiLuongGiangDayChiTiet();
			newViewLietKeKhoiLuongGiangDayChiTiet.MaQuanLy = _maQuanLy;
			newViewLietKeKhoiLuongGiangDayChiTiet.Ho = _ho;
			newViewLietKeKhoiLuongGiangDayChiTiet.Ten = _ten;
			newViewLietKeKhoiLuongGiangDayChiTiet.HoTen = _hoTen;
			newViewLietKeKhoiLuongGiangDayChiTiet.MaHocHam = _maHocHam;
			newViewLietKeKhoiLuongGiangDayChiTiet.MaHocVi = _maHocVi;
			newViewLietKeKhoiLuongGiangDayChiTiet.MaLoaiGiangVien = _maLoaiGiangVien;
			newViewLietKeKhoiLuongGiangDayChiTiet.MaDonVi = _maDonVi;
			newViewLietKeKhoiLuongGiangDayChiTiet.NamHoc = _namHoc;
			newViewLietKeKhoiLuongGiangDayChiTiet.HocKy = _hocKy;
			newViewLietKeKhoiLuongGiangDayChiTiet.Loai = _loai;
			newViewLietKeKhoiLuongGiangDayChiTiet.MaMonHoc = _maMonHoc;
			newViewLietKeKhoiLuongGiangDayChiTiet.TenMonHoc = _tenMonHoc;
			newViewLietKeKhoiLuongGiangDayChiTiet.Nhom = _nhom;
			newViewLietKeKhoiLuongGiangDayChiTiet.MaLop = _maLop;
			newViewLietKeKhoiLuongGiangDayChiTiet.SiSo = _siSo;
			newViewLietKeKhoiLuongGiangDayChiTiet.SoTiet = _soTiet;
			newViewLietKeKhoiLuongGiangDayChiTiet.TietChuNhat = _tietChuNhat;
			newViewLietKeKhoiLuongGiangDayChiTiet.LopClc = _lopClc;
			newViewLietKeKhoiLuongGiangDayChiTiet.HeSoLopDong = _heSoLopDong;
			newViewLietKeKhoiLuongGiangDayChiTiet.HeSoHocKy = _heSoHocKy;
			newViewLietKeKhoiLuongGiangDayChiTiet.DonGia = _donGia;
			newViewLietKeKhoiLuongGiangDayChiTiet.TongThanhTien = _tongThanhTien;
			newViewLietKeKhoiLuongGiangDayChiTiet.TietQuyDoi = _tietQuyDoi;
			newViewLietKeKhoiLuongGiangDayChiTiet.PhanLoai = _phanLoai;
			return newViewLietKeKhoiLuongGiangDayChiTiet;
		}
		...
		public virtual System.String PhanLoai
		{
			...
			{
				if ( value == null )
					throw new ArgumentNullException("value", "PhanLoai does not allow null values.");
				if (_phanLoai == value)
					return;
		...
		{
			get { return "View_LietKeKhoiLuongGiangDayChiTiet"; }
		}
		...
		///<summary>
		///  Returns a Typed ViewLietKeKhoiLuongGiangDayChiTietBase Entity 
		///</summary>
		public virtual ViewLietKeKhoiLuongGiangDayChiTietBase Copy()
		{
			//shallow copy entity
			ViewLietKeKhoiLuongGiangDayChiTiet copy = new ViewLietKeKhoiLuongGiangDayChiTiet();
			...
			copy.AcceptChanges();
			return (ViewLietKeKhoiLuongGiangDayChiTiet)copy;
		}
		...
		///<returns>true if toObject is a <see cref="ViewLietKeKhoiLuongGiangDayChiTietBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ViewLietKeKhoiLuongGiangDayChiTietBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ViewLietKeKhoiLuongGiangDayChiTietBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="ViewLietKeKhoiLuongGiangDayChiTietBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="ViewLietKeKhoiLuongGiangDayChiTietBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(ViewLietKeKhoiLuongGiangDayChiTietBase Object1, ViewLietKeKhoiLuongGiangDayChiTietBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(ViewLietKeKhoiLuongGiangDayChiTiet entity, string propertyName)
		{
			switch (propertyName)
			{
				case "MaQuanLy":
		...
		{			
			return GetPropertyValueByName(this as ViewLietKeKhoiLuongGiangDayChiTiet, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{26}{25}- MaQuanLy: {0}{25}- Ho: {1}{25}- Ten: {2}{25}- HoTen: {3}{25}- MaHocHam: {4}{25}- MaHocVi: {5}{25}- MaLoaiGiangVien: {6}{25}- MaDonVi: {7}{25}- NamHoc: {8}{25}- HocKy: {9}{25}- Loai: {10}{25}- MaMonHoc: {11}{25}- TenMonHoc: {12}{25}- Nhom: {13}{25}- MaLop: {14}{25}- SiSo: {15}{25}- SoTiet: {16}{25}- TietChuNhat: {17}{25}- LopClc: {18}{25}- HeSoLopDong: {19}{25}- HeSoHocKy: {20}{25}- DonGia: {21}{25}- TongThanhTien: {22}{25}- TietQuyDoi: {23}{25}- PhanLoai: {24}{25}", 
	...
	/// <summary>
	/// Enumerate the ViewLietKeKhoiLuongGiangDayChiTiet columns.
	/// </summary>
	[Serializable]
	public enum ViewLietKeKhoiLuongGiangDayChiTietColumn
	{
		/// <summary>
		/// MaQuanLy : 
		/// </summary>
		...
		/// </summary>
		[EnumTextValue("Loai")]
		[ColumnEnum("Loai", typeof(System.String), System.Data.DbType.String, false, false, true, 10)]
		Loai,
		/// <summary>
		/// MaMonHoc : 
		/// </summary>
		...
		[ColumnEnum("PhanLoai", typeof(System.String), System.Data.DbType.String, false, false, false, 100)]
		PhanLoai
	}//End enum
