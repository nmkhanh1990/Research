...
{
	///<summary>
	/// An object representation of the 'View_KetQuaThanhToanThuLao' view. [No description found in the database]	
	///</summary>
	[Serializable]
	[CLSCompliant(true)]
	[ToolboxItem("ViewKetQuaThanhToanThuLaoBase")]
	public abstract partial class ViewKetQuaThanhToanThuLaoBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		#region Constructors
		///<summary>
		/// Creates a new <see cref="ViewKetQuaThanhToanThuLaoBase"/> instance.
		///</summary>
		public ViewKetQuaThanhToanThuLaoBase()
		{
		}		
		...
		{
			ViewKetQuaThanhToanThuLao newViewKetQuaThanhToanThuLao = new ViewKetQuaThanhToanThuLao();
			newViewKetQuaThanhToanThuLao.MaGiangVien = _maGiangVien;
			newViewKetQuaThanhToanThuLao.MaQuanLy = _maQuanLy;
			newViewKetQuaThanhToanThuLao.Ho = _ho;
			newViewKetQuaThanhToanThuLao.Ten = _ten;
			newViewKetQuaThanhToanThuLao.HoTen = _hoTen;
			newViewKetQuaThanhToanThuLao.NamHoc = _namHoc;
			newViewKetQuaThanhToanThuLao.HocKy = _hocKy;
			newViewKetQuaThanhToanThuLao.MaHocHam = _maHocHam;
			newViewKetQuaThanhToanThuLao.TenHocHam = _tenHocHam;
			newViewKetQuaThanhToanThuLao.MaHocVi = _maHocVi;
			newViewKetQuaThanhToanThuLao.TenHocVi = _tenHocVi;
			newViewKetQuaThanhToanThuLao.MaLoaiGiangVien = _maLoaiGiangVien;
			newViewKetQuaThanhToanThuLao.TenLoaiGiangVien = _tenLoaiGiangVien;
			newViewKetQuaThanhToanThuLao.MaDonVi = _maDonVi;
			newViewKetQuaThanhToanThuLao.TenDonVi = _tenDonVi;
			newViewKetQuaThanhToanThuLao.Loai = _loai;
			newViewKetQuaThanhToanThuLao.PhanLoai = _phanLoai;
			newViewKetQuaThanhToanThuLao.MaMonHoc = _maMonHoc;
			newViewKetQuaThanhToanThuLao.TenMonHoc = _tenMonHoc;
			newViewKetQuaThanhToanThuLao.LoaiHocPhan = _loaiHocPhan;
			newViewKetQuaThanhToanThuLao.Nhom = _nhom;
			newViewKetQuaThanhToanThuLao.MaLop = _maLop;
			newViewKetQuaThanhToanThuLao.LopClc = _lopClc;
			newViewKetQuaThanhToanThuLao.SiSo = _siSo;
			newViewKetQuaThanhToanThuLao.TietThucDay = _tietThucDay;
			newViewKetQuaThanhToanThuLao.TietChuNhat = _tietChuNhat;
			newViewKetQuaThanhToanThuLao.HeSoHocKy = _heSoHocKy;
			newViewKetQuaThanhToanThuLao.HeSoLopDong = _heSoLopDong;
			newViewKetQuaThanhToanThuLao.TietQuyDoi = _tietQuyDoi;
			newViewKetQuaThanhToanThuLao.DonGia = _donGia;
			newViewKetQuaThanhToanThuLao.ThanhTien = _thanhTien;
			newViewKetQuaThanhToanThuLao.LanChot = _lanChot;
			newViewKetQuaThanhToanThuLao.NgayCapNhat = _ngayCapNhat;
			return newViewKetQuaThanhToanThuLao;
		}
		...
		{
			get { return "View_KetQuaThanhToanThuLao"; }
		}
		...
		///<summary>
		///  Returns a Typed ViewKetQuaThanhToanThuLaoBase Entity 
		///</summary>
		public virtual ViewKetQuaThanhToanThuLaoBase Copy()
		{
			//shallow copy entity
			ViewKetQuaThanhToanThuLao copy = new ViewKetQuaThanhToanThuLao();
			...
			copy.AcceptChanges();
			return (ViewKetQuaThanhToanThuLao)copy;
		}
		...
		///<returns>true if toObject is a <see cref="ViewKetQuaThanhToanThuLaoBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ViewKetQuaThanhToanThuLaoBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ViewKetQuaThanhToanThuLaoBase"/> instances are considered equal.
		///</summary>
		///<param name="Object1">The first <see cref="ViewKetQuaThanhToanThuLaoBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="ViewKetQuaThanhToanThuLaoBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool Equals(ViewKetQuaThanhToanThuLaoBase Object1, ViewKetQuaThanhToanThuLaoBase Object2)
		{
			// both are null
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		/// <returns></returns>
		public static object GetPropertyValueByName(ViewKetQuaThanhToanThuLao entity, string propertyName)
		{
			switch (propertyName)
			{
				case "MaGiangVien":
		...
		{			
			return GetPropertyValueByName(this as ViewKetQuaThanhToanThuLao, propertyName);
		}
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{34}{33}- MaGiangVien: {0}{33}- MaQuanLy: {1}{33}- Ho: {2}{33}- Ten: {3}{33}- HoTen: {4}{33}- NamHoc: {5}{33}- HocKy: {6}{33}- MaHocHam: {7}{33}- TenHocHam: {8}{33}- MaHocVi: {9}{33}- TenHocVi: {10}{33}- MaLoaiGiangVien: {11}{33}- TenLoaiGiangVien: {12}{33}- MaDonVi: {13}{33}- TenDonVi: {14}{33}- Loai: {15}{33}- PhanLoai: {16}{33}- MaMonHoc: {17}{33}- TenMonHoc: {18}{33}- LoaiHocPhan: {19}{33}- Nhom: {20}{33}- MaLop: {21}{33}- LopClc: {22}{33}- SiSo: {23}{33}- TietThucDay: {24}{33}- TietChuNhat: {25}{33}- HeSoHocKy: {26}{33}- HeSoLopDong: {27}{33}- TietQuyDoi: {28}{33}- DonGia: {29}{33}- ThanhTien: {30}{33}- LanChot: {31}{33}- NgayCapNhat: {32}{33}", 
	...
	/// <summary>
	/// Enumerate the ViewKetQuaThanhToanThuLao columns.
	/// </summary>
	[Serializable]
	public enum ViewKetQuaThanhToanThuLaoColumn
	{
		/// <summary>
		/// MaGiangVien : 
		/// </summary>
		...
		/// </summary>
		[EnumTextValue("MaLop")]
		[ColumnEnum("MaLop", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 2000)]
		MaLop,
		/// <summary>
		/// LopClc : 
		/// </summary>
