...
{
	///<summary>
	/// An object representation of the 'CoVanHocTap' table. [No description found the database]	
	///</summary>
	[Serializable]
	[DataObject, CLSCompliant(true)]
	public abstract partial class CoVanHocTapBase : EntityBase, ICoVanHocTap, IEntityId<CoVanHocTapKey>, System.IComparable, System.ICloneable, ICloneableEx, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		/// </summary>
		private CoVanHocTapEntityData entityData;
		
		/// <summary>
		/// 	Hold the original data of the entity, as loaded from the repository.
		/// </summary>
		private CoVanHocTapEntityData _originalData;
		
		/// <summary>
		/// 	Hold a backup of the inner data of the entity.
		/// </summary>
		private CoVanHocTapEntityData backupData; 
		...
		[NonSerialized]
		private TList<CoVanHocTap> parentCollection;
		...
		/// </summary>
		[field:NonSerialized]
		public event CoVanHocTapEventHandler ColumnChanging;		
		
		/// <summary>
		/// Occurs after a value has been changed for the specified column.
		/// </summary>
		[field:NonSerialized]
		public event CoVanHocTapEventHandler ColumnChanged;
		
		#endregion Variable Declarations
		
		#region Constructors
		///<summary>
		/// Creates a new <see cref="CoVanHocTapBase"/> instance.
		///</summary>
		public CoVanHocTapBase()
		{
			this.entityData = new CoVanHocTapEntityData();
		...
		public CoVanHocTapBase(System.Int32? _maGiangVien, System.String _namHoc, System.String _hocKy, 
			System.String _maLop, System.String _maKhoaHoc, System.Int32? _soTiet, System.Decimal? _soTien, 
			System.DateTime? _ngayTao, System.Boolean? _trangThai, System.Int32? _siSo, System.Int32? _danhGiaHoanThanh, 
			System.DateTime? _ngayKetThuc, System.String _ghiChu, System.String _ngayCapNhat, System.String _nguoiCapNhat, 
			System.Int32? _nhom, System.Decimal? _heSo)
		{
			this.entityData = new CoVanHocTapEntityData();
			this.backupData = null;
			...
			this.SiSo = _siSo;
			this.DanhGiaHoanThanh = _danhGiaHoanThanh;
		...
		///<param name="_nhom"></param>
		///<param name="_heSo"></param>
		public static CoVanHocTap CreateCoVanHocTap(System.Int32? _maGiangVien, System.String _namHoc, System.String _hocKy, 
			System.String _maLop, System.String _maKhoaHoc, System.Int32? _soTiet, System.Decimal? _soTien, 
			System.DateTime? _ngayTao, System.Boolean? _trangThai, System.Int32? _siSo, System.Int32? _danhGiaHoanThanh, 
			System.DateTime? _ngayKetThuc, System.String _ghiChu, System.String _ngayCapNhat, System.String _nguoiCapNhat, 
			System.Int32? _nhom, System.Decimal? _heSo)
		{
			CoVanHocTap newCoVanHocTap = new CoVanHocTap();
			newCoVanHocTap.MaGiangVien = _maGiangVien;
			newCoVanHocTap.NamHoc = _namHoc;
			newCoVanHocTap.HocKy = _hocKy;
			newCoVanHocTap.MaLop = _maLop;
			newCoVanHocTap.MaKhoaHoc = _maKhoaHoc;
			newCoVanHocTap.SoTiet = _soTiet;
			newCoVanHocTap.SoTien = _soTien;
			newCoVanHocTap.NgayTao = _ngayTao;
			newCoVanHocTap.TrangThai = _trangThai;
			newCoVanHocTap.SiSo = _siSo;
			newCoVanHocTap.DanhGiaHoanThanh = _danhGiaHoanThanh;
			newCoVanHocTap.NgayKetThuc = _ngayKetThuc;
			newCoVanHocTap.GhiChu = _ghiChu;
			newCoVanHocTap.NgayCapNhat = _ngayCapNhat;
			newCoVanHocTap.NguoiCapNhat = _nguoiCapNhat;
			newCoVanHocTap.Nhom = _nhom;
			newCoVanHocTap.HeSo = _heSo;
			return newCoVanHocTap;
		}
		...
		[Required(ErrorMessage = "MaCoVan is required")]
		...
		public virtual System.Int32 MaCoVan
		{
			get
			{
				return this.entityData.MaCoVan; 
			}
			
			set
			{
				if (this.entityData.MaCoVan == value)
					return;
				
                OnPropertyChanging("MaCoVan");                    
				OnColumnChanging(CoVanHocTapColumn.MaCoVan, this.entityData.MaCoVan);
				this.entityData.MaCoVan = value;
				this.EntityId.MaCoVan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.MaCoVan, this.entityData.MaCoVan);
		...
		public virtual System.Int32? MaGiangVien
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.MaGiangVien, this.entityData.MaGiangVien);
				this.entityData.MaGiangVien = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.MaGiangVien, this.entityData.MaGiangVien);
		...
		public virtual System.String NamHoc
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.NamHoc, this.entityData.NamHoc);
				this.entityData.NamHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.NamHoc, this.entityData.NamHoc);
		...
		public virtual System.String HocKy
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.HocKy, this.entityData.HocKy);
				this.entityData.HocKy = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.HocKy, this.entityData.HocKy);
		...
		public virtual System.String MaLop
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.MaLop, this.entityData.MaLop);
				this.entityData.MaLop = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.MaLop, this.entityData.MaLop);
		...
		public virtual System.String MaKhoaHoc
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.MaKhoaHoc, this.entityData.MaKhoaHoc);
				this.entityData.MaKhoaHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.MaKhoaHoc, this.entityData.MaKhoaHoc);
		...
		public virtual System.Int32? SoTiet
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.SoTiet, this.entityData.SoTiet);
				this.entityData.SoTiet = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.SoTiet, this.entityData.SoTiet);
		...
		public virtual System.Decimal? SoTien
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.SoTien, this.entityData.SoTien);
				this.entityData.SoTien = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.SoTien, this.entityData.SoTien);
		...
		public virtual System.DateTime? NgayTao
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.NgayTao, this.entityData.NgayTao);
				this.entityData.NgayTao = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.NgayTao, this.entityData.NgayTao);
		...
		public virtual System.Boolean? TrangThai
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.TrangThai, this.entityData.TrangThai);
				this.entityData.TrangThai = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.TrangThai, this.entityData.TrangThai);
		...
		public virtual System.Int32? SiSo
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.SiSo, this.entityData.SiSo);
				this.entityData.SiSo = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.SiSo, this.entityData.SiSo);
				OnPropertyChanged("SiSo");
			}
		}
		
		/// <summary>
		/// 	Gets or sets the DanhGiaHoanThanh property. 
		///		
		/// </summary>
		/// <value>This type is int.</value>
		/// <remarks>
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		public virtual System.Int32? DanhGiaHoanThanh
		{
			get
			{
				return this.entityData.DanhGiaHoanThanh; 
			}
			
			set
			{
				if (this.entityData.DanhGiaHoanThanh == value)
					return;
				
                OnPropertyChanging("DanhGiaHoanThanh");                    
				OnColumnChanging(CoVanHocTapColumn.DanhGiaHoanThanh, this.entityData.DanhGiaHoanThanh);
				this.entityData.DanhGiaHoanThanh = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.DanhGiaHoanThanh, this.entityData.DanhGiaHoanThanh);
				OnPropertyChanged("DanhGiaHoanThanh");
			}
		}
		...
		public virtual System.DateTime? NgayKetThuc
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.NgayKetThuc, this.entityData.NgayKetThuc);
				this.entityData.NgayKetThuc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.NgayKetThuc, this.entityData.NgayKetThuc);
		...
		public virtual System.String GhiChu
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.GhiChu, this.entityData.GhiChu);
				this.entityData.GhiChu = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.GhiChu, this.entityData.GhiChu);
		...
		public virtual System.String NgayCapNhat
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.NgayCapNhat, this.entityData.NgayCapNhat);
				this.entityData.NgayCapNhat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.NgayCapNhat, this.entityData.NgayCapNhat);
		...
		public virtual System.String NguoiCapNhat
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.NguoiCapNhat, this.entityData.NguoiCapNhat);
				this.entityData.NguoiCapNhat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.NguoiCapNhat, this.entityData.NguoiCapNhat);
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		public virtual System.Int32? Nhom
		{
			get
			{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.Nhom, this.entityData.Nhom);
				this.entityData.Nhom = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.Nhom, this.entityData.Nhom);
		...
		public virtual System.Decimal? HeSo
		{
			...
			set
			{
				...
				OnColumnChanging(CoVanHocTapColumn.HeSo, this.entityData.HeSo);
				this.entityData.HeSo = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(CoVanHocTapColumn.HeSo, this.entityData.HeSo);
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"MaCoVan", "MaGiangVien", "NamHoc", "HocKy", "MaLop", "MaKhoaHoc", "SoTiet", "SoTien", "NgayTao", "TrangThai", "SiSo", "DanhGiaHoanThanh", "NgayKetThuc", "GhiChu", "NgayCapNhat", "NguoiCapNhat", "Nhom", "HeSo"};
			}
		}
		#endregion 
		...
		void IEditableObject.BeginEdit() 
	    {
	        ...
	        if (!inTxn) 
	        {
	            this.backupData = this.entityData.Clone() as CoVanHocTapEntityData;
	            inTxn = true;
	        ...
	        if (this.inTxn) 
	        {
	        	...
	        	//if (this.EntityState == EntityState.Added)
	        	{
					if (this.parentCollection != null)
						this.parentCollection.Remove( (CoVanHocTap) this ) ;
				}	            
	        }
	    ...
	    public override object ParentCollection
	    {
	        ...
	        set 
	        {
	            this.parentCollection = value as TList<CoVanHocTap>;
	        }
	    }
	    ...
	    private void OnEntityChanged() 
	    {
	        ...
	        {
	            this.parentCollection.EntityChanged(this as CoVanHocTap);
	        }
	    }
		...
		///<summary>
		///  Returns a Typed CoVanHocTap Entity 
		///</summary>
		protected virtual CoVanHocTap Copy(IDictionary existingCopies)
		{
			...
			//shallow copy entity
			CoVanHocTap copy = new CoVanHocTap();
			...
			copy.SuppressEntityEvents = true;
				...
				copy.SiSo = this.SiSo;
				copy.DanhGiaHoanThanh = this.DanhGiaHoanThanh;
		...
		///  Returns a Typed CoVanHocTap Entity 
		///</summary>
		public virtual CoVanHocTap Copy()
		{
		...
		///<summary>
		///  Returns a Typed CoVanHocTap Entity which is a deep copy of the current entity.
		///</summary>
		public virtual CoVanHocTap DeepCopy()
		{
			return EntityHelper.Clone<CoVanHocTap>(this as CoVanHocTap);	
		}
		#endregion
		...
		public override void CancelChanges()
		{
			...
			{
				this.entityData = this._originalData.Clone() as CoVanHocTapEntityData;
			}
			else
			{
		...
		public override void AcceptChanges()
		{
			...
			this._originalData = this.entityData.Clone() as CoVanHocTapEntityData;
		}
		...
		/// </returns>
		public bool IsPropertyChanged(CoVanHocTapColumn column)
		{
			switch(column)
			{
					case CoVanHocTapColumn.MaCoVan:
					return entityData.MaCoVan != _originalData.MaCoVan;
					case CoVanHocTapColumn.MaGiangVien:
					return entityData.MaGiangVien != _originalData.MaGiangVien;
					case CoVanHocTapColumn.NamHoc:
					return entityData.NamHoc != _originalData.NamHoc;
					case CoVanHocTapColumn.HocKy:
					return entityData.HocKy != _originalData.HocKy;
					case CoVanHocTapColumn.MaLop:
					return entityData.MaLop != _originalData.MaLop;
					case CoVanHocTapColumn.MaKhoaHoc:
					return entityData.MaKhoaHoc != _originalData.MaKhoaHoc;
					case CoVanHocTapColumn.SoTiet:
					return entityData.SoTiet != _originalData.SoTiet;
					case CoVanHocTapColumn.SoTien:
					return entityData.SoTien != _originalData.SoTien;
					case CoVanHocTapColumn.NgayTao:
					return entityData.NgayTao != _originalData.NgayTao;
					case CoVanHocTapColumn.TrangThai:
					return entityData.TrangThai != _originalData.TrangThai;
					case CoVanHocTapColumn.SiSo:
					return entityData.SiSo != _originalData.SiSo;
					case CoVanHocTapColumn.DanhGiaHoanThanh:
					return entityData.DanhGiaHoanThanh != _originalData.DanhGiaHoanThanh;
					case CoVanHocTapColumn.NgayKetThuc:
					return entityData.NgayKetThuc != _originalData.NgayKetThuc;
					case CoVanHocTapColumn.GhiChu:
					return entityData.GhiChu != _originalData.GhiChu;
					case CoVanHocTapColumn.NgayCapNhat:
					return entityData.NgayCapNhat != _originalData.NgayCapNhat;
					case CoVanHocTapColumn.NguoiCapNhat:
					return entityData.NguoiCapNhat != _originalData.NguoiCapNhat;
					case CoVanHocTapColumn.Nhom:
					return entityData.Nhom != _originalData.Nhom;
					case CoVanHocTapColumn.HeSo:
		...
		{
			return 	IsPropertyChanged(EntityHelper.GetEnumValue< CoVanHocTapColumn >(columnName));
		}
		...
		{
			bool result = false;
			result = result || entityData.MaCoVan != _originalData.MaCoVan;
			...
			result = result || entityData.DanhGiaHoanThanh != _originalData.DanhGiaHoanThanh;
		...
		///<summary>
		///  Returns a CoVanHocTap Entity with the original data.
		///</summary>
		public CoVanHocTap GetOriginalEntity()
		{
			if (_originalData != null)
				return CreateCoVanHocTap(
				...
				_originalData.SiSo,
				_originalData.DanhGiaHoanThanh,
	...
	#region Value Semantics Instance Equality
        ...
        ///<returns>true if Object1 is a <see cref="CoVanHocTapBase"/> and has the same value as this instance; otherwise, false.</returns>
        public override bool Equals(object Object1)
        {
			// Cast exception if Object1 is null or DbNull
			if (Object1 != null && Object1 != DBNull.Value && Object1 is CoVanHocTapBase)
				return ValueEquals(this, (CoVanHocTapBase)Object1);
			else
				return false;
        }
        ...
        /// Provides a hash function that is appropriate for <see cref="CoVanHocTapBase"/> class 
        /// and that ensures a better distribution in the hash table
        /// </summary>
        /// <returns>number (hash code) that corresponds to the value of an object</returns>
        public override int GetHashCode()
        {
			return this.MaCoVan.GetHashCode() ^ 
					...
					((this.DanhGiaHoanThanh == null) ? string.Empty : this.DanhGiaHoanThanh.ToString()).GetHashCode() ^ 
		...
		///<returns>true if toObject is a <see cref="CoVanHocTapBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(CoVanHocTapBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="CoVanHocTapBase"/> instances are considered equal using value semantics.
		///</summary>
		///<param name="Object1">The first <see cref="CoVanHocTapBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="CoVanHocTapBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool ValueEquals(CoVanHocTapBase Object1, CoVanHocTapBase Object2)
		{
			// both are null
			...
			if ( Object1.DanhGiaHoanThanh != null && Object2.DanhGiaHoanThanh != null )
			{
				if (Object1.DanhGiaHoanThanh != Object2.DanhGiaHoanThanh)
					equal = false;
			}
			else if (Object1.DanhGiaHoanThanh == null ^ Object2.DanhGiaHoanThanh == null )
			{
				equal = false;
			}
		...
		public virtual int CompareTo(object obj)
		{
			...
			//return this. GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]) .CompareTo(((CoVanHocTapBase)obj).GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]));
		}
		
		/*
		// static method to get a Comparer object
        public static CoVanHocTapComparer GetComparer()
        {
            return new CoVanHocTapComparer();
        }
        */

        // Comparer delegates back to CoVanHocTap
...
/*
        ...
        public int CompareTo(CoVanHocTap rhs, CoVanHocTapColumn which)
        {
            switch (which)
            {
            	...
            	case CoVanHocTapColumn.MaCoVan:
            		return this.MaCoVan.CompareTo(rhs.MaCoVan);
            	...
            	case CoVanHocTapColumn.DanhGiaHoanThanh:
            		return this.DanhGiaHoanThanh.Value.CompareTo(rhs.DanhGiaHoanThanh.Value);
            	...
            	case CoVanHocTapColumn.Nhom:
            		return this.Nhom.Value.CompareTo(rhs.Nhom.Value);
        ...
        */
		...
		#region IEntityKey<CoVanHocTapKey> Members
		
		// member variable for the EntityId property
		private CoVanHocTapKey _entityId;

		/// <summary>
		/// Gets or sets the EntityId property.
		/// </summary>
		[XmlIgnore]
		public virtual CoVanHocTapKey EntityId
		{
			get
			{
				if ( _entityId == null )
				{
					_entityId = new CoVanHocTapKey(this);
				}
		...
		public override string EntityTrackingKey
		{
			get
			{
				if(entityTrackingKey == null)
					entityTrackingKey = new System.Text.StringBuilder("CoVanHocTap")
					.Append("|").Append( this.MaCoVan.ToString()).ToString();
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{19}{18}- MaCoVan: {0}{18}- MaGiangVien: {1}{18}- NamHoc: {2}{18}- HocKy: {3}{18}- MaLop: {4}{18}- MaKhoaHoc: {5}{18}- SoTiet: {6}{18}- SoTien: {7}{18}- NgayTao: {8}{18}- TrangThai: {9}{18}- SiSo: {10}{18}- DanhGiaHoanThanh: {11}{18}- NgayKetThuc: {12}{18}- GhiChu: {13}{18}- NgayCapNhat: {14}{18}- NguoiCapNhat: {15}{18}- Nhom: {16}{18}- HeSo: {17}{18}{20}", 
				this.MaCoVan,
				...
				(this.DanhGiaHoanThanh == null) ? string.Empty : this.DanhGiaHoanThanh.ToString(),
	...
	/// <summary>
	///		The data structure representation of the 'CoVanHocTap' table.
	/// </summary>
	/// <remarks>
	...
	[Serializable]
	internal protected class CoVanHocTapEntityData : ICloneable, ICloneableEx
	{
		#region Variable Declarations
		...
		/// DanhGiaHoanThanh : 
		/// </summary>
		public System.Int32? DanhGiaHoanThanh = null;
		...
		public Object Clone()
		{
			CoVanHocTapEntityData _tmp = new CoVanHocTapEntityData();
						
			_tmp.MaCoVan = this.MaCoVan;
			...
			_tmp.SiSo = this.SiSo;
			_tmp.DanhGiaHoanThanh = this.DanhGiaHoanThanh;
		...
		/// </summary>
		/// <param name="column">The <see cref="CoVanHocTapColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanging(CoVanHocTapColumn column)
		{
		...
		/// </summary>
		/// <param name="column">The <see cref="CoVanHocTapColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanged(CoVanHocTapColumn column)
		{
		...
		public virtual void OnColumnChanging(CoVanHocTapColumn column, object value)
		{
			...
			if (!SuppressEntityEvents)
			{
				CoVanHocTapEventHandler handler = ColumnChanging;
				if(handler != null)
				{
					handler(this, new CoVanHocTapEventArgs(column, value));
				}
			}
		}
		...
		/// <param name="column">The <see cref="CoVanHocTapColumn"/> which has raised the event.</param>
		/// <param name="value">The changed value.</param>
		public virtual void OnColumnChanged(CoVanHocTapColumn column, object value)
		{
			if (!SuppressEntityEvents)
			{
				CoVanHocTapEventHandler handler = ColumnChanged;
				if(handler != null)
				{
					handler(this, new CoVanHocTapEventArgs(column, value));
				}
	...
	#region CoVanHocTapEventArgs class
	/// <summary>
	/// Provides data for the ColumnChanging and ColumnChanged events.
	/// </summary>
	/// <remarks>
	/// The ColumnChanging and ColumnChanged events occur when a change is made to the value 
	/// of a property of a <see cref="CoVanHocTap"/> object.
	/// </remarks>
	public class CoVanHocTapEventArgs : System.EventArgs
	{
		private CoVanHocTapColumn column;
		private object value;
		
		///<summary>
		/// Initalizes a new Instance of the CoVanHocTapEventArgs class.
		///</summary>
		public CoVanHocTapEventArgs(CoVanHocTapColumn column)
		{
			this.column = column;
		}
		...
		/// Initalizes a new Instance of the CoVanHocTapEventArgs class.
		///</summary>
		public CoVanHocTapEventArgs(CoVanHocTapColumn column, object value)
		{
			this.column = column;
			this.value = value;
		}
		...
		///<summary>
		/// The CoVanHocTapColumn that was modified, which has raised the event.
		///</summary>
		///<value cref="CoVanHocTapColumn" />
		public CoVanHocTapColumn Column { get { return this.column; } }
	...
	///<summary>
	/// Define a delegate for all CoVanHocTap related events.
	///</summary>
	public delegate void CoVanHocTapEventHandler(object sender, CoVanHocTapEventArgs e);
	
	#region CoVanHocTapComparer
		
	/// <summary>
	///	Strongly Typed IComparer
	/// </summary>
	public class CoVanHocTapComparer : System.Collections.Generic.IComparer<CoVanHocTap>
	{
		CoVanHocTapColumn whichComparison;
		
		/// <summary>
        /// Initializes a new instance of the <see cref="T:CoVanHocTapComparer"/> class.
        /// </summary>
		public CoVanHocTapComparer()
        {            
        }               
        ...
        public CoVanHocTapComparer(CoVanHocTapColumn column)
        {
            this.whichComparison = column;
        }

		/// <summary>
        /// Determines whether the specified <see cref="CoVanHocTap"/> instances are considered equal.
        /// </summary>
        /// <param name="a">The first <see cref="CoVanHocTap"/> to compare.</param>
        /// <param name="b">The second <c>CoVanHocTap</c> to compare.</param>
        /// <returns>true if objA is the same instance as objB or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
        public bool Equals(CoVanHocTap a, CoVanHocTap b)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(CoVanHocTap entity)
        {
        ...
        /// <returns></returns>
        public int Compare(CoVanHocTap a, CoVanHocTap b)
        {
        ...
        public CoVanHocTapColumn WhichComparison
        {
	...
	#region CoVanHocTapKey Class

	/// <summary>
	/// Wraps the unique identifier values for the <see cref="CoVanHocTap"/> object.
	/// </summary>
	[Serializable]
	[CLSCompliant(true)]
	public class CoVanHocTapKey : EntityKeyBase
	{
		#region Constructors
		
		/// <summary>
		/// Initializes a new instance of the CoVanHocTapKey class.
		/// </summary>
		public CoVanHocTapKey()
		{
		}
		...
		/// Initializes a new instance of the CoVanHocTapKey class.
		/// </summary>
		public CoVanHocTapKey(CoVanHocTapBase entity)
		{
			this.Entity = entity;
		...
		/// Initializes a new instance of the CoVanHocTapKey class.
		/// </summary>
		public CoVanHocTapKey(System.Int32 _maCoVan)
		{
			#region Init Properties

			this.MaCoVan = _maCoVan;
		...
		private CoVanHocTapBase _entity;
		
		/// <summary>
		/// Gets or sets the Entity property.
		/// </summary>
		public CoVanHocTapBase Entity
		{
			get { return _entity; }
			set { _entity = value; }
		}
		
		// member variable for the MaCoVan property
		private System.Int32 _maCoVan;
		...
		public override void Load(IDictionary values)
		{
			...
			if ( values != null )
			{
				MaCoVan = ( values["MaCoVan"] != null ) ? (System.Int32) EntityUtil.ChangeType(values["MaCoVan"], typeof(System.Int32)) : (int)0;
			}
		...
		public override string ToString()
		{
			return String.Format("MaCoVan: {0}{1}",
								MaCoVan,
								System.Environment.NewLine);
		}
	...
	#region CoVanHocTapColumn Enum
	
	/// <summary>
	/// Enumerate the CoVanHocTap columns.
	/// </summary>
	[Serializable]
	public enum CoVanHocTapColumn : int
	{
		/// <summary>
		/// MaCoVan : 
		/// </summary>
		[EnumTextValue("Ma Co Van")]
		[ColumnEnum("MaCoVan", typeof(System.Int32), System.Data.DbType.Int32, true, true, false)]
		MaCoVan = 1,
		/// <summary>
		/// MaGiangVien : 
		/// </summary>
		...
		/// DanhGiaHoanThanh : 
		/// </summary>
		[EnumTextValue("Danh Gia Hoan Thanh")]
		[ColumnEnum("DanhGiaHoanThanh", typeof(System.Int32), System.Data.DbType.Int32, false, false, true)]
		DanhGiaHoanThanh = 12,
		/// <summary>
		/// NgayKetThuc : 
		/// </summary>
		...
		/// </summary>
		[EnumTextValue("Nhom")]
		[ColumnEnum("Nhom", typeof(System.Int32), System.Data.DbType.Int32, false, false, true)]
		Nhom = 17,
		/// <summary>
		/// HeSo : 
		/// </summary>
	...
	#endregion CoVanHocTapColumn Enum
