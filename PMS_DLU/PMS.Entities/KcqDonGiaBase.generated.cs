...
/*
	...
	Important: Do not modify this file. Edit the file KcqDonGia.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'KcqDonGia' table. [No description found the database]	
	///</summary>
	[Serializable]
	[DataObject, CLSCompliant(true)]
	public abstract partial class KcqDonGiaBase : EntityBase, IKcqDonGia, IEntityId<KcqDonGiaKey>, System.IComparable, System.ICloneable, ICloneableEx, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		/// </summary>
		private KcqDonGiaEntityData entityData;
		
		/// <summary>
		/// 	Hold the original data of the entity, as loaded from the repository.
		/// </summary>
		private KcqDonGiaEntityData _originalData;
		
		/// <summary>
		/// 	Hold a backup of the inner data of the entity.
		/// </summary>
		private KcqDonGiaEntityData backupData; 
		...
		[NonSerialized]
		private TList<KcqDonGia> parentCollection;
		...
		/// </summary>
		[field:NonSerialized]
		public event KcqDonGiaEventHandler ColumnChanging;		
		
		/// <summary>
		/// Occurs after a value has been changed for the specified column.
		/// </summary>
		[field:NonSerialized]
		public event KcqDonGiaEventHandler ColumnChanged;
		
		#endregion Variable Declarations
		
		#region Constructors
		///<summary>
		/// Creates a new <see cref="KcqDonGiaBase"/> instance.
		///</summary>
		public KcqDonGiaBase()
		{
			this.entityData = new KcqDonGiaEntityData();
		...
		public KcqDonGiaBase(System.String _maQuanLy, System.Int32? _maLoaiGiangVien, System.Int32? _maHocHam, 
		...
		///<summary>
		/// A simple factory method to create a new <see cref="KcqDonGia"/> instance.
		///</summary>
		///<param name="_maQuanLy"></param>
		///<param name="_maLoaiGiangVien"></param>
		///<param name="_maHocHam"></param>
		...
		///<param name="_namHoc"></param>
		///<param name="_hocKy"></param>
		public static KcqDonGia CreateKcqDonGia(System.String _maQuanLy, System.Int32? _maLoaiGiangVien, System.Int32? _maHocHam, 
			System.Int32? _maHocVi, System.Decimal? _donGia, System.DateTime? _ngayCapNhat, System.String _nguoiCapNhat, 
			System.Decimal? _donGiaClc, System.Decimal? _heSoQuyDoiChatLuong, System.Decimal? _donGiaTrongChuan, 
			System.Decimal? _donGiaNgoaiChuan, System.String _maHinhThucDaoTao, System.String _bacDaoTao, 
			System.String _ngonNguGiangDay, System.String _namHoc, System.String _hocKy)
		{
			KcqDonGia newKcqDonGia = new KcqDonGia();
			newKcqDonGia.MaQuanLy = _maQuanLy;
			newKcqDonGia.MaLoaiGiangVien = _maLoaiGiangVien;
			newKcqDonGia.MaHocHam = _maHocHam;
			newKcqDonGia.MaHocVi = _maHocVi;
			newKcqDonGia.DonGia = _donGia;
			newKcqDonGia.NgayCapNhat = _ngayCapNhat;
			newKcqDonGia.NguoiCapNhat = _nguoiCapNhat;
			newKcqDonGia.DonGiaClc = _donGiaClc;
			newKcqDonGia.HeSoQuyDoiChatLuong = _heSoQuyDoiChatLuong;
			newKcqDonGia.DonGiaTrongChuan = _donGiaTrongChuan;
			newKcqDonGia.DonGiaNgoaiChuan = _donGiaNgoaiChuan;
			newKcqDonGia.MaHinhThucDaoTao = _maHinhThucDaoTao;
			newKcqDonGia.BacDaoTao = _bacDaoTao;
			newKcqDonGia.NgonNguGiangDay = _ngonNguGiangDay;
			newKcqDonGia.NamHoc = _namHoc;
			newKcqDonGia.HocKy = _hocKy;
			return newKcqDonGia;
		}
		...
		public virtual System.Int32 Id
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.Id, this.entityData.Id);
				this.entityData.Id = value;
				this.EntityId.Id = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.Id, this.entityData.Id);
		...
		public virtual System.String MaQuanLy
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.MaQuanLy, this.entityData.MaQuanLy);
				this.entityData.MaQuanLy = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.MaQuanLy, this.entityData.MaQuanLy);
		...
		public virtual System.Int32? MaLoaiGiangVien
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.MaLoaiGiangVien, this.entityData.MaLoaiGiangVien);
				this.entityData.MaLoaiGiangVien = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.MaLoaiGiangVien, this.entityData.MaLoaiGiangVien);
		...
		public virtual System.Int32? MaHocHam
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.MaHocHam, this.entityData.MaHocHam);
				this.entityData.MaHocHam = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.MaHocHam, this.entityData.MaHocHam);
		...
		public virtual System.Int32? MaHocVi
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.MaHocVi, this.entityData.MaHocVi);
				this.entityData.MaHocVi = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.MaHocVi, this.entityData.MaHocVi);
		...
		public virtual System.Decimal? DonGia
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.DonGia, this.entityData.DonGia);
				this.entityData.DonGia = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.DonGia, this.entityData.DonGia);
		...
		public virtual System.DateTime? NgayCapNhat
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.NgayCapNhat, this.entityData.NgayCapNhat);
				this.entityData.NgayCapNhat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.NgayCapNhat, this.entityData.NgayCapNhat);
		...
		public virtual System.String NguoiCapNhat
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.NguoiCapNhat, this.entityData.NguoiCapNhat);
				this.entityData.NguoiCapNhat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.NguoiCapNhat, this.entityData.NguoiCapNhat);
		...
		public virtual System.Decimal? DonGiaClc
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.DonGiaClc, this.entityData.DonGiaClc);
				this.entityData.DonGiaClc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.DonGiaClc, this.entityData.DonGiaClc);
		...
		public virtual System.Decimal? HeSoQuyDoiChatLuong
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.HeSoQuyDoiChatLuong, this.entityData.HeSoQuyDoiChatLuong);
				this.entityData.HeSoQuyDoiChatLuong = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.HeSoQuyDoiChatLuong, this.entityData.HeSoQuyDoiChatLuong);
		...
		public virtual System.Decimal? DonGiaTrongChuan
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.DonGiaTrongChuan, this.entityData.DonGiaTrongChuan);
				this.entityData.DonGiaTrongChuan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.DonGiaTrongChuan, this.entityData.DonGiaTrongChuan);
		...
		public virtual System.Decimal? DonGiaNgoaiChuan
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.DonGiaNgoaiChuan, this.entityData.DonGiaNgoaiChuan);
				this.entityData.DonGiaNgoaiChuan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.DonGiaNgoaiChuan, this.entityData.DonGiaNgoaiChuan);
		...
		public virtual System.String MaHinhThucDaoTao
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.MaHinhThucDaoTao, this.entityData.MaHinhThucDaoTao);
				this.entityData.MaHinhThucDaoTao = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.MaHinhThucDaoTao, this.entityData.MaHinhThucDaoTao);
		...
		public virtual System.String BacDaoTao
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.BacDaoTao, this.entityData.BacDaoTao);
				this.entityData.BacDaoTao = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.BacDaoTao, this.entityData.BacDaoTao);
		...
		public virtual System.String NgonNguGiangDay
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.NgonNguGiangDay, this.entityData.NgonNguGiangDay);
				this.entityData.NgonNguGiangDay = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.NgonNguGiangDay, this.entityData.NgonNguGiangDay);
		...
		public virtual System.String NamHoc
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.NamHoc, this.entityData.NamHoc);
				this.entityData.NamHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.NamHoc, this.entityData.NamHoc);
		...
		public virtual System.String HocKy
		{
			...
			set
			{
				...
				OnColumnChanging(KcqDonGiaColumn.HocKy, this.entityData.HocKy);
				this.entityData.HocKy = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KcqDonGiaColumn.HocKy, this.entityData.HocKy);
		...
		void IEditableObject.BeginEdit() 
	    {
	        ...
	        if (!inTxn) 
	        {
	            this.backupData = this.entityData.Clone() as KcqDonGiaEntityData;
	            inTxn = true;
	        ...
	        if (this.inTxn) 
	        {
	        	...
	        	//if (this.EntityState == EntityState.Added)
	        	{
					if (this.parentCollection != null)
						this.parentCollection.Remove( (KcqDonGia) this ) ;
				}	            
	        }
	    ...
	    public override object ParentCollection
	    {
	        ...
	        set 
	        {
	            this.parentCollection = value as TList<KcqDonGia>;
	        }
	    }
	    ...
	    private void OnEntityChanged() 
	    {
	        ...
	        {
	            this.parentCollection.EntityChanged(this as KcqDonGia);
	        }
	    }
		...
		///<summary>
		///  Returns a Typed KcqDonGia Entity 
		///</summary>
		protected virtual KcqDonGia Copy(IDictionary existingCopies)
		{
		...
		///<summary>
		///  Returns a Typed KcqDonGia Entity which is a deep copy of the current entity.
		///</summary>
		public virtual KcqDonGia DeepCopy()
		{
			return EntityHelper.Clone<KcqDonGia>(this as KcqDonGia);	
		}
		#endregion
		...
		public override void CancelChanges()
		{
			...
			{
				this.entityData = this._originalData.Clone() as KcqDonGiaEntityData;
			}
			else
			{
		...
		public override void AcceptChanges()
		{
			...
			this._originalData = this.entityData.Clone() as KcqDonGiaEntityData;
		}
		...
		{
			return 	IsPropertyChanged(EntityHelper.GetEnumValue< KcqDonGiaColumn >(columnName));
		}
		...
		///<summary>
		///  Returns a KcqDonGia Entity with the original data.
		///</summary>
		public KcqDonGia GetOriginalEntity()
		{
			if (_originalData != null)
				return CreateKcqDonGia(
	...
	#region Value Semantics Instance Equality
        ...
        ///<returns>true if Object1 is a <see cref="KcqDonGiaBase"/> and has the same value as this instance; otherwise, false.</returns>
        public override bool Equals(object Object1)
        {
			// Cast exception if Object1 is null or DbNull
			if (Object1 != null && Object1 != DBNull.Value && Object1 is KcqDonGiaBase)
				return ValueEquals(this, (KcqDonGiaBase)Object1);
			else
				return false;
        }
        ...
        /// Provides a hash function that is appropriate for <see cref="KcqDonGiaBase"/> class 
		...
		///<returns>true if toObject is a <see cref="KcqDonGiaBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(KcqDonGiaBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="KcqDonGiaBase"/> instances are considered equal using value semantics.
		///</summary>
		///<param name="Object1">The first <see cref="KcqDonGiaBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="KcqDonGiaBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool ValueEquals(KcqDonGiaBase Object1, KcqDonGiaBase Object2)
		{
			// both are null
		...
		public virtual int CompareTo(object obj)
		{
			...
			//return this. GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]) .CompareTo(((KcqDonGiaBase)obj).GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]));
		}
		
		/*
		// static method to get a Comparer object
        public static KcqDonGiaComparer GetComparer()
        {
            return new KcqDonGiaComparer();
        }
        */

        // Comparer delegates back to KcqDonGia
...
/*
        ...
        public int CompareTo(KcqDonGia rhs, KcqDonGiaColumn which)
        {
            switch (which)
            {
        ...
        */
		...
		#region IEntityKey<KcqDonGiaKey> Members
		
		// member variable for the EntityId property
		private KcqDonGiaKey _entityId;

		/// <summary>
		/// Gets or sets the EntityId property.
		/// </summary>
		[XmlIgnore]
		public virtual KcqDonGiaKey EntityId
		{
			get
			{
				if ( _entityId == null )
				{
					_entityId = new KcqDonGiaKey(this);
				}
		...
		public override string EntityTrackingKey
		{
			get
			{
				if(entityTrackingKey == null)
					entityTrackingKey = new System.Text.StringBuilder("KcqDonGia")
	...
	/// <summary>
	///		The data structure representation of the 'KcqDonGia' table.
	/// </summary>
	/// <remarks>
	...
	[Serializable]
	internal protected class KcqDonGiaEntityData : ICloneable, ICloneableEx
	{
		#region Variable Declarations
		...
		/// Id : 
		/// </summary>
		/// <remarks>Member of the primary key of the underlying table "KcqDonGia"</remarks>
		...
		public Object Clone()
		{
			KcqDonGiaEntityData _tmp = new KcqDonGiaEntityData();
		...
		/// </summary>
		/// <param name="column">The <see cref="KcqDonGiaColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanging(KcqDonGiaColumn column)
		{
		...
		/// </summary>
		/// <param name="column">The <see cref="KcqDonGiaColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanged(KcqDonGiaColumn column)
		{
		...
		public virtual void OnColumnChanging(KcqDonGiaColumn column, object value)
		{
			...
			if (!SuppressEntityEvents)
			{
				KcqDonGiaEventHandler handler = ColumnChanging;
				if(handler != null)
				{
					handler(this, new KcqDonGiaEventArgs(column, value));
				}
			}
		}
		...
		/// <param name="column">The <see cref="KcqDonGiaColumn"/> which has raised the event.</param>
		/// <param name="value">The changed value.</param>
		public virtual void OnColumnChanged(KcqDonGiaColumn column, object value)
		{
			if (!SuppressEntityEvents)
			{
				KcqDonGiaEventHandler handler = ColumnChanged;
				if(handler != null)
				{
					handler(this, new KcqDonGiaEventArgs(column, value));
				}
	...
	#region KcqDonGiaEventArgs class
	/// <summary>
	/// Provides data for the ColumnChanging and ColumnChanged events.
	/// </summary>
	/// <remarks>
	/// The ColumnChanging and ColumnChanged events occur when a change is made to the value 
	/// of a property of a <see cref="KcqDonGia"/> object.
	/// </remarks>
	public class KcqDonGiaEventArgs : System.EventArgs
	{
		private KcqDonGiaColumn column;
		private object value;
		
		///<summary>
		/// Initalizes a new Instance of the KcqDonGiaEventArgs class.
		///</summary>
		public KcqDonGiaEventArgs(KcqDonGiaColumn column)
		{
			this.column = column;
		}
		...
		/// Initalizes a new Instance of the KcqDonGiaEventArgs class.
		///</summary>
		public KcqDonGiaEventArgs(KcqDonGiaColumn column, object value)
		{
			this.column = column;
			this.value = value;
		}
		...
		///<summary>
		/// The KcqDonGiaColumn that was modified, which has raised the event.
		///</summary>
		///<value cref="KcqDonGiaColumn" />
		public KcqDonGiaColumn Column { get { return this.column; } }
	...
	///<summary>
	/// Define a delegate for all KcqDonGia related events.
	///</summary>
	public delegate void KcqDonGiaEventHandler(object sender, KcqDonGiaEventArgs e);
	
	#region KcqDonGiaComparer
		
	/// <summary>
	///	Strongly Typed IComparer
	/// </summary>
	public class KcqDonGiaComparer : System.Collections.Generic.IComparer<KcqDonGia>
	{
		KcqDonGiaColumn whichComparison;
		
		/// <summary>
        /// Initializes a new instance of the <see cref="T:KcqDonGiaComparer"/> class.
        /// </summary>
		public KcqDonGiaComparer()
        {            
        }               
        ...
        public KcqDonGiaComparer(KcqDonGiaColumn column)
        {
            this.whichComparison = column;
        }

		/// <summary>
        /// Determines whether the specified <see cref="KcqDonGia"/> instances are considered equal.
        /// </summary>
        /// <param name="a">The first <see cref="KcqDonGia"/> to compare.</param>
        /// <param name="b">The second <c>KcqDonGia</c> to compare.</param>
        /// <returns>true if objA is the same instance as objB or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
        public bool Equals(KcqDonGia a, KcqDonGia b)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(KcqDonGia entity)
        {
        ...
        /// <returns></returns>
        public int Compare(KcqDonGia a, KcqDonGia b)
        {
        ...
        public KcqDonGiaColumn WhichComparison
        {
	...
	#region KcqDonGiaKey Class

	/// <summary>
	/// Wraps the unique identifier values for the <see cref="KcqDonGia"/> object.
	/// </summary>
	[Serializable]
	[CLSCompliant(true)]
	public class KcqDonGiaKey : EntityKeyBase
	{
		#region Constructors
		
		/// <summary>
		/// Initializes a new instance of the KcqDonGiaKey class.
		/// </summary>
		public KcqDonGiaKey()
		{
		}
		...
		/// Initializes a new instance of the KcqDonGiaKey class.
		/// </summary>
		public KcqDonGiaKey(KcqDonGiaBase entity)
		{
			this.Entity = entity;
		...
		/// Initializes a new instance of the KcqDonGiaKey class.
		/// </summary>
		public KcqDonGiaKey(System.Int32 _id)
		{
			#region Init Properties
		...
		private KcqDonGiaBase _entity;
		
		/// <summary>
		/// Gets or sets the Entity property.
		/// </summary>
		public KcqDonGiaBase Entity
		{
			get { return _entity; }
			set { _entity = value; }
		}
	...
	#region KcqDonGiaColumn Enum
	
	/// <summary>
	/// Enumerate the KcqDonGia columns.
	/// </summary>
	[Serializable]
	public enum KcqDonGiaColumn : int
	{
		/// <summary>
		/// Id : 
		/// </summary>
	...
	#endregion KcqDonGiaColumn Enum
