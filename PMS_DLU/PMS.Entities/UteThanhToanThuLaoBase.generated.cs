...
{
	///<summary>
	/// An object representation of the 'Ute_ThanhToanThuLao' table. [No description found the database]	
	///</summary>
	[Serializable]
	[DataObject, CLSCompliant(true)]
	public abstract partial class UteThanhToanThuLaoBase : EntityBase, IUteThanhToanThuLao, IEntityId<UteThanhToanThuLaoKey>, System.IComparable, System.ICloneable, ICloneableEx, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		/// </summary>
		private UteThanhToanThuLaoEntityData entityData;
		
		/// <summary>
		/// 	Hold the original data of the entity, as loaded from the repository.
		/// </summary>
		private UteThanhToanThuLaoEntityData _originalData;
		
		/// <summary>
		/// 	Hold a backup of the inner data of the entity.
		/// </summary>
		private UteThanhToanThuLaoEntityData backupData; 
		...
		[NonSerialized]
		private TList<UteThanhToanThuLao> parentCollection;
		...
		/// </summary>
		[field:NonSerialized]
		public event UteThanhToanThuLaoEventHandler ColumnChanging;		
		
		/// <summary>
		/// Occurs after a value has been changed for the specified column.
		/// </summary>
		[field:NonSerialized]
		public event UteThanhToanThuLaoEventHandler ColumnChanged;
		
		#endregion Variable Declarations
		
		#region Constructors
		///<summary>
		/// Creates a new <see cref="UteThanhToanThuLaoBase"/> instance.
		///</summary>
		public UteThanhToanThuLaoBase()
		{
			this.entityData = new UteThanhToanThuLaoEntityData();
		...
		public UteThanhToanThuLaoBase(System.Int32 _idKhoiLuongQuyDoi, System.String _maMonHoc, 
		...
		///<param name="_soGioThucGiangTrenLop"></param>
		///<param name="_soGioChuanTinhThem"></param>
		public static UteThanhToanThuLao CreateUteThanhToanThuLao(System.Int32 _idKhoiLuongQuyDoi, System.String _maMonHoc, 
			System.String _tenMonHoc, System.String _nhomMonHoc, System.String _namHoc, 
			System.String _hocKy, System.String _maLopHocPhan, System.String _nhom, 
			System.String _maLop, System.Int32? _soTinChi, System.Int32? _soTiet, 
			System.Int32? _siSo, System.Boolean? _lopClc, System.Int32? _soTietDayChuNhat, 
			...
			System.Decimal? _heSoHocKy, System.Decimal? _soGioThucGiangTrenLop, System.Decimal? _soGioChuanTinhThem)
		{
			UteThanhToanThuLao newUteThanhToanThuLao = new UteThanhToanThuLao();
			newUteThanhToanThuLao.IdKhoiLuongQuyDoi = _idKhoiLuongQuyDoi;
			newUteThanhToanThuLao.MaMonHoc = _maMonHoc;
			newUteThanhToanThuLao.TenMonHoc = _tenMonHoc;
			newUteThanhToanThuLao.NhomMonHoc = _nhomMonHoc;
			newUteThanhToanThuLao.NamHoc = _namHoc;
			newUteThanhToanThuLao.HocKy = _hocKy;
			newUteThanhToanThuLao.MaLopHocPhan = _maLopHocPhan;
			newUteThanhToanThuLao.Nhom = _nhom;
			newUteThanhToanThuLao.MaLop = _maLop;
			newUteThanhToanThuLao.SoTinChi = _soTinChi;
			newUteThanhToanThuLao.SoTiet = _soTiet;
			newUteThanhToanThuLao.SiSo = _siSo;
			newUteThanhToanThuLao.LopClc = _lopClc;
			newUteThanhToanThuLao.SoTietDayChuNhat = _soTietDayChuNhat;
			newUteThanhToanThuLao.MaLoaiHocPhan = _maLoaiHocPhan;
			newUteThanhToanThuLao.HeSoLopDongLyThuyet = _heSoLopDongLyThuyet;
			newUteThanhToanThuLao.HeSoLopDongThTnTt = _heSoLopDongThTnTt;
			newUteThanhToanThuLao.MaQuanLy = _maQuanLy;
			newUteThanhToanThuLao.Ho = _ho;
			newUteThanhToanThuLao.Ten = _ten;
			newUteThanhToanThuLao.HoTen = _hoTen;
			newUteThanhToanThuLao.MaHocHam = _maHocHam;
			newUteThanhToanThuLao.MaHocVi = _maHocVi;
			newUteThanhToanThuLao.MaLoaiGiangVien = _maLoaiGiangVien;
			newUteThanhToanThuLao.MaDonVi = _maDonVi;
			newUteThanhToanThuLao.DonGia = _donGia;
			newUteThanhToanThuLao.TietQuyDoi = _tietQuyDoi;
			newUteThanhToanThuLao.ThanhTienDayChuNhat = _thanhTienDayChuNhat;
			newUteThanhToanThuLao.ThanhTien = _thanhTien;
			newUteThanhToanThuLao.TongThanhTien = _tongThanhTien;
			newUteThanhToanThuLao.NgayCapNhat = _ngayCapNhat;
			newUteThanhToanThuLao.DaChot = _daChot;
			newUteThanhToanThuLao.HeSoHocKy = _heSoHocKy;
			newUteThanhToanThuLao.SoGioThucGiangTrenLop = _soGioThucGiangTrenLop;
			newUteThanhToanThuLao.SoGioChuanTinhThem = _soGioChuanTinhThem;
			return newUteThanhToanThuLao;
		}
		...
		[Required(ErrorMessage = "IdKhoiLuongQuyDoi is required")]
		...
		public virtual System.Int32 IdKhoiLuongQuyDoi
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.IdKhoiLuongQuyDoi, this.entityData.IdKhoiLuongQuyDoi);
				this.entityData.IdKhoiLuongQuyDoi = value;
				this.EntityId.IdKhoiLuongQuyDoi = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.IdKhoiLuongQuyDoi, this.entityData.IdKhoiLuongQuyDoi);
		...
		public virtual System.String MaMonHoc
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.MaMonHoc, this.entityData.MaMonHoc);
				this.entityData.MaMonHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.MaMonHoc, this.entityData.MaMonHoc);
		...
		public virtual System.String TenMonHoc
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.TenMonHoc, this.entityData.TenMonHoc);
				this.entityData.TenMonHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.TenMonHoc, this.entityData.TenMonHoc);
		...
		public virtual System.String NhomMonHoc
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.NhomMonHoc, this.entityData.NhomMonHoc);
				this.entityData.NhomMonHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.NhomMonHoc, this.entityData.NhomMonHoc);
		...
		public virtual System.String NamHoc
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.NamHoc, this.entityData.NamHoc);
				this.entityData.NamHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.NamHoc, this.entityData.NamHoc);
		...
		public virtual System.String HocKy
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.HocKy, this.entityData.HocKy);
				this.entityData.HocKy = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.HocKy, this.entityData.HocKy);
		...
		public virtual System.String MaLopHocPhan
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.MaLopHocPhan, this.entityData.MaLopHocPhan);
				this.entityData.MaLopHocPhan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.MaLopHocPhan, this.entityData.MaLopHocPhan);
		...
		public virtual System.String Nhom
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.Nhom, this.entityData.Nhom);
				this.entityData.Nhom = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.Nhom, this.entityData.Nhom);
		...
		public virtual System.String MaLop
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.MaLop, this.entityData.MaLop);
				this.entityData.MaLop = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.MaLop, this.entityData.MaLop);
		...
		public virtual System.Int32? SoTinChi
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.SoTinChi, this.entityData.SoTinChi);
				this.entityData.SoTinChi = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.SoTinChi, this.entityData.SoTinChi);
		...
		public virtual System.Int32? SoTiet
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.SoTiet, this.entityData.SoTiet);
				this.entityData.SoTiet = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.SoTiet, this.entityData.SoTiet);
		...
		public virtual System.Int32? SiSo
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.SiSo, this.entityData.SiSo);
				this.entityData.SiSo = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.SiSo, this.entityData.SiSo);
		...
		public virtual System.Boolean? LopClc
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.LopClc, this.entityData.LopClc);
				this.entityData.LopClc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.LopClc, this.entityData.LopClc);
		...
		public virtual System.Int32? SoTietDayChuNhat
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.SoTietDayChuNhat, this.entityData.SoTietDayChuNhat);
				this.entityData.SoTietDayChuNhat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.SoTietDayChuNhat, this.entityData.SoTietDayChuNhat);
		...
		public virtual System.Int32? MaLoaiHocPhan
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.MaLoaiHocPhan, this.entityData.MaLoaiHocPhan);
				this.entityData.MaLoaiHocPhan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.MaLoaiHocPhan, this.entityData.MaLoaiHocPhan);
		...
		public virtual System.Decimal? HeSoLopDongLyThuyet
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.HeSoLopDongLyThuyet, this.entityData.HeSoLopDongLyThuyet);
				this.entityData.HeSoLopDongLyThuyet = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.HeSoLopDongLyThuyet, this.entityData.HeSoLopDongLyThuyet);
		...
		public virtual System.Decimal? HeSoLopDongThTnTt
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.HeSoLopDongThTnTt, this.entityData.HeSoLopDongThTnTt);
				this.entityData.HeSoLopDongThTnTt = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.HeSoLopDongThTnTt, this.entityData.HeSoLopDongThTnTt);
		...
		public virtual System.String MaQuanLy
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.MaQuanLy, this.entityData.MaQuanLy);
				this.entityData.MaQuanLy = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.MaQuanLy, this.entityData.MaQuanLy);
		...
		public virtual System.String Ho
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.Ho, this.entityData.Ho);
				this.entityData.Ho = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.Ho, this.entityData.Ho);
		...
		public virtual System.String Ten
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.Ten, this.entityData.Ten);
				this.entityData.Ten = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.Ten, this.entityData.Ten);
		...
		public virtual System.String HoTen
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.HoTen, this.entityData.HoTen);
				this.entityData.HoTen = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.HoTen, this.entityData.HoTen);
		...
		public virtual System.Int32? MaHocHam
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.MaHocHam, this.entityData.MaHocHam);
				this.entityData.MaHocHam = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.MaHocHam, this.entityData.MaHocHam);
		...
		public virtual System.Int32? MaHocVi
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.MaHocVi, this.entityData.MaHocVi);
				this.entityData.MaHocVi = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.MaHocVi, this.entityData.MaHocVi);
		...
		public virtual System.Int32? MaLoaiGiangVien
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.MaLoaiGiangVien, this.entityData.MaLoaiGiangVien);
				this.entityData.MaLoaiGiangVien = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.MaLoaiGiangVien, this.entityData.MaLoaiGiangVien);
		...
		public virtual System.String MaDonVi
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.MaDonVi, this.entityData.MaDonVi);
				this.entityData.MaDonVi = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.MaDonVi, this.entityData.MaDonVi);
		...
		public virtual System.Decimal? DonGia
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.DonGia, this.entityData.DonGia);
				this.entityData.DonGia = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.DonGia, this.entityData.DonGia);
		...
		public virtual System.Decimal? TietQuyDoi
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.TietQuyDoi, this.entityData.TietQuyDoi);
				this.entityData.TietQuyDoi = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.TietQuyDoi, this.entityData.TietQuyDoi);
		...
		public virtual System.Decimal? ThanhTienDayChuNhat
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.ThanhTienDayChuNhat, this.entityData.ThanhTienDayChuNhat);
				this.entityData.ThanhTienDayChuNhat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.ThanhTienDayChuNhat, this.entityData.ThanhTienDayChuNhat);
		...
		public virtual System.Decimal? ThanhTien
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.ThanhTien, this.entityData.ThanhTien);
				this.entityData.ThanhTien = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.ThanhTien, this.entityData.ThanhTien);
		...
		public virtual System.Decimal? TongThanhTien
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.TongThanhTien, this.entityData.TongThanhTien);
				this.entityData.TongThanhTien = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.TongThanhTien, this.entityData.TongThanhTien);
		...
		public virtual System.DateTime? NgayCapNhat
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.NgayCapNhat, this.entityData.NgayCapNhat);
				this.entityData.NgayCapNhat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.NgayCapNhat, this.entityData.NgayCapNhat);
		...
		public virtual System.Boolean? DaChot
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.DaChot, this.entityData.DaChot);
				this.entityData.DaChot = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.DaChot, this.entityData.DaChot);
		...
		public virtual System.Decimal? HeSoHocKy
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.HeSoHocKy, this.entityData.HeSoHocKy);
				this.entityData.HeSoHocKy = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.HeSoHocKy, this.entityData.HeSoHocKy);
		...
		public virtual System.Decimal? SoGioThucGiangTrenLop
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.SoGioThucGiangTrenLop, this.entityData.SoGioThucGiangTrenLop);
				this.entityData.SoGioThucGiangTrenLop = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.SoGioThucGiangTrenLop, this.entityData.SoGioThucGiangTrenLop);
		...
		public virtual System.Decimal? SoGioChuanTinhThem
		{
			...
			set
			{
				...
				OnColumnChanging(UteThanhToanThuLaoColumn.SoGioChuanTinhThem, this.entityData.SoGioChuanTinhThem);
				this.entityData.SoGioChuanTinhThem = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UteThanhToanThuLaoColumn.SoGioChuanTinhThem, this.entityData.SoGioChuanTinhThem);
		...
		/// <summary>
		/// Gets or sets the source <see cref="UteKhoiLuongQuyDoi"/>.
		/// </summary>
		/// <value>The source UteKhoiLuongQuyDoi for IdKhoiLuongQuyDoi.</value>
        [XmlIgnore()]
		[Browsable(false), System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
		public virtual UteKhoiLuongQuyDoi IdKhoiLuongQuyDoiSource
      	{
		...
		{
			get { return "Ute_ThanhToanThuLao"; }
		}
		...
		void IEditableObject.BeginEdit() 
	    {
	        ...
	        if (!inTxn) 
	        {
	            this.backupData = this.entityData.Clone() as UteThanhToanThuLaoEntityData;
	            inTxn = true;
	        ...
	        if (this.inTxn) 
	        {
	        	...
	        	//if (this.EntityState == EntityState.Added)
	        	{
					if (this.parentCollection != null)
						this.parentCollection.Remove( (UteThanhToanThuLao) this ) ;
				}	            
	        }
	    ...
	    public override object ParentCollection
	    {
	        ...
	        set 
	        {
	            this.parentCollection = value as TList<UteThanhToanThuLao>;
	        }
	    }
	    ...
	    private void OnEntityChanged() 
	    {
	        ...
	        {
	            this.parentCollection.EntityChanged(this as UteThanhToanThuLao);
	        }
	    }
		...
		///<summary>
		///  Returns a Typed UteThanhToanThuLao Entity 
		///</summary>
		protected virtual UteThanhToanThuLao Copy(IDictionary existingCopies)
		{
			...
			//shallow copy entity
			UteThanhToanThuLao copy = new UteThanhToanThuLao();
			...
			if (this.IdKhoiLuongQuyDoiSource != null && existingCopies.Contains(this.IdKhoiLuongQuyDoiSource))
				copy.IdKhoiLuongQuyDoiSource = existingCopies[this.IdKhoiLuongQuyDoiSource] as UteKhoiLuongQuyDoi;
			else
				copy.IdKhoiLuongQuyDoiSource = MakeCopyOf(this.IdKhoiLuongQuyDoiSource, existingCopies) as UteKhoiLuongQuyDoi;
		...
		///  Returns a Typed UteThanhToanThuLao Entity 
		///</summary>
		public virtual UteThanhToanThuLao Copy()
		{
		...
		///<summary>
		///  Returns a Typed UteThanhToanThuLao Entity which is a deep copy of the current entity.
		///</summary>
		public virtual UteThanhToanThuLao DeepCopy()
		{
			return EntityHelper.Clone<UteThanhToanThuLao>(this as UteThanhToanThuLao);	
		}
		#endregion
		...
		public override void CancelChanges()
		{
			...
			{
				this.entityData = this._originalData.Clone() as UteThanhToanThuLaoEntityData;
			}
			else
			{
		...
		public override void AcceptChanges()
		{
			...
			this._originalData = this.entityData.Clone() as UteThanhToanThuLaoEntityData;
		}
		...
		{
			return 	IsPropertyChanged(EntityHelper.GetEnumValue< UteThanhToanThuLaoColumn >(columnName));
		}
		...
		///<summary>
		///  Returns a UteThanhToanThuLao Entity with the original data.
		///</summary>
		public UteThanhToanThuLao GetOriginalEntity()
		{
			if (_originalData != null)
				return CreateUteThanhToanThuLao(
			...
			return (UteThanhToanThuLao)this.Clone();
		}
		#endregion
	...
	#region Value Semantics Instance Equality
        ...
        ///<returns>true if Object1 is a <see cref="UteThanhToanThuLaoBase"/> and has the same value as this instance; otherwise, false.</returns>
        public override bool Equals(object Object1)
        {
			// Cast exception if Object1 is null or DbNull
			if (Object1 != null && Object1 != DBNull.Value && Object1 is UteThanhToanThuLaoBase)
				return ValueEquals(this, (UteThanhToanThuLaoBase)Object1);
			else
				return false;
        }
        ...
        /// Provides a hash function that is appropriate for <see cref="UteThanhToanThuLaoBase"/> class 
		...
		///<returns>true if toObject is a <see cref="UteThanhToanThuLaoBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(UteThanhToanThuLaoBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="UteThanhToanThuLaoBase"/> instances are considered equal using value semantics.
		///</summary>
		///<param name="Object1">The first <see cref="UteThanhToanThuLaoBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="UteThanhToanThuLaoBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool ValueEquals(UteThanhToanThuLaoBase Object1, UteThanhToanThuLaoBase Object2)
		{
			// both are null
		...
		public virtual int CompareTo(object obj)
		{
			...
			//return this. GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]) .CompareTo(((UteThanhToanThuLaoBase)obj).GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]));
		}
		
		/*
		// static method to get a Comparer object
        public static UteThanhToanThuLaoComparer GetComparer()
        {
            return new UteThanhToanThuLaoComparer();
        }
        */

        // Comparer delegates back to UteThanhToanThuLao
...
/*
        ...
        public int CompareTo(UteThanhToanThuLao rhs, UteThanhToanThuLaoColumn which)
        {
            switch (which)
            {
        ...
        */
		...
		#region IEntityKey<UteThanhToanThuLaoKey> Members
		
		// member variable for the EntityId property
		private UteThanhToanThuLaoKey _entityId;

		/// <summary>
		/// Gets or sets the EntityId property.
		/// </summary>
		[XmlIgnore]
		public virtual UteThanhToanThuLaoKey EntityId
		{
			get
			{
				if ( _entityId == null )
				{
					_entityId = new UteThanhToanThuLaoKey(this);
				}
		...
		public override string EntityTrackingKey
		{
			get
			{
				if(entityTrackingKey == null)
					entityTrackingKey = new System.Text.StringBuilder("UteThanhToanThuLao")
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{36}{35}- IdKhoiLuongQuyDoi: {0}{35}- MaMonHoc: {1}{35}- TenMonHoc: {2}{35}- NhomMonHoc: {3}{35}- NamHoc: {4}{35}- HocKy: {5}{35}- MaLopHocPhan: {6}{35}- Nhom: {7}{35}- MaLop: {8}{35}- SoTinChi: {9}{35}- SoTiet: {10}{35}- SiSo: {11}{35}- LopClc: {12}{35}- SoTietDayChuNhat: {13}{35}- MaLoaiHocPhan: {14}{35}- HeSoLopDongLyThuyet: {15}{35}- HeSoLopDongThTnTt: {16}{35}- MaQuanLy: {17}{35}- Ho: {18}{35}- Ten: {19}{35}- HoTen: {20}{35}- MaHocHam: {21}{35}- MaHocVi: {22}{35}- MaLoaiGiangVien: {23}{35}- MaDonVi: {24}{35}- DonGia: {25}{35}- TietQuyDoi: {26}{35}- ThanhTienDayChuNhat: {27}{35}- ThanhTien: {28}{35}- TongThanhTien: {29}{35}- NgayCapNhat: {30}{35}- DaChot: {31}{35}- HeSoHocKy: {32}{35}- SoGioThucGiangTrenLop: {33}{35}- SoGioChuanTinhThem: {34}{35}{37}", 
	...
	/// <summary>
	///		The data structure representation of the 'Ute_ThanhToanThuLao' table.
	/// </summary>
	/// <remarks>
	...
	[Serializable]
	internal protected class UteThanhToanThuLaoEntityData : ICloneable, ICloneableEx
	{
		#region Variable Declarations
		...
		private UteKhoiLuongQuyDoi _idKhoiLuongQuyDoiSource = null;
		...
		public Object Clone()
		{
			UteThanhToanThuLaoEntityData _tmp = new UteThanhToanThuLaoEntityData();
			...
			if (this.IdKhoiLuongQuyDoiSource != null)
				_tmp.IdKhoiLuongQuyDoiSource = MakeCopyOf(this.IdKhoiLuongQuyDoiSource) as UteKhoiLuongQuyDoi;
			#endregion
		...
		public object Clone(IDictionary existingCopies)
		{
			...
			#region Source Parent Composite Entities
			if (this.IdKhoiLuongQuyDoiSource != null && existingCopies.Contains(this.IdKhoiLuongQuyDoiSource))
				_tmp.IdKhoiLuongQuyDoiSource = existingCopies[this.IdKhoiLuongQuyDoiSource] as UteKhoiLuongQuyDoi;
			else
				_tmp.IdKhoiLuongQuyDoiSource = MakeCopyOf(this.IdKhoiLuongQuyDoiSource, existingCopies) as UteKhoiLuongQuyDoi;
			#endregion
		...
		/// </summary>
		/// <param name="column">The <see cref="UteThanhToanThuLaoColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanging(UteThanhToanThuLaoColumn column)
		{
		...
		/// </summary>
		/// <param name="column">The <see cref="UteThanhToanThuLaoColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanged(UteThanhToanThuLaoColumn column)
		{
		...
		public virtual void OnColumnChanging(UteThanhToanThuLaoColumn column, object value)
		{
			...
			if (!SuppressEntityEvents)
			{
				UteThanhToanThuLaoEventHandler handler = ColumnChanging;
				if(handler != null)
				{
					handler(this, new UteThanhToanThuLaoEventArgs(column, value));
				}
			}
		}
		...
		/// <param name="column">The <see cref="UteThanhToanThuLaoColumn"/> which has raised the event.</param>
		/// <param name="value">The changed value.</param>
		public virtual void OnColumnChanged(UteThanhToanThuLaoColumn column, object value)
		{
			if (!SuppressEntityEvents)
			{
				UteThanhToanThuLaoEventHandler handler = ColumnChanged;
				if(handler != null)
				{
					handler(this, new UteThanhToanThuLaoEventArgs(column, value));
				}
	...
	#region UteThanhToanThuLaoEventArgs class
	/// <summary>
	/// Provides data for the ColumnChanging and ColumnChanged events.
	/// </summary>
	/// <remarks>
	/// The ColumnChanging and ColumnChanged events occur when a change is made to the value 
	/// of a property of a <see cref="UteThanhToanThuLao"/> object.
	/// </remarks>
	public class UteThanhToanThuLaoEventArgs : System.EventArgs
	{
		private UteThanhToanThuLaoColumn column;
		private object value;
		
		///<summary>
		/// Initalizes a new Instance of the UteThanhToanThuLaoEventArgs class.
		///</summary>
		public UteThanhToanThuLaoEventArgs(UteThanhToanThuLaoColumn column)
		{
			this.column = column;
		}
		...
		/// Initalizes a new Instance of the UteThanhToanThuLaoEventArgs class.
		///</summary>
		public UteThanhToanThuLaoEventArgs(UteThanhToanThuLaoColumn column, object value)
		{
			this.column = column;
			this.value = value;
		}
		...
		///<summary>
		/// The UteThanhToanThuLaoColumn that was modified, which has raised the event.
		///</summary>
		///<value cref="UteThanhToanThuLaoColumn" />
		public UteThanhToanThuLaoColumn Column { get { return this.column; } }
	...
	///<summary>
	/// Define a delegate for all UteThanhToanThuLao related events.
	///</summary>
	public delegate void UteThanhToanThuLaoEventHandler(object sender, UteThanhToanThuLaoEventArgs e);
	
	#region UteThanhToanThuLaoComparer
		
	/// <summary>
	///	Strongly Typed IComparer
	/// </summary>
	public class UteThanhToanThuLaoComparer : System.Collections.Generic.IComparer<UteThanhToanThuLao>
	{
		UteThanhToanThuLaoColumn whichComparison;
		
		/// <summary>
        /// Initializes a new instance of the <see cref="T:UteThanhToanThuLaoComparer"/> class.
        /// </summary>
		public UteThanhToanThuLaoComparer()
        {            
        }               
        ...
        public UteThanhToanThuLaoComparer(UteThanhToanThuLaoColumn column)
        {
            this.whichComparison = column;
        }

		/// <summary>
        /// Determines whether the specified <see cref="UteThanhToanThuLao"/> instances are considered equal.
        /// </summary>
        /// <param name="a">The first <see cref="UteThanhToanThuLao"/> to compare.</param>
        /// <param name="b">The second <c>UteThanhToanThuLao</c> to compare.</param>
        /// <returns>true if objA is the same instance as objB or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
        public bool Equals(UteThanhToanThuLao a, UteThanhToanThuLao b)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(UteThanhToanThuLao entity)
        {
        ...
        /// <returns></returns>
        public int Compare(UteThanhToanThuLao a, UteThanhToanThuLao b)
        {
        ...
        public UteThanhToanThuLaoColumn WhichComparison
        {
	...
	#region UteThanhToanThuLaoKey Class

	/// <summary>
	/// Wraps the unique identifier values for the <see cref="UteThanhToanThuLao"/> object.
	/// </summary>
	[Serializable]
	[CLSCompliant(true)]
	public class UteThanhToanThuLaoKey : EntityKeyBase
	{
		#region Constructors
		
		/// <summary>
		/// Initializes a new instance of the UteThanhToanThuLaoKey class.
		/// </summary>
		public UteThanhToanThuLaoKey()
		{
		}
		...
		/// Initializes a new instance of the UteThanhToanThuLaoKey class.
		/// </summary>
		public UteThanhToanThuLaoKey(UteThanhToanThuLaoBase entity)
		{
			this.Entity = entity;
		...
		/// Initializes a new instance of the UteThanhToanThuLaoKey class.
		/// </summary>
		public UteThanhToanThuLaoKey(System.Int32 _idKhoiLuongQuyDoi)
		{
			#region Init Properties
		...
		private UteThanhToanThuLaoBase _entity;
		
		/// <summary>
		/// Gets or sets the Entity property.
		/// </summary>
		public UteThanhToanThuLaoBase Entity
		{
			get { return _entity; }
			set { _entity = value; }
		}
	...
	#region UteThanhToanThuLaoColumn Enum
	
	/// <summary>
	/// Enumerate the UteThanhToanThuLao columns.
	/// </summary>
	[Serializable]
	public enum UteThanhToanThuLaoColumn : int
	{
		/// <summary>
		/// IdKhoiLuongQuyDoi : 
		/// </summary>
	...
	#endregion UteThanhToanThuLaoColumn Enum
