...
/*
	...
	Important: Do not modify this file. Edit the file MonPhanCongNhieuGiangVien.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'MonPhanCongNhieuGiangVien' table. [No description found the database]	
	///</summary>
	[Serializable]
	[DataObject, CLSCompliant(true)]
	public abstract partial class MonPhanCongNhieuGiangVienBase : EntityBase, IMonPhanCongNhieuGiangVien, IEntityId<MonPhanCongNhieuGiangVienKey>, System.IComparable, System.ICloneable, ICloneableEx, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		/// </summary>
		private MonPhanCongNhieuGiangVienEntityData entityData;
		
		/// <summary>
		/// 	Hold the original data of the entity, as loaded from the repository.
		/// </summary>
		private MonPhanCongNhieuGiangVienEntityData _originalData;
		
		/// <summary>
		/// 	Hold a backup of the inner data of the entity.
		/// </summary>
		private MonPhanCongNhieuGiangVienEntityData backupData; 
		...
		[NonSerialized]
		private TList<MonPhanCongNhieuGiangVien> parentCollection;
		...
		/// </summary>
		[field:NonSerialized]
		public event MonPhanCongNhieuGiangVienEventHandler ColumnChanging;		
		
		/// <summary>
		/// Occurs after a value has been changed for the specified column.
		/// </summary>
		[field:NonSerialized]
		public event MonPhanCongNhieuGiangVienEventHandler ColumnChanged;
		
		#endregion Variable Declarations
		
		#region Constructors
		///<summary>
		/// Creates a new <see cref="MonPhanCongNhieuGiangVienBase"/> instance.
		///</summary>
		public MonPhanCongNhieuGiangVienBase()
		{
			this.entityData = new MonPhanCongNhieuGiangVienEntityData();
		...
		public MonPhanCongNhieuGiangVienBase(System.String _maMonHoc, System.String _tenMonHoc, 
		...
		///<summary>
		/// A simple factory method to create a new <see cref="MonPhanCongNhieuGiangVien"/> instance.
		///</summary>
		///<param name="_maMonHoc"></param>
		///<param name="_tenMonHoc"></param>
		///<param name="_nhomMonHoc"></param>
		...
		///<param name="_nhom"></param>
		///<param name="_ngayCapNhat"></param>
		public static MonPhanCongNhieuGiangVien CreateMonPhanCongNhieuGiangVien(System.String _maMonHoc, System.String _tenMonHoc, 
			System.String _nhomMonHoc, System.String _maHocPhan, System.String _namHoc, 
			System.String _hocKy, System.String _maLopHocPhan, System.String _maLop, 
			System.String _maGiangVienQuanLy, System.Int32? _soTinChi, System.Int32? _siSo, 
			System.Boolean? _lopClc, System.Int32? _soTietDayChuNhat, System.Int32? _soTiet, 
			...
			System.Int32? _maHocVi, System.String _nhom, System.DateTime? _ngayCapNhat)
		{
			MonPhanCongNhieuGiangVien newMonPhanCongNhieuGiangVien = new MonPhanCongNhieuGiangVien();
			newMonPhanCongNhieuGiangVien.MaMonHoc = _maMonHoc;
			newMonPhanCongNhieuGiangVien.TenMonHoc = _tenMonHoc;
			newMonPhanCongNhieuGiangVien.NhomMonHoc = _nhomMonHoc;
			newMonPhanCongNhieuGiangVien.MaHocPhan = _maHocPhan;
			newMonPhanCongNhieuGiangVien.NamHoc = _namHoc;
			newMonPhanCongNhieuGiangVien.HocKy = _hocKy;
			newMonPhanCongNhieuGiangVien.MaLopHocPhan = _maLopHocPhan;
			newMonPhanCongNhieuGiangVien.MaLop = _maLop;
			newMonPhanCongNhieuGiangVien.MaGiangVienQuanLy = _maGiangVienQuanLy;
			newMonPhanCongNhieuGiangVien.SoTinChi = _soTinChi;
			newMonPhanCongNhieuGiangVien.SiSo = _siSo;
			newMonPhanCongNhieuGiangVien.LopClc = _lopClc;
			newMonPhanCongNhieuGiangVien.SoTietDayChuNhat = _soTietDayChuNhat;
			newMonPhanCongNhieuGiangVien.SoTiet = _soTiet;
			newMonPhanCongNhieuGiangVien.MaLoaiHocPhan = _maLoaiHocPhan;
			newMonPhanCongNhieuGiangVien.MaLoaiGiangVien = _maLoaiGiangVien;
			newMonPhanCongNhieuGiangVien.MaHocHam = _maHocHam;
			newMonPhanCongNhieuGiangVien.MaHocVi = _maHocVi;
			newMonPhanCongNhieuGiangVien.Nhom = _nhom;
			newMonPhanCongNhieuGiangVien.NgayCapNhat = _ngayCapNhat;
			return newMonPhanCongNhieuGiangVien;
		}
		...
		public virtual System.Int32 Id
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.Id, this.entityData.Id);
				this.entityData.Id = value;
				this.EntityId.Id = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.Id, this.entityData.Id);
		...
		public virtual System.String MaMonHoc
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.MaMonHoc, this.entityData.MaMonHoc);
				this.entityData.MaMonHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.MaMonHoc, this.entityData.MaMonHoc);
		...
		public virtual System.String TenMonHoc
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.TenMonHoc, this.entityData.TenMonHoc);
				this.entityData.TenMonHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.TenMonHoc, this.entityData.TenMonHoc);
		...
		public virtual System.String NhomMonHoc
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.NhomMonHoc, this.entityData.NhomMonHoc);
				this.entityData.NhomMonHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.NhomMonHoc, this.entityData.NhomMonHoc);
		...
		public virtual System.String MaHocPhan
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.MaHocPhan, this.entityData.MaHocPhan);
				this.entityData.MaHocPhan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.MaHocPhan, this.entityData.MaHocPhan);
		...
		public virtual System.String NamHoc
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.NamHoc, this.entityData.NamHoc);
				this.entityData.NamHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.NamHoc, this.entityData.NamHoc);
		...
		public virtual System.String HocKy
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.HocKy, this.entityData.HocKy);
				this.entityData.HocKy = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.HocKy, this.entityData.HocKy);
		...
		public virtual System.String MaLopHocPhan
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.MaLopHocPhan, this.entityData.MaLopHocPhan);
				this.entityData.MaLopHocPhan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.MaLopHocPhan, this.entityData.MaLopHocPhan);
		...
		public virtual System.String MaLop
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.MaLop, this.entityData.MaLop);
				this.entityData.MaLop = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.MaLop, this.entityData.MaLop);
		...
		public virtual System.String MaGiangVienQuanLy
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.MaGiangVienQuanLy, this.entityData.MaGiangVienQuanLy);
				this.entityData.MaGiangVienQuanLy = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.MaGiangVienQuanLy, this.entityData.MaGiangVienQuanLy);
		...
		public virtual System.Int32? SoTinChi
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.SoTinChi, this.entityData.SoTinChi);
				this.entityData.SoTinChi = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.SoTinChi, this.entityData.SoTinChi);
		...
		public virtual System.Int32? SiSo
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.SiSo, this.entityData.SiSo);
				this.entityData.SiSo = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.SiSo, this.entityData.SiSo);
		...
		public virtual System.Boolean? LopClc
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.LopClc, this.entityData.LopClc);
				this.entityData.LopClc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.LopClc, this.entityData.LopClc);
		...
		public virtual System.Int32? SoTietDayChuNhat
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.SoTietDayChuNhat, this.entityData.SoTietDayChuNhat);
				this.entityData.SoTietDayChuNhat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.SoTietDayChuNhat, this.entityData.SoTietDayChuNhat);
		...
		public virtual System.Int32? SoTiet
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.SoTiet, this.entityData.SoTiet);
				this.entityData.SoTiet = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.SoTiet, this.entityData.SoTiet);
		...
		public virtual System.Int32? MaLoaiHocPhan
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.MaLoaiHocPhan, this.entityData.MaLoaiHocPhan);
				this.entityData.MaLoaiHocPhan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.MaLoaiHocPhan, this.entityData.MaLoaiHocPhan);
		...
		public virtual System.Int32? MaLoaiGiangVien
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.MaLoaiGiangVien, this.entityData.MaLoaiGiangVien);
				this.entityData.MaLoaiGiangVien = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.MaLoaiGiangVien, this.entityData.MaLoaiGiangVien);
		...
		public virtual System.Int32? MaHocHam
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.MaHocHam, this.entityData.MaHocHam);
				this.entityData.MaHocHam = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.MaHocHam, this.entityData.MaHocHam);
		...
		public virtual System.Int32? MaHocVi
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.MaHocVi, this.entityData.MaHocVi);
				this.entityData.MaHocVi = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.MaHocVi, this.entityData.MaHocVi);
		...
		public virtual System.String Nhom
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.Nhom, this.entityData.Nhom);
				this.entityData.Nhom = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.Nhom, this.entityData.Nhom);
		...
		public virtual System.DateTime? NgayCapNhat
		{
			...
			set
			{
				...
				OnColumnChanging(MonPhanCongNhieuGiangVienColumn.NgayCapNhat, this.entityData.NgayCapNhat);
				this.entityData.NgayCapNhat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(MonPhanCongNhieuGiangVienColumn.NgayCapNhat, this.entityData.NgayCapNhat);
		...
		{
			get { return "MonPhanCongNhieuGiangVien"; }
		}
		...
		void IEditableObject.BeginEdit() 
	    {
	        ...
	        if (!inTxn) 
	        {
	            this.backupData = this.entityData.Clone() as MonPhanCongNhieuGiangVienEntityData;
	            inTxn = true;
	        ...
	        if (this.inTxn) 
	        {
	        	...
	        	//if (this.EntityState == EntityState.Added)
	        	{
					if (this.parentCollection != null)
						this.parentCollection.Remove( (MonPhanCongNhieuGiangVien) this ) ;
				}	            
	        }
	    ...
	    public override object ParentCollection
	    {
	        ...
	        set 
	        {
	            this.parentCollection = value as TList<MonPhanCongNhieuGiangVien>;
	        }
	    }
	    ...
	    private void OnEntityChanged() 
	    {
	        ...
	        {
	            this.parentCollection.EntityChanged(this as MonPhanCongNhieuGiangVien);
	        }
	    }
		...
		///<summary>
		///  Returns a Typed MonPhanCongNhieuGiangVien Entity 
		///</summary>
		protected virtual MonPhanCongNhieuGiangVien Copy(IDictionary existingCopies)
		{
			...
			//shallow copy entity
			MonPhanCongNhieuGiangVien copy = new MonPhanCongNhieuGiangVien();
		...
		///  Returns a Typed MonPhanCongNhieuGiangVien Entity 
		///</summary>
		public virtual MonPhanCongNhieuGiangVien Copy()
		{
		...
		///<summary>
		///  Returns a Typed MonPhanCongNhieuGiangVien Entity which is a deep copy of the current entity.
		///</summary>
		public virtual MonPhanCongNhieuGiangVien DeepCopy()
		{
			return EntityHelper.Clone<MonPhanCongNhieuGiangVien>(this as MonPhanCongNhieuGiangVien);	
		}
		#endregion
		...
		public override void CancelChanges()
		{
			...
			{
				this.entityData = this._originalData.Clone() as MonPhanCongNhieuGiangVienEntityData;
			}
			else
			{
		...
		public override void AcceptChanges()
		{
			...
			this._originalData = this.entityData.Clone() as MonPhanCongNhieuGiangVienEntityData;
		}
		...
		/// </returns>
		public bool IsPropertyChanged(MonPhanCongNhieuGiangVienColumn column)
		{
			switch(column)
			{
					case MonPhanCongNhieuGiangVienColumn.Id:
					return entityData.Id != _originalData.Id;
					case MonPhanCongNhieuGiangVienColumn.MaMonHoc:
					return entityData.MaMonHoc != _originalData.MaMonHoc;
					case MonPhanCongNhieuGiangVienColumn.TenMonHoc:
					return entityData.TenMonHoc != _originalData.TenMonHoc;
					case MonPhanCongNhieuGiangVienColumn.NhomMonHoc:
					return entityData.NhomMonHoc != _originalData.NhomMonHoc;
					case MonPhanCongNhieuGiangVienColumn.MaHocPhan:
					return entityData.MaHocPhan != _originalData.MaHocPhan;
					case MonPhanCongNhieuGiangVienColumn.NamHoc:
					return entityData.NamHoc != _originalData.NamHoc;
					case MonPhanCongNhieuGiangVienColumn.HocKy:
					return entityData.HocKy != _originalData.HocKy;
					case MonPhanCongNhieuGiangVienColumn.MaLopHocPhan:
					return entityData.MaLopHocPhan != _originalData.MaLopHocPhan;
					case MonPhanCongNhieuGiangVienColumn.MaLop:
					return entityData.MaLop != _originalData.MaLop;
					case MonPhanCongNhieuGiangVienColumn.MaGiangVienQuanLy:
					return entityData.MaGiangVienQuanLy != _originalData.MaGiangVienQuanLy;
					case MonPhanCongNhieuGiangVienColumn.SoTinChi:
					return entityData.SoTinChi != _originalData.SoTinChi;
					case MonPhanCongNhieuGiangVienColumn.SiSo:
					return entityData.SiSo != _originalData.SiSo;
					case MonPhanCongNhieuGiangVienColumn.LopClc:
					return entityData.LopClc != _originalData.LopClc;
					case MonPhanCongNhieuGiangVienColumn.SoTietDayChuNhat:
					return entityData.SoTietDayChuNhat != _originalData.SoTietDayChuNhat;
					case MonPhanCongNhieuGiangVienColumn.SoTiet:
					return entityData.SoTiet != _originalData.SoTiet;
					case MonPhanCongNhieuGiangVienColumn.MaLoaiHocPhan:
					return entityData.MaLoaiHocPhan != _originalData.MaLoaiHocPhan;
					case MonPhanCongNhieuGiangVienColumn.MaLoaiGiangVien:
					return entityData.MaLoaiGiangVien != _originalData.MaLoaiGiangVien;
					case MonPhanCongNhieuGiangVienColumn.MaHocHam:
					return entityData.MaHocHam != _originalData.MaHocHam;
					case MonPhanCongNhieuGiangVienColumn.MaHocVi:
					return entityData.MaHocVi != _originalData.MaHocVi;
					case MonPhanCongNhieuGiangVienColumn.Nhom:
					return entityData.Nhom != _originalData.Nhom;
					case MonPhanCongNhieuGiangVienColumn.NgayCapNhat:
		...
		{
			return 	IsPropertyChanged(EntityHelper.GetEnumValue< MonPhanCongNhieuGiangVienColumn >(columnName));
		}
		...
		///<summary>
		///  Returns a MonPhanCongNhieuGiangVien Entity with the original data.
		///</summary>
		public MonPhanCongNhieuGiangVien GetOriginalEntity()
		{
			if (_originalData != null)
				return CreateMonPhanCongNhieuGiangVien(
			...
			return (MonPhanCongNhieuGiangVien)this.Clone();
		}
		#endregion
	...
	#region Value Semantics Instance Equality
        ...
        ///<returns>true if Object1 is a <see cref="MonPhanCongNhieuGiangVienBase"/> and has the same value as this instance; otherwise, false.</returns>
        public override bool Equals(object Object1)
        {
			// Cast exception if Object1 is null or DbNull
			if (Object1 != null && Object1 != DBNull.Value && Object1 is MonPhanCongNhieuGiangVienBase)
				return ValueEquals(this, (MonPhanCongNhieuGiangVienBase)Object1);
			else
				return false;
        }
        ...
        /// Provides a hash function that is appropriate for <see cref="MonPhanCongNhieuGiangVienBase"/> class 
		...
		///<returns>true if toObject is a <see cref="MonPhanCongNhieuGiangVienBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(MonPhanCongNhieuGiangVienBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="MonPhanCongNhieuGiangVienBase"/> instances are considered equal using value semantics.
		///</summary>
		///<param name="Object1">The first <see cref="MonPhanCongNhieuGiangVienBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="MonPhanCongNhieuGiangVienBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool ValueEquals(MonPhanCongNhieuGiangVienBase Object1, MonPhanCongNhieuGiangVienBase Object2)
		{
			// both are null
		...
		public virtual int CompareTo(object obj)
		{
			...
			//return this. GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]) .CompareTo(((MonPhanCongNhieuGiangVienBase)obj).GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]));
		}
		
		/*
		// static method to get a Comparer object
        public static MonPhanCongNhieuGiangVienComparer GetComparer()
        {
            return new MonPhanCongNhieuGiangVienComparer();
        }
        */

        // Comparer delegates back to MonPhanCongNhieuGiangVien
...
/*
        ...
        public int CompareTo(MonPhanCongNhieuGiangVien rhs, MonPhanCongNhieuGiangVienColumn which)
        {
            switch (which)
            {
        ...
        */
		...
		#region IEntityKey<MonPhanCongNhieuGiangVienKey> Members
		
		// member variable for the EntityId property
		private MonPhanCongNhieuGiangVienKey _entityId;

		/// <summary>
		/// Gets or sets the EntityId property.
		/// </summary>
		[XmlIgnore]
		public virtual MonPhanCongNhieuGiangVienKey EntityId
		{
			get
			{
				if ( _entityId == null )
				{
					_entityId = new MonPhanCongNhieuGiangVienKey(this);
				}
		...
		public override string EntityTrackingKey
		{
			get
			{
				if(entityTrackingKey == null)
					entityTrackingKey = new System.Text.StringBuilder("MonPhanCongNhieuGiangVien")
	...
	/// <summary>
	///		The data structure representation of the 'MonPhanCongNhieuGiangVien' table.
	/// </summary>
	/// <remarks>
	...
	[Serializable]
	internal protected class MonPhanCongNhieuGiangVienEntityData : ICloneable, ICloneableEx
	{
		#region Variable Declarations
		...
		/// Id : 
		/// </summary>
		/// <remarks>Member of the primary key of the underlying table "MonPhanCongNhieuGiangVien"</remarks>
		...
		public Object Clone()
		{
			MonPhanCongNhieuGiangVienEntityData _tmp = new MonPhanCongNhieuGiangVienEntityData();
		...
		/// </summary>
		/// <param name="column">The <see cref="MonPhanCongNhieuGiangVienColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanging(MonPhanCongNhieuGiangVienColumn column)
		{
		...
		/// </summary>
		/// <param name="column">The <see cref="MonPhanCongNhieuGiangVienColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanged(MonPhanCongNhieuGiangVienColumn column)
		{
		...
		public virtual void OnColumnChanging(MonPhanCongNhieuGiangVienColumn column, object value)
		{
			...
			if (!SuppressEntityEvents)
			{
				MonPhanCongNhieuGiangVienEventHandler handler = ColumnChanging;
				if(handler != null)
				{
					handler(this, new MonPhanCongNhieuGiangVienEventArgs(column, value));
				}
			}
		}
		...
		/// <param name="column">The <see cref="MonPhanCongNhieuGiangVienColumn"/> which has raised the event.</param>
		/// <param name="value">The changed value.</param>
		public virtual void OnColumnChanged(MonPhanCongNhieuGiangVienColumn column, object value)
		{
			if (!SuppressEntityEvents)
			{
				MonPhanCongNhieuGiangVienEventHandler handler = ColumnChanged;
				if(handler != null)
				{
					handler(this, new MonPhanCongNhieuGiangVienEventArgs(column, value));
				}
	...
	#region MonPhanCongNhieuGiangVienEventArgs class
	/// <summary>
	/// Provides data for the ColumnChanging and ColumnChanged events.
	/// </summary>
	/// <remarks>
	/// The ColumnChanging and ColumnChanged events occur when a change is made to the value 
	/// of a property of a <see cref="MonPhanCongNhieuGiangVien"/> object.
	/// </remarks>
	public class MonPhanCongNhieuGiangVienEventArgs : System.EventArgs
	{
		private MonPhanCongNhieuGiangVienColumn column;
		private object value;
		
		///<summary>
		/// Initalizes a new Instance of the MonPhanCongNhieuGiangVienEventArgs class.
		///</summary>
		public MonPhanCongNhieuGiangVienEventArgs(MonPhanCongNhieuGiangVienColumn column)
		{
			this.column = column;
		}
		...
		/// Initalizes a new Instance of the MonPhanCongNhieuGiangVienEventArgs class.
		///</summary>
		public MonPhanCongNhieuGiangVienEventArgs(MonPhanCongNhieuGiangVienColumn column, object value)
		{
			this.column = column;
			this.value = value;
		}
		...
		///<summary>
		/// The MonPhanCongNhieuGiangVienColumn that was modified, which has raised the event.
		///</summary>
		///<value cref="MonPhanCongNhieuGiangVienColumn" />
		public MonPhanCongNhieuGiangVienColumn Column { get { return this.column; } }
	...
	///<summary>
	/// Define a delegate for all MonPhanCongNhieuGiangVien related events.
	///</summary>
	public delegate void MonPhanCongNhieuGiangVienEventHandler(object sender, MonPhanCongNhieuGiangVienEventArgs e);
	
	#region MonPhanCongNhieuGiangVienComparer
		
	/// <summary>
	///	Strongly Typed IComparer
	/// </summary>
	public class MonPhanCongNhieuGiangVienComparer : System.Collections.Generic.IComparer<MonPhanCongNhieuGiangVien>
	{
		MonPhanCongNhieuGiangVienColumn whichComparison;
		
		/// <summary>
        /// Initializes a new instance of the <see cref="T:MonPhanCongNhieuGiangVienComparer"/> class.
        /// </summary>
		public MonPhanCongNhieuGiangVienComparer()
        {            
        }               
        ...
        public MonPhanCongNhieuGiangVienComparer(MonPhanCongNhieuGiangVienColumn column)
        {
            this.whichComparison = column;
        }

		/// <summary>
        /// Determines whether the specified <see cref="MonPhanCongNhieuGiangVien"/> instances are considered equal.
        /// </summary>
        /// <param name="a">The first <see cref="MonPhanCongNhieuGiangVien"/> to compare.</param>
        /// <param name="b">The second <c>MonPhanCongNhieuGiangVien</c> to compare.</param>
        /// <returns>true if objA is the same instance as objB or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
        public bool Equals(MonPhanCongNhieuGiangVien a, MonPhanCongNhieuGiangVien b)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(MonPhanCongNhieuGiangVien entity)
        {
        ...
        /// <returns></returns>
        public int Compare(MonPhanCongNhieuGiangVien a, MonPhanCongNhieuGiangVien b)
        {
        ...
        public MonPhanCongNhieuGiangVienColumn WhichComparison
        {
	...
	#region MonPhanCongNhieuGiangVienKey Class

	/// <summary>
	/// Wraps the unique identifier values for the <see cref="MonPhanCongNhieuGiangVien"/> object.
	/// </summary>
	[Serializable]
	[CLSCompliant(true)]
	public class MonPhanCongNhieuGiangVienKey : EntityKeyBase
	{
		#region Constructors
		
		/// <summary>
		/// Initializes a new instance of the MonPhanCongNhieuGiangVienKey class.
		/// </summary>
		public MonPhanCongNhieuGiangVienKey()
		{
		}
		...
		/// Initializes a new instance of the MonPhanCongNhieuGiangVienKey class.
		/// </summary>
		public MonPhanCongNhieuGiangVienKey(MonPhanCongNhieuGiangVienBase entity)
		{
			this.Entity = entity;
		...
		/// Initializes a new instance of the MonPhanCongNhieuGiangVienKey class.
		/// </summary>
		public MonPhanCongNhieuGiangVienKey(System.Int32 _id)
		{
			#region Init Properties
		...
		private MonPhanCongNhieuGiangVienBase _entity;
		
		/// <summary>
		/// Gets or sets the Entity property.
		/// </summary>
		public MonPhanCongNhieuGiangVienBase Entity
		{
			get { return _entity; }
			set { _entity = value; }
		}
	...
	#region MonPhanCongNhieuGiangVienColumn Enum
	
	/// <summary>
	/// Enumerate the MonPhanCongNhieuGiangVien columns.
	/// </summary>
	[Serializable]
	public enum MonPhanCongNhieuGiangVienColumn : int
	{
		/// <summary>
		/// Id : 
		/// </summary>
	...
	#endregion MonPhanCongNhieuGiangVienColumn Enum
