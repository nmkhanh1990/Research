...
namespace PMS.Entities
{
	...
	{		
		...
		public DonGiaBase(System.String _maQuanLy, System.Int32? _maLoaiGiangVien, System.Int32? _maHocHam, 
			...
			System.Decimal? _donGiaGdtc, System.Decimal? _donGiaDoAnClc)
		{
			this.entityData = new DonGiaEntityData();
			this.backupData = null;
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"Id", "MaQuanLy", "MaLoaiGiangVien", "MaHocHam", "MaHocVi", "DonGia", "NgayCapNhat", "NguoiCapNhat", "DonGiaClc", "HeSoQuyDoiChatLuong", "DonGiaTrongChuan", "DonGiaNgoaiChuan", "MaHinhThucDaoTao", "BacDaoTao", "NgonNguGiangDay", "NamHoc", "HocKy", "MaNhomMon", "NhomMonHoc", "DonGiaNgoaiNgu", "DonGiaGdtc", "DonGiaDoAnClc"};
			}
		}
		#endregion 
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{23}{22}- Id: {0}{22}- MaQuanLy: {1}{22}- MaLoaiGiangVien: {2}{22}- MaHocHam: {3}{22}- MaHocVi: {4}{22}- DonGia: {5}{22}- NgayCapNhat: {6}{22}- NguoiCapNhat: {7}{22}- DonGiaClc: {8}{22}- HeSoQuyDoiChatLuong: {9}{22}- DonGiaTrongChuan: {10}{22}- DonGiaNgoaiChuan: {11}{22}- MaHinhThucDaoTao: {12}{22}- BacDaoTao: {13}{22}- NgonNguGiangDay: {14}{22}- NamHoc: {15}{22}- HocKy: {16}{22}- MaNhomMon: {17}{22}- NhomMonHoc: {18}{22}- DonGiaNgoaiNgu: {19}{22}- DonGiaGdtc: {20}{22}- DonGiaDoAnClc: {21}{22}{24}", 
				this.Id,
