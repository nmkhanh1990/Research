...
{	
	...
	{		
		...
		public static TList<DinhMucGioChuanToiThieuTheoChucVu> Fill(IDataReader reader, TList<DinhMucGioChuanToiThieuTheoChucVu> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.NhomGiangVien = (reader[DinhMucGioChuanToiThieuTheoChucVuColumn.NhomGiangVien.ToString()] == DBNull.Value) ? null : (System.String)reader[(DinhMucGioChuanToiThieuTheoChucVuColumn.NhomGiangVien.ToString())];
					...
					c.SoTietNghiaVuNckh = (reader[DinhMucGioChuanToiThieuTheoChucVuColumn.SoTietNghiaVuNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DinhMucGioChuanToiThieuTheoChucVuColumn.SoTietNghiaVuNckh.ToString())];
					c.SoTietNghiaVuKhac = (reader[DinhMucGioChuanToiThieuTheoChucVuColumn.SoTietNghiaVuKhac.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DinhMucGioChuanToiThieuTheoChucVuColumn.SoTietNghiaVuKhac.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.DinhMucGioChuanToiThieuTheoChucVu entity)
		{
			...
			entity.NhomGiangVien = (reader[DinhMucGioChuanToiThieuTheoChucVuColumn.NhomGiangVien.ToString()] == DBNull.Value) ? null : (System.String)reader[(DinhMucGioChuanToiThieuTheoChucVuColumn.NhomGiangVien.ToString())];
			...
			entity.SoTietNghiaVuNckh = (reader[DinhMucGioChuanToiThieuTheoChucVuColumn.SoTietNghiaVuNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DinhMucGioChuanToiThieuTheoChucVuColumn.SoTietNghiaVuNckh.ToString())];
			entity.SoTietNghiaVuKhac = (reader[DinhMucGioChuanToiThieuTheoChucVuColumn.SoTietNghiaVuKhac.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(DinhMucGioChuanToiThieuTheoChucVuColumn.SoTietNghiaVuKhac.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.DinhMucGioChuanToiThieuTheoChucVu entity)
		{
			...
			entity.NhomGiangVien = Convert.IsDBNull(dataRow["NhomGiangVien"]) ? null : (System.String)dataRow["NhomGiangVien"];
			entity.IdQuyMo = Convert.IsDBNull(dataRow["IdQuyMo"]) ? null : (System.Int32?)dataRow["IdQuyMo"];
			entity.SoTietNghiaVuNckh = Convert.IsDBNull(dataRow["SoTietNghiaVuNckh"]) ? null : (System.Decimal?)dataRow["SoTietNghiaVuNckh"];
			entity.SoTietNghiaVuKhac = Convert.IsDBNull(dataRow["SoTietNghiaVuKhac"]) ? null : (System.Decimal?)dataRow["SoTietNghiaVuKhac"];
			entity.AcceptChanges();
		}
		#endregion 
