...
{	
	...
	{		
		...
		#region cust_KhoiLuongDoAnTotNghiepChiTiet_GetDoAnVaPhanBienByNamHocHocKy 
		
		/// <summary>
		///	This method wrap the 'cust_KhoiLuongDoAnTotNghiepChiTiet_GetDoAnVaPhanBienByNamHocHocKy' stored procedure. 
		/// </summary>
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader GetDoAnVaPhanBienByNamHocHocKy(System.String namHoc, System.String hocKy)
		{
			return GetDoAnVaPhanBienByNamHocHocKy(null, 0, int.MaxValue , namHoc, hocKy);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader GetDoAnVaPhanBienByNamHocHocKy(int start, int pageLength, System.String namHoc, System.String hocKy)
		{
			return GetDoAnVaPhanBienByNamHocHocKy(null, start, pageLength , namHoc, hocKy);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader GetDoAnVaPhanBienByNamHocHocKy(TransactionManager transactionManager, System.String namHoc, System.String hocKy)
		{
			return GetDoAnVaPhanBienByNamHocHocKy(transactionManager, 0, int.MaxValue , namHoc, hocKy);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public abstract IDataReader GetDoAnVaPhanBienByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy);
