...
{	
	...
	{		
		...
		public static TList<GiamTruDinhMuc> Fill(IDataReader reader, TList<GiamTruDinhMuc> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.PhanTramGiamTruNckh = (reader[GiamTruDinhMucColumn.PhanTramGiamTruNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(GiamTruDinhMucColumn.PhanTramGiamTruNckh.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.GiamTruDinhMuc entity)
		{
			...
			entity.PhanTramGiamTruNckh = (reader[GiamTruDinhMucColumn.PhanTramGiamTruNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(GiamTruDinhMucColumn.PhanTramGiamTruNckh.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.GiamTruDinhMuc entity)
		{
			...
			entity.PhanTramGiamTruNckh = Convert.IsDBNull(dataRow["PhanTramGiamTruNckh"]) ? null : (System.Decimal?)dataRow["PhanTramGiamTruNckh"];
			entity.AcceptChanges();
		}
		#endregion 
