...
{	
	...
	{		
		...
		#region cust_TietNghiaVu_GetByNamHocHocKy 
		
		/// <summary>
		///	This method wrap the 'cust_TietNghiaVu_GetByNamHocHocKy' stored procedure. 
		/// </summary>
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		...
		public static TList<TietNghiaVu> Fill(IDataReader reader, TList<TietNghiaVu> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.GhiChu = (reader[TietNghiaVuColumn.GhiChu.ToString()] == DBNull.Value) ? null : (System.String)reader[(TietNghiaVuColumn.GhiChu.ToString())];
					...
					c.DinhMucGiangDay = (reader[TietNghiaVuColumn.DinhMucGiangDay.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucGiangDay.ToString())];
					c.DinhMucNckh = (reader[TietNghiaVuColumn.DinhMucNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucNckh.ToString())];
					c.DinhMucKhac = (reader[TietNghiaVuColumn.DinhMucKhac.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucKhac.ToString())];
					...
					c.DinhMucTheoChucVu = (reader[TietNghiaVuColumn.DinhMucTheoChucVu.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucTheoChucVu.ToString())];
					c.GiamGioChuanTheoChucVu = (reader[TietNghiaVuColumn.GiamGioChuanTheoChucVu.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.GiamGioChuanTheoChucVu.ToString())];
					c.GiamGioChuanNckh = (reader[TietNghiaVuColumn.GiamGioChuanNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.GiamGioChuanNckh.ToString())];
					c.GiamGioChuanKhac = (reader[TietNghiaVuColumn.GiamGioChuanKhac.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.GiamGioChuanKhac.ToString())];
					c.DinhMucTgqlKiemNhiem = (reader[TietNghiaVuColumn.DinhMucTgqlKiemNhiem.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucTgqlKiemNhiem.ToString())];
					c.NoGioChuanGiangDay = (reader[TietNghiaVuColumn.NoGioChuanGiangDay.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.NoGioChuanGiangDay.ToString())];
					c.NoBaoLuuGioChuanNckh = (reader[TietNghiaVuColumn.NoBaoLuuGioChuanNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.NoBaoLuuGioChuanNckh.ToString())];
					c.NoGioChuanKhac = (reader[TietNghiaVuColumn.NoGioChuanKhac.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.NoGioChuanKhac.ToString())];
					c.TietNghiaVuKhac = (reader[TietNghiaVuColumn.TietNghiaVuKhac.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.TietNghiaVuKhac.ToString())];
					c.XacNhanChiTra = (reader[TietNghiaVuColumn.XacNhanChiTra.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(TietNghiaVuColumn.XacNhanChiTra.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.TietNghiaVu entity)
		{
			...
			entity.GhiChu = (reader[TietNghiaVuColumn.GhiChu.ToString()] == DBNull.Value) ? null : (System.String)reader[(TietNghiaVuColumn.GhiChu.ToString())];
			...
			entity.DinhMucGiangDay = (reader[TietNghiaVuColumn.DinhMucGiangDay.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucGiangDay.ToString())];
			entity.DinhMucNckh = (reader[TietNghiaVuColumn.DinhMucNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucNckh.ToString())];
			entity.DinhMucKhac = (reader[TietNghiaVuColumn.DinhMucKhac.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucKhac.ToString())];
			...
			entity.DinhMucTheoChucVu = (reader[TietNghiaVuColumn.DinhMucTheoChucVu.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucTheoChucVu.ToString())];
			entity.GiamGioChuanTheoChucVu = (reader[TietNghiaVuColumn.GiamGioChuanTheoChucVu.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.GiamGioChuanTheoChucVu.ToString())];
			entity.GiamGioChuanNckh = (reader[TietNghiaVuColumn.GiamGioChuanNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.GiamGioChuanNckh.ToString())];
			entity.GiamGioChuanKhac = (reader[TietNghiaVuColumn.GiamGioChuanKhac.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.GiamGioChuanKhac.ToString())];
			entity.DinhMucTgqlKiemNhiem = (reader[TietNghiaVuColumn.DinhMucTgqlKiemNhiem.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.DinhMucTgqlKiemNhiem.ToString())];
			entity.NoGioChuanGiangDay = (reader[TietNghiaVuColumn.NoGioChuanGiangDay.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.NoGioChuanGiangDay.ToString())];
			entity.NoBaoLuuGioChuanNckh = (reader[TietNghiaVuColumn.NoBaoLuuGioChuanNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.NoBaoLuuGioChuanNckh.ToString())];
			entity.NoGioChuanKhac = (reader[TietNghiaVuColumn.NoGioChuanKhac.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.NoGioChuanKhac.ToString())];
			entity.TietNghiaVuKhac = (reader[TietNghiaVuColumn.TietNghiaVuKhac.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(TietNghiaVuColumn.TietNghiaVuKhac.ToString())];
			entity.XacNhanChiTra = (reader[TietNghiaVuColumn.XacNhanChiTra.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(TietNghiaVuColumn.XacNhanChiTra.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.TietNghiaVu entity)
		{
			...
			entity.DinhMucKhac = Convert.IsDBNull(dataRow["DinhMucKhac"]) ? null : (System.Decimal?)dataRow["DinhMucKhac"];
			entity.TietGioiHan = Convert.IsDBNull(dataRow["TietGioiHan"]) ? null : (System.Decimal?)dataRow["TietGioiHan"];
			entity.DinhMucTheoChucVu = Convert.IsDBNull(dataRow["DinhMucTheoChucVu"]) ? null : (System.Decimal?)dataRow["DinhMucTheoChucVu"];
			entity.GiamGioChuanTheoChucVu = Convert.IsDBNull(dataRow["GiamGioChuanTheoChucVu"]) ? null : (System.Decimal?)dataRow["GiamGioChuanTheoChucVu"];
			entity.GiamGioChuanNckh = Convert.IsDBNull(dataRow["GiamGioChuanNCKH"]) ? null : (System.Decimal?)dataRow["GiamGioChuanNCKH"];
			entity.GiamGioChuanKhac = Convert.IsDBNull(dataRow["GiamGioChuanKhac"]) ? null : (System.Decimal?)dataRow["GiamGioChuanKhac"];
			entity.DinhMucTgqlKiemNhiem = Convert.IsDBNull(dataRow["DinhMucTGQLKiemNhiem"]) ? null : (System.Decimal?)dataRow["DinhMucTGQLKiemNhiem"];
			entity.NoGioChuanGiangDay = Convert.IsDBNull(dataRow["NoGioChuanGiangDay"]) ? null : (System.Decimal?)dataRow["NoGioChuanGiangDay"];
			entity.NoBaoLuuGioChuanNckh = Convert.IsDBNull(dataRow["NoBaoLuuGioChuanNCKH"]) ? null : (System.Decimal?)dataRow["NoBaoLuuGioChuanNCKH"];
			entity.NoGioChuanKhac = Convert.IsDBNull(dataRow["NoGioChuanKhac"]) ? null : (System.Decimal?)dataRow["NoGioChuanKhac"];
			entity.TietNghiaVuKhac = Convert.IsDBNull(dataRow["TietNghiaVuKhac"]) ? null : (System.Decimal?)dataRow["TietNghiaVuKhac"];
