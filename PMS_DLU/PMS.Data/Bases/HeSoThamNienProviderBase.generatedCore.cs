...
{	
	...
	{		
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key PK__HeSoTham__3214EC07E1DFDE4F index.
		/// </summary>
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the PK__HeSoTham__3214EC07E1DFDE4F index.
		/// </summary>
		/// <param name="_id"></param>
		/// <param name="start">Row number at which to start reading, the first row is 0.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		...
		#region cust_HeSoThamNien_GetByNamHocHocKy 
		
		/// <summary>
		///	This method wrap the 'cust_HeSoThamNien_GetByNamHocHocKy' stored procedure. 
		/// </summary>
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;HeSoThamNien&gt;"/> instance.</returns>
		public TList<HeSoThamNien> GetByNamHocHocKy(System.String namHoc, System.String hocKy)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;HeSoThamNien&gt;"/> instance.</returns>
		public TList<HeSoThamNien> GetByNamHocHocKy(int start, int pageLength, System.String namHoc, System.String hocKy)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;HeSoThamNien&gt;"/> instance.</returns>
		public TList<HeSoThamNien> GetByNamHocHocKy(TransactionManager transactionManager, System.String namHoc, System.String hocKy)
		{
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="TList&lt;HeSoThamNien&gt;"/> instance.</returns>
		public abstract TList<HeSoThamNien> GetByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy);
		...
		public static TList<HeSoThamNien> Fill(IDataReader reader, TList<HeSoThamNien> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.TuNam = (reader[HeSoThamNienColumn.TuNam.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(HeSoThamNienColumn.TuNam.ToString())];
					c.DenNam = (reader[HeSoThamNienColumn.DenNam.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(HeSoThamNienColumn.DenNam.ToString())];
					...
					c.HocKy = (reader[HeSoThamNienColumn.HocKy.ToString()] == DBNull.Value) ? null : (System.String)reader[(HeSoThamNienColumn.HocKy.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.HeSoThamNien entity)
		{
			...
			entity.TuNam = (reader[HeSoThamNienColumn.TuNam.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(HeSoThamNienColumn.TuNam.ToString())];
			entity.DenNam = (reader[HeSoThamNienColumn.DenNam.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(HeSoThamNienColumn.DenNam.ToString())];
			...
			entity.HocKy = (reader[HeSoThamNienColumn.HocKy.ToString()] == DBNull.Value) ? null : (System.String)reader[(HeSoThamNienColumn.HocKy.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.HeSoThamNien entity)
		{
			...
			entity.TuNam = Convert.IsDBNull(dataRow["TuNam"]) ? null : (System.Int32?)dataRow["TuNam"];
			entity.DenNam = Convert.IsDBNull(dataRow["DenNam"]) ? null : (System.Int32?)dataRow["DenNam"];
