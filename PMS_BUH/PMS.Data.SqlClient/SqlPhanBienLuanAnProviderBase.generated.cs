/*
	...
	Important: Do not modify this file. Edit the file SqlPhanBienLuanAnProvider.cs instead.
*/
...
{
	///<summary>
	/// This class is the SqlClient Data Access Logic Component implementation for the <see cref="PhanBienLuanAn"/> entity.
	///</summary>
	public abstract partial class SqlPhanBienLuanAnProviderBase : PhanBienLuanAnProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlPhanBienLuanAnProviderBase"/> instance.
		/// </summary>
		public SqlPhanBienLuanAnProviderBase()
		{
		}
	...
	public SqlPhanBienLuanAnProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int32 _maGiangVien, System.String _namHoc, System.String _hocKy, System.String _loai, System.String _maLopHocPhan)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_PhanBienLuanAn_Delete", _useStoredProcedure);
			...
			database.AddInParameter(commandWrapper, "@Loai", DbType.String, _loai);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(PhanBienLuanAn)
					,_maGiangVien,_namHoc,_hocKy,_loai,_maLopHocPhan);
		...
		/// <returns>Returns a typed collection of PMS.Entities.PhanBienLuanAn objects.</returns>
		public override TList<PhanBienLuanAn> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<PhanBienLuanAn>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_PhanBienLuanAn_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@DanhSachMon", DbType.String, DBNull.Value);
		database.AddInParameter(commandWrapper, "@MaLopHocPhan", DbType.AnsiString, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("danhsachmon ") || clause.Trim().StartsWith("danhsachmon="))
				{
					database.SetParameterValue(commandWrapper, "@DanhSachMon", 
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
			...
			//Create Collection
			TList<PhanBienLuanAn> rows = new TList<PhanBienLuanAn>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of PMS.Entities.PhanBienLuanAn objects.</returns>
		public override TList<PhanBienLuanAn> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_PhanBienLuanAn_Find_Dynamic", typeof(PhanBienLuanAnColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<PhanBienLuanAn> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_PhanBienLuanAn_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of PMS.Entities.PhanBienLuanAn objects.</returns>
		public override TList<PhanBienLuanAn> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_PhanBienLuanAn_GetPaged", _useStoredProcedure);
		...
		#region GetByMaGiangVienNamHocHocKyLoaiMaLopHocPhan
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override PMS.Entities.PhanBienLuanAn GetByMaGiangVienNamHocHocKyLoaiMaLopHocPhan(TransactionManager transactionManager, System.Int32 _maGiangVien, System.String _namHoc, System.String _hocKy, System.String _loai, System.String _maLopHocPhan, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_PhanBienLuanAn_GetByMaGiangVienNamHocHocKyLoaiMaLopHocPhan", _useStoredProcedure);
			...
			IDataReader reader = null;
			TList<PhanBienLuanAn> tmp = new TList<PhanBienLuanAn>();
			try
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByMaGiangVienNamHocHocKyLoaiMaLopHocPhan", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByMaGiangVienNamHocHocKyLoaiMaLopHocPhan", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.PhanBienLuanAn object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.PhanBienLuanAn> entities)
		{
			...
			bulkCopy.DestinationTableName = "PhanBienLuanAn";
			...
			DataColumn col5 = dataTable.Columns.Add("MaLoaiGiangVien", typeof(System.Int32));
			col5.AllowDBNull = true;		
			DataColumn col6 = dataTable.Columns.Add("SoLuong", typeof(System.Int32));
			...
			DataColumn col10 = dataTable.Columns.Add("TongThanhTien", typeof(System.Decimal));
			col10.AllowDBNull = true;		
			DataColumn col11 = dataTable.Columns.Add("NgayCapNhat", typeof(System.DateTime));
			col11.AllowDBNull = true;		
			DataColumn col12 = dataTable.Columns.Add("HeSoHocKy", typeof(System.Decimal));
			col12.AllowDBNull = true;		
			DataColumn col13 = dataTable.Columns.Add("Loai", typeof(System.String));
			col13.AllowDBNull = false;		
			DataColumn col14 = dataTable.Columns.Add("DanhSachMon", typeof(System.String));
			col14.AllowDBNull = true;		
			DataColumn col15 = dataTable.Columns.Add("MaLopHocPhan", typeof(System.String));
			...
			bulkCopy.ColumnMappings.Add("DanhSachMon", "DanhSachMon");
			bulkCopy.ColumnMappings.Add("MaLopHocPhan", "MaLopHocPhan");
			
			foreach(PMS.Entities.PhanBienLuanAn entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["DanhSachMon"] = entity.DanhSachMon;
		...
		/// <summary>
		/// 	Inserts a PMS.Entities.PhanBienLuanAn object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.PhanBienLuanAn object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the PMS.Entities.PhanBienLuanAn object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.PhanBienLuanAn entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_PhanBienLuanAn_Insert", _useStoredProcedure);
            ...
            database.AddInParameter(commandWrapper, "@DanhSachMon", DbType.String, entity.DanhSachMon );
			...
			entity.OriginalLoai = entity.Loai;
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">PMS.Entities.PhanBienLuanAn object to update.</param>
		/// <remarks>
		///		After updating the datasource, the PMS.Entities.PhanBienLuanAn object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, PMS.Entities.PhanBienLuanAn entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.sp_PhanBienLuanAn_Update", _useStoredProcedure);
			...
			database.AddInParameter(commandWrapper, "@HeSoHocKy", DbType.Decimal, (entity.HeSoHocKy.HasValue ? (object) entity.HeSoHocKy : System.DBNull.Value) );
            database.AddInParameter(commandWrapper, "@Loai", DbType.String, entity.Loai );
			database.AddInParameter(commandWrapper, "@OriginalLoai", DbType.String, entity.OriginalLoai);
            database.AddInParameter(commandWrapper, "@DanhSachMon", DbType.String, entity.DanhSachMon );
            database.AddInParameter(commandWrapper, "@MaLopHocPhan", DbType.AnsiString, entity.MaLopHocPhan );
		...
		/// <summary>
		///	This method wraps the 'cust_PhanBienLuanAn_Luu' stored procedure. 
		/// </summary>	
		...
		public override void Luu(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_PhanBienLuanAn_Luu", true);
