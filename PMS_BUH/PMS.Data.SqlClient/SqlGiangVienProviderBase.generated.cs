...
namespace PMS.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@MaQuanLyHrm", DbType.String, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("maquanlyhrm ") || clause.Trim().StartsWith("maquanlyhrm="))
				{
					database.SetParameterValue(commandWrapper, "@MaQuanLyHrm", 
						clause.Trim().Remove(0,11).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.GiangVien> entities)
		{
			...
			DataColumn col62 = dataTable.Columns.Add("MaQuanLyHRM", typeof(System.String));
			...
			bulkCopy.ColumnMappings.Add("MaQuanLyHRM", "MaQuanLyHRM");
			...
			foreach(PMS.Entities.GiangVien entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["MaQuanLyHRM"] = entity.MaQuanLyHrm;
		...
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.GiangVien entity)
		{
            ...
            database.AddInParameter(commandWrapper, "@MaQuanLyHrm", DbType.String, entity.MaQuanLyHrm );
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_GetThuMoiGiang' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="khoaDonVi"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader GetThuMoiGiang(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String khoaDonVi, System.String tenUserDangNhap)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_GetThuMoiGiang", true);
			
			database.AddInParameter(commandWrapper, "@NamHoc", DbType.AnsiString,  namHoc );
			database.AddInParameter(commandWrapper, "@HocKy", DbType.AnsiString,  hocKy );
			database.AddInParameter(commandWrapper, "@KhoaDonVi", DbType.AnsiString,  khoaDonVi );
			database.AddInParameter(commandWrapper, "@TenUserDangNhap", DbType.AnsiString,  tenUserDangNhap );
	
			
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "GetThuMoiGiang", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "GetThuMoiGiang", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_HoatDongNgoaiGiangDay_GetDanhSachThanhToanChamThiTayHai' stored procedure. 
		/// </summary>	
		/// <param name="xmlData"> A <c>System.String</c> instance.</param>
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader HoatDongNgoaiGiangDay_GetDanhSachThanhToanChamThiTayHai(TransactionManager transactionManager, int start, int pageLength , System.String xmlData, System.String namHoc, System.String hocKy, System.String maDonVi, System.String maHoatDong)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_HoatDongNgoaiGiangDay_GetDanhSachThanhToanChamThiTayHai", true);
			...
			database.AddInParameter(commandWrapper, "@MaHoatDong", DbType.String,  maHoatDong );
	
			
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "HoatDongNgoaiGiangDay_GetDanhSachThanhToanChamThiTayHai", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "HoatDongNgoaiGiangDay_GetDanhSachThanhToanChamThiTayHai", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_PhucCap_GetByNamHocHocKy' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader PhucCap_GetByNamHocHocKy(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String donVi)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_PhucCap_GetByNamHocHocKy", true);
			
			database.AddInParameter(commandWrapper, "@NamHoc", DbType.String,  namHoc );
			database.AddInParameter(commandWrapper, "@HocKy", DbType.String,  hocKy );
			database.AddInParameter(commandWrapper, "@DonVi", DbType.String,  donVi );
	
			
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "PhucCap_GetByNamHocHocKy", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "PhucCap_GetByNamHocHocKy", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_ChucVu_DanhSachChucVu' stored procedure. 
		/// </summary>	
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader ChucVu_DanhSachChucVu(TransactionManager transactionManager, int start, int pageLength , System.String maKhoa)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_ChucVu_DanhSachChucVu", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "ChucVu_DanhSachChucVu", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "ChucVu_DanhSachChucVu", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_LayGiangVienTrungTenKhacMa' stored procedure. 
		/// </summary>	
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader LayGiangVienTrungTenKhacMa(TransactionManager transactionManager, int start, int pageLength )
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_LayGiangVienTrungTenKhacMa", true);
			
	
			
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "LayGiangVienTrungTenKhacMa", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "LayGiangVienTrungTenKhacMa", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_HoatDongNgoaiGiangDay_GetThanhToatChamThiTayHai' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="maDonVi"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader HoatDongNgoaiGiangDay_GetThanhToatChamThiTayHai(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maDonVi, System.String maHoatDong)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_HoatDongNgoaiGiangDay_GetThanhToatChamThiTayHai", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "HoatDongNgoaiGiangDay_GetThanhToatChamThiTayHai", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "HoatDongNgoaiGiangDay_GetThanhToatChamThiTayHai", (IEntity)null));
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader HoatDongNgoaiGiangDay_GetByNamHocHocKyKhoa(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maKhoa, System.String maHoatDong)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_HoatDongNgoaiGiangDay_GetByNamHocHocKyKhoaExportExcel' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="donVi"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader HoatDongNgoaiGiangDay_GetByNamHocHocKyKhoaExportExcel(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String donVi, System.String maHoatDong)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_HoatDongNgoaiGiangDay_GetByNamHocHocKyKhoaExportExcel", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "HoatDongNgoaiGiangDay_GetByNamHocHocKyKhoaExportExcel", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "HoatDongNgoaiGiangDay_GetByNamHocHocKyKhoaExportExcel", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_LayDuLieuDongBoTuHRM' stored procedure. 
		/// </summary>	
		/// <param name="start">Row number at which to start reading.</param>
		/// <param name="pageLength">Number of rows to return.</param>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader LayDuLieuDongBoTuHRM(TransactionManager transactionManager, int start, int pageLength )
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_LayDuLieuDongBoTuHRM", true);
			
	
			
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "LayDuLieuDongBoTuHRM", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "LayDuLieuDongBoTuHRM", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_HoatDongNgoaiGiangDay_LuuImportExcel' stored procedure. 
		/// </summary>	
		/// <param name="xmlData"> A <c>System.String</c> instance.</param>
			/// <param name="reVal"> A <c>System.Int32</c> instance.</param>
		/// <param name="start">Row number at which to start reading.</param>
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void HoatDongNgoaiGiangDay_LuuImportExcel(TransactionManager transactionManager, int start, int pageLength , System.String xmlData, ref System.Int32 reVal)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_HoatDongNgoaiGiangDay_LuuImportExcel", true);
			...
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "HoatDongNgoaiGiangDay_LuuImportExcel", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "HoatDongNgoaiGiangDay_LuuImportExcel", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_HoatDongNgoaiGiangDay_GetThanhToanTongHopChamThiTayHai' stored procedure. 
		/// </summary>	
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <param name="maDonVi"> A <c>System.String</c> instance.</param>
		...
		/// <remark>This method is generated from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public override IDataReader HoatDongNgoaiGiangDay_GetThanhToanTongHopChamThiTayHai(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maDonVi, System.String maHoatDong)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_HoatDongNgoaiGiangDay_GetThanhToanTongHopChamThiTayHai", true);
			...
			IDataReader dr = null;
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "HoatDongNgoaiGiangDay_GetThanhToanTongHopChamThiTayHai", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "HoatDongNgoaiGiangDay_GetThanhToanTongHopChamThiTayHai", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_LayDuLieuDongBo_Luu' stored procedure. 
		/// </summary>	
		/// <param name="xmlData"> A <c>System.String</c> instance.</param>
			/// <param name="reVal"> A <c>System.Int32</c> instance.</param>
		/// <param name="start">Row number at which to start reading.</param>
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void LayDuLieuDongBo_Luu(TransactionManager transactionManager, int start, int pageLength , System.String xmlData, ref System.Int32 reVal)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_LayDuLieuDongBo_Luu", true);
			...
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "LayDuLieuDongBo_Luu", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "LayDuLieuDongBo_Luu", (IEntity)null));
		...
		/// <summary>
		///	This method wraps the 'cust_GiangVien_ChucVu_LuuDanhSachInHopDong' stored procedure. 
		/// </summary>	
		/// <param name="xmlData"> A <c>System.String</c> instance.</param>
		/// <param name="maDonVi"> A <c>System.String</c> instance.</param>
			/// <param name="reVal"> A <c>System.Int32</c> instance.</param>
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void ChucVu_LuuDanhSachInHopDong(TransactionManager transactionManager, int start, int pageLength , System.String xmlData, System.String maDonVi, ref System.Int32 reVal)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.cust_GiangVien_ChucVu_LuuDanhSachInHopDong", true);
			...
			//Provider Data Requesting Command Event
			OnDataRequesting(new CommandEventArgs(commandWrapper, "ChucVu_LuuDanhSachInHopDong", (IEntity)null));
			...
			//Provider Data Requested Command Event
			OnDataRequested(new CommandEventArgs(commandWrapper, "ChucVu_LuuDanhSachInHopDong", (IEntity)null));
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void ThongKeGioGiangBuh_Bk(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String donVi, System.String loaiGiangVien, System.Int32 lanChotHk01, System.Int32 lanChotHk02)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
