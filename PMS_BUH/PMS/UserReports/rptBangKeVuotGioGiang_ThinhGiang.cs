...
{
    public partial class rptBangKeVuotGioGiang_ThinhGiang : DevExpress.XtraReports.UI.XtraReport
    {
        DataTable dtData;
        DataTable dtNoiDung;
        int _dem = 1;
        ...
        private void GroupHeader1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            checkEditPGS_GVC.EditValue = false;           
            if (_listGiangVien.Rows.Count > 0)
            {
