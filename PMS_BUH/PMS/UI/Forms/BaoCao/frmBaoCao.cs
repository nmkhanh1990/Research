...
namespace PMS.UI.Forms.BaoCao
{
    public partial class frmBaoCao : XtraForm
    {
        ...
        public void InBangKeDanhSachGiangVienChamTay2( string namhoc, string hocky, string nguoilapbieu, DateTime ngayin, DataTable tb)
        {
            Text = "Bảng kê danh sách giảng viên chấm tay 2 ";
            BangDanhSachGiangVienChamKetThucHocPhamTay2 report = new BangDanhSachGiangVienChamKetThucHocPhamTay2();
            XReport = report;
            OpenLayout(report);
            report.InitData(namhoc, hocky, nguoilapbieu, ngayin, tb);
            printControl.PrintingSystem = report.PrintingSystem;
            report.CreateDocument();
        }
        #endregion
        ...
        #region In bảng kê vượt giờ giảng CLC BUH
        public void InBangKeThanhToanChamThiTayHai( DataTable tblData, string strNguoiLap, DateTime dNgayIn)
        {
            Text = "Thống kê danh sách thanh toán thù lao bổ sung";
            rptBangDanhSachNhanTienChamThiTay2 report = new rptBangDanhSachNhanTienChamThiTay2();
            XReport = report;
            OpenLayout(report);
            report.InitData(tblData, strNguoiLap, dNgayIn);
            printControl.PrintingSystem = report.PrintingSystem;
            report.CreateDocument();
        }
        #endregion
        ...
        public void InThongKeThanhToanTienChamBaiGVThinhGiang(string namhoc, string hocky, string khoabomon, string phongdaotao, string phongketoan, string hieutruong, string nguoilapbieu, string khoahoc, string bacdaotao, DateTime ngayin, DataTable tb)
        {
            ...
            OpenLayout(report);
            report.InitData(namhoc, hocky, khoabomon, phongdaotao, phongketoan, hieutruong, nguoilapbieu, khoahoc, bacdaotao, ngayin, tb);
            //report.Parameters[7].Value = String.Format("Ngày {0:dd} tháng {0:MM} năm {0:yyyy}", ngayin);
            printControl.PrintingSystem = report.PrintingSystem;
            report.CreateDocument();
        }
        #endregion
        ...
        #region In kết quả giảng dạy theo năm
        public void InKetQuaGiangDayTheoNam_VHU(string tenTruong, string namhoc, DateTime ngayin, DataTable tb)
        {
            Text = "Bảng kê dự trù cả năm theo giảng viên trước thời khoá biểu";
            rptKetQuaGiangDayTheoNam_VHU report = new rptKetQuaGiangDayTheoNam_VHU();
            XReport = report;
            OpenLayout(report);
            report.InitData(tenTruong, namhoc, ngayin, tb);
            printControl.PrintingSystem = report.PrintingSystem;
            report.CreateDocument();
        }
        #endregion
        ...
        public void InHopDongMoiGiangDay_CTIM(DateTime ngayin, DataTable tb)
        {
            Text = "Hợp đồng mời giảng dạy";
            rptHopDongMoiGiangDay_CTIM report = new rptHopDongMoiGiangDay_CTIM();
            XReport = report;
            OpenLayout(report);
            report.InitData(ngayin, tb);
            printControl.PrintingSystem = report.PrintingSystem;
            report.CreateDocument();
        }

        public void InThanhLyHopDongMoiGiangDay_CTIM(DateTime ngayin, DataTable tb)
        {
            Text = "Hợp đồng mời giảng dạy";
        ...
        public void InHopDongMoiGiangDay_VHU(DataTable tb)
        {
            ...
            report.InitData(tb);
            printControl.PrintingSystem = report.PrintingSystem;
            report.Margins = new System.Drawing.Printing.Margins(60,10,25,25);
            report.CreateDocument();
           
        }

        public void InHopDongMoiGiangDay_ACT(string diachi, string dienthoai, string dongia, string donvicongtac, string hochamhocvi, string masothunhap, string noicapcmnd, string nganhanggv, string ngaybdgiangday, string ngaycapcmndgv, string ngayktgiangday, string socmndgv, string sotaikhoangv, string tengv, string tentruongkhoa, decimal tonggiatrihd, string tonggiatrihdbangchu, int tongtietthucday, string truong, string chucvutruongkhoa, string daidienbenA, string chucvudaidienbenA, string chucvu02daidienbenA, string diachidaidienbenA, string dienthoaidaidienbenA, string faxdaidienbenA, DateTime ngayin, DataTable tb)
        {
            Text = "Hợp đồng mời giảng dạy";
            rptHopDongMoiGiangDay_ACT report = new rptHopDongMoiGiangDay_ACT();
            XReport = report;
            OpenLayout(report);
            report.InitData(diachi, dienthoai, dongia, donvicongtac, hochamhocvi, masothunhap, noicapcmnd, nganhanggv, ngaybdgiangday, ngaycapcmndgv, ngayktgiangday, socmndgv, sotaikhoangv, tengv, tentruongkhoa, tonggiatrihd, tonggiatrihdbangchu, tongtietthucday, truong, chucvutruongkhoa, daidienbenA, chucvudaidienbenA, chucvu02daidienbenA, diachidaidienbenA, dienthoaidaidienbenA, faxdaidienbenA, tb);
            printControl.PrintingSystem = report.PrintingSystem;
        ...
        public void InBangThongKeGioChuanDLU(string tenTruong, string namHoc, string hocKy, string tenDot, string phongDaoTao, string nguoiLapBieu, DateTime ngayIn, DataTable data)
        {
            Text = "Bảng thống kê giờ chuẩn";
            rptBangThongKeGioNghiaVuDLU report = new rptBangThongKeGioNghiaVuDLU();
            XReport = report;
            OpenLayout(report);
            report.InitData(tenTruong, namHoc, hocKy, tenDot, phongDaoTao, nguoiLapBieu, ngayIn, data);
            printControl.PrintingSystem = report.PrintingSystem;
        ...
        public void InThongKeVuotGioChuanDLU(string tenTruong, string namHoc, string hocKy, string tenDot, string phongDaoTao, string nguoiLapBieu, DateTime ngayIn, DataTable data)
        {
            Text = "Bảng thống kê vượt giờ chuẩn";
        ...
        #region In thống kê thanh toán tiền giảng lý thuyết giảng viên cơ hữu CTIM
        public void InThongKeThanhToanTienGiangLyThuyetGiangVienCoHuu(string tentruong, string namhoc, string hocky, string khoabomon, string truongphongdaotao, string phongketoan, string hieutruong, string nguoilapbieu, string khoahoc, string bacdaotao, string chucdanhbangiamhieu, string chucvuketoan, string chucvudaotao, DateTime ngayin, DataTable tb)
        {
            Text = "Thống kê thanh toán tiền giảng lý thuyết giảng viên cơ hữu";
            rptThanhToanGiangDayLyThuyetGiangVienCoHuuCTIM report = new rptThanhToanGiangDayLyThuyetGiangVienCoHuuCTIM();
            XReport = report;
            OpenLayout(report);
        ...
        public void InThongKeThanhToanTienGiangThucHanhGiangVienCoHuu(string tentruong, string namhoc, string hocky, string khoabomon, string truongphongdaotao, string phongketoan, string hieutruong, string nguoilapbieu, string khoahoc, string bacdaotao, string chucdanhbangiamhieu, string chucvuketoan, string chucvudaotao, DateTime ngayin, DataTable tb)
        {
            Text = "Thống kê thanh toán tiền giảng thực hành giảng viên cơ hữu";
            rptThanhToanGiangDayThucHanhGiangVienCoHuuCTIM report = new rptThanhToanGiangDayThucHanhGiangVienCoHuuCTIM();
            XReport = report;
            OpenLayout(report);
            report.InitData(tentruong, namhoc, hocky, khoabomon, truongphongdaotao, phongketoan, hieutruong, nguoilapbieu, khoahoc, bacdaotao, chucdanhbangiamhieu, chucvuketoan, chucvudaotao, ngayin, tb);
            printControl.PrintingSystem = report.PrintingSystem;
        ...
        public void InDanhSachPhanTramSoVoiDinhMuc(string tenTruong, string namHoc, string hocKy, string phongToChucCanBo, string phongDaoTao, string nguoiLapBieu, DataTable data)
        {
            Text = "Phần trăm khối lượng giảng dạy của giảng viên so với tiết chuẩn";
            rptDanhSachPhanTramGioThucHienSoVoiDinhMuc report = new rptDanhSachPhanTramGioThucHienSoVoiDinhMuc();
            XReport = report;
            OpenLayout(report);
            report.InitData(tenTruong, namHoc, hocKy, phongToChucCanBo, phongDaoTao, nguoiLapBieu, data);
            printControl.PrintingSystem = report.PrintingSystem;
        ...
        #region Báo cáo HBU
        #region In biên bản thanh lý hợp đồng thính giảng
        public void InBienBanThanhLyHopDongThinhGiang_HBU( string tenTruong, DataSet data,TList<CauHinh> lstCauHinh)
        {
            Text = "Biên bản thanh lý hợp đồng thính giảng";
            rptBienBanThanhLyHopDongThinhGiang_HBU report = new rptBienBanThanhLyHopDongThinhGiang_HBU();
            XReport = report;
            OpenLayout(report);
            report.InitData(tenTruong, data, lstCauHinh[0].DaiDienHopDongThinhGiang ==null?"Đăng ký người đại diện": lstCauHinh[0].DaiDienHopDongThinhGiang.ToString());
            printControl.PrintingSystem = report.PrintingSystem;
            report.CreateDocument();
        }
        ...
        #region In biên bản thanh lý hợp đồng thính giảng
        public void InHopDongThinhGiang_HBU(string tenTruong, DataSet data, TList<CauHinh> lstCauHinh)
        {
            Text = "Biên bản hợp đồng thính giảng";
            rptHopDongThinhGiang_HBU report = new rptHopDongThinhGiang_HBU();
            XReport = report;
            OpenLayout(report);
            report.InitData(tenTruong, data, lstCauHinh[0].DaiDienHopDongThinhGiang == null ? "Đăng ký người đại diện" : lstCauHinh[0].DaiDienHopDongThinhGiang.ToString());
            printControl.PrintingSystem = report.PrintingSystem;
        ...
        #region In Bảng kê khai giờ giảng của giảng viên
        public void InBangKeKhaiGioGiangCuaGiangVien_HBU(string truong, DataTable data)
        {
            Text = "Bảng kê khai giờ giảng của giảng viên";
            rptBangKeKhaiGioGiangCuaGiangVien_HBU report = new rptBangKeKhaiGioGiangCuaGiangVien_HBU();
            XReport = report;
            OpenLayout(report);
            report.InitData(truong,  data);
            printControl.PrintingSystem = report.PrintingSystem;
            report.CreateDocument();
        }
        ...
        #region In Bảng tổng hợp giờ giảng các khoa viện
        public void InBangTongHopGioGiangCacKhoaVien_HBU(string truong, DataTable data)
        {
            Text = "In Bảng tổng hợp giờ giảng các khoa viện";
            rptBangTongHopGioGiangCacKhoa_HBU report = new rptBangTongHopGioGiangCacKhoa_HBU();
            XReport = report;
            OpenLayout(report);
            report.InitData(truong, data);
            printControl.PrintingSystem = report.PrintingSystem;
        ...
        #region In Tổng hợp giờ chuẩn của khoa
        public void InTongHopGioChuanChuanCuaKhoa_HBU(string truong, DataTable data)
        {
            Text = "BTổng hợp giờ chuẩn của khoa";
            rptTongHopGioChuanCuaKhoa_HBU report = new rptTongHopGioChuanCuaKhoa_HBU();
            XReport = report;
            OpenLayout(report);
            report.InitData(truong, data);
            printControl.PrintingSystem = report.PrintingSystem;
        ...
        #region In Bảng tổng hợp vượt giờ giảng viên cơ hữu
        public void InBangTongHopVuotGioGiangVienCoHuu_HBU(string truong, DataTable data)
        {
            Text = "BTổng hợp giờ chuẩn của khoa";
            rptBangTongHopVuotGioGiangVienCoHuu_HBU report = new rptBangTongHopVuotGioGiangVienCoHuu_HBU();
            XReport = report;
            OpenLayout(report);
            report.InitData(truong, data);
            printControl.PrintingSystem = report.PrintingSystem;
        ...
        #region Báo cáo VHU
        #region In Bảng Kê Thực Tế Giờ Giảng KLK
        public void InBangKeThucTeGioGiangKLK_VHU(string truong,string nguoiLapBieu,DateTime _ngayIn, DataTable data)
        {
            Text = "In Bảng Kê Thực Tế Giờ Giảng KLK";
            rptBangKeThucTeGioGiangDay_VHU report = new rptBangKeThucTeGioGiangDay_VHU();
            XReport = report;
            OpenLayout(report);
            report.InitData(truong, nguoiLapBieu, _ngayIn, data);
            printControl.PrintingSystem = report.PrintingSystem;
            report.CreateDocument();
        }
        #endregion
        ...
        #region In Bảng Chi Trả Thù Lao Giảng Dạy KLK
        public void InBangChiTraThuLaoGiangDayKLK_VHU(string truong, string nguoiLapBieu, DateTime _ngayIn, DataTable data)
        {
            Text = "In Bảng Chi Trả Thù Lao Giảng Dạy KLK";
            rptBangChiTraThuLaoGiangDay_VHU report = new rptBangChiTraThuLaoGiangDay_VHU();
            XReport = report;
            OpenLayout(report);
            report.InitData(truong, nguoiLapBieu, _ngayIn, data);
            printControl.PrintingSystem = report.PrintingSystem;
        ...
        public void InChiTietKhoiLuongGiangDay_HBU(DateTime ngayIn,string strTenTruong, DataTable data)
        {
            Text = "Chi tiết khối lượng giảng dạy của giảng viên";
            rptChiTietKhoiLuongGiangDay_HBU report = new rptChiTietKhoiLuongGiangDay_HBU();
            XReport = report;
            OpenLayout(report);
            report.InitData(ngayIn, strTenTruong, data);
            printControl.PrintingSystem = report.PrintingSystem;
            report.CreateDocument();
        }
        #endregion
        ...
        #region Thư mời giảng
        public void InThuMoiGiang(DataTable data)
        {
            Text = "Thư mời giảng";
            rptThuMoiGiang_VHU report = new rptThuMoiGiang_VHU();
            XReport = report;
            OpenLayout(report);
        ...
        public void InBangLietKeKhoiLuongGiangDay_HBU(DateTime ngayIn, DataTable data)
        {
            Text = "Liệt kê khối lượng giảng dạy";
            rptChiTietKhoiLuongGiangDay_HBU report = new rptChiTietKhoiLuongGiangDay_HBU();
            XReport = report;
            OpenLayout(report);
            report.InitData(ngayIn, PMS.Common.Globals._cauhinh.TenTruong, data);
            printControl.PrintingSystem = report.PrintingSystem;
            report.CreateDocument();
        }
        #endregion
        ...
        public void InThongKeTongHopPhanCong(DataTable dsData, string strUseLap, DateTime date)
        {
            Text = "Chi tiết khối lượng giảng dạy của giảng viên ";
            rptBangTongHopPhanCongChamThiTay2 report = new rptBangTongHopPhanCongChamThiTay2();
            XReport = report;
            OpenLayout(report);
            report.InitData(dsData, strUseLap, date);
            printControl.PrintingSystem = report.PrintingSystem;
            report.CreateDocument();
        }
        #endregion
        ...
        {
            Text = "Bảng thống kê giờ coi thi, chấm bài, ra đề theo đơn vị tổ chức thi";
        ...
        public void BangKeChiTietGioGioTheoDot_TheoMonHoc(string tenTruong, string namHoc, string hocKy, string tenDot, string phongDaoTao, string nguoiLapBieu, DateTime ngayIn, DataTable data)
        {
            Text = "Bảng kê chi tiết giờ giảng";
            rptThongKeChiTietGioGiangTheoDot_TheoMonHoc report = new rptThongKeChiTietGioGiangTheoDot_TheoMonHoc();
            XReport = report;
            OpenLayout(report);
            report.InitData(tenTruong, namHoc, hocKy, tenDot, phongDaoTao, nguoiLapBieu, ngayIn, data);
            printControl.PrintingSystem = report.PrintingSystem;
        ...
        public void OpenLayout(XtraReport report)
        {
        ...
        private void ExportToDOC(string extension, DocumentFormat df)
        {
            ...
            sfd.FileName = Environment.CurrentDirectory + "\\" + XReport.ExportOptions.PrintPreview.DefaultFileName + "." + extension;
            sfd.Filter = extension + " File|*.doc";
            if (sfd.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                using (RichEditDocumentServer docServer = new RichEditDocumentServer())
                {
                    XReport.ExportToHtml("test.html", new HtmlExportOptions() { ExportMode = HtmlExportMode.SingleFilePageByPage, EmbedImagesInHTML = true });
        ...
        private void barButtonItem_DocFile_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ExportToDOC("doc", DocumentFormat.OpenXml);
        }
    }
}
