    ...
    public partial class frmGiangVienChoDuyetHoSo : DevExpress.XtraEditors.XtraForm
    {
        ...
        public void KhongDuocPhepCapNhat(string value)
        {
            if (value.ToLower() == "true")
            {
                ...
                btnDuyetHoSo.ItemShortcut = DevExpress.XtraBars.BarShortcut.Empty;
            }
            else
            {
        ...
        private void InitData()
        {
            ...
            gridLookUpEditTinhTrang.DataBindings.Add("EditValue", bindingSourceTinhTrang, "MaTinhTrang", true, DataSourceUpdateMode.Never);
            ...
            gridLookUpEditHocHam.DataBindings.Add("EditValue", bindingSourceCloneHocHam, "MaHocHam", true, DataSourceUpdateMode.Never);
            ...
            gridLookUpEditHocVi.DataBindings.Add("EditValue", bindingSourceCloneHocVi, "MaHocVi", true, DataSourceUpdateMode.Never);
