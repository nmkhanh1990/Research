...
{
    public partial class ucTongHopKhoiLuongThucDay : XtraUserControl
    {
        public ucTongHopKhoiLuongThucDay()
        {
            InitializeComponent();
        }

        private void ucTongHopKhoiLuongThucDay_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewThanhToanThuLao, new string[] { "MaKhoa", "TenKhoa", "LyThuyet1", "ThucHanh1", "ThiNghiem1", "DoAn1", "LyThuyet2", "ThucHanh2", "ThiNghiem2", "DoAn2" },
                new string[] { "Mã khoa", "Khoa", "LT (CH)", "TH (CH)", "TN (CH)", "DAMH (CH)", "LT (MG)", "TH (MG)", "TN (MG)", "DAMH (MG)" },
                new int[] { 100, 300, 80, 80, 80, 80, 80, 80, 80, 80 });
        ...
        private void InitData()
        {
            ...
            cboNamHoc.DataBindings.Add("EditValue", bindingSourceNamHoc, "NamHoc", true, DataSourceUpdateMode.Never);
        ...
        private void btnLoc_Click(object sender, EventArgs e)
        {
            ...
            bindingSourceTongHopKhoiLuong.DataSource = DataServices.ViewKhoiLuongThucDay.GetByNamHocHocKy(vHocKy.NamHoc, vHocKy.MaHocKy);
            Cursor.Current = Cursors.Default;
        }
        ...
        private void btnIn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //Init Report
            VList<ViewKhoiLuongThucDay> vList = bindingSourceTongHopKhoiLuong.DataSource as VList<ViewKhoiLuongThucDay>;
            if (vList != null)
            {
                frmBaoCao frm = new frmBaoCao();
                if (PMS.Common.Globals._cauhinh != null)
                {
                    frm.InBangTongHopKhoiLuongThucDay(PMS.Common.Globals._cauhinh.TenTruong.ToUpper(), PMS.Common.Globals._cauhinh.PhongDaoTao, vHocKy.NamHoc, vHocKy.MaHocKy, vList);
                    frm.ShowDialog();
                }
                else
                {
