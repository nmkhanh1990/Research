...
{
    public partial class ucHopDongMoiGiangDay_CTIM : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        ...
        public ucHopDongMoiGiangDay_CTIM()
        {
            InitializeComponent();
        ...
        private void ucHopDongMoiGiangDay_CTIM_Load(object sender, EventArgs e)
        {
            #region InitGridview
        ...
        private void btnIn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (vListBaoCao != null && vListBaoCao.Rows.Count > 0)
            {
                ...
                {
                    frm.InHopDongMoiGiangDay_CTIM(_ngayIn, vListBaoCao);
                    frm.ShowDialog();
                }
            }
            Cursor.Current = Cursors.Default;
