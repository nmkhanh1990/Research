    ...
    public partial class ucBangThanhToanTongHop_ACT : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void InitData()
        {
            ...
            if (cboDonVi.EditValue != null)
            {
                ...
                cboGiangVien.DataBindings.Add("EditValue", bindingSourceGiangVien, "MaGiangVien", true, DataSourceUpdateMode.Never);
            }
        ...
        private void btnLocDuLieu_Click(object sender, EventArgs e)
        {
            ...
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null && cboGiangVien.EditValue != null)
            {
                DataTable dt = new DataTable();
                IDataReader reader;
                if ("Administrator;Daotao;Ketoan;".Contains(BLL.UserInfo.GroupName))
                {
                    reader = DataServices.KetQuaThanhToanThuLao.ThongKeTongHop_Act(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), int.Parse(cboGiangVien.EditValue.ToString()));
                }
                else
                {
                    reader = DataServices.KhoiLuongQuyDoi.ThongKeTongHop_Act(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), int.Parse(cboGiangVien.EditValue.ToString()));
                }
                dt.Load(reader);
                bindingSourceThongKe.DataSource = dt;
                gridViewThongKe.ExpandAllGroups();
