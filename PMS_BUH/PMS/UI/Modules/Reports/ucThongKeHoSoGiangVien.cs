...
{
    public partial class ucThongKeHoSoGiangVien : XtraUserControl
    {
        DateTime _ngayIn;
        ...
        private void ucThongKeHoSoGiangVien_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewThongKe, new string[] { "Stt", "MaQuanLy", "HoTen", "TenDonVi", "TenHoSo", "TenHoSoConThieu" }
                    , new string[] { "STT", "Mã giảng viên", "Họ tên", "Khoa - Đơn vị", "Danh sách hồ sơ hiện có","Danh sách hồ sơ còn thiếu" }
                    , new int[] { 50, 90, 170, 200, 550 ,550});
            AppGridView.ReadOnlyColumn(gridViewThongKe);
            AppGridView.AlignHeader(gridViewThongKe, new string[] { "Stt", "MaQuanLy", "HoTen", "TenDonVi", "TenHoSo", "TenHoSoConThieu" }, DevExpress.Utils.HorzAlignment.Center);
