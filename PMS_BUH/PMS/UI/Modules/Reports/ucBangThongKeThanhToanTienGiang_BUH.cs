                        ...
                        foreach (DataRow r in tb.Rows)
                        {
                            if (r.RowState == DataRowState.Modified)
                            {
                                xmlData += String.Format(
                                    "<Input M=\"{0}\" T=\"{1}\" G=\"{2}\" D=\"{3}\" L=\"{4}\" K=\"{5}\" NCN=\"{6}\" FRN=\"{7}\" NH=\"{8}\" HK=\"{9}\" />"
                                    , r["IdGiangVien"], r["ThueTncn"], r["GhiChu"], cboDotThanhToan.EditValue.ToString()
                                    , r["MaLoaiGiangVien"], r["TrangThai"], PMS.Data.Utility.userID.ToString()
                                    , this.Name.ToString(), cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString());
                            }
                        }
