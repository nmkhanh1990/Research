    ...
    public partial class ucTietNoKyTruoc : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void KhongDuocPhepCapNhat(string value)
        {
            if (value.ToLower() == "true")
            {
                ...
                btnImportExcel.ItemShortcut = DevExpress.XtraBars.BarShortcut.Empty;

                btnLayTuDong.Visibility = DevExpress.XtraBars.BarItemVisibility.Never;
                btnLayTuDong.ItemShortcut = DevExpress.XtraBars.BarShortcut.Empty;
            }
            else
            {
        ...
        void InitGridACT()
        {
            ...
            AppGridView.ShowField(gridViewNoKyTruoc, new string[] { "MaGiangVien", "HoTen", "TenDonVi", "SoTietNoKyTruoc", "TietNoKhac", "NgayCapNhat", "NguoiCapNhat" },
                                                           new string[] { "Mã giảng viên", "Họ tên", "Đơn vị", "Số GC nợ kỳ trước", "Số GC nợ khác", "NgayCapNhat", "NguoiCapNhat" },
        ...
        void InitGridVHU()
        {
            ...
            AppGridView.ShowField(gridViewNoKyTruoc, new string[] { "MaGiangVien", "HoTen", "TenDonVi", "SoTietNoKyTruoc", "TietNoNckh", "TietNoKhac", "NgayCapNhat", "NguoiCapNhat", "GhiChu", "LayTuDong" },
                                                           new string[] { "Mã giảng viên", "Họ tên", "Đơn vị", "GC giảng dạy", "GC NCKH", "GC tham gia quản lý", "NgayCapNhat", "NguoiCapNhat", "Ghi chú", "LayTuDong" },
                                                           new int[] { 90, 150, 150, 80, 80, 80, 100, 80, 150, 80 });
            ...
            AppGridView.FixedField(gridViewNoKyTruoc, new string[] { "MaGiangVien", "HoTen", "TenDonVi" }, FixedStyle.Left);
            AppGridView.BackColorFieldAppearance(gridViewNoKyTruoc, new string[] { "SoTietNoKyTruoc" }, Color.FromArgb(235, 220, 255));
            AppGridView.BackColorFieldAppearance(gridViewNoKyTruoc, new string[] { "TietNoNckh" }, Color.FromArgb(230, 255, 245));
            AppGridView.BackColorFieldAppearance(gridViewNoKyTruoc, new string[] { "TietNoKhac" }, Color.FromArgb(255, 250, 240));
            PMS.Common.Globals.WordWrapHeader(gridViewNoKyTruoc, 40);

            AppGridView.SummaryField(gridViewNoKyTruoc, "MaGiangVien", "{0} GV", DevExpress.Data.SummaryItemType.Count);
            AppGridView.SummaryField(gridViewNoKyTruoc, "SoTietNoKyTruoc", "{0:n2}", DevExpress.Data.SummaryItemType.Sum);
            AppGridView.SummaryField(gridViewNoKyTruoc, "TietNoNckh", "{0:n2}", DevExpress.Data.SummaryItemType.Sum);
            //AppGridView.SummaryField(gridViewNoKyTruoc, "TietBaoLuuNckh", "{0:n2}", DevExpress.Data.SummaryItemType.Sum);
            AppGridView.SummaryField(gridViewNoKyTruoc, "TietNoKhac", "{0:n2}", DevExpress.Data.SummaryItemType.Sum);

            labelControl1.Text = "GHI CHÚ: GC nợ đều được ghi lại. Chỉ có NCKH vượt là được bảo lưu, giảng dạy vượt thì tính tiền, TGQL vượt thì không được tính.";
        ...
        void InitGridHBU()
        {
            ...
            AppGridView.ShowEditor(gridViewNoKyTruoc, DevExpress.XtraGrid.Views.Grid.NewItemRowPosition.Top);
            AppGridView.ShowField(gridViewNoKyTruoc, new string[] { "MaGiangVien", "HoTen", "TenDonVi", "SoTietNoKyTruoc", "TietNoNckh", "TietNoKhac", "NgayCapNhat", "NguoiCapNhat", "GhiChu", "LayTuDong" },
                                                           new string[] { "Mã giảng viên", "Họ tên", "Đơn vị", "GC nợ / bảo lưu giảng dạy", "GC nợ / bảo lưu NCKH", "GC nợ / bảo lưu các hoạt động khác", "NgayCapNhat", "NguoiCapNhat", "Ghi chú", "LayTuDong" },
                                                           new int[] { 120, 150, 150, 100, 100, 100, 99, 99, 140, 99 });
            AppGridView.AlignHeader(gridViewNoKyTruoc, new string[] { "MaGiangVien", "HoTen", "TenDonVi", "SoTietNoKyTruoc", "TietNoNckh", "TietNoKhac", "NgayCapNhat", "NguoiCapNhat", "GhiChu", "LayTuDong" }, DevExpress.Utils.HorzAlignment.Center);

            AppGridView.RegisterControlField(gridViewNoKyTruoc, "MaGiangVien", repositoryItemGridLookUpEditGiangVien);
            AppGridView.HideField(gridViewNoKyTruoc, new string[] { "NgayCapNhat", "NguoiCapNhat", "LayTuDong" });
            labelControl1.Text = "GHI CHÚ: - Số GC nhỏ hơn 0 là số GC nợ; số GC lớn hơn 0 là số GC bảo lưu";
        ...
        void InitGridDLU()
        {
            ...
            AppGridView.ShowField(gridViewNoKyTruoc, new string[] { "MaGiangVien", "HoTen", "TenDonVi", "SoTietNoKyTruoc", "TietNoNckh", "NgayCapNhat", "NguoiCapNhat", "GhiChu", "LayTuDong" },
                                                           new string[] { "Mã giảng viên", "Họ tên", "Đơn vị", "Tiet nợ/bảo lưu giảng dạy", "GC nợ/bảo lưu NCKH", "NgayCapNhat", "NguoiCapNhat", "Ghi chú", "LayTuDong" },
        ...
        void InitRemaining()//UEL, IUH
        {
            ...
            AppGridView.ShowField(gridViewNoKyTruoc, new string[] { "MaGiangVien", "HoTen", "TenDonVi", "SoTietNoKyTruoc", "NgayCapNhat", "NguoiCapNhat" },
                                                           new string[] { "Mã giảng viên", "Họ tên", "Đơn vị", "Số GC nợ kỳ trước", "NgayCapNhat", "NguoiCapNhat" },
        ...
        private void btnLayTuDong_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (cboNamHoc.EditValue != null) 
            {
                if (XtraMessageBox.Show("Bạn muốn lấy dữ liệu GC nợ/bảo lưu của giảng viên từ năm học trước?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    try
                    {
                        int result = 0;
