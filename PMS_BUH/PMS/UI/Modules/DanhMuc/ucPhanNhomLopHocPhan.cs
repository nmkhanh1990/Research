...
{
    public partial class ucPhanNhomLopHocPhan : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        void InitData()
        {
            try
            {
                ...
                if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null)
                    bindingSourcePhanNhom.DataSource = DataServices.ViewPhanNhomMonHoc.GetByNamHocHocKy(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString());
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            VList<ViewPhanNhomMonHoc> list = bindingSourcePhanNhom.DataSource as VList<ViewPhanNhomMonHoc>;
            if (list != null)
            {
                if (XtraMessageBox.Show("Bạn có muốn lưu các thay đổi?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        foreach (ViewPhanNhomMonHoc v in list)
                        {
