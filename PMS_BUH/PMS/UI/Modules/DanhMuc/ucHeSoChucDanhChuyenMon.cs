...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucHeSoChucDanhChuyenMon : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucHeSoChucDanhChuyenMon_Load(object sender, EventArgs e)
        {
            ...
            if (_maTruong == "ACT" || _maTruong == "CTIM" || _maTruong == "VHU" || _maTruong == "HBU")
        ...
        void InitGridVHU()
        {
            ...
            AppGridView.ShowField(gridViewHeSoChucDanhChuyenMon, new string[] { "MaQuanLy", "MaLoaiGiangVien", "MaHocHam","MaChucDanh", "MaHocVi", "HeSo" },
                        new string[] { "Mã quản lý", "Loại giảng viên", "Học hàm","Chức danh", "Học vị", "Hệ số" }, 
                        new int[] { 90, 150,150, 150, 150, 100 });
            AppGridView.AlignHeader(gridViewHeSoChucDanhChuyenMon, new string[] { "MaQuanLy", "MaLoaiGiangVien", "MaHocHam","MaChucDanh", "MaHocVi", "HeSo" }, DevExpress.Utils.HorzAlignment.Center);
            ...
            AppGridView.RegisterControlField(gridViewHeSoChucDanhChuyenMon, "MaChucDanh", repositoryItemGridLookUpEditChucDanh);
        ...
        void InitGridDLU()
        {
            ...
            AppGridView.InitGridView(gridViewHeSoChucDanhChuyenMon, true, true, DevExpress.XtraGrid.Views.Grid.GridMultiSelectMode.RowSelect, false, false, "Nhấn vào đây để thêm dòng mới");
            AppGridView.ShowEditor(gridViewHeSoChucDanhChuyenMon, DevExpress.XtraGrid.Views.Grid.NewItemRowPosition.Top);
            AppGridView.ShowField(gridViewHeSoChucDanhChuyenMon, new string[] { "BacDaoTao", "MaHocHam", "MaHocVi", "HeSo" },
                        new string[] { "Bậc đào tạo", "Học hàm", "Học vị", "Hệ số" }, new int[] { 200, 200, 200, 100 });
            AppGridView.AlignHeader(gridViewHeSoChucDanhChuyenMon, new string[] { "BacDaoTao", "MaHocHam", "MaHocVi", "HeSo" }, DevExpress.Utils.HorzAlignment.Center);
            AppGridView.RegisterControlField(gridViewHeSoChucDanhChuyenMon, "MaHocHam", repositoryItemGridLookUpEditHocHam);
            AppGridView.RegisterControlField(gridViewHeSoChucDanhChuyenMon, "MaHocVi", repositoryItemGridLookUpEditHocVi);
            AppGridView.RegisterControlField(gridViewHeSoChucDanhChuyenMon, "HeSo", repositoryItemSpinEditHeSo);
        ...
        void InitRemaining()
        {
            ...
            if (_maTruong == "ACT" || _maTruong == "CTIM")
                AppGridView.HideField(gridViewHeSoChucDanhChuyenMon, new string[] { "MaQuanLy", "MaLoaiGiangVien" });
            #endregion
        }
        #endregion
