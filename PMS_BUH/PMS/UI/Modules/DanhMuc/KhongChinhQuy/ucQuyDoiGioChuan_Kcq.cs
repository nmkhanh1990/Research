...
{
    public partial class ucQuyDoiGioChuan_Kcq : XtraUserControl
    {
        ...
        private void ucQuyDoiGioChuan_Load(object sender, EventArgs e)
        {
            ...
            bindingSourceQuyDoiGioChuan.DataSource = DataServices.KcqQuyDoiGioChuan.GetAll();
        ...
        {
            KcqQuyDoiGioChuan obj = bindingSourceQuyDoiGioChuan.Current as KcqQuyDoiGioChuan;
            if (obj != null)
            {
                if (obj.IsNew)
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            TList<KcqQuyDoiGioChuan> list = bindingSourceQuyDoiGioChuan.DataSource as TList<KcqQuyDoiGioChuan>;
            if (list != null)
            {
                if (XtraMessageBox.Show("Bạn có muốn lưu các thay đổi không ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    try
                    {
                        if (list.IsValid)
                        {
                            ...
                            DataServices.KcqQuyDoiGioChuan.Save(list);
        ...
        {
            KcqQuyDoiGioChuan obj = target as KcqQuyDoiGioChuan;
            if (obj != null)
            {
                if (((TList<KcqQuyDoiGioChuan>)bindingSourceQuyDoiGioChuan.DataSource).FindAll(p => p.MaQuanLy == obj.MaQuanLy).Count > 1)
                {
        ...
        {
            KcqQuyDoiGioChuan obj = e.Row as KcqQuyDoiGioChuan;
            if (obj != null)
            {
        ...
        private void gridViewQuyDoiGioChuan_RowCellClick(object sender, RowCellClickEventArgs e)
        {
            ...
            if (view.ActiveFilter.IsEmpty)
            {
                ...
                {
                    KcqQuyDoiGioChuan obj = gridViewQuyDoiGioChuan.GetFocusedRow() as KcqQuyDoiGioChuan;
                    if (obj != null)
                    {
                        if (!obj.IsNew)
                        {
                            using (frmKhoanQuyDoi_Kcq frm = new frmKhoanQuyDoi_Kcq(obj.MaQuyDoi))
                            {
                                frm.ShowDialog();
                            }
                        }
        ...
        {
            KcqQuyDoiGioChuan obj = gridViewQuyDoiGioChuan.GetRow(e.RowHandle) as KcqQuyDoiGioChuan;
            if (obj != null)
                obj.CongDon = false;
        }
        ...
        private void barButtonItem1_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                sf.Filter = "(*.xls)|*.xls";
                //sf.FileName = this.Name.ToString();
