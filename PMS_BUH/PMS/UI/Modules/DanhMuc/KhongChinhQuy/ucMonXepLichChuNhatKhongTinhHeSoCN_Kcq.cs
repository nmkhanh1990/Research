...
{
    public partial class ucMonXepLichChuNhatKhongTinhHeSoCN_Kcq : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        #endregion
        public ucMonXepLichChuNhatKhongTinhHeSoCN_Kcq()
        {
            InitializeComponent();
        }
        ...
        void InitData()
        {
            ...
            {
                bindingSourceData.DataSource = DataServices.ViewKcqMonXepLichChuNhatKhongTinhHeSo.GetByNamHocHocKy(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString());
            }
        }
        #endregion
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                VList<ViewKcqMonXepLichChuNhatKhongTinhHeSo> list = bindingSourceData.DataSource as VList<ViewKcqMonXepLichChuNhatKhongTinhHeSo>;
                if (list != null)
                {
                    try
                    {
                        string xmlData = "";
                        foreach (ViewKcqMonXepLichChuNhatKhongTinhHeSo kl in list)
                        {
                        ...
                        int kq = 0;
                        DataServices.KcqMonXepLichChuNhatKhongTinhHeSo.Luu(xmlData, cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), ref kq);
                        if (kq == 0)
        ...
        private void gridViewData_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            {
                ViewKcqMonXepLichChuNhatKhongTinhHeSo v = (ViewKcqMonXepLichChuNhatKhongTinhHeSo)gridViewData.GetRow(pos);
