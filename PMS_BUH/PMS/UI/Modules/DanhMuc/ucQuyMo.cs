...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucQuyMo : XtraUserControl
    {
        ...
        private void ucQuyMo_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewQuyMo, new string[] { "MaQuyMo", "TenQuyMo", "GhiChu","TinhTrang" },
                new string[] { "Mã quy mô", "Tên quy mô", "Ghi chú","Không dùng" },
                new int[] { 100, 400, 200,100 });
            AppGridView.AlignHeader(gridViewQuyMo, new string[] { "MaQuyMo", "TenQuyMo", "GhiChu", "TinhTrang" }, DevExpress.Utils.HorzAlignment.Center);
