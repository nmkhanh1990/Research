...
namespace PMS.UI.Modules.DanhMucTheoNam
{
    public partial class ucDonGiaTheoNam : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucDonGiaTheoNam_Load(object sender, EventArgs e)
        {
            ...
            string[] showFields = { "MaQuanLy", "MaLoaiGiangVien", "MaHocHam", "MaHocVi", "BacDaoTao", "NgonNguGiangDay", "DonGia", "DonGiaClc", "DonGiaGdtc", "NgayCapNhat", "NguoiCapNhat" };
            string[] showCaptions = { "Mã quản lý", "Loại giảng viên", "Học hàm", "Học vị", "Bậc đào tạo", "Ngôn ngữ giảng dạy", "Đơn giá", "Đơn giá CLC", "Đơn giá GDTC", "NgayCapNhat", "NguoiCapNhat" };
            int[] columnWidths = { 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100 };
            ...
            AppGridView.ShowField(gridViewDonGia, showFields, showCaptions, columnWidths);
            AppGridView.AlignHeader(gridViewDonGia, showFields, DevExpress.Utils.HorzAlignment.Center);
            ...
            AppGridView.FormatDataField(gridViewDonGia, new string[] { "DonGia", "DonGiaClc", "DonGiaGdtc" }, DevExpress.Utils.FormatType.Custom, "n0");
