...
namespace PMS.UI.Modules.DanhMucTheoNam
{
    public partial class ucHeSoNgonNguTheoNam : XtraUserControl
    {
        ...
        void InitData()
        {
            ...
            {
                TList<HeSoNgonNgu> lstHSNN = new TList<HeSoNgonNgu>();
                lstHSNN = DataServices.HeSoNgonNgu.GetByNamHocKocKy(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString());
                bindingSourceHeSoCoSo.DataSource = lstHSNN;                
            }
        }
