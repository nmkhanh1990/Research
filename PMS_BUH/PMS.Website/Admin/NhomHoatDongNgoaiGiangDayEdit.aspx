...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridViewHoatDongNgoaiGiangDay1" runat="server"
			...
			<Columns>
				...
				<asp:BoundField DataField="NhomHoatDongBt" HeaderText="Nhom Hoat Dong Bt" SortExpression="[NhomHoatDongBT]" />				
				<asp:BoundField DataField="NhomHoatDongClc" HeaderText="Nhom Hoat Dong Clc" SortExpression="[NhomHoatDongCLC]" />				
			</Columns>
			<EmptyDataTemplate>
