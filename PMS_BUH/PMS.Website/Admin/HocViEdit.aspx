<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="HocViEdit.aspx.cs" Inherits="HocViEdit" Title="HocVi Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Hoc Vi - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="MaHocVi" runat="server" DataSourceID="HocViDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/HocViFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:HeSoChucDanhTietNghiaVuDataSource ID="HeSoChucDanhTietNghiaVuDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:HeSoChucDanhTietNghiaVuFilter  Column="MaHocVi" QueryStringField="MaHocVi" /> 
					</Filters>
				</data:SqlParameter>
		...
		<data:DonGiaDataSource ID="DonGiaDataSource2" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DonGiaFilter  Column="MaHocVi" QueryStringField="MaHocVi" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
		...
		<data:QuyDinhTienCanTrenDataSource ID="QuyDinhTienCanTrenDataSource3" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:QuyDinhTienCanTrenFilter  Column="MaHocVi" QueryStringField="MaHocVi" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
		...
		<data:GiangVienDataSource ID="GiangVienDataSource4" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:GiangVienFilter  Column="MaHocVi" QueryStringField="MaHocVi" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
