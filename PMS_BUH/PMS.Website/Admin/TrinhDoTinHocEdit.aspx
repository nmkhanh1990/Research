<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="TrinhDoTinHocEdit.aspx.cs" Inherits="TrinhDoTinHocEdit" Title="TrinhDoTinHoc Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Trinh Do Tin Hoc - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="MaTrinhDoTinHoc" runat="server" DataSourceID="TrinhDoTinHocDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/TrinhDoTinHocFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:TrinhDoTinHocDataSource ID="TrinhDoTinHocDataSource" runat="server"
			SelectMethod="GetByMaTrinhDoTinHoc"
		>
			<Parameters>
				<asp:QueryStringParameter Name="MaTrinhDoTinHoc" QueryStringField="MaTrinhDoTinHoc" Type="String" />

			</Parameters>
		</data:TrinhDoTinHocDataSource>
		...
		<data:GiangVienDataSource ID="GiangVienDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:GiangVienFilter  Column="MaTrinhDoTinHoc" QueryStringField="MaTrinhDoTinHoc" /> 
					</Filters>
				</data:SqlParameter>
