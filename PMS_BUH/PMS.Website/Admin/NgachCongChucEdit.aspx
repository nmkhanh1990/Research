<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="NgachCongChucEdit.aspx.cs" Inherits="NgachCongChucEdit" Title="NgachCongChuc Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Ngach Cong Chuc - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="MaNgachCongChuc" runat="server" DataSourceID="NgachCongChucDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/NgachCongChucFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:NgachCongChucDataSource ID="NgachCongChucDataSource" runat="server"
			SelectMethod="GetByMaNgachCongChuc"
		>
			<Parameters>
				<asp:QueryStringParameter Name="MaNgachCongChuc" QueryStringField="MaNgachCongChuc" Type="String" />
		...
		<data:GiangVienDataSource ID="GiangVienDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:GiangVienFilter  Column="MaNgachCongChuc" QueryStringField="MaNgachCongChuc" /> 
					</Filters>
				</data:SqlParameter>
