...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
			...
			<Columns>
				...
				<asp:BoundField DataField="ChucVuKiemNhiemKhac" HeaderText="Chuc Vu Kiem Nhiem Khac" SortExpression="[ChucVuKiemNhiemKhac]"  />
				...
				<asp:BoundField DataField="DaiDienHopDongThinhGiang02" HeaderText="Dai Dien Hop Dong Thinh Giang02" SortExpression="[DaiDienHopDongThinhGiang02]"  />
