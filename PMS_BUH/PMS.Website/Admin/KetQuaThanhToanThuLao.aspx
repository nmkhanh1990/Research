...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
			...
			<Columns>
				...
				<asp:BoundField DataField="NgayXacNhanThanhToan" DataFormatString="{0:d}" HtmlEncode="False" HeaderText="Ngay Xac Nhan Thanh Toan" SortExpression="[NgayXacNhanThanhToan]"  />
