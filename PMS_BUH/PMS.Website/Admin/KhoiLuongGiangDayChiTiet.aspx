<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="KhoiLuongGiangDayChiTiet.aspx.cs" Inherits="KhoiLuongGiangDayChiTiet" Title="KhoiLuongGiangDayChiTiet List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Khoi Luong Giang Day Chi Tiet List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				DataSourceID="KhoiLuongGiangDayChiTietDataSource"
				DataKeyNames="MaKhoiLuong"
				AllowMultiColumnSorting="false"
				DefaultSortColumnName="" 
				DefaultSortDirection="Ascending"	
				ExcelExportFileName="Export_KhoiLuongGiangDayChiTiet.xls"  		
			>
			<Columns>
				...
				<asp:BoundField DataField="MaKhoaCuaMonHoc" HeaderText="Ma Khoa Cua Mon Hoc" SortExpression="[MaKhoaCuaMonHoc]"  />
			...
			<EmptyDataTemplate>
				<b>No KhoiLuongGiangDayChiTiet Found!</b>
			</EmptyDataTemplate>
		</data:EntityGridView>
		<br />
		<asp:Button runat="server" ID="btnKhoiLuongGiangDayChiTiet" OnClientClick="javascript:location.href='KhoiLuongGiangDayChiTietEdit.aspx'; return false;" Text="Add New"></asp:Button>
