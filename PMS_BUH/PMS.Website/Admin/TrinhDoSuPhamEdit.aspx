<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="TrinhDoSuPhamEdit.aspx.cs" Inherits="TrinhDoSuPhamEdit" Title="TrinhDoSuPham Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Trinh Do Su Pham - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="MaTrinhDoSuPham" runat="server" DataSourceID="TrinhDoSuPhamDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/TrinhDoSuPhamFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:TrinhDoSuPhamDataSource ID="TrinhDoSuPhamDataSource" runat="server"
			SelectMethod="GetByMaTrinhDoSuPham"
		>
			<Parameters>
				<asp:QueryStringParameter Name="MaTrinhDoSuPham" QueryStringField="MaTrinhDoSuPham" Type="String" />
		...
		<data:GiangVienDataSource ID="GiangVienDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:GiangVienFilter  Column="MaTrinhDoSuPham" QueryStringField="MaTrinhDoSuPham" /> 
					</Filters>
				</data:SqlParameter>
