<%@ Control Language="C#" ClassName="DonGiaChatLuongCaoFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataNhomMonHoc" Text='<%# Bind("NhomMonHoc") %>' MaxLength="50"></asp:TextBox>
				</td>
			</tr>
			<tr>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataPhanLoaiGiangVien" Text='<%# Bind("PhanLoaiGiangVien") %>' MaxLength="200"></asp:TextBox>
				</td>
			</tr>
			<tr>
