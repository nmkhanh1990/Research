...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataHeSoThamNien" runat="server" Text="He So Tham Nien:" AssociatedControlID="dataHeSoThamNien" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataHeSoThamNien" Text='<%# Bind("HeSoThamNien") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataHeSoThamNien" runat="server" Display="Dynamic" ControlToValidate="dataHeSoThamNien" ErrorMessage="Invalid value" MaximumValue="999999999" MinimumValue="-999999999" Type="Double"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataMaKhoaCuaMonHoc" runat="server" Text="Ma Khoa Cua Mon Hoc:" AssociatedControlID="dataMaKhoaCuaMonHoc" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataMaKhoaCuaMonHoc" Text='<%# Bind("MaKhoaCuaMonHoc") %>' MaxLength="20"></asp:TextBox>
				</td>
			</tr>
			<tr>
