...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataMaChucDanh" runat="server" Text="Ma Chuc Danh:" AssociatedControlID="dataMaChucDanh" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataMaChucDanh" Text='<%# Bind("MaChucDanh") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataMaChucDanh" runat="server" Display="Dynamic" ControlToValidate="dataMaChucDanh" ErrorMessage="Invalid value" MaximumValue="2147483647" MinimumValue="-2147483648" Type="Integer"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataSiSoToiDa" runat="server" Text="Si So Toi Da:" AssociatedControlID="dataSiSoToiDa" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataSiSoToiDa" Text='<%# Bind("SiSoToiDa") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataSiSoToiDa" runat="server" Display="Dynamic" ControlToValidate="dataSiSoToiDa" ErrorMessage="Invalid value" MaximumValue="2147483647" MinimumValue="-2147483648" Type="Integer"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataSiSoToiThieu" runat="server" Text="Si So Toi Thieu:" AssociatedControlID="dataSiSoToiThieu" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataSiSoToiThieu" Text='<%# Bind("SiSoToiThieu") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataSiSoToiThieu" runat="server" Display="Dynamic" ControlToValidate="dataSiSoToiThieu" ErrorMessage="Invalid value" MaximumValue="2147483647" MinimumValue="-2147483648" Type="Integer"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
