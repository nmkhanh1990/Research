...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataPhanTramGiamTruNckh" runat="server" Text="Phan Tram Giam Tru Nckh:" AssociatedControlID="dataPhanTramGiamTruNckh" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataPhanTramGiamTruNckh" Text='<%# Bind("PhanTramGiamTruNckh") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataPhanTramGiamTruNckh" runat="server" Display="Dynamic" ControlToValidate="dataPhanTramGiamTruNckh" ErrorMessage="Invalid value" MaximumValue="999999999" MinimumValue="-999999999" Type="Double"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
