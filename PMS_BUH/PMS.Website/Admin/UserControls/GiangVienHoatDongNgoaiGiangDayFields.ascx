...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataLayDuLieu" runat="server" Text="Lay Du Lieu:" AssociatedControlID="dataLayDuLieu" /></td>
        <td>
					<asp:RadioButtonList runat="server" ID="dataLayDuLieu" SelectedValue='<%# Bind("LayDuLieu") %>' RepeatDirection="Horizontal"><asp:ListItem Value="True" Text="Yes" Selected="True"></asp:ListItem><asp:ListItem Value="False" Text="No"></asp:ListItem></asp:RadioButtonList>
				</td>
			</tr>
			<tr>
