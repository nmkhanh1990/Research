<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="TaiKhoanEdit.aspx.cs" Inherits="TaiKhoanEdit" Title="TaiKhoan Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Tai Khoan - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="MaTaiKhoan" runat="server" DataSourceID="TaiKhoanDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/TaiKhoanFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:TaiKhoanDataSource ID="TaiKhoanDataSource" runat="server"
			SelectMethod="GetByMaTaiKhoan"
		>
			<Parameters>
				<asp:QueryStringParameter Name="MaTaiKhoan" QueryStringField="MaTaiKhoan" Type="String" />
		...
		<data:GiangVienDataSource ID="GiangVienDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:GiangVienFilter  Column="MaNguoiLap" QueryStringField="MaTaiKhoan" /> 
					</Filters>
				</data:SqlParameter>
		...
		<br />
		<data:EntityGridView ID="GridViewReportTemplate2" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewReportTemplate2_SelectedIndexChanged"			 			 
			DataSourceID="ReportTemplateDataSource2"
			...
			<EmptyDataTemplate>
				<b>No Report Template Found! </b>
				<asp:HyperLink runat="server" ID="hypReportTemplate" NavigateUrl="~/admin/ReportTemplateEdit.aspx">Add New</asp:HyperLink>
			</EmptyDataTemplate>
		</data:EntityGridView>					
		
		<data:ReportTemplateDataSource ID="ReportTemplateDataSource2" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:ReportTemplateFilter  Column="UserId" QueryStringField="MaTaiKhoan" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
