...
namespace PMS.Entities
{
	...
	{		
		...
		public GiangVienBase(System.String _maDanToc, System.String _maTonGiao, System.String _maDonVi, 
			...
			System.Boolean? _daXoaHrm, System.String _maQuanLyHrm)
		{
			this.entityData = new GiangVienEntityData();
			this.backupData = null;
			...
			System.Boolean? _daXoaHrm, System.String _maQuanLyHrm)
		{
			...
			newGiangVien.MaQuanLyHrm = _maQuanLyHrm;
			return newGiangVien;
		}
		...
		public virtual System.String MaQuanLyHrm
		{
			...
			set
			{
				...
				OnColumnChanging(GiangVienColumn.MaQuanLyHrm, this.entityData.MaQuanLyHrm);
				this.entityData.MaQuanLyHrm = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(GiangVienColumn.MaQuanLyHrm, this.entityData.MaQuanLyHrm);
		...
		protected override void AddValidationRules()
		{
			...
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
				new CommonRules.MaxLengthRuleArgs("MaQuanLyHrm", "Ma Quan Ly Hrm", 250));
		}
   		#endregion
		...
		public bool IsPropertyChanged(GiangVienColumn column)
		{
			switch(column)
			{
					...
					case GiangVienColumn.MaQuanLyHrm:
...
/*
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{64}{63}- MaGiangVien: {0}{63}- MaDanToc: {1}{63}- MaTonGiao: {2}{63}- MaDonVi: {3}{63}- MaHocHam: {4}{63}- MaHocVi: {5}{63}- MaLoaiGiangVien: {6}{63}- MaNguoiLap: {7}{63}- MatKhau: {8}{63}- MaTinhTrang: {9}{63}- MaQuanLy: {10}{63}- Ho: {11}{63}- TenDem: {12}{63}- Ten: {13}{63}- NgaySinh: {14}{63}- GioiTinh: {15}{63}- NoiSinh: {16}{63}- Cmnd: {17}{63}- NgayCap: {18}{63}- NoiCap: {19}{63}- DoanDang: {20}{63}- NgayVaoDoanDang: {21}{63}- NgayKyHopDong: {22}{63}- NgayKetThucHopDong: {23}{63}- HinhAnh: {24}{63}- DiaChi: {25}{63}- ThuongTru: {26}{63}- NoiLamViec: {27}{63}- Email: {28}{63}- DienThoai: {29}{63}- SoDiDong: {30}{63}- SoTaiKhoan: {31}{63}- TenNganHang: {32}{63}- MaSoThue: {33}{63}- ChiNhanh: {34}{63}- SoSoBaoHiem: {35}{63}- ThoiGianBatDau: {36}{63}- BacLuong: {37}{63}- NgayHuongLuong: {38}{63}- NamLamViec: {39}{63}- ChuyenNganh: {40}{63}- MaHeSoThuLao: {41}{63}- Ngach: {42}{63}- SoHieuCongChuc: {43}{63}- Hrmid: {44}{63}- NoiCapBang: {45}{63}- KhoaTaiKhoan: {46}{63}- MaLoaiNhanVien: {47}{63}- MaNgachCongChuc: {48}{63}- MaTrinhDoChinhTri: {49}{63}- MaTrinhDoSuPham: {50}{63}- MaTrinhDoNgoaiNgu: {51}{63}- MaTrinhDoTinHoc: {52}{63}- MaTrinhDoQuanLyNhaNuoc: {53}{63}- NguoiCapNhat: {54}{63}- NgayCapNhat: {55}{63}- KhoiKienThucGiangDay: {56}{63}- NganhDaoTao: {57}{63}- DonViGiangDay: {58}{63}- IdHoSo: {59}{63}- MaQuocTich: {60}{63}- DaXoaHrm: {61}{63}- MaQuanLyHrm: {62}{63}{65}", 
				this.MaGiangVien,
	...
	public enum GiangVienColumn : int
	{
		...
		[ColumnEnum("MaQuanLyHRM", typeof(System.String), System.Data.DbType.String, false, false, true, 250)]
		MaQuanLyHrm = 63
	}//End enum
