...
namespace PMS.Entities
{
	...
	public abstract partial class ViewDanhSachLopPhanCongGiangDayBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// LoaiHP : 
		/// </summary>
		private System.String		  _loaiHp = null;
		...
		public static bool Equals(ViewDanhSachLopPhanCongGiangDayBase Object1, ViewDanhSachLopPhanCongGiangDayBase Object2)
		{
			...
			if (Object1.TenHp != Object2.TenHp)
				equal = false;
			if (Object1.LoaiHp != null && Object2.LoaiHp != null )
			{
				if (Object1.LoaiHp != Object2.LoaiHp)
					equal = false;
			}
			else if (Object1.LoaiHp == null ^ Object1.LoaiHp == null )
			{
				equal = false;
			}
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				...
				this.TenHp,
				(this.LoaiHp == null) ? string.Empty : this.LoaiHp.ToString(),
	...
	public enum ViewDanhSachLopPhanCongGiangDayColumn
	{
		...
		[ColumnEnum("LoaiHP", typeof(System.String), System.Data.DbType.String, false, false, true, 100)]
		LoaiHp,
		/// <summary>
		/// SoTC : 
		/// </summary>
		...
		[ColumnEnum("MaCBGD", typeof(System.String), System.Data.DbType.AnsiString, false, false, true, 2000)]
		MaCbgd,
		/// <summary>
		/// TenCBGD : 
		/// </summary>
		[EnumTextValue("TenCBGD")]
		[ColumnEnum("TenCBGD", typeof(System.String), System.Data.DbType.String, false, false, true, 2000)]
		TenCbgd,
		/// <summary>
		/// TKB : 
		/// </summary>
