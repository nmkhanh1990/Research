...
namespace PMS.Entities
{
	...
	{		
		...
		public KetQuaThanhToanThuLaoBase(System.Int32? _maGiangVien, System.String _namHoc, 
			...
			System.DateTime? _ngayXacNhanThanhToan)
		{
			this.entityData = new KetQuaThanhToanThuLaoEntityData();
			this.backupData = null;
			...
			this.NgayXacNhanThanhToan = _ngayXacNhanThanhToan;
		}
			...
			System.DateTime? _ngayXacNhanThanhToan)
		{
			...
			newKetQuaThanhToanThuLao.NgayXacNhanThanhToan = _ngayXacNhanThanhToan;
		...
		/// <summary>
		/// 	Gets or sets the NgayXacNhanThanhToan property. 
		///		
		/// </summary>
		/// <value>This type is datetime.</value>
		/// <remarks>
		...
		[DescriptionAttribute(@""), System.ComponentModel.Bindable( System.ComponentModel.BindableSupport.Yes)]
		[DataObjectField(false, false, true)]
		public virtual System.DateTime? NgayXacNhanThanhToan
		{
			get
			{
				return this.entityData.NgayXacNhanThanhToan; 
			}
			
			set
			{
				if (this.entityData.NgayXacNhanThanhToan == value)
					return;
				
                OnPropertyChanging("NgayXacNhanThanhToan");                    
				OnColumnChanging(KetQuaThanhToanThuLaoColumn.NgayXacNhanThanhToan, this.entityData.NgayXacNhanThanhToan);
				this.entityData.NgayXacNhanThanhToan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(KetQuaThanhToanThuLaoColumn.NgayXacNhanThanhToan, this.entityData.NgayXacNhanThanhToan);
				OnPropertyChanged("NgayXacNhanThanhToan");
			}
		}
		...
		protected virtual KetQuaThanhToanThuLao Copy(IDictionary existingCopies)
		{
			...
			copy.SuppressEntityEvents = true;
				...
				copy.NgayXacNhanThanhToan = this.NgayXacNhanThanhToan;
		...
		public bool IsPropertyChanged(KetQuaThanhToanThuLaoColumn column)
		{
			switch(column)
			{
					...
					case KetQuaThanhToanThuLaoColumn.NgayXacNhanThanhToan:
					return entityData.NgayXacNhanThanhToan != _originalData.NgayXacNhanThanhToan;
		...
		public bool HasDataChanged()
		{
			...
			result = result || entityData.NgayXacNhanThanhToan != _originalData.NgayXacNhanThanhToan;
			return result;
		}	
		...
		public KetQuaThanhToanThuLao GetOriginalEntity()
		{
			if (_originalData != null)
				...
				_originalData.NgayXacNhanThanhToan
				);
	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.Id.GetHashCode() ^ 
					...
					((this.NgayXacNhanThanhToan == null) ? string.Empty : this.NgayXacNhanThanhToan.ToString()).GetHashCode();
        }
		...
		public static bool ValueEquals(KetQuaThanhToanThuLaoBase Object1, KetQuaThanhToanThuLaoBase Object2)
		{
			...
			if ( Object1.NgayXacNhanThanhToan != null && Object2.NgayXacNhanThanhToan != null )
			{
				if (Object1.NgayXacNhanThanhToan != Object2.NgayXacNhanThanhToan)
					equal = false;
			}
			else if (Object1.NgayXacNhanThanhToan == null ^ Object2.NgayXacNhanThanhToan == null )
			{
				equal = false;
			}
...
/*
        ...
        public int CompareTo(KetQuaThanhToanThuLao rhs, KetQuaThanhToanThuLaoColumn which)
        {
            switch (which)
            {
            	...
            	case KetQuaThanhToanThuLaoColumn.NgayXacNhanThanhToan:
            		return this.NgayXacNhanThanhToan.Value.CompareTo(rhs.NgayXacNhanThanhToan.Value);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{65}{64}- Id: {0}{64}- MaGiangVien: {1}{64}- NamHoc: {2}{64}- HocKy: {3}{64}- MaHocHam: {4}{64}- MaHocVi: {5}{64}- MaLoaiGiangVien: {6}{64}- MaDonVi: {7}{64}- Loai: {8}{64}- PhanLoai: {9}{64}- MaMonHoc: {10}{64}- TenMonHoc: {11}{64}- LoaiHocPhan: {12}{64}- Nhom: {13}{64}- MaLop: {14}{64}- LopClc: {15}{64}- SiSo: {16}{64}- TietThucDay: {17}{64}- TietChuNhat: {18}{64}- HeSoHocKy: {19}{64}- HeSoLopDong: {20}{64}- TietQuyDoi: {21}{64}- DonGia: {22}{64}- ThanhTien: {23}{64}- LanChot: {24}{64}- NgayCapNhat: {25}{64}- MaHinhThucDaoTao: {26}{64}- DonGiaTrongChuan: {27}{64}- DonGiaNgoaiChuan: {28}{64}- TenCoSo: {29}{64}- HeSoQuyDoiThucHanhSangLyThuyet: {30}{64}- HeSoCoSo: {31}{64}- SoGioThucGiangTrenLop: {32}{64}- SoGioChuanTinhThem: {33}{64}- HeSoChucDanhChuyenMon: {34}{64}- HeSoClcCntn: {35}{64}- HeSoThinhGiangMonChuyenNganh: {36}{64}- MaNhomMonHoc: {37}{64}- LoaiLop: {38}{64}- MaBacDaoTao: {39}{64}- MalopHocPhan: {40}{64}- MaKhoaHoc: {41}{64}- HeSoTroCap: {42}{64}- HeSoNgoaiGio: {43}{64}- HeSoLuong: {44}{64}- HeSoMonMoi: {45}{64}- HeSoNienCheTinChi: {46}{64}- HeSoNgonNgu: {47}{64}- HeSoBacDaoTao: {48}{64}- NgayChiTra: {49}{64}- XacNhanChiTra: {50}{64}- GhiChu: {51}{64}- NguoiCapNhat: {52}{64}- HeSoCongViec: {53}{64}- NgonNguGiangDay: {54}{64}- MaCoSo: {55}{64}- MucThanhToan: {56}{64}- DotChiTra: {57}{64}- HeSoKhoiNganh: {58}{64}- MaCauHinhChotGio: {59}{64}- MaKhoaCuaMonHoc: {60}{64}- HeSoThamNien: {61}{64}- MaLoaiHinhDaoTao: {62}{64}- NgayXacNhanThanhToan: {63}{64}{66}", 
				this.Id,
				...
				(this.NgayXacNhanThanhToan == null) ? string.Empty : this.NgayXacNhanThanhToan.ToString(),
	...
	internal protected class KetQuaThanhToanThuLaoEntityData : ICloneable, ICloneableEx
	{
		...
		/// NgayXacNhanThanhToan : 
		/// </summary>
		public System.DateTime? NgayXacNhanThanhToan = null;
		#endregion
		...
		public Object Clone()
		{
			...
			_tmp.NgayXacNhanThanhToan = this.NgayXacNhanThanhToan;
	...
	public enum KetQuaThanhToanThuLaoColumn : int
	{
		...
		/// NgayXacNhanThanhToan : 
		/// </summary>
		[EnumTextValue("Ngay Xac Nhan Thanh Toan")]
		[ColumnEnum("NgayXacNhanThanhToan", typeof(System.DateTime), System.Data.DbType.DateTime, false, false, true)]
		NgayXacNhanThanhToan = 64
	}//End enum
