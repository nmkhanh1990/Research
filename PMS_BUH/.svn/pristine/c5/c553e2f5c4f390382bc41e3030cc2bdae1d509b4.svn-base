...
{	
	...
	{		
		...
		public static TList<TinhTrang> Fill(IDataReader reader, TList<TinhTrang> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.TinhTrang = (reader[TinhTrangColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(TinhTrangColumn.TinhTrang.ToString())];
					c.TrangThai = (reader[TinhTrangColumn.TrangThai.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(TinhTrangColumn.TrangThai.ToString())];
					c.MaQuanLyHrm = (reader[TinhTrangColumn.MaQuanLyHrm.ToString()] == DBNull.Value) ? null : (System.String)reader[(TinhTrangColumn.MaQuanLyHrm.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.TinhTrang entity)
		{
			...
			entity.TinhTrang = (reader[TinhTrangColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(TinhTrangColumn.TinhTrang.ToString())];
			entity.TrangThai = (reader[TinhTrangColumn.TrangThai.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(TinhTrangColumn.TrangThai.ToString())];
			entity.MaQuanLyHrm = (reader[TinhTrangColumn.MaQuanLyHrm.ToString()] == DBNull.Value) ? null : (System.String)reader[(TinhTrangColumn.MaQuanLyHrm.ToString())];
