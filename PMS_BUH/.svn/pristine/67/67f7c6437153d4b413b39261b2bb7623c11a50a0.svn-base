...
namespace PMS.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@NgayXacNhanThanhToan", DbType.DateTime, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("ngayxacnhanthanhtoan ") || clause.Trim().StartsWith("ngayxacnhanthanhtoan="))
				{
					database.SetParameterValue(commandWrapper, "@NgayXacNhanThanhToan", 
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.KetQuaThanhToanThuLao> entities)
		{
			...
			DataColumn col63 = dataTable.Columns.Add("NgayXacNhanThanhToan", typeof(System.DateTime));
			...
			bulkCopy.ColumnMappings.Add("NgayXacNhanThanhToan", "NgayXacNhanThanhToan");
			...
			foreach(PMS.Entities.KetQuaThanhToanThuLao entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["NgayXacNhanThanhToan"] = entity.NgayXacNhanThanhToan.HasValue ? (object) entity.NgayXacNhanThanhToan  : System.DBNull.Value;
		...
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.KetQuaThanhToanThuLao entity)
		{
			...
			database.AddInParameter(commandWrapper, "@NgayXacNhanThanhToan", DbType.DateTime, (entity.NgayXacNhanThanhToan.HasValue ? (object) entity.NgayXacNhanThanhToan  : System.DBNull.Value));
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object.</param>
		/// <remark>This method is generated from a stored procedure.</remark>
		public override void GetDataVuotGioBoSung_Bk(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.Int32 lanChotHk01, System.Int32 lanChotHk02, System.String khoaDonVi)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
