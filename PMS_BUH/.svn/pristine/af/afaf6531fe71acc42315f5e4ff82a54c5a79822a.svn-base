...
{	
	...
	{		
		...
		public static TList<NhomHoatDongNgoaiGiangDay> Fill(IDataReader reader, TList<NhomHoatDongNgoaiGiangDay> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.NhomClc = (reader[NhomHoatDongNgoaiGiangDayColumn.NhomClc.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(NhomHoatDongNgoaiGiangDayColumn.NhomClc.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.NhomHoatDongNgoaiGiangDay entity)
		{
			...
			entity.NhomClc = (reader[NhomHoatDongNgoaiGiangDayColumn.NhomClc.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(NhomHoatDongNgoaiGiangDayColumn.NhomClc.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.NhomHoatDongNgoaiGiangDay entity)
		{
			...
			entity.NhomClc = Convert.IsDBNull(dataRow["NhomCLC"]) ? null : (System.Boolean?)dataRow["NhomCLC"];
			entity.AcceptChanges();
		}
		#endregion 
