<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="DanhMucNghienCuuKhoaHocEdit.aspx.cs" Inherits="DanhMucNghienCuuKhoaHocEdit" Title="DanhMucNghienCuuKhoaHoc Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Danh Muc Nghien Cuu Khoa Hoc - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="Id" runat="server" DataSourceID="DanhMucNghienCuuKhoaHocDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/DanhMucNghienCuuKhoaHocFields.ascx" />
			</EditItemTemplatePaths>
			...
			<EmptyDataTemplate>
				<b>DanhMucNghienCuuKhoaHoc not found!</b>
			</EmptyDataTemplate>
		...
		<data:GiangVienNghienCuuKhDataSource ID="GiangVienNghienCuuKhDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:GiangVienNghienCuuKhFilter  Column="MaNckh" QueryStringField="Id" /> 
					</Filters>
				</data:SqlParameter>
