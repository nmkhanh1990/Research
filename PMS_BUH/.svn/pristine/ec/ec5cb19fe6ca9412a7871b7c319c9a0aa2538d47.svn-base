...
{	
	...
	{		
		...
		public static TList<LoaiLop> Fill(IDataReader reader, TList<LoaiLop> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.MaHoatDong = (reader[LoaiLopColumn.MaHoatDong.ToString()] == DBNull.Value) ? null : (System.String)reader[(LoaiLopColumn.MaHoatDong.ToString())];
					c.TinhTrangHoatDong = (reader[LoaiLopColumn.TinhTrangHoatDong.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(LoaiLopColumn.TinhTrangHoatDong.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.LoaiLop entity)
		{
			...
			entity.MaHoatDong = (reader[LoaiLopColumn.MaHoatDong.ToString()] == DBNull.Value) ? null : (System.String)reader[(LoaiLopColumn.MaHoatDong.ToString())];
			entity.TinhTrangHoatDong = (reader[LoaiLopColumn.TinhTrangHoatDong.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(LoaiLopColumn.TinhTrangHoatDong.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.LoaiLop entity)
		{
			...
			entity.TinhTrangHoatDong = Convert.IsDBNull(dataRow["TinhTrangHoatDong"]) ? null : (System.Boolean?)dataRow["TinhTrangHoatDong"];
			entity.AcceptChanges();
		}
		#endregion 
