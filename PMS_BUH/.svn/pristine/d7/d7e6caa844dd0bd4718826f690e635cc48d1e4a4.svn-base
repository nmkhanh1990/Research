<%@ Control Language="C#" ClassName="ChucDanhFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataTenChucDanh" runat="server" Text="Ten Chuc Danh:" AssociatedControlID="dataTenChucDanh" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataTenChucDanh" Text='<%# Bind("TenChucDanh") %>' MaxLength="200"></asp:TextBox>
				</td>
			</tr>
