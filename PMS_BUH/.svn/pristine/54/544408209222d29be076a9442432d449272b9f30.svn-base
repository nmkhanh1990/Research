...
{	
	...
	{		
		...
		public static TList<LoaiGiangVien> Fill(IDataReader reader, TList<LoaiGiangVien> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.TinhTrang = (reader[LoaiGiangVienColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(LoaiGiangVienColumn.TinhTrang.ToString())];
					c.TrangThai = (reader[LoaiGiangVienColumn.TrangThai.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(LoaiGiangVienColumn.TrangThai.ToString())];
					c.MaQuanLyHrm = (reader[LoaiGiangVienColumn.MaQuanLyHrm.ToString()] == DBNull.Value) ? null : (System.String)reader[(LoaiGiangVienColumn.MaQuanLyHrm.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.LoaiGiangVien entity)
		{
			...
			entity.TinhTrang = (reader[LoaiGiangVienColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(LoaiGiangVienColumn.TinhTrang.ToString())];
			entity.TrangThai = (reader[LoaiGiangVienColumn.TrangThai.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(LoaiGiangVienColumn.TrangThai.ToString())];
			entity.MaQuanLyHrm = (reader[LoaiGiangVienColumn.MaQuanLyHrm.ToString()] == DBNull.Value) ? null : (System.String)reader[(LoaiGiangVienColumn.MaQuanLyHrm.ToString())];
		...
		public override void DeepLoad(TransactionManager transactionManager, PMS.Entities.LoaiGiangVien entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			...
			if (CanDeepLoad(entity, "List<DonGiaTheoNganh>|DonGiaTheoNganhCollection", deepLoadType, innerList)) 
			{
				...
				entity.DonGiaTheoNganhCollection = DataRepository.DonGiaTheoNganhProvider.GetByMaLoaiGiangVien(transactionManager, entity.MaLoaiGiangVien);
	...
	{
		///<summary>
		/// Collection of <c>LoaiGiangVien</c> as OneToMany for DonGiaTheoNganhCollection
		///</summary>
