...
namespace PMS.UI.Forms.HeThong
{
    public partial class frmThongTin : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frmThongTin_Load(object sender, EventArgs e)
        {
            ...
            //cbnamhoc.DataBindings.Add("EditValue", bindingSourceNamHoc, "_namHoc", true, DataSourceUpdateMode.Never);
            ...
            //    cbhocky.DataBindings.Add("EditValue", bindingSourceHocKy, "MaHocKy", true, DataSourceUpdateMode.Never);
            //}
            //getHocKyCurrent();
            //getNamHocCurrent();
