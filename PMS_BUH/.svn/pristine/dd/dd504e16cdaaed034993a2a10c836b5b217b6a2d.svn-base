...
{	
	...
	{		
		...
		public static TList<LoaiNghienCuuKhoaHoc> Fill(IDataReader reader, TList<LoaiNghienCuuKhoaHoc> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.DonViNckh = (reader[LoaiNghienCuuKhoaHocColumn.DonViNckh.ToString()] == DBNull.Value) ? null : (System.String)reader[(LoaiNghienCuuKhoaHocColumn.DonViNckh.ToString())];
					c.TinhTrang = (reader[LoaiNghienCuuKhoaHocColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(LoaiNghienCuuKhoaHocColumn.TinhTrang.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.LoaiNghienCuuKhoaHoc entity)
		{
			...
			entity.DonViNckh = (reader[LoaiNghienCuuKhoaHocColumn.DonViNckh.ToString()] == DBNull.Value) ? null : (System.String)reader[(LoaiNghienCuuKhoaHocColumn.DonViNckh.ToString())];
			entity.TinhTrang = (reader[LoaiNghienCuuKhoaHocColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(LoaiNghienCuuKhoaHocColumn.TinhTrang.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.LoaiNghienCuuKhoaHoc entity)
		{
			...
			entity.DonViNckh = Convert.IsDBNull(dataRow["DonViNCKH"]) ? null : (System.String)dataRow["DonViNCKH"];
