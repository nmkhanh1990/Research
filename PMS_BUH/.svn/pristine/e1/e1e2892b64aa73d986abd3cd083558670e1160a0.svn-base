...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
			...
			<Columns>
				...
				<data:BoundRadioButtonField DataField="NhomHoatDongClc" HeaderText="Nhom Hoat Dong Clc" SortExpression="[NhomHoatDongCLC]"  />
				<data:BoundRadioButtonField DataField="NhomHoatDongBt" HeaderText="Nhom Hoat Dong Bt" SortExpression="[NhomHoatDongBT]"  />
