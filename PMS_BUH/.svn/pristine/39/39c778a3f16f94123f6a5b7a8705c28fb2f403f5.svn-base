...
{
    public partial class ucTrinhDoNgoaiNgu : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTrinhDoNgoaiNgu()
        {
            InitializeComponent();
        }

        private void ucTrinhDoNgoaiNgu_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewKyThi, new string[] { "MaQuanLy", "TenTrinhDoNgoaiNgu", "GhiChu", "NgayCapNhat", "NguoiCapNhat" },
                new string[] { "Mã trình độ ngoại ngữ", "Tên trình độ ngoại ngữ", "Ghi chú", "Ngày cập nhật", "Người cập nhật" },
        ...
        void InitData()
        {
            bindingSourceKyThi.DataSource = DataServices.TrinhDoNgoaiNgu.GetAll();
        }
        ...
        private void btnLuu_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            TList<TrinhDoNgoaiNgu> list = bindingSourceKyThi.DataSource as TList<TrinhDoNgoaiNgu>;
            if (list != null)
            {
                if (XtraMessageBox.Show("Bạn có muốn lưu các thay đổi không ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    try
                    {
                        if (list.IsValid)
                        {
                            ...
                            DataServices.TrinhDoNgoaiNgu.Save(list);
        ...
        private void gridViewKyThi_CellValueChanged(object sender, DevExpress.XtraGrid.Views.Base.CellValueChangedEventArgs e)
        {
            ...
            if (col.FieldName == "MaQuanLy" || col.FieldName == "TenTrinhDoNgoaiNgu" || col.FieldName == "GhiChu")
            {
        ...
        {
            TrinhDoNgoaiNgu obj = e.Row as TrinhDoNgoaiNgu;
            if (obj != null)
            {
        ...
        {
            TrinhDoNgoaiNgu obj = target as TrinhDoNgoaiNgu;
            if (obj != null)
            {
                if (((TList<TrinhDoNgoaiNgu>)bindingSourceKyThi.DataSource).FindAll(p => p.MaQuanLy == obj.MaQuanLy).Count > 1)
                {
