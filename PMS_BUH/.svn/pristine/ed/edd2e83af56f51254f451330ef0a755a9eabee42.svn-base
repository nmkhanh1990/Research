...
{	
	...
	{		
		...
		public static TList<BacLuong> Fill(IDataReader reader, TList<BacLuong> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.TinhTrang = (reader[BacLuongColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(BacLuongColumn.TinhTrang.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.BacLuong entity)
		{
			...
			entity.TinhTrang = (reader[BacLuongColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(BacLuongColumn.TinhTrang.ToString())];
