...
namespace PMS.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@NhomClc", DbType.Boolean, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("nhomclc ") || clause.Trim().StartsWith("nhomclc="))
				{
					database.SetParameterValue(commandWrapper, "@NhomClc", 
						clause.Trim().Remove(0,7).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.NhomHoatDongNgoaiGiangDay> entities)
		{
			...
			DataColumn col4 = dataTable.Columns.Add("NhomCLC", typeof(System.Boolean));
			...
			bulkCopy.ColumnMappings.Add("NhomCLC", "NhomCLC");
			...
			foreach(PMS.Entities.NhomHoatDongNgoaiGiangDay entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["NhomCLC"] = entity.NhomClc.HasValue ? (object) entity.NhomClc  : System.DBNull.Value;
		...
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.NhomHoatDongNgoaiGiangDay entity)
		{
			...
			database.AddInParameter(commandWrapper, "@NhomClc", DbType.Boolean, (entity.NhomClc.HasValue ? (object) entity.NhomClc  : System.DBNull.Value));
