...
{	
	...
	{		
		...
		public static TList<DonGiaChatLuongCao> Fill(IDataReader reader, TList<DonGiaChatLuongCao> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.MaHocHam = (reader[DonGiaChatLuongCaoColumn.MaHocHam.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(DonGiaChatLuongCaoColumn.MaHocHam.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.DonGiaChatLuongCao entity)
		{
			...
			entity.MaHocHam = (reader[DonGiaChatLuongCaoColumn.MaHocHam.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(DonGiaChatLuongCaoColumn.MaHocHam.ToString())];
