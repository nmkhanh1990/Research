<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="TrinhDoQuanLyNhaNuocEdit.aspx.cs" Inherits="TrinhDoQuanLyNhaNuocEdit" Title="TrinhDoQuanLyNhaNuoc Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Trinh Do Quan Ly Nha Nuoc - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="MaTrinhDoQuanLyNhaNuoc" runat="server" DataSourceID="TrinhDoQuanLyNhaNuocDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/TrinhDoQuanLyNhaNuocFields.ascx" />
			</EditItemTemplatePaths>
			...
			<EmptyDataTemplate>
				<b>TrinhDoQuanLyNhaNuoc not found!</b>
			</EmptyDataTemplate>
		...
		<data:TrinhDoQuanLyNhaNuocDataSource ID="TrinhDoQuanLyNhaNuocDataSource" runat="server"
			SelectMethod="GetByMaTrinhDoQuanLyNhaNuoc"
		>
			<Parameters>
				<asp:QueryStringParameter Name="MaTrinhDoQuanLyNhaNuoc" QueryStringField="MaTrinhDoQuanLyNhaNuoc" Type="String" />
		...
		<data:GiangVienDataSource ID="GiangVienDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:GiangVienFilter  Column="MaTrinhDoQuanLyNhaNuoc" QueryStringField="MaTrinhDoQuanLyNhaNuoc" /> 
					</Filters>
				</data:SqlParameter>
