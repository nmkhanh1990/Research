<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="TrinhDoNgoaiNguEdit.aspx.cs" Inherits="TrinhDoNgoaiNguEdit" Title="TrinhDoNgoaiNgu Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Trinh Do Ngoai Ngu - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="MaTrinhDoNgoaiNgu" runat="server" DataSourceID="TrinhDoNgoaiNguDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/TrinhDoNgoaiNguFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:TrinhDoNgoaiNguDataSource ID="TrinhDoNgoaiNguDataSource" runat="server"
			SelectMethod="GetByMaTrinhDoNgoaiNgu"
		>
			<Parameters>
				<asp:QueryStringParameter Name="MaTrinhDoNgoaiNgu" QueryStringField="MaTrinhDoNgoaiNgu" Type="String" />
		...
		<data:GiangVienDataSource ID="GiangVienDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:GiangVienFilter  Column="MaTrinhDoNgoaiNgu" QueryStringField="MaTrinhDoNgoaiNgu" /> 
					</Filters>
				</data:SqlParameter>
