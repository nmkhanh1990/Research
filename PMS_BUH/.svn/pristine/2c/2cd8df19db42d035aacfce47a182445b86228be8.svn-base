...
{	
	...
	{		
		...
		public static TList<DanhMucNghienCuuKhoaHoc> Fill(IDataReader reader, TList<DanhMucNghienCuuKhoaHoc> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.DonVi = (reader[DanhMucNghienCuuKhoaHocColumn.DonVi.ToString()] == DBNull.Value) ? null : (System.String)reader[(DanhMucNghienCuuKhoaHocColumn.DonVi.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.DanhMucNghienCuuKhoaHoc entity)
		{
			...
			entity.DonVi = (reader[DanhMucNghienCuuKhoaHocColumn.DonVi.ToString()] == DBNull.Value) ? null : (System.String)reader[(DanhMucNghienCuuKhoaHocColumn.DonVi.ToString())];
