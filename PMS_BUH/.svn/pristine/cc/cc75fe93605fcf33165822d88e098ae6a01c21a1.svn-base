...
{	
	...
	{		
		...
		public static TList<ChucVu> Fill(IDataReader reader, TList<ChucVu> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.DinhMucToiThieuNckh = (reader[ChucVuColumn.DinhMucToiThieuNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(ChucVuColumn.DinhMucToiThieuNckh.ToString())];
					c.TinhTrang = (reader[ChucVuColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(ChucVuColumn.TinhTrang.ToString())];
					c.MaQuanLyHrm = (reader[ChucVuColumn.MaQuanLyHrm.ToString()] == DBNull.Value) ? null : (System.String)reader[(ChucVuColumn.MaQuanLyHrm.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.ChucVu entity)
		{
			...
			entity.DinhMucToiThieuNckh = (reader[ChucVuColumn.DinhMucToiThieuNckh.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(ChucVuColumn.DinhMucToiThieuNckh.ToString())];
			entity.TinhTrang = (reader[ChucVuColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(ChucVuColumn.TinhTrang.ToString())];
			entity.MaQuanLyHrm = (reader[ChucVuColumn.MaQuanLyHrm.ToString()] == DBNull.Value) ? null : (System.String)reader[(ChucVuColumn.MaQuanLyHrm.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.ChucVu entity)
		{
			...
			entity.DinhMucToiThieuNckh = Convert.IsDBNull(dataRow["DinhMucToiThieuNckh"]) ? null : (System.Decimal?)dataRow["DinhMucToiThieuNckh"];
