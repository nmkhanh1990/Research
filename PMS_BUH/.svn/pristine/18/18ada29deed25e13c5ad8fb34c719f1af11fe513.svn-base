...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucNhomHoatDongNgoaiGiangDay : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucNhomHoatDongNgoaiGiangDay_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewHoatDongNgoaiGiangDay, new string[] { "MaNhom", "TenNhom","NhomClc", "GhiChu" }
                        , new string[] { "Mã nhóm hoạt động", "Tên nhóm hoạt động","Nhóm Clc", "Ghi chú" }
                        , new int[] { 120, 170,60, 100});
            AppGridView.AlignHeader(gridViewHoatDongNgoaiGiangDay, new string[] { "MaNhom", "TenNhom", "NhomClc", "GhiChu" }, DevExpress.Utils.HorzAlignment.Center);
            #endregion
