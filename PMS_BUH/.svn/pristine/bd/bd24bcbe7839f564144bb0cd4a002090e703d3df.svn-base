...
{
    public partial class ucThongKeTongHopThanhToanThuLao_Kcq : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable
        TList<CauHinhChung> _cauHinhChung = DataServices.CauHinhChung.GetAll();
        int lanchot = 0;
        #endregion
        public ucThongKeTongHopThanhToanThuLao_Kcq()
        {
            InitializeComponent();
        ...
        void InitData()
        {
            ...
            if (cboNamHoc.EditValue != null && cboDonVi.EditValue != null)
            {
                ...
                try
                {
                    IDataReader reader = DataServices.KcqKetQuaThanhToanThuLao.TongHopKetQuaThanhToan(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), cboDonVi.EditValue.ToString(), cboLoaiGiangVien.EditValue.ToString(), int.Parse(cboLanChot.EditValue.ToString()));
                    dt.Load(reader);
                }
                catch
                {
