...
{	
	...
	{		
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader Luu(System.String xmlData, System.String maGiangVien)
		{
			return Luu(null, 0, int.MaxValue , xmlData, maGiangVien);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader Luu(int start, int pageLength, System.String xmlData, System.String maGiangVien)
		{
			return Luu(null, start, pageLength , xmlData, maGiangVien);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader Luu(TransactionManager transactionManager, System.String xmlData, System.String maGiangVien)
		{
			return Luu(transactionManager, 0, int.MaxValue , xmlData, maGiangVien);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public abstract IDataReader Luu(TransactionManager transactionManager, int start, int pageLength , System.String xmlData, System.String maGiangVien);
		...
		#region cust_CoVanHocTap_LayHeSoSiSoTheoMaLop 
		
		/// <summary>
		///	This method wrap the 'cust_CoVanHocTap_LayHeSoSiSoTheoMaLop' stored procedure. 
		/// </summary>
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader LayHeSoSiSoTheoMaLop(System.String namHoc, System.String hocKy)
		{
			return LayHeSoSiSoTheoMaLop(null, 0, int.MaxValue , namHoc, hocKy);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader LayHeSoSiSoTheoMaLop(int start, int pageLength, System.String namHoc, System.String hocKy)
		{
			return LayHeSoSiSoTheoMaLop(null, start, pageLength , namHoc, hocKy);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader LayHeSoSiSoTheoMaLop(TransactionManager transactionManager, System.String namHoc, System.String hocKy)
		{
			return LayHeSoSiSoTheoMaLop(transactionManager, 0, int.MaxValue , namHoc, hocKy);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public abstract IDataReader LayHeSoSiSoTheoMaLop(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy);
		...
		public static TList<CoVanHocTap> Fill(IDataReader reader, TList<CoVanHocTap> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.HeSo = (reader[CoVanHocTapColumn.HeSo.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(CoVanHocTapColumn.HeSo.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.CoVanHocTap entity)
		{
			...
			entity.HeSo = (reader[CoVanHocTapColumn.HeSo.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(CoVanHocTapColumn.HeSo.ToString())];
