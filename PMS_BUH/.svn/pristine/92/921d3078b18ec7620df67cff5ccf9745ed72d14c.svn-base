...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridViewGiangVienHoatDongQuanLy1" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewGiangVienHoatDongQuanLy1_SelectedIndexChanged"			 			 
			DataSourceID="GiangVienHoatDongQuanLyDataSource1"
			DataKeyNames="Id"
		...
		<data:GiangVienHoatDongQuanLyDataSource ID="GiangVienHoatDongQuanLyDataSource1" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
