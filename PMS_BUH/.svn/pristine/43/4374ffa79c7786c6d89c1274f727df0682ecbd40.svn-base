...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
			...
			<Columns>
				...
				<data:BoundRadioButtonField DataField="XacNhanThue" HeaderText="Xac Nhan Thue" SortExpression="[XacNhanThue]"  />
				<asp:BoundField DataField="MaHoatDong" HeaderText="Ma Hoat Dong" SortExpression="[MaHoatDong]"  />
				<data:BoundRadioButtonField DataField="XacNhanKhongThue" HeaderText="Xac Nhan Khong Thue" SortExpression="[XacNhanKhongThue]"  />
