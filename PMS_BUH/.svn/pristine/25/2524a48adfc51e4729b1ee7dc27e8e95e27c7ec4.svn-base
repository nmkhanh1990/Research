...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridViewGiangVienCamKetKhongTruThue4" runat="server"
			...
			<Columns>
				...
				<asp:BoundField DataField="XacNhanThue" HeaderText="Xac Nhan Thue" SortExpression="[XacNhanThue]" />				
				<asp:BoundField DataField="XacNhanKhongThue" HeaderText="Xac Nhan Khong Thue" SortExpression="[XacNhanKhongThue]" />				
		...
		<br />
		<data:EntityGridView ID="GridViewGiangVienChuyenMon15" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewGiangVienChuyenMon15_SelectedIndexChanged"			 			 
			DataSourceID="GiangVienChuyenMonDataSource15"
		...
		<data:GiangVienChuyenMonDataSource ID="GiangVienChuyenMonDataSource15" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
		...
		<br />
		<data:EntityGridView ID="GridViewTietNghiaVu16" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewTietNghiaVu16_SelectedIndexChanged"			 			 
			DataSourceID="TietNghiaVuDataSource16"
			DataKeyNames="Id"
			AllowMultiColumnSorting="false"
			DefaultSortColumnName="" 
			DefaultSortDirection="Ascending"	
		...
		<data:TietNghiaVuDataSource ID="TietNghiaVuDataSource16" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
		...
		<br />
		<data:EntityGridView ID="GridViewGiangVienMocTangLuong17" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewGiangVienMocTangLuong17_SelectedIndexChanged"			 			 
			DataSourceID="GiangVienMocTangLuongDataSource17"
			DataKeyNames="Id"
			AllowMultiColumnSorting="false"
			DefaultSortColumnName="" 
			DefaultSortDirection="Ascending"	
		...
		<data:GiangVienMocTangLuongDataSource ID="GiangVienMocTangLuongDataSource17" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
		...
		<br />
		<data:EntityGridView ID="GridViewGiangVienGiamTruDinhMuc18" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewGiangVienGiamTruDinhMuc18_SelectedIndexChanged"			 			 
			DataSourceID="GiangVienGiamTruDinhMucDataSource18"
		...
		<data:GiangVienGiamTruDinhMucDataSource ID="GiangVienGiamTruDinhMucDataSource18" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
		...
		<br />
		<data:EntityGridView ID="GridViewGiangVienHoatDongNgoaiGiangDay19" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewGiangVienHoatDongNgoaiGiangDay19_SelectedIndexChanged"			 			 
			DataSourceID="GiangVienHoatDongNgoaiGiangDayDataSource19"
			DataKeyNames="MaQuanLy"
			AllowMultiColumnSorting="false"
			DefaultSortColumnName="" 
			DefaultSortDirection="Ascending"	
			...
			<Columns>
				...
				<asp:BoundField DataField="LayDuLieu" HeaderText="Lay Du Lieu" SortExpression="[LayDuLieu]" />				
			</Columns>
			<EmptyDataTemplate>
		...
		<data:GiangVienHoatDongNgoaiGiangDayDataSource ID="GiangVienHoatDongNgoaiGiangDayDataSource19" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
