<%@ Control Language="C#" ClassName="KetQuaThanhToanThuLaoFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataNgayXacNhanThanhToan" runat="server" Text="Ngay Xac Nhan Thanh Toan:" AssociatedControlID="dataNgayXacNhanThanhToan" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataNgayXacNhanThanhToan" Text='<%# Bind("NgayXacNhanThanhToan", "{0:d}") %>' MaxLength="10"></asp:TextBox><asp:ImageButton ID="cal_dataNgayXacNhanThanhToan" runat="server" SkinID="CalendarImageButton" OnClientClick="javascript:showCalendarControl(this.previousSibling);return false;" />
				</td>
			</tr>
			<tr>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataNgayChiTra" Text='<%# Bind("NgayChiTra") %>' MaxLength="19"></asp:TextBox>
				</td>
			</tr>
			<tr>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataXacNhanChiTra" runat="server" Text="Xac Nhan Chi Tra:" AssociatedControlID="dataXacNhanChiTra" /></td>
        <td>
					<asp:RadioButtonList runat="server" ID="dataXacNhanChiTra" SelectedValue='<%# Bind("XacNhanChiTra") %>' RepeatDirection="Horizontal"><asp:ListItem Value="True" Text="Yes" Selected="True"></asp:ListItem><asp:ListItem Value="False" Text="No"></asp:ListItem></asp:RadioButtonList>
				</td>
			</tr>
			<tr>
