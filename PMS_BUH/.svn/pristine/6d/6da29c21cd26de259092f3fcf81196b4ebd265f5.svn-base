...
namespace PMS.Entities
{
	...
	public abstract partial class ViewChiTietPhanCongGiangDayBase : System.IComparable, System.ICloneable, INotifyPropertyChanged
	{
		...
		/// TenLoaiHP : 
		/// </summary>
		private System.String		  _tenLoaiHp = null;
		...
		public static bool Equals(ViewChiTietPhanCongGiangDayBase Object1, ViewChiTietPhanCongGiangDayBase Object2)
		{
			...
			if (Object1.TenNhom != Object2.TenNhom)
				equal = false;
			if (Object1.TenLoaiHp != null && Object2.TenLoaiHp != null )
			{
				if (Object1.TenLoaiHp != Object2.TenLoaiHp)
					equal = false;
			}
			else if (Object1.TenLoaiHp == null ^ Object1.TenLoaiHp == null )
			{
				equal = false;
			}
      ...
      /// <param name="e">PropertyChangedEventArgs</param>
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				...
				this.TenNhom,
				(this.TenLoaiHp == null) ? string.Empty : this.TenLoaiHp.ToString(),
	...
	public enum ViewChiTietPhanCongGiangDayColumn
	{
		...
		[ColumnEnum("TenLoaiHP", typeof(System.String), System.Data.DbType.String, false, false, true, 100)]
		TenLoaiHp,
		/// <summary>
		/// MaLich : 
		/// </summary>
