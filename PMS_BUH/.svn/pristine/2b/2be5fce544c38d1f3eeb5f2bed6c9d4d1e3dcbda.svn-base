...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucLoaiNghienCuuKhoaHoc : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        {
            AppGridView.InitGridView(gridView1, true, true, GridMultiSelectMode.RowSelect, false, false, "Nhấn vào đây để thêm dòng mới");
            AppGridView.ShowField(gridView1, new string[] { "MaLoaiNckh", "TenLoaiNckh", "GhiChu" ,"TinhTrang"},
                new string[] { "Mã loại nghiên cứu khoa học", "Tên loại nghiên cứu khoa học", "Ghi chú","Không dùng" },
                new int[] { 200, 300, 400,100});
            AppGridView.AlignHeader(gridView1, new string[] { "MaLoaiNckh", "TenLoaiNckh", "GhiChu", "TinhTrang" }, DevExpress.Utils.HorzAlignment.Center);
