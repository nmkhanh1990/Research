...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataDinhMucToiThieuNckh" runat="server" Text="Dinh Muc Toi Thieu Nckh:" AssociatedControlID="dataDinhMucToiThieuNckh" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataDinhMucToiThieuNckh" Text='<%# Bind("DinhMucToiThieuNckh") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataDinhMucToiThieuNckh" runat="server" Display="Dynamic" ControlToValidate="dataDinhMucToiThieuNckh" ErrorMessage="Invalid value" MaximumValue="999999999" MinimumValue="-999999999" Type="Double"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
