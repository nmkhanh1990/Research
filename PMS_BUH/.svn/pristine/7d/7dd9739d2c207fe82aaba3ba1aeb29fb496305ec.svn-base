<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="LoaiNhanVienEdit.aspx.cs" Inherits="LoaiNhanVienEdit" Title="LoaiNhanVien Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Loai Nhan Vien - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="MaLoaiNhanVien" runat="server" DataSourceID="LoaiNhanVienDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/LoaiNhanVienFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:LoaiNhanVienDataSource ID="LoaiNhanVienDataSource" runat="server"
			SelectMethod="GetByMaLoaiNhanVien"
		>
			<Parameters>
				<asp:QueryStringParameter Name="MaLoaiNhanVien" QueryStringField="MaLoaiNhanVien" Type="String" />
		...
		<data:GiangVienDataSource ID="GiangVienDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:GiangVienFilter  Column="MaLoaiNhanVien" QueryStringField="MaLoaiNhanVien" /> 
					</Filters>
				</data:SqlParameter>
		...
		<br />
		<data:EntityGridView ID="GridViewQuyDinhTienCanTren2" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewQuyDinhTienCanTren2_SelectedIndexChanged"			 			 
			DataSourceID="QuyDinhTienCanTrenDataSource2"
			DataKeyNames="Id"
			AllowMultiColumnSorting="false"
			DefaultSortColumnName="" 
			DefaultSortDirection="Ascending"	
		...
		<data:QuyDinhTienCanTrenDataSource ID="QuyDinhTienCanTrenDataSource2" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:QuyDinhTienCanTrenFilter  Column="MaLoaiNhanVien" QueryStringField="MaLoaiNhanVien" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
