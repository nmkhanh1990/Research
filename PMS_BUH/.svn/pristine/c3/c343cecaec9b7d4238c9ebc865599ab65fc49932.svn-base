...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataDotChiTra" DataSourceID="DotChiTraDotChiTraDataSource" DataTextField="MaDotChiTra" DataValueField="Id" SelectedValue='<%# Bind("DotChiTra") %>' AppendNullItem="true" Required="false" NullItemText="< Please Choose ...>" />
					<data:DotChiTraDataSource ID="DotChiTraDotChiTraDataSource" runat="server" SelectMethod="GetAll"  />
				</td>
			</tr>
			<tr>
