...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataNhomClc" runat="server" Text="Nhom Clc:" AssociatedControlID="dataNhomClc" /></td>
        <td>
					<asp:RadioButtonList runat="server" ID="dataNhomClc" SelectedValue='<%# Bind("NhomClc") %>' RepeatDirection="Horizontal"><asp:ListItem Value="True" Text="Yes" Selected="True"></asp:ListItem><asp:ListItem Value="False" Text="No"></asp:ListItem></asp:RadioButtonList>
				</td>
			</tr>
			<tr>
