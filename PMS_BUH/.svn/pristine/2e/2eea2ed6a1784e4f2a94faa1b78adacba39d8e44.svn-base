<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="TrinhDoChinhTriEdit.aspx.cs" Inherits="TrinhDoChinhTriEdit" Title="TrinhDoChinhTri Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Trinh Do Chinh Tri - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="MaTrinhDoChinhTri" runat="server" DataSourceID="TrinhDoChinhTriDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/TrinhDoChinhTriFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:TrinhDoChinhTriDataSource ID="TrinhDoChinhTriDataSource" runat="server"
			SelectMethod="GetByMaTrinhDoChinhTri"
		>
			<Parameters>
				<asp:QueryStringParameter Name="MaTrinhDoChinhTri" QueryStringField="MaTrinhDoChinhTri" Type="String" />
		...
		<data:GiangVienDataSource ID="GiangVienDataSource1" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:GiangVienFilter  Column="MaTrinhDoChinhTri" QueryStringField="MaTrinhDoChinhTri" /> 
					</Filters>
				</data:SqlParameter>
