...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucLoaiKhoiLuong : XtraUserControl
    {
        ...
        {
            AppGridView.InitGridView(gridViewLoaiKhoiLuong, true, true, GridMultiSelectMode.RowSelect, false, false, "Nhấn vào đây để thêm dòng mới");
            AppGridView.ShowField(gridViewLoaiKhoiLuong, new string[] { "MaLoaiKhoiLuong", "TenLoaiKhoiLuong", "NghiaVu","TinhTrang" },
                new string[] { "Mã loại khối lượng", "Tên loại khối lượng", "Nghĩa vụ","Không dùng" },
                new int[] { 110, 300, 70,100 });
            AppGridView.ShowEditor(gridViewLoaiKhoiLuong, NewItemRowPosition.Top);
            AppGridView.HideField(gridViewLoaiKhoiLuong, new string[] { "NghiaVu" });
            AppGridView.AlignHeader(gridViewLoaiKhoiLuong, new string[] { "MaLoaiKhoiLuong", "TenLoaiKhoiLuong", "NghiaVu", "TinhTrang" }, DevExpress.Utils.HorzAlignment.Center);
