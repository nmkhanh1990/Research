...
namespace PMS.UI.Modules.Reports
{
    public partial class ucThongKeChiTietGioGiangTheoDot : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void ucThongKeChiTietGioGiangTheoDot_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.SummaryField(gridViewThongKe, "Thdc", "{0:n2}", DevExpress.Data.SummaryItemType.Sum);
            AppGridView.SummaryField(gridViewThongKe, "Thcn", "{0:n2}", DevExpress.Data.SummaryItemType.Sum);
            ...
            AppGridView.FormatDataField(gridViewThongKe, new string[] { "SiSo", "ThucDayLt", "Thdc", "Thcn", "Nn", "LyThuyetSuPham", "ThcnSuPham", "TongTietQuyDoi" }, DevExpress.Utils.FormatType.Custom, "{0:n2}");
            ...
            AppGridView.BackColorFieldAppearance(gridViewThongKe, new string[] { "ThucDayLt", "Thdc", "Thcn", "LyThuyetSuPham", "ThcnSuPham" }, Color.FromArgb(0xD2, 0xE2, 0xC4));
