<%@ Control Language="C#" ClassName="GiangVienPhucCapFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataMaPhuCap" runat="server" Text="Ma Phu Cap:" AssociatedControlID="dataMaPhuCap" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataMaPhuCap" Text='<%# Bind("MaPhuCap") %>' MaxLength="100"></asp:TextBox>
				</td>
			</tr>
			<tr>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataSoNgay" runat="server" Text="So Ngay:" AssociatedControlID="dataSoNgay" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataSoNgay" Text='<%# Bind("SoNgay") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataSoNgay" runat="server" Display="Dynamic" ControlToValidate="dataSoNgay" ErrorMessage="Invalid value" MaximumValue="2147483647" MinimumValue="-2147483648" Type="Integer"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataSoDot" runat="server" Text="So Dot:" AssociatedControlID="dataSoDot" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataSoDot" Text='<%# Bind("SoDot") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataSoDot" runat="server" Display="Dynamic" ControlToValidate="dataSoDot" ErrorMessage="Invalid value" MaximumValue="2147483647" MinimumValue="-2147483648" Type="Integer"></asp:RangeValidator>
				</td>
			</tr>
