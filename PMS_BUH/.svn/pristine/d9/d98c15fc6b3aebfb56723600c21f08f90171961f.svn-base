...
/*
	...
	Important: Do not modify this file. Edit the file SdhMonPhanCongNhieuGiangVien.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'SdhMonPhanCongNhieuGiangVien' table. [No description found the database]	
	///</summary>
	[Serializable]
	[DataObject, CLSCompliant(true)]
	public abstract partial class SdhMonPhanCongNhieuGiangVienBase : EntityBase, ISdhMonPhanCongNhieuGiangVien, IEntityId<SdhMonPhanCongNhieuGiangVienKey>, System.IComparable, System.ICloneable, ICloneableEx, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		/// </summary>
		private SdhMonPhanCongNhieuGiangVienEntityData entityData;
		
		/// <summary>
		/// 	Hold the original data of the entity, as loaded from the repository.
		/// </summary>
		private SdhMonPhanCongNhieuGiangVienEntityData _originalData;
		
		/// <summary>
		/// 	Hold a backup of the inner data of the entity.
		/// </summary>
		private SdhMonPhanCongNhieuGiangVienEntityData backupData; 
		...
		[NonSerialized]
		private TList<SdhMonPhanCongNhieuGiangVien> parentCollection;
		...
		/// </summary>
		[field:NonSerialized]
		public event SdhMonPhanCongNhieuGiangVienEventHandler ColumnChanging;		
		
		/// <summary>
		/// Occurs after a value has been changed for the specified column.
		/// </summary>
		[field:NonSerialized]
		public event SdhMonPhanCongNhieuGiangVienEventHandler ColumnChanged;
		
		#endregion Variable Declarations
		
		#region Constructors
		///<summary>
		/// Creates a new <see cref="SdhMonPhanCongNhieuGiangVienBase"/> instance.
		///</summary>
		public SdhMonPhanCongNhieuGiangVienBase()
		{
			this.entityData = new SdhMonPhanCongNhieuGiangVienEntityData();
		...
		public SdhMonPhanCongNhieuGiangVienBase(System.String _maMonHoc, System.String _tenMonHoc, 
		...
		///<summary>
		/// A simple factory method to create a new <see cref="SdhMonPhanCongNhieuGiangVien"/> instance.
		///</summary>
		///<param name="_maMonHoc"></param>
		///<param name="_tenMonHoc"></param>
		///<param name="_nhomMonHoc"></param>
		...
		///<param name="_nhom"></param>
		///<param name="_ngayCapNhat"></param>
		public static SdhMonPhanCongNhieuGiangVien CreateSdhMonPhanCongNhieuGiangVien(System.String _maMonHoc, System.String _tenMonHoc, 
			System.String _nhomMonHoc, System.String _maHocPhan, System.String _namHoc, 
			System.String _hocKy, System.String _maLopHocPhan, System.String _maLop, 
			System.String _maGiangVienQuanLy, System.Int32? _soTinChi, System.Int32? _siSo, 
			System.Boolean? _lopClc, System.Int32? _soTietDayChuNhat, System.Int32? _soTiet, 
			...
			System.Int32? _maHocVi, System.String _nhom, System.DateTime? _ngayCapNhat)
		{
			SdhMonPhanCongNhieuGiangVien newSdhMonPhanCongNhieuGiangVien = new SdhMonPhanCongNhieuGiangVien();
			newSdhMonPhanCongNhieuGiangVien.MaMonHoc = _maMonHoc;
			newSdhMonPhanCongNhieuGiangVien.TenMonHoc = _tenMonHoc;
			newSdhMonPhanCongNhieuGiangVien.NhomMonHoc = _nhomMonHoc;
			newSdhMonPhanCongNhieuGiangVien.MaHocPhan = _maHocPhan;
			newSdhMonPhanCongNhieuGiangVien.NamHoc = _namHoc;
			newSdhMonPhanCongNhieuGiangVien.HocKy = _hocKy;
			newSdhMonPhanCongNhieuGiangVien.MaLopHocPhan = _maLopHocPhan;
			newSdhMonPhanCongNhieuGiangVien.MaLop = _maLop;
			newSdhMonPhanCongNhieuGiangVien.MaGiangVienQuanLy = _maGiangVienQuanLy;
			newSdhMonPhanCongNhieuGiangVien.SoTinChi = _soTinChi;
			newSdhMonPhanCongNhieuGiangVien.SiSo = _siSo;
			newSdhMonPhanCongNhieuGiangVien.LopClc = _lopClc;
			newSdhMonPhanCongNhieuGiangVien.SoTietDayChuNhat = _soTietDayChuNhat;
			newSdhMonPhanCongNhieuGiangVien.SoTiet = _soTiet;
			newSdhMonPhanCongNhieuGiangVien.MaLoaiHocPhan = _maLoaiHocPhan;
			newSdhMonPhanCongNhieuGiangVien.MaLoaiGiangVien = _maLoaiGiangVien;
			newSdhMonPhanCongNhieuGiangVien.MaHocHam = _maHocHam;
			newSdhMonPhanCongNhieuGiangVien.MaHocVi = _maHocVi;
			newSdhMonPhanCongNhieuGiangVien.Nhom = _nhom;
			newSdhMonPhanCongNhieuGiangVien.NgayCapNhat = _ngayCapNhat;
			return newSdhMonPhanCongNhieuGiangVien;
		}
		...
		public virtual System.Int32 Id
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.Id, this.entityData.Id);
				this.entityData.Id = value;
				this.EntityId.Id = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.Id, this.entityData.Id);
		...
		public virtual System.String MaMonHoc
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.MaMonHoc, this.entityData.MaMonHoc);
				this.entityData.MaMonHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.MaMonHoc, this.entityData.MaMonHoc);
		...
		public virtual System.String TenMonHoc
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.TenMonHoc, this.entityData.TenMonHoc);
				this.entityData.TenMonHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.TenMonHoc, this.entityData.TenMonHoc);
		...
		public virtual System.String NhomMonHoc
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.NhomMonHoc, this.entityData.NhomMonHoc);
				this.entityData.NhomMonHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.NhomMonHoc, this.entityData.NhomMonHoc);
		...
		public virtual System.String MaHocPhan
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.MaHocPhan, this.entityData.MaHocPhan);
				this.entityData.MaHocPhan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.MaHocPhan, this.entityData.MaHocPhan);
		...
		public virtual System.String NamHoc
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.NamHoc, this.entityData.NamHoc);
				this.entityData.NamHoc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.NamHoc, this.entityData.NamHoc);
		...
		public virtual System.String HocKy
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.HocKy, this.entityData.HocKy);
				this.entityData.HocKy = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.HocKy, this.entityData.HocKy);
		...
		public virtual System.String MaLopHocPhan
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.MaLopHocPhan, this.entityData.MaLopHocPhan);
				this.entityData.MaLopHocPhan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.MaLopHocPhan, this.entityData.MaLopHocPhan);
		...
		public virtual System.String MaLop
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.MaLop, this.entityData.MaLop);
				this.entityData.MaLop = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.MaLop, this.entityData.MaLop);
		...
		public virtual System.String MaGiangVienQuanLy
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.MaGiangVienQuanLy, this.entityData.MaGiangVienQuanLy);
				this.entityData.MaGiangVienQuanLy = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.MaGiangVienQuanLy, this.entityData.MaGiangVienQuanLy);
		...
		public virtual System.Int32? SoTinChi
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.SoTinChi, this.entityData.SoTinChi);
				this.entityData.SoTinChi = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.SoTinChi, this.entityData.SoTinChi);
		...
		public virtual System.Int32? SiSo
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.SiSo, this.entityData.SiSo);
				this.entityData.SiSo = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.SiSo, this.entityData.SiSo);
		...
		public virtual System.Boolean? LopClc
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.LopClc, this.entityData.LopClc);
				this.entityData.LopClc = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.LopClc, this.entityData.LopClc);
		...
		public virtual System.Int32? SoTietDayChuNhat
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.SoTietDayChuNhat, this.entityData.SoTietDayChuNhat);
				this.entityData.SoTietDayChuNhat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.SoTietDayChuNhat, this.entityData.SoTietDayChuNhat);
		...
		public virtual System.Int32? SoTiet
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.SoTiet, this.entityData.SoTiet);
				this.entityData.SoTiet = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.SoTiet, this.entityData.SoTiet);
		...
		public virtual System.Int32? MaLoaiHocPhan
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.MaLoaiHocPhan, this.entityData.MaLoaiHocPhan);
				this.entityData.MaLoaiHocPhan = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.MaLoaiHocPhan, this.entityData.MaLoaiHocPhan);
		...
		public virtual System.Int32? MaLoaiGiangVien
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.MaLoaiGiangVien, this.entityData.MaLoaiGiangVien);
				this.entityData.MaLoaiGiangVien = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.MaLoaiGiangVien, this.entityData.MaLoaiGiangVien);
		...
		public virtual System.Int32? MaHocHam
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.MaHocHam, this.entityData.MaHocHam);
				this.entityData.MaHocHam = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.MaHocHam, this.entityData.MaHocHam);
		...
		public virtual System.Int32? MaHocVi
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.MaHocVi, this.entityData.MaHocVi);
				this.entityData.MaHocVi = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.MaHocVi, this.entityData.MaHocVi);
		...
		public virtual System.String Nhom
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.Nhom, this.entityData.Nhom);
				this.entityData.Nhom = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.Nhom, this.entityData.Nhom);
		...
		public virtual System.DateTime? NgayCapNhat
		{
			...
			set
			{
				...
				OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn.NgayCapNhat, this.entityData.NgayCapNhat);
				this.entityData.NgayCapNhat = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn.NgayCapNhat, this.entityData.NgayCapNhat);
		...
		{
			get { return "SdhMonPhanCongNhieuGiangVien"; }
		}
		...
		void IEditableObject.BeginEdit() 
	    {
	        ...
	        if (!inTxn) 
	        {
	            this.backupData = this.entityData.Clone() as SdhMonPhanCongNhieuGiangVienEntityData;
	            inTxn = true;
	        ...
	        if (this.inTxn) 
	        {
	        	...
	        	//if (this.EntityState == EntityState.Added)
	        	{
					if (this.parentCollection != null)
						this.parentCollection.Remove( (SdhMonPhanCongNhieuGiangVien) this ) ;
				}	            
	        }
	    ...
	    public override object ParentCollection
	    {
	        ...
	        set 
	        {
	            this.parentCollection = value as TList<SdhMonPhanCongNhieuGiangVien>;
	        }
	    }
	    ...
	    private void OnEntityChanged() 
	    {
	        ...
	        {
	            this.parentCollection.EntityChanged(this as SdhMonPhanCongNhieuGiangVien);
	        }
	    }
		...
		///<summary>
		///  Returns a Typed SdhMonPhanCongNhieuGiangVien Entity 
		///</summary>
		protected virtual SdhMonPhanCongNhieuGiangVien Copy(IDictionary existingCopies)
		{
			...
			//shallow copy entity
			SdhMonPhanCongNhieuGiangVien copy = new SdhMonPhanCongNhieuGiangVien();
		...
		///  Returns a Typed SdhMonPhanCongNhieuGiangVien Entity 
		///</summary>
		public virtual SdhMonPhanCongNhieuGiangVien Copy()
		{
		...
		///<summary>
		///  Returns a Typed SdhMonPhanCongNhieuGiangVien Entity which is a deep copy of the current entity.
		///</summary>
		public virtual SdhMonPhanCongNhieuGiangVien DeepCopy()
		{
			return EntityHelper.Clone<SdhMonPhanCongNhieuGiangVien>(this as SdhMonPhanCongNhieuGiangVien);	
		}
		#endregion
		...
		public override void CancelChanges()
		{
			...
			{
				this.entityData = this._originalData.Clone() as SdhMonPhanCongNhieuGiangVienEntityData;
			}
			else
			{
		...
		public override void AcceptChanges()
		{
			...
			this._originalData = this.entityData.Clone() as SdhMonPhanCongNhieuGiangVienEntityData;
		}
		...
		/// </returns>
		public bool IsPropertyChanged(SdhMonPhanCongNhieuGiangVienColumn column)
		{
			switch(column)
			{
					case SdhMonPhanCongNhieuGiangVienColumn.Id:
					return entityData.Id != _originalData.Id;
					case SdhMonPhanCongNhieuGiangVienColumn.MaMonHoc:
					return entityData.MaMonHoc != _originalData.MaMonHoc;
					case SdhMonPhanCongNhieuGiangVienColumn.TenMonHoc:
					return entityData.TenMonHoc != _originalData.TenMonHoc;
					case SdhMonPhanCongNhieuGiangVienColumn.NhomMonHoc:
					return entityData.NhomMonHoc != _originalData.NhomMonHoc;
					case SdhMonPhanCongNhieuGiangVienColumn.MaHocPhan:
					return entityData.MaHocPhan != _originalData.MaHocPhan;
					case SdhMonPhanCongNhieuGiangVienColumn.NamHoc:
					return entityData.NamHoc != _originalData.NamHoc;
					case SdhMonPhanCongNhieuGiangVienColumn.HocKy:
					return entityData.HocKy != _originalData.HocKy;
					case SdhMonPhanCongNhieuGiangVienColumn.MaLopHocPhan:
					return entityData.MaLopHocPhan != _originalData.MaLopHocPhan;
					case SdhMonPhanCongNhieuGiangVienColumn.MaLop:
					return entityData.MaLop != _originalData.MaLop;
					case SdhMonPhanCongNhieuGiangVienColumn.MaGiangVienQuanLy:
					return entityData.MaGiangVienQuanLy != _originalData.MaGiangVienQuanLy;
					case SdhMonPhanCongNhieuGiangVienColumn.SoTinChi:
					return entityData.SoTinChi != _originalData.SoTinChi;
					case SdhMonPhanCongNhieuGiangVienColumn.SiSo:
					return entityData.SiSo != _originalData.SiSo;
					case SdhMonPhanCongNhieuGiangVienColumn.LopClc:
					return entityData.LopClc != _originalData.LopClc;
					case SdhMonPhanCongNhieuGiangVienColumn.SoTietDayChuNhat:
					return entityData.SoTietDayChuNhat != _originalData.SoTietDayChuNhat;
					case SdhMonPhanCongNhieuGiangVienColumn.SoTiet:
					return entityData.SoTiet != _originalData.SoTiet;
					case SdhMonPhanCongNhieuGiangVienColumn.MaLoaiHocPhan:
					return entityData.MaLoaiHocPhan != _originalData.MaLoaiHocPhan;
					case SdhMonPhanCongNhieuGiangVienColumn.MaLoaiGiangVien:
					return entityData.MaLoaiGiangVien != _originalData.MaLoaiGiangVien;
					case SdhMonPhanCongNhieuGiangVienColumn.MaHocHam:
					return entityData.MaHocHam != _originalData.MaHocHam;
					case SdhMonPhanCongNhieuGiangVienColumn.MaHocVi:
					return entityData.MaHocVi != _originalData.MaHocVi;
					case SdhMonPhanCongNhieuGiangVienColumn.Nhom:
					return entityData.Nhom != _originalData.Nhom;
					case SdhMonPhanCongNhieuGiangVienColumn.NgayCapNhat:
		...
		{
			return 	IsPropertyChanged(EntityHelper.GetEnumValue< SdhMonPhanCongNhieuGiangVienColumn >(columnName));
		}
		...
		///<summary>
		///  Returns a SdhMonPhanCongNhieuGiangVien Entity with the original data.
		///</summary>
		public SdhMonPhanCongNhieuGiangVien GetOriginalEntity()
		{
			if (_originalData != null)
				return CreateSdhMonPhanCongNhieuGiangVien(
			...
			return (SdhMonPhanCongNhieuGiangVien)this.Clone();
		}
		#endregion
	...
	#region Value Semantics Instance Equality
        ...
        ///<returns>true if Object1 is a <see cref="SdhMonPhanCongNhieuGiangVienBase"/> and has the same value as this instance; otherwise, false.</returns>
        public override bool Equals(object Object1)
        {
			// Cast exception if Object1 is null or DbNull
			if (Object1 != null && Object1 != DBNull.Value && Object1 is SdhMonPhanCongNhieuGiangVienBase)
				return ValueEquals(this, (SdhMonPhanCongNhieuGiangVienBase)Object1);
			else
				return false;
        }
        ...
        /// Provides a hash function that is appropriate for <see cref="SdhMonPhanCongNhieuGiangVienBase"/> class 
		...
		///<returns>true if toObject is a <see cref="SdhMonPhanCongNhieuGiangVienBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(SdhMonPhanCongNhieuGiangVienBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="SdhMonPhanCongNhieuGiangVienBase"/> instances are considered equal using value semantics.
		///</summary>
		///<param name="Object1">The first <see cref="SdhMonPhanCongNhieuGiangVienBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="SdhMonPhanCongNhieuGiangVienBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool ValueEquals(SdhMonPhanCongNhieuGiangVienBase Object1, SdhMonPhanCongNhieuGiangVienBase Object2)
		{
			// both are null
		...
		public virtual int CompareTo(object obj)
		{
			...
			//return this. GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]) .CompareTo(((SdhMonPhanCongNhieuGiangVienBase)obj).GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]));
		}
		
		/*
		// static method to get a Comparer object
        public static SdhMonPhanCongNhieuGiangVienComparer GetComparer()
        {
            return new SdhMonPhanCongNhieuGiangVienComparer();
        }
        */

        // Comparer delegates back to SdhMonPhanCongNhieuGiangVien
...
/*
        ...
        public int CompareTo(SdhMonPhanCongNhieuGiangVien rhs, SdhMonPhanCongNhieuGiangVienColumn which)
        {
            switch (which)
            {
        ...
        */
		...
		#region IEntityKey<SdhMonPhanCongNhieuGiangVienKey> Members
		
		// member variable for the EntityId property
		private SdhMonPhanCongNhieuGiangVienKey _entityId;

		/// <summary>
		/// Gets or sets the EntityId property.
		/// </summary>
		[XmlIgnore]
		public virtual SdhMonPhanCongNhieuGiangVienKey EntityId
		{
			get
			{
				if ( _entityId == null )
				{
					_entityId = new SdhMonPhanCongNhieuGiangVienKey(this);
				}
		...
		public override string EntityTrackingKey
		{
			get
			{
				if(entityTrackingKey == null)
					entityTrackingKey = new System.Text.StringBuilder("SdhMonPhanCongNhieuGiangVien")
	...
	/// <summary>
	///		The data structure representation of the 'SdhMonPhanCongNhieuGiangVien' table.
	/// </summary>
	/// <remarks>
	...
	[Serializable]
	internal protected class SdhMonPhanCongNhieuGiangVienEntityData : ICloneable, ICloneableEx
	{
		#region Variable Declarations
		...
		/// Id : 
		/// </summary>
		/// <remarks>Member of the primary key of the underlying table "SdhMonPhanCongNhieuGiangVien"</remarks>
		...
		public Object Clone()
		{
			SdhMonPhanCongNhieuGiangVienEntityData _tmp = new SdhMonPhanCongNhieuGiangVienEntityData();
		...
		/// </summary>
		/// <param name="column">The <see cref="SdhMonPhanCongNhieuGiangVienColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn column)
		{
		...
		/// </summary>
		/// <param name="column">The <see cref="SdhMonPhanCongNhieuGiangVienColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn column)
		{
		...
		public virtual void OnColumnChanging(SdhMonPhanCongNhieuGiangVienColumn column, object value)
		{
			...
			if (!SuppressEntityEvents)
			{
				SdhMonPhanCongNhieuGiangVienEventHandler handler = ColumnChanging;
				if(handler != null)
				{
					handler(this, new SdhMonPhanCongNhieuGiangVienEventArgs(column, value));
				}
			}
		}
		...
		/// <param name="column">The <see cref="SdhMonPhanCongNhieuGiangVienColumn"/> which has raised the event.</param>
		/// <param name="value">The changed value.</param>
		public virtual void OnColumnChanged(SdhMonPhanCongNhieuGiangVienColumn column, object value)
		{
			if (!SuppressEntityEvents)
			{
				SdhMonPhanCongNhieuGiangVienEventHandler handler = ColumnChanged;
				if(handler != null)
				{
					handler(this, new SdhMonPhanCongNhieuGiangVienEventArgs(column, value));
				}
	...
	#region SdhMonPhanCongNhieuGiangVienEventArgs class
	/// <summary>
	/// Provides data for the ColumnChanging and ColumnChanged events.
	/// </summary>
	/// <remarks>
	/// The ColumnChanging and ColumnChanged events occur when a change is made to the value 
	/// of a property of a <see cref="SdhMonPhanCongNhieuGiangVien"/> object.
	/// </remarks>
	public class SdhMonPhanCongNhieuGiangVienEventArgs : System.EventArgs
	{
		private SdhMonPhanCongNhieuGiangVienColumn column;
		private object value;
		
		///<summary>
		/// Initalizes a new Instance of the SdhMonPhanCongNhieuGiangVienEventArgs class.
		///</summary>
		public SdhMonPhanCongNhieuGiangVienEventArgs(SdhMonPhanCongNhieuGiangVienColumn column)
		{
			this.column = column;
		}
		...
		/// Initalizes a new Instance of the SdhMonPhanCongNhieuGiangVienEventArgs class.
		///</summary>
		public SdhMonPhanCongNhieuGiangVienEventArgs(SdhMonPhanCongNhieuGiangVienColumn column, object value)
		{
			this.column = column;
			this.value = value;
		}
		...
		///<summary>
		/// The SdhMonPhanCongNhieuGiangVienColumn that was modified, which has raised the event.
		///</summary>
		///<value cref="SdhMonPhanCongNhieuGiangVienColumn" />
		public SdhMonPhanCongNhieuGiangVienColumn Column { get { return this.column; } }
	...
	///<summary>
	/// Define a delegate for all SdhMonPhanCongNhieuGiangVien related events.
	///</summary>
	public delegate void SdhMonPhanCongNhieuGiangVienEventHandler(object sender, SdhMonPhanCongNhieuGiangVienEventArgs e);
	
	#region SdhMonPhanCongNhieuGiangVienComparer
		
	/// <summary>
	///	Strongly Typed IComparer
	/// </summary>
	public class SdhMonPhanCongNhieuGiangVienComparer : System.Collections.Generic.IComparer<SdhMonPhanCongNhieuGiangVien>
	{
		SdhMonPhanCongNhieuGiangVienColumn whichComparison;
		
		/// <summary>
        /// Initializes a new instance of the <see cref="T:SdhMonPhanCongNhieuGiangVienComparer"/> class.
        /// </summary>
		public SdhMonPhanCongNhieuGiangVienComparer()
        {            
        }               
        ...
        public SdhMonPhanCongNhieuGiangVienComparer(SdhMonPhanCongNhieuGiangVienColumn column)
        {
            this.whichComparison = column;
        }

		/// <summary>
        /// Determines whether the specified <see cref="SdhMonPhanCongNhieuGiangVien"/> instances are considered equal.
        /// </summary>
        /// <param name="a">The first <see cref="SdhMonPhanCongNhieuGiangVien"/> to compare.</param>
        /// <param name="b">The second <c>SdhMonPhanCongNhieuGiangVien</c> to compare.</param>
        /// <returns>true if objA is the same instance as objB or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
        public bool Equals(SdhMonPhanCongNhieuGiangVien a, SdhMonPhanCongNhieuGiangVien b)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(SdhMonPhanCongNhieuGiangVien entity)
        {
        ...
        /// <returns></returns>
        public int Compare(SdhMonPhanCongNhieuGiangVien a, SdhMonPhanCongNhieuGiangVien b)
        {
        ...
        public SdhMonPhanCongNhieuGiangVienColumn WhichComparison
        {
	...
	#region SdhMonPhanCongNhieuGiangVienKey Class

	/// <summary>
	/// Wraps the unique identifier values for the <see cref="SdhMonPhanCongNhieuGiangVien"/> object.
	/// </summary>
	[Serializable]
	[CLSCompliant(true)]
	public class SdhMonPhanCongNhieuGiangVienKey : EntityKeyBase
	{
		#region Constructors
		
		/// <summary>
		/// Initializes a new instance of the SdhMonPhanCongNhieuGiangVienKey class.
		/// </summary>
		public SdhMonPhanCongNhieuGiangVienKey()
		{
		}
		...
		/// Initializes a new instance of the SdhMonPhanCongNhieuGiangVienKey class.
		/// </summary>
		public SdhMonPhanCongNhieuGiangVienKey(SdhMonPhanCongNhieuGiangVienBase entity)
		{
			this.Entity = entity;
		...
		/// Initializes a new instance of the SdhMonPhanCongNhieuGiangVienKey class.
		/// </summary>
		public SdhMonPhanCongNhieuGiangVienKey(System.Int32 _id)
		{
			#region Init Properties
		...
		private SdhMonPhanCongNhieuGiangVienBase _entity;
		
		/// <summary>
		/// Gets or sets the Entity property.
		/// </summary>
		public SdhMonPhanCongNhieuGiangVienBase Entity
		{
			get { return _entity; }
			set { _entity = value; }
		}
	...
	#region SdhMonPhanCongNhieuGiangVienColumn Enum
	
	/// <summary>
	/// Enumerate the SdhMonPhanCongNhieuGiangVien columns.
	/// </summary>
	[Serializable]
	public enum SdhMonPhanCongNhieuGiangVienColumn : int
	{
		/// <summary>
		/// Id : 
		/// </summary>
	...
	#endregion SdhMonPhanCongNhieuGiangVienColumn Enum
