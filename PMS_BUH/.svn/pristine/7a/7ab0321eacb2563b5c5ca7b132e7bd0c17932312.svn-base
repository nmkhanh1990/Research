...
namespace PMS.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
		...
		database.AddInParameter(commandWrapper, "@NhomHoatDongBt", DbType.Boolean, DBNull.Value);
		database.AddInParameter(commandWrapper, "@NhomHoatDongClc", DbType.Boolean, DBNull.Value);
		database.AddInParameter(commandWrapper, "@ThanhToanBinhThuong", DbType.Boolean, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("nhomhoatdongbt ") || clause.Trim().StartsWith("nhomhoatdongbt="))
				{
					database.SetParameterValue(commandWrapper, "@NhomHoatDongBt", 
						clause.Trim().Remove(0,14).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("nhomhoatdongclc ") || clause.Trim().StartsWith("nhomhoatdongclc="))
				{
					database.SetParameterValue(commandWrapper, "@NhomHoatDongClc", 
						clause.Trim().Remove(0,15).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("thanhtoanbinhthuong ") || clause.Trim().StartsWith("thanhtoanbinhthuong="))
				{
					database.SetParameterValue(commandWrapper, "@ThanhToanBinhThuong", 
		...
		public override void BulkInsert(TransactionManager transactionManager, TList<PMS.Entities.HoatDongNgoaiGiangDay> entities)
		{
			...
			DataColumn col8 = dataTable.Columns.Add("NhomHoatDongBT", typeof(System.Boolean));
			col8.AllowDBNull = true;		
			DataColumn col9 = dataTable.Columns.Add("NhomHoatDongCLC", typeof(System.Boolean));
			col9.AllowDBNull = true;		
			DataColumn col10 = dataTable.Columns.Add("ThanhToanBinhThuong", typeof(System.Boolean));
			...
			bulkCopy.ColumnMappings.Add("NhomHoatDongBT", "NhomHoatDongBT");
			bulkCopy.ColumnMappings.Add("NhomHoatDongCLC", "NhomHoatDongCLC");
			bulkCopy.ColumnMappings.Add("ThanhToanBinhThuong", "ThanhToanBinhThuong");
			...
			foreach(PMS.Entities.HoatDongNgoaiGiangDay entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["NhomHoatDongBT"] = entity.NhomHoatDongBt.HasValue ? (object) entity.NhomHoatDongBt  : System.DBNull.Value;
							
				
					row["NhomHoatDongCLC"] = entity.NhomHoatDongClc.HasValue ? (object) entity.NhomHoatDongClc  : System.DBNull.Value;
							
				
					row["ThanhToanBinhThuong"] = entity.ThanhToanBinhThuong.HasValue ? (object) entity.ThanhToanBinhThuong  : System.DBNull.Value;
		...
		public override bool Insert(TransactionManager transactionManager, PMS.Entities.HoatDongNgoaiGiangDay entity)
		{
			...
			database.AddInParameter(commandWrapper, "@NhomHoatDongBt", DbType.Boolean, (entity.NhomHoatDongBt.HasValue ? (object) entity.NhomHoatDongBt  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@NhomHoatDongClc", DbType.Boolean, (entity.NhomHoatDongClc.HasValue ? (object) entity.NhomHoatDongClc  : System.DBNull.Value));
			database.AddInParameter(commandWrapper, "@ThanhToanBinhThuong", DbType.Boolean, (entity.ThanhToanBinhThuong.HasValue ? (object) entity.ThanhToanBinhThuong  : System.DBNull.Value));
