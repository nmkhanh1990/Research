...
namespace PMS.UI.Modules.DanhMuc
{
    public partial class ucLoaiGiangVien : XtraUserControl
    {
        ...
        private void ucLoaiGiangVien_Load(object sender, EventArgs e)
        {
            ...
            AppGridView.ShowField(gridViewLoaiGiangVien, new string[] { "ThuTu", "MaQuanLy", "TenLoaiGiangVien","TinhTrang","TrangThai" },
                new string[] { "STT", "Mã loại giảng viên", "Tên loại giảng viên","Không dùng","Không tính định mức" },
                new int[] { 70, 150, 300,100,100 });
            AppGridView.AlignHeader(gridViewLoaiGiangVien, new string[] { "ThuTu", "MaQuanLy", "TenLoaiGiangVien", "TinhTrang", "TrangThai" },DevExpress.Utils.HorzAlignment.Center);
            AppGridView.HideField(gridViewLoaiGiangVien, new string[] { "ThuTu" });
