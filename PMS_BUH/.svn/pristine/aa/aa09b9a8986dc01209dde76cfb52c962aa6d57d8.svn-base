...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataChucVuKiemNhiemKhac" runat="server" Text="Chuc Vu Kiem Nhiem Khac:" AssociatedControlID="dataChucVuKiemNhiemKhac" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataChucVuKiemNhiemKhac" Text='<%# Bind("ChucVuKiemNhiemKhac") %>' MaxLength="100"></asp:TextBox>
				</td>
			</tr>
			<tr>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataDaiDienHopDongThinhGiang02" runat="server" Text="Dai Dien Hop Dong Thinh Giang02:" AssociatedControlID="dataDaiDienHopDongThinhGiang02" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataDaiDienHopDongThinhGiang02" Text='<%# Bind("DaiDienHopDongThinhGiang02") %>' MaxLength="100"></asp:TextBox>
				</td>
			</tr>
			<tr>
