...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataDonGiaGdtc" runat="server" Text="Don Gia Gdtc:" AssociatedControlID="dataDonGiaGdtc" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataDonGiaGdtc" Text='<%# Bind("DonGiaGdtc") %>'></asp:TextBox><asp:RangeValidator ID="RangeVal_dataDonGiaGdtc" runat="server" Display="Dynamic" ControlToValidate="dataDonGiaGdtc" ErrorMessage="Invalid value" MaximumValue="999999999" MinimumValue="-999999999" Type="Double"></asp:RangeValidator>
				</td>
			</tr>
			<tr>
