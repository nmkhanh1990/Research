...
{	
	...
	public abstract class ViewGiangVienProviderBaseCore : EntityViewProviderBase<ViewGiangVien>
	{
		...
		#region cust_view_GiangVien_GetByMaDonViTrucThuoc
		
		/// <summary>
		///	This method wrap the 'cust_view_GiangVien_GetByMaDonViTrucThuoc' stored procedure. 
		/// </summary>
		/// <param name="maDonVi"> A <c>System.String</c> instance.</param>
		/// <param name="namHoc"> A <c>System.String</c> instance.</param>
		/// <param name="hocKy"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewGiangVien&gt;"/> instance.</returns>
		public VList<ViewGiangVien> GetByMaDonViTrucThuoc(System.String maDonVi, System.String namHoc, System.String hocKy)
		{
			return GetByMaDonViTrucThuoc(null, 0, int.MaxValue , maDonVi, namHoc, hocKy);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewGiangVien&gt;"/> instance.</returns>
		public VList<ViewGiangVien> GetByMaDonViTrucThuoc(int start, int pageLength, System.String maDonVi, System.String namHoc, System.String hocKy)
		{
			return GetByMaDonViTrucThuoc(null, start, pageLength , maDonVi, namHoc, hocKy);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <returns>A <see cref="VList&lt;ViewGiangVien&gt;"/> instance.</returns>
		public VList<ViewGiangVien> GetByMaDonViTrucThuoc(TransactionManager transactionManager, System.String maDonVi, System.String namHoc, System.String hocKy)
		{
			return GetByMaDonViTrucThuoc(transactionManager, 0, int.MaxValue , maDonVi, namHoc, hocKy);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="VList&lt;ViewGiangVien&gt;"/> instance.</returns>
		public abstract VList<ViewGiangVien> GetByMaDonViTrucThuoc(TransactionManager transactionManager, int start, int pageLength, System.String maDonVi, System.String namHoc, System.String hocKy);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader hoatDongngoaigiangday_GetByMaHoatDong(System.String maHoatDong)
		{
			return hoatDongngoaigiangday_GetByMaHoatDong(null, 0, int.MaxValue , maHoatDong);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader hoatDongngoaigiangday_GetByMaHoatDong(int start, int pageLength, System.String maHoatDong)
		{
			return hoatDongngoaigiangday_GetByMaHoatDong(null, start, pageLength , maHoatDong);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader hoatDongngoaigiangday_GetByMaHoatDong(TransactionManager transactionManager, System.String maHoatDong)
		{
			return hoatDongngoaigiangday_GetByMaHoatDong(transactionManager, 0, int.MaxValue , maHoatDong);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public abstract IDataReader hoatDongngoaigiangday_GetByMaHoatDong(TransactionManager transactionManager, int start, int pageLength, System.String maHoatDong);
		...
		protected static VList&lt;ViewGiangVien&gt; Fill(DataTable dataTable, VList<ViewGiangVien> rows, int start, int pagelen)
		{
			...
			while (dataRows.MoveNext() && (pagelen != 0))
			{
				if(recordnum >= start)
				{
					...
					c.MaBacLuong = (Convert.IsDBNull(row["MaBacLuong"]))?string.Empty:(System.String)row["MaBacLuong"];
					c.TenBacLuong = (Convert.IsDBNull(row["TenBacLuong"]))?string.Empty:(System.String)row["TenBacLuong"];
		...
		*/	
		...
		protected VList<ViewGiangVien> Fill(IDataReader reader, VList<ViewGiangVien> rows, int start, int pageLength)
		{
			...
			while (reader.Read() && (pageLength != 0))
			{
				if(recordnum >= start)
				{
					...
					entity.MaBacLuong = reader.IsDBNull(reader.GetOrdinal("MaBacLuong")) ? null : (System.String)reader["MaBacLuong"];
					//entity.MaBacLuong = (Convert.IsDBNull(reader["MaBacLuong"]))?string.Empty:(System.String)reader["MaBacLuong"];
					entity.TenBacLuong = (System.String)reader["TenBacLuong"];
					//entity.TenBacLuong = (Convert.IsDBNull(reader["TenBacLuong"]))?string.Empty:(System.String)reader["TenBacLuong"];
		...
		protected static void RefreshEntity(DataSet dataSet, ViewGiangVien entity)
		{
			...
			entity.MaBacLuong = (Convert.IsDBNull(dataRow["MaBacLuong"]))?string.Empty:(System.String)dataRow["MaBacLuong"];
			entity.TenBacLuong = (Convert.IsDBNull(dataRow["TenBacLuong"]))?string.Empty:(System.String)dataRow["TenBacLuong"];
