...
namespace PMS.Common
{
    public class ThongBao   //Tên biến thông báo nên sắp xếp theo A->Z cho dễ tìm.
    {
        ...
        public const string Str_LoiDuoiCoSoDuLieu = "Đã xảy ra lỗi trong quá trình lưu thay đổi..........";
        ...
        public const string Str_SoLuongCLC = "Vui lòng nhập tối đa là 2 thấp nhất là 1.";
        public const string Str_ChiNhapSo = "Vui lòng nhập số.";
        public const string Str_LoiImport = "Đã xảy ra lỗi trong quá trình import dữ liệu.";
        public const string Str_ImportThanhCong = "Import dữ liệu thành công.";
        public const string Str_LoadData = "Loading data ...";
        public const string Str_ExcelWorkbook = "Excel Workbook (*.xls)|*.xls";
        public const string Str_KiemTraFileExcel= "Vui lòng kiểm tra lại file excel.";
        public const string Str_LuuImportThanhCong = "Lưu import thành công.";
        public const string Str_LuuImportThatBai = "Lưu import thất bại.";
        public const string Str_ChonLoaiHoatDong = "Vui lòng chọn loại trước khi lưu.";
        public const string Str_Luuxoathanhcong = "Xóa thành công.";
        public const string Str_Luuxoathatbai = "Xóa thất bại.";
        public const string Str_LuuDongBoThanhCong = "Lưu đồng bộ thành công..!";
        public const string Str_LuuDongBoThatBai = "Lưu đồng bộ thất bại..!";
        #endregion
