...
{	
	...
	{		
		...
		public static TList<ThanhTraTheoThoiKhoaBieu> Fill(IDataReader reader, TList<ThanhTraTheoThoiKhoaBieu> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.GioVao = (reader[ThanhTraTheoThoiKhoaBieuColumn.GioVao.ToString()] == DBNull.Value) ? null : (System.String)reader[(ThanhTraTheoThoiKhoaBieuColumn.GioVao.ToString())];
					c.GioRa = (reader[ThanhTraTheoThoiKhoaBieuColumn.GioRa.ToString()] == DBNull.Value) ? null : (System.String)reader[(ThanhTraTheoThoiKhoaBieuColumn.GioRa.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.ThanhTraTheoThoiKhoaBieu entity)
		{
			...
			entity.GioVao = (reader[ThanhTraTheoThoiKhoaBieuColumn.GioVao.ToString()] == DBNull.Value) ? null : (System.String)reader[(ThanhTraTheoThoiKhoaBieuColumn.GioVao.ToString())];
			entity.GioRa = (reader[ThanhTraTheoThoiKhoaBieuColumn.GioRa.ToString()] == DBNull.Value) ? null : (System.String)reader[(ThanhTraTheoThoiKhoaBieuColumn.GioRa.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.ThanhTraTheoThoiKhoaBieu entity)
		{
			...
			entity.GioVao = Convert.IsDBNull(dataRow["GioVao"]) ? null : (System.String)dataRow["GioVao"];
			entity.GioRa = Convert.IsDBNull(dataRow["GioRa"]) ? null : (System.String)dataRow["GioRa"];
			entity.AcceptChanges();
		}
		#endregion 
