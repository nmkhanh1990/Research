<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="HocHamEdit.aspx.cs" Inherits="HocHamEdit" Title="HocHam Edit" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Hoc Ham - Add/Edit</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		<data:MultiFormView ID="FormView1" DataKeyNames="MaHocHam" runat="server" DataSourceID="HocHamDataSource">
		
			<EditItemTemplatePaths>
				<data:TemplatePath Path="~/Admin/UserControls/HocHamFields.ascx" />
			</EditItemTemplatePaths>
		...
		<data:EntityGridView ID="GridViewHeSoChucDanhTietNghiaVu1" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewHeSoChucDanhTietNghiaVu1_SelectedIndexChanged"			 			 
			DataSourceID="HeSoChucDanhTietNghiaVuDataSource1"
			DataKeyNames="MaHeSo"
			...
			<Columns>
				...
				<asp:BoundField DataField="NgayBdApDung" HeaderText="Ngay Bd Ap Dung" SortExpression="[NgayBDApDung]" />				
				<asp:BoundField DataField="NgayKtApDung" HeaderText="Ngay Kt Ap Dung" SortExpression="[NgayKTApDung]" />				
				...
				<asp:BoundField DataField="GiangDaySauDaiHoc" HeaderText="Giang Day Sau Dai Hoc" SortExpression="[GiangDaySauDaiHoc]" />				
				<asp:BoundField DataField="NamHoc" HeaderText="Nam Hoc" SortExpression="[NamHoc]" />				
				<asp:BoundField DataField="HocKy" HeaderText="Hoc Ky" SortExpression="[HocKy]" />				
			</Columns>
			<EmptyDataTemplate>
				<b>No He So Chuc Danh Tiet Nghia Vu Found! </b>
				<asp:HyperLink runat="server" ID="hypHeSoChucDanhTietNghiaVu" NavigateUrl="~/admin/HeSoChucDanhTietNghiaVuEdit.aspx">Add New</asp:HyperLink>
			</EmptyDataTemplate>
		</data:EntityGridView>					
		
		<data:HeSoChucDanhTietNghiaVuDataSource ID="HeSoChucDanhTietNghiaVuDataSource1" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:HeSoChucDanhTietNghiaVuFilter  Column="MaHocHam" QueryStringField="MaHocHam" /> 
					</Filters>
				</data:SqlParameter>
		...
		<data:EntityGridView ID="GridViewDonGia2" runat="server"
			...
			<Columns>
				...
				<asp:BoundField DataField="DonGiaGdtc" HeaderText="Don Gia Gdtc" SortExpression="[DonGiaGdtc]" />				
		...
		<data:DonGiaDataSource ID="DonGiaDataSource2" runat="server" SelectMethod="Find"
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:DonGiaFilter  Column="MaHocHam" QueryStringField="MaHocHam" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
		...
		<br />
		<data:EntityGridView ID="GridViewQuyDinhTienCanTren3" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewQuyDinhTienCanTren3_SelectedIndexChanged"			 			 
			DataSourceID="QuyDinhTienCanTrenDataSource3"
			DataKeyNames="Id"
			AllowMultiColumnSorting="false"
			DefaultSortColumnName="" 
			DefaultSortDirection="Ascending"	
		...
		<data:QuyDinhTienCanTrenDataSource ID="QuyDinhTienCanTrenDataSource3" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:QuyDinhTienCanTrenFilter  Column="MaHocHam" QueryStringField="MaHocHam" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
		...
		<br />
		<data:EntityGridView ID="GridViewGiangVien4" runat="server"
			AutoGenerateColumns="False"	
			OnSelectedIndexChanged="GridViewGiangVien4_SelectedIndexChanged"			 			 
			DataSourceID="GiangVienDataSource4"
		...
		<data:GiangVienDataSource ID="GiangVienDataSource4" runat="server" SelectMethod="Find"
			EnableDeepLoad="True"
			>
			<DeepLoadProperties Method="IncludeChildren" Recursive="False">
	            <Types>
		    ...
		    <Parameters>
				<data:SqlParameter Name="Parameters">
					<Filters>
						<data:GiangVienFilter  Column="MaHocHam" QueryStringField="MaHocHam" /> 
					</Filters>
				</data:SqlParameter>
				<data:CustomParameter Name="OrderByClause" Value="" ConvertEmptyStringToNull="false" /> 
		    </Parameters>
