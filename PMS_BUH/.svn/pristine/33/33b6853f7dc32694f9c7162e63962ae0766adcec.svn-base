...
{
    public partial class ucThanhToanThuLaoHBU : DevExpress.XtraEditors.XtraUserControl
    {
        #region Variable 
        ...
        private void ucThanhToanThuLaoUTE_Load(object sender, EventArgs e)
        {
            ...
            AppGridLookupEdit.ShowField(cboKhoaDonVi, new string[] {  "TenKhoa" }, new string[] { "Tên khoa" }, new int[] { 80, 130 });
        ...
        void InitData()
        {
            ...
            if (cboNamHoc.EditValue != null && cboHocKy.EditValue != null && cboKhoaDonVi.EditValue != null && cboLoaiGiangVien.EditValue != null)
                bindingSourceThanhToan.DataSource = DataServices.UteThanhToanThuLao.GetByNamHocHocKyDonViLoaiGiangVien(cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), cboKhoaDonVi.EditValue.ToString(), int.Parse(cboLoaiGiangVien.EditValue.ToString()));
        }
        ...
        private void btnIn_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            TList<UteThanhToanThuLao> data = new TList<UteThanhToanThuLao>();
            data = bindingSourceThanhToan.DataSource as TList<UteThanhToanThuLao>;
            ...
            {
                frm.InThanhToanThuLaoTheoKhoa_Kcq(PMS.Common.Globals._cauhinh.TenTruong, cboKhoaDonVi.Text, cboLoaiGiangVien.Text, cboNamHoc.EditValue.ToString(), cboHocKy.EditValue.ToString(), PMS.Common.Globals._cauhinh.NguoiLapbieu, data);
                frm.ShowDialog();
            }
            //}
            Cursor.Current = Cursors.Default;
