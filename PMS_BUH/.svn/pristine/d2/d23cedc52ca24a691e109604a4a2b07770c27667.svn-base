...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
			...
			<Columns>
				...
				<asp:BoundField DataField="MaChucDanh" HeaderText="Ma Chuc Danh" SortExpression="[MaChucDanh]"  />
				<asp:BoundField DataField="SiSoToiDa" HeaderText="Si So Toi Da" SortExpression="[SiSoToiDa]"  />
				<asp:BoundField DataField="SiSoToiThieu" HeaderText="Si So Toi Thieu" SortExpression="[SiSoToiThieu]"  />
