...
namespace DevExpress.Common.Grid
{
    public static class AppRepositoryItemGridLookUpEdit
    {
        ...
        public static void InitRepositoryItemCheckedComboBoxEdit(RepositoryItemCheckedComboBoxEdit chk)
        {
            //Show filter
            chk.AutoHeight = false;
            chk.TextEditStyle = TextEditStyles.Standard;
            chk.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
