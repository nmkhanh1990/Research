...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
			...
			<tr>
        <td class="literal"><asp:Label ID="lbldataNhomHoatDongClc" runat="server" Text="Nhom Hoat Dong Clc:" AssociatedControlID="dataNhomHoatDongClc" /></td>
        <td>
					<asp:RadioButtonList runat="server" ID="dataNhomHoatDongClc" SelectedValue='<%# Bind("NhomHoatDongClc") %>' RepeatDirection="Horizontal"><asp:ListItem Value="True" Text="Yes" Selected="True"></asp:ListItem><asp:ListItem Value="False" Text="No"></asp:ListItem></asp:RadioButtonList>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataNhomHoatDongBt" runat="server" Text="Nhom Hoat Dong Bt:" AssociatedControlID="dataNhomHoatDongBt" /></td>
        <td>
					<asp:RadioButtonList runat="server" ID="dataNhomHoatDongBt" SelectedValue='<%# Bind("NhomHoatDongBt") %>' RepeatDirection="Horizontal"><asp:ListItem Value="True" Text="Yes" Selected="True"></asp:ListItem><asp:ListItem Value="False" Text="No"></asp:ListItem></asp:RadioButtonList>
				</td>
			</tr>
			<tr>
