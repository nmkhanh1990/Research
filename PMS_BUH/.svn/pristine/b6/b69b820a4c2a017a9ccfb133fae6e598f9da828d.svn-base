...
{	
	...
	{		
		...
		#region cust_HoatDongNgoaiGiangDayClc_GetByNamHocHocKyKhoaDonViMaHoatDong 
		
		/// <summary>
		///	This method wrap the 'cust_HoatDongNgoaiGiangDayClc_GetByNamHocHocKyKhoaDonViMaHoatDong' stored procedure. 
		/// </summary>
		...
		public IDataReader GetByNamHocHocKyKhoaDonViMaHoatDong(System.String namHoc, System.String hocKy, System.String maDonVi, System.String maHoatDong)
		{
			return GetByNamHocHocKyKhoaDonViMaHoatDong(null, 0, int.MaxValue , namHoc, hocKy, maDonVi, maHoatDong);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader GetByNamHocHocKyKhoaDonViMaHoatDong(int start, int pageLength, System.String namHoc, System.String hocKy, System.String maDonVi, System.String maHoatDong)
		{
			return GetByNamHocHocKyKhoaDonViMaHoatDong(null, start, pageLength , namHoc, hocKy, maDonVi, maHoatDong);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader GetByNamHocHocKyKhoaDonViMaHoatDong(TransactionManager transactionManager, System.String namHoc, System.String hocKy, System.String maDonVi, System.String maHoatDong)
		{
			return GetByNamHocHocKyKhoaDonViMaHoatDong(transactionManager, 0, int.MaxValue , namHoc, hocKy, maDonVi, maHoatDong);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public abstract IDataReader GetByNamHocHocKyKhoaDonViMaHoatDong(TransactionManager transactionManager, int start, int pageLength , System.String namHoc, System.String hocKy, System.String maDonVi, System.String maHoatDong);
		...
		#region cust_HoatDongNgoaiGiangDayClc_LuuImportExcel 
		
		/// <summary>
		///	This method wrap the 'cust_HoatDongNgoaiGiangDayClc_LuuImportExcel' stored procedure. 
		/// </summary>
		...
		public static TList<HoatDongNgoaiGiangDayClc> Fill(IDataReader reader, TList<HoatDongNgoaiGiangDayClc> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.LayDuLieu = (reader[HoatDongNgoaiGiangDayClcColumn.LayDuLieu.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(HoatDongNgoaiGiangDayClcColumn.LayDuLieu.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.HoatDongNgoaiGiangDayClc entity)
		{
			...
			entity.LayDuLieu = (reader[HoatDongNgoaiGiangDayClcColumn.LayDuLieu.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(HoatDongNgoaiGiangDayClcColumn.LayDuLieu.ToString())];
