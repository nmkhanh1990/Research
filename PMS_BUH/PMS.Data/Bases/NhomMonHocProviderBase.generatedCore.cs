...
{	
	...
	{		
		...
		public static TList<NhomMonHoc> Fill(IDataReader reader, TList<NhomMonHoc> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.TinhTrang = (reader[NhomMonHocColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(NhomMonHocColumn.TinhTrang.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.NhomMonHoc entity)
		{
			...
			entity.TinhTrang = (reader[NhomMonHocColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(NhomMonHocColumn.TinhTrang.ToString())];
		...
		public override void DeepLoad(TransactionManager transactionManager, PMS.Entities.NhomMonHoc entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			...
			if (CanDeepLoad(entity, "List<DonGiaTheoNganh>|DonGiaTheoNganhCollection", deepLoadType, innerList)) 
			{
				...
				entity.DonGiaTheoNganhCollection = DataRepository.DonGiaTheoNganhProvider.GetByMaNhomMon(transactionManager, entity.MaNhomMon);
	...
	{
		///<summary>
		/// Collection of <c>NhomMonHoc</c> as OneToMany for DonGiaTheoNganhCollection
		///</summary>
