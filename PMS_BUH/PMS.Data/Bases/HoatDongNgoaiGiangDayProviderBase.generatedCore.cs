...
{	
	...
	{		
		...
		public static TList<HoatDongNgoaiGiangDay> Fill(IDataReader reader, TList<HoatDongNgoaiGiangDay> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.NhomHoatDongBt = (reader[HoatDongNgoaiGiangDayColumn.NhomHoatDongBt.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(HoatDongNgoaiGiangDayColumn.NhomHoatDongBt.ToString())];
					c.NhomHoatDongClc = (reader[HoatDongNgoaiGiangDayColumn.NhomHoatDongClc.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(HoatDongNgoaiGiangDayColumn.NhomHoatDongClc.ToString())];
					c.ThanhToanBinhThuong = (reader[HoatDongNgoaiGiangDayColumn.ThanhToanBinhThuong.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(HoatDongNgoaiGiangDayColumn.ThanhToanBinhThuong.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.HoatDongNgoaiGiangDay entity)
		{
			...
			entity.NhomHoatDongBt = (reader[HoatDongNgoaiGiangDayColumn.NhomHoatDongBt.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(HoatDongNgoaiGiangDayColumn.NhomHoatDongBt.ToString())];
			entity.NhomHoatDongClc = (reader[HoatDongNgoaiGiangDayColumn.NhomHoatDongClc.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(HoatDongNgoaiGiangDayColumn.NhomHoatDongClc.ToString())];
			entity.ThanhToanBinhThuong = (reader[HoatDongNgoaiGiangDayColumn.ThanhToanBinhThuong.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(HoatDongNgoaiGiangDayColumn.ThanhToanBinhThuong.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.HoatDongNgoaiGiangDay entity)
		{
			...
			entity.NhomHoatDongBt = Convert.IsDBNull(dataRow["NhomHoatDongBT"]) ? null : (System.Boolean?)dataRow["NhomHoatDongBT"];
			entity.NhomHoatDongClc = Convert.IsDBNull(dataRow["NhomHoatDongCLC"]) ? null : (System.Boolean?)dataRow["NhomHoatDongCLC"];
			entity.ThanhToanBinhThuong = Convert.IsDBNull(dataRow["ThanhToanBinhThuong"]) ? null : (System.Boolean?)dataRow["ThanhToanBinhThuong"];
			entity.AcceptChanges();
		}
		#endregion 
