...
{	
	...
	{		
		...
		#region cust_TaiKhoan_GetMapTaiKhoanUis 
		
		/// <summary>
		///	This method wrap the 'cust_TaiKhoan_GetMapTaiKhoanUis' stored procedure. 
		/// </summary>
		/// <param name="maTaiKhoanUis"> A <c>System.String</c> instance.</param>
			/// <param name="tenDangNhap"> A <c>System.String</c> instance.</param>
			/// <param name="matKhau"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetMapTaiKhoanUis(System.String maTaiKhoanUis, ref System.String tenDangNhap, ref System.String matKhau)
		{
			 GetMapTaiKhoanUis(null, 0, int.MaxValue , maTaiKhoanUis, ref tenDangNhap, ref matKhau);
		}
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetMapTaiKhoanUis(int start, int pageLength, System.String maTaiKhoanUis, ref System.String tenDangNhap, ref System.String matKhau)
		{
			 GetMapTaiKhoanUis(null, start, pageLength , maTaiKhoanUis, ref tenDangNhap, ref matKhau);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void GetMapTaiKhoanUis(TransactionManager transactionManager, System.String maTaiKhoanUis, ref System.String tenDangNhap, ref System.String matKhau)
		{
			 GetMapTaiKhoanUis(transactionManager, 0, int.MaxValue , maTaiKhoanUis, ref tenDangNhap, ref matKhau);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public abstract void GetMapTaiKhoanUis(TransactionManager transactionManager, int start, int pageLength , System.String maTaiKhoanUis, ref System.String tenDangNhap, ref System.String matKhau);
		...
		#region cust_TaiKhoan_GetAllTaiKhoanUis 
		
		/// <summary>
		///	This method wrap the 'cust_TaiKhoan_GetAllTaiKhoanUis' stored procedure. 
		/// </summary>
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader GetAllTaiKhoanUis()
		{
			return GetAllTaiKhoanUis(null, 0, int.MaxValue );
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader GetAllTaiKhoanUis(int start, int pageLength)
		{
			return GetAllTaiKhoanUis(null, start, pageLength );
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader GetAllTaiKhoanUis(TransactionManager transactionManager)
		{
			return GetAllTaiKhoanUis(transactionManager, 0, int.MaxValue );
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public abstract IDataReader GetAllTaiKhoanUis(TransactionManager transactionManager, int start, int pageLength );
		
		#endregion
		
		#region cust_TaiKhoan_DoiMatKhau 
		
		/// <summary>
		///	This method wrap the 'cust_TaiKhoan_DoiMatKhau' stored procedure. 
		/// </summary>
		/// <param name="maTaiKhoan"> A <c>System.Int32</c> instance.</param>
		/// <param name="tenDangNhap"> A <c>System.String</c> instance.</param>
		/// <param name="matKhau"> A <c>System.String</c> instance.</param>
		/// <param name="md5"> A <c>System.String</c> instance.</param>
			/// <param name="reval"> A <c>System.String</c> instance.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void DoiMatKhau(System.Int32 maTaiKhoan, System.String tenDangNhap, System.String matKhau, System.String md5, ref System.String reval)
		{
			 DoiMatKhau(null, 0, int.MaxValue , maTaiKhoan, tenDangNhap, matKhau, md5, ref reval);
		}
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void DoiMatKhau(int start, int pageLength, System.Int32 maTaiKhoan, System.String tenDangNhap, System.String matKhau, System.String md5, ref System.String reval)
		{
			 DoiMatKhau(null, start, pageLength , maTaiKhoan, tenDangNhap, matKhau, md5, ref reval);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void DoiMatKhau(TransactionManager transactionManager, System.Int32 maTaiKhoan, System.String tenDangNhap, System.String matKhau, System.String md5, ref System.String reval)
		{
			 DoiMatKhau(transactionManager, 0, int.MaxValue , maTaiKhoan, tenDangNhap, matKhau, md5, ref reval);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public abstract void DoiMatKhau(TransactionManager transactionManager, int start, int pageLength , System.Int32 maTaiKhoan, System.String tenDangNhap, System.String matKhau, System.String md5, ref System.String reval);
		...
		public static TList<TaiKhoan> Fill(IDataReader reader, TList<TaiKhoan> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.MaGiangVien = (reader[TaiKhoanColumn.MaGiangVien.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(TaiKhoanColumn.MaGiangVien.ToString())];
					c.UserUis = (reader[TaiKhoanColumn.UserUis.ToString()] == DBNull.Value) ? null : (System.String)reader[(TaiKhoanColumn.UserUis.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.TaiKhoan entity)
		{
			...
			entity.MaGiangVien = (reader[TaiKhoanColumn.MaGiangVien.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(TaiKhoanColumn.MaGiangVien.ToString())];
			entity.UserUis = (reader[TaiKhoanColumn.UserUis.ToString()] == DBNull.Value) ? null : (System.String)reader[(TaiKhoanColumn.UserUis.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.TaiKhoan entity)
		{
			...
			entity.UserUis = Convert.IsDBNull(dataRow["UserUis"]) ? null : (System.String)dataRow["UserUis"];
			entity.AcceptChanges();
		}
		#endregion 
