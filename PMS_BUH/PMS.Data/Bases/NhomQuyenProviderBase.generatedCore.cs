...
{	
	...
	{		
		...
		public static TList<NhomQuyen> Fill(IDataReader reader, TList<NhomQuyen> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.LoaiLop = (reader[NhomQuyenColumn.LoaiLop.ToString()] == DBNull.Value) ? null : (System.String)reader[(NhomQuyenColumn.LoaiLop.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.NhomQuyen entity)
		{
			...
			entity.LoaiLop = (reader[NhomQuyenColumn.LoaiLop.ToString()] == DBNull.Value) ? null : (System.String)reader[(NhomQuyenColumn.LoaiLop.ToString())];
