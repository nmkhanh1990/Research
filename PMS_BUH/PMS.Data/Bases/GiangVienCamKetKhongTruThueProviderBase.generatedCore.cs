...
{	
	...
	{		
		...
		#region cust_GiangVienCamKetKhongTruThue_LuuXacNhanChiTra 
		
		/// <summary>
		///	This method wrap the 'cust_GiangVienCamKetKhongTruThue_LuuXacNhanChiTra' stored procedure. 
		/// </summary>
		...
		public static TList<GiangVienCamKetKhongTruThue> Fill(IDataReader reader, TList<GiangVienCamKetKhongTruThue> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.ThueTncn = (reader[GiangVienCamKetKhongTruThueColumn.ThueTncn.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(GiangVienCamKetKhongTruThueColumn.ThueTncn.ToString())];
					c.XacNhanThue = (reader[GiangVienCamKetKhongTruThueColumn.XacNhanThue.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(GiangVienCamKetKhongTruThueColumn.XacNhanThue.ToString())];
					c.XacNhanKhongThue = (reader[GiangVienCamKetKhongTruThueColumn.XacNhanKhongThue.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(GiangVienCamKetKhongTruThueColumn.XacNhanKhongThue.ToString())];
					c.MaHoatDong = (reader[GiangVienCamKetKhongTruThueColumn.MaHoatDong.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(GiangVienCamKetKhongTruThueColumn.MaHoatDong.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.GiangVienCamKetKhongTruThue entity)
		{
			...
			entity.ThueTncn = (reader[GiangVienCamKetKhongTruThueColumn.ThueTncn.ToString()] == DBNull.Value) ? null : (System.Decimal?)reader[(GiangVienCamKetKhongTruThueColumn.ThueTncn.ToString())];
			entity.XacNhanThue = (reader[GiangVienCamKetKhongTruThueColumn.XacNhanThue.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(GiangVienCamKetKhongTruThueColumn.XacNhanThue.ToString())];
			entity.XacNhanKhongThue = (reader[GiangVienCamKetKhongTruThueColumn.XacNhanKhongThue.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(GiangVienCamKetKhongTruThueColumn.XacNhanKhongThue.ToString())];
			entity.MaHoatDong = (reader[GiangVienCamKetKhongTruThueColumn.MaHoatDong.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(GiangVienCamKetKhongTruThueColumn.MaHoatDong.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.GiangVienCamKetKhongTruThue entity)
		{
			...
			entity.XacNhanThue = Convert.IsDBNull(dataRow["XacNhanThue"]) ? null : (System.Boolean?)dataRow["XacNhanThue"];
			entity.XacNhanKhongThue = Convert.IsDBNull(dataRow["XacNhanKhongThue"]) ? null : (System.Boolean?)dataRow["XacNhanKhongThue"];
