...
{	
	...
	{		
		...
		public static TList<HocVi> Fill(IDataReader reader, TList<HocVi> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.TinhTrang = (reader[HocViColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(HocViColumn.TinhTrang.ToString())];
					c.MaQuanLyHrm = (reader[HocViColumn.MaQuanLyHrm.ToString()] == DBNull.Value) ? null : (System.String)reader[(HocViColumn.MaQuanLyHrm.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.HocVi entity)
		{
			...
			entity.TinhTrang = (reader[HocViColumn.TinhTrang.ToString()] == DBNull.Value) ? null : (System.Boolean?)reader[(HocViColumn.TinhTrang.ToString())];
			entity.MaQuanLyHrm = (reader[HocViColumn.MaQuanLyHrm.ToString()] == DBNull.Value) ? null : (System.String)reader[(HocViColumn.MaQuanLyHrm.ToString())];
		...
		public override void DeepLoad(TransactionManager transactionManager, PMS.Entities.HocVi entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			...
			if (CanDeepLoad(entity, "List<DonGiaTheoNganh>|DonGiaTheoNganhCollection", deepLoadType, innerList)) 
			{
				...
				entity.DonGiaTheoNganhCollection = DataRepository.DonGiaTheoNganhProvider.GetByMaHocVi(transactionManager, entity.MaHocVi);
	...
	{
		///<summary>
		/// Collection of <c>HocVi</c> as OneToMany for DonGiaTheoNganhCollection
		///</summary>
