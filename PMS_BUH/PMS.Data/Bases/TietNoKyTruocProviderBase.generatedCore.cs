...
{	
	...
	{		
		...
		#region cust_TietNoKyTruoc_LuuSauKhiBaoLuu 
		
		/// <summary>
		///	This method wrap the 'cust_TietNoKyTruoc_LuuSauKhiBaoLuu' stored procedure. 
		/// </summary>
		...
		public void LuuSauKhiBaoLuu(System.String xmlData, System.String namHoc, System.String hocKy, ref System.Int32 reVal)
		{
			 LuuSauKhiBaoLuu(null, 0, int.MaxValue , xmlData, namHoc, hocKy, ref reVal);
		}
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void LuuSauKhiBaoLuu(int start, int pageLength, System.String xmlData, System.String namHoc, System.String hocKy, ref System.Int32 reVal)
		{
			 LuuSauKhiBaoLuu(null, start, pageLength , xmlData, namHoc, hocKy, ref reVal);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void LuuSauKhiBaoLuu(TransactionManager transactionManager, System.String xmlData, System.String namHoc, System.String hocKy, ref System.Int32 reVal)
		{
			 LuuSauKhiBaoLuu(transactionManager, 0, int.MaxValue , xmlData, namHoc, hocKy, ref reVal);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public abstract void LuuSauKhiBaoLuu(TransactionManager transactionManager, int start, int pageLength , System.String xmlData, System.String namHoc, System.String hocKy, ref System.Int32 reVal);
		...
		public static TList<TietNoKyTruoc> Fill(IDataReader reader, TList<TietNoKyTruoc> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.DotChiTra = (reader[TietNoKyTruocColumn.DotChiTra.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(TietNoKyTruocColumn.DotChiTra.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.TietNoKyTruoc entity)
		{
			...
			entity.DotChiTra = (reader[TietNoKyTruocColumn.DotChiTra.ToString()] == DBNull.Value) ? null : (System.Int32?)reader[(TietNoKyTruocColumn.DotChiTra.ToString())];
		...
		public static void RefreshEntity(DataSet dataSet, PMS.Entities.TietNoKyTruoc entity)
		{
			...
			entity.DotChiTra = Convert.IsDBNull(dataRow["DotChiTra"]) ? null : (System.Int32?)dataRow["DotChiTra"];
			entity.AcceptChanges();
		}
		#endregion 
