...
{	
	...
	{		
		...
		public IDataReader DanhSachChucVu(System.String maKhoa)
		{
			return DanhSachChucVu(null, 0, int.MaxValue , maKhoa);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader DanhSachChucVu(int start, int pageLength, System.String maKhoa)
		{
			return DanhSachChucVu(null, start, pageLength , maKhoa);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public IDataReader DanhSachChucVu(TransactionManager transactionManager, System.String maKhoa)
		{
			return DanhSachChucVu(transactionManager, 0, int.MaxValue , maKhoa);
		}
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		/// <returns>A <see cref="IDataReader"/> instance.</returns>
		public abstract IDataReader DanhSachChucVu(TransactionManager transactionManager, int start, int pageLength , System.String maKhoa);
		...
		/// <remark>This method is generate from a stored procedure.</remark>
		public void LuuDanhSachInHopDong(System.String xmlData, System.String maDonVi, ref System.Int32 reVal)
		{
			 LuuDanhSachInHopDong(null, 0, int.MaxValue , xmlData, maDonVi, ref reVal);
		}
		...
		/// <param name="pageLength">Number of rows to return.</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void LuuDanhSachInHopDong(int start, int pageLength, System.String xmlData, System.String maDonVi, ref System.Int32 reVal)
		{
			 LuuDanhSachInHopDong(null, start, pageLength , xmlData, maDonVi, ref reVal);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public void LuuDanhSachInHopDong(TransactionManager transactionManager, System.String xmlData, System.String maDonVi, ref System.Int32 reVal)
		{
			 LuuDanhSachInHopDong(transactionManager, 0, int.MaxValue , xmlData, maDonVi, ref reVal);
		}
		...
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <remark>This method is generate from a stored procedure.</remark>
		public abstract void LuuDanhSachInHopDong(TransactionManager transactionManager, int start, int pageLength , System.String xmlData, System.String maDonVi, ref System.Int32 reVal);
