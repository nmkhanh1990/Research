...
{	
	...
	{		
		...
		public static TList<DinhMucGioChuan> Fill(IDataReader reader, TList<DinhMucGioChuan> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.MaBacDaoTao = (reader[DinhMucGioChuanColumn.MaBacDaoTao.ToString()] == DBNull.Value) ? null : (System.String)reader[(DinhMucGioChuanColumn.MaBacDaoTao.ToString())];
					c.MaLoaiHinhDaoTao = (reader[DinhMucGioChuanColumn.MaLoaiHinhDaoTao.ToString()] == DBNull.Value) ? null : (System.String)reader[(DinhMucGioChuanColumn.MaLoaiHinhDaoTao.ToString())];
					c.MaNhomGiangVien = (reader[DinhMucGioChuanColumn.MaNhomGiangVien.ToString()] == DBNull.Value) ? null : (System.String)reader[(DinhMucGioChuanColumn.MaNhomGiangVien.ToString())];
		...
		public static void RefreshEntity(IDataReader reader, PMS.Entities.DinhMucGioChuan entity)
		{
			...
			entity.MaBacDaoTao = (reader[DinhMucGioChuanColumn.MaBacDaoTao.ToString()] == DBNull.Value) ? null : (System.String)reader[(DinhMucGioChuanColumn.MaBacDaoTao.ToString())];
			entity.MaLoaiHinhDaoTao = (reader[DinhMucGioChuanColumn.MaLoaiHinhDaoTao.ToString()] == DBNull.Value) ? null : (System.String)reader[(DinhMucGioChuanColumn.MaLoaiHinhDaoTao.ToString())];
			entity.MaNhomGiangVien = (reader[DinhMucGioChuanColumn.MaNhomGiangVien.ToString()] == DBNull.Value) ? null : (System.String)reader[(DinhMucGioChuanColumn.MaNhomGiangVien.ToString())];
